package classes.UIComponents 
{
	...
	public class ButtonTray extends Sprite
	{
		 ...
		 */
		public function addItemButton(slot:int, name:String = "", quantity:int = 0, func:Function = undefined, arg:* = undefined, ttHeader:String = null, ttBody:String = null, ttComparison:String = null):void
		{
			if (slot <= 14)
			{
