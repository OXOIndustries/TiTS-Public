package classes.UIComponents 
{
	...
	public class ButtonTray extends Sprite
	{
		 ...
		 */
		public function addItemButton(slot:int, name:String = "", quantity:int = 0, func:Function = null, arg:* = undefined, ttHeader:String = null, ttBody:String = null, ttComparison:String = null):void
		{
			if (slot <= 14)
			{
				if(func === null) _buttons[slot].setItemDisabledData(name, quantity, ttHeader, ttBody, ttComparison);
