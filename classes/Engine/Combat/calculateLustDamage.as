package classes.Engine.Combat 
{
	...
	public function calculateLustDamage(target:Creature, attacker:Creature, damageResult:DamageResult, special:String = ""):void
	{
		...
		if (target.hasPiercingOfClass(GeddaniumRingPiercing) && attacker.hasScales()) damMulti += 0.3;
		else if(attacker.hasPiercingOfClass(GeddaniumRingPiercing) && target.hasScales()) damMulti += 0.3;
