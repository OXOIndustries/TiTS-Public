		...
		public function earDescript(): String
		{
			...
			switch (earType)
			{
				...
				case GLOBAL.TYPE_MOUSE:
					adjectives = ["mousy", "mouse-like", "rounded", "furry", "circular"];
					break;
		...
		*/
		...
		public function cockNoun(type: Number, simple: Boolean = true, tail: Boolean = false): String {
			...
			else if (type == GLOBAL.TYPE_SAURIAN)
			{
				...
				if(silly)
				{
					if (descript != "dinosaur ") choices.push("dino-dick","dino-cock");
					if (descript != "saurian ") choices.push("penisaurus","schlongosaur");
				}
				noun += choices[rand(choices.length)];
			}
