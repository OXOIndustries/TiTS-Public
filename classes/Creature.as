	...
	public class Creature extends VersionedSaveable implements IOwner {
		...
		*/
		...
		public function breastCup(rowNum: Number = 0, ratingCheck: int = -1): String {
			...
			else if (check < 25) return "large HHH-cup";
			else if (check < 26) return "I-cup";
			else if (check < 27) return "large I-cup";
			else if (check < 28) return "II-cup";
			else if (check < 29) return "large II-cup";
			else if (check < 30) return "J-cup";
			else if (check < 31) return "large J-cup";
			else if (check < 32) return "JJ-cup";
			else if (check < 33) return "large JJ-cup";
			else if (check < 34) return "K-cup";
			else if (check < 35) return "large K-cup";
			else if (check < 36) return "KK-cup";
			else if (check < 37) return "large KK-cup";
			else if (check < 38) return "L-cup";
			else if (check < 39) return "large L-cup";
			else if (check < 40) return "LL-cup";
			else if (check < 41) return "large LL-cup";
			else if (check < 42) return "M-cup";
			else if (check < 43) return "large M-cup";
			else if (check < 44) return "MM-cup";
			else if (check < 45) return "large MM-cup";
			else if (check < 46) return "N-cup";
			else if (check < 47) return "large N-cup";
			else if (check < 48) return "NN-cup";
			else if (check < 49) return "large NN-cup";
			else if (check < 50) return "O-cup";
			else if (check < 51) return "large O-cup";
			else if (check < 52) return "OO-cup";
			else if (check < 53) return "large OO-cup";
			else if (check < 54) return "P-cup";
			else if (check < 55) return "large P-cup";
			else if (check < 56) return "PP-cup";
			else if (check < 57) return "large PP-cup";
			else if (check < 58) return "Q-cup";
			else if (check < 59) return "large Q-cup";
			else if (check < 60) return "QQ-cup";
			else if (check < 61) return "large QQ-cup";
			else if (check < 62) return "QQQ-cup";
			else if (check < 63) return "huge QQQ-cup";
			else if (check < 64) return "R-cup";
			else if (check < 65) return "huge R-cup";
			else if (check < 66) return "RR-cup";
			else if (check < 67) return "huge RR-cup";
			else if (check < 68) return "S-cup";
			else if (check < 69) return "huge S-cup";
			else if (check < 70) return "SS-cup";
			else if (check < 71) return "huge SS-cup";
			else if (check < 72) return "T-cup";
			else if (check < 73) return "huge T-cup";
			else if (check < 74) return "TT-cup";
			else if (check < 75) return "huge TT-cup";
			else if (check < 76) return "U-cup";
			else if (check < 77) return "huge U-cup";
			else if (check < 78) return "UU-cup";
			else if (check < 79) return "huge UU-cup";
			else if (check < 80) return "V-cup";
			else if (check < 81) return "huge V-cup";
			else if (check < 82) return "VV-cup";
			else if (check < 83) return "huge VV-cup";
			else if (check < 84) return "W-cup";
			else if (check < 85) return "huge W-cup";
			else if (check < 86) return "WW-cup";
			else if (check < 87) return "huge WW-cup";
			else if (check < 88) return "X-cup";
			else if (check < 89) return "huge X-cup";
			else if (check < 90) return "XX-cup";
			else if (check < 91) return "huge XX-cup";
			else if (check < 92) return "Y-cup";
			else if (check < 93) return "huge Y-cup";
			else if (check < 94) return "YY-cup";
			else if (check < 95) return "huge YY-cup";
			else if (check < 96) return "Z-cup";
			else if (check < 97) return "huge Z-cup";
			else if (check < 98) return "ZZ-cup";
			else if (check < 99) return "huge ZZ-cup";
			else if (check < 100) return "ZZZ-cup";
			...
			else if (check < 124) return "hyper large HHH-cup";
			else if (check < 125) return "hyper I-cup";
			else if (check < 126) return "hyper large I-cup";
			else if (check < 127) return "hyper II-cup";
			else if (check < 128) return "hyper large II-cup";
			else if (check < 129) return "hyper J-cup";
			else if (check < 130) return "hyper large J-cup";
			else if (check < 131) return "hyper JJ-cup";
			else if (check < 132) return "hyper large JJ-cup";
			else if (check < 133) return "hyper K-cup";
			else if (check < 134) return "hyper large K-cup";
			else if (check < 135) return "hyper KK-cup";
			else if (check < 136) return "hyper large KK-cup";
			else if (check < 137) return "hyper L-cup";
			else if (check < 138) return "hyper large L-cup";
			else if (check < 139) return "hyper LL-cup";
			else if (check < 140) return "hyper large LL-cup";
			else if (check < 141) return "hyper M-cup";
			else if (check < 142) return "hyper large M-cup";
			else if (check < 143) return "hyper MM-cup";
			else if (check < 144) return "hyper large MM-cup";
			else if (check < 145) return "hyper N-cup";
			else if (check < 146) return "hyper large N-cup";
			else if (check < 147) return "hyper NN-cup";
			else if (check < 148) return "hyper large NN-cup";
			else if (check < 149) return "hyper O-cup";
			else if (check < 150) return "hyper large O-cup";
			else if (check < 151) return "hyper OO-cup";
			else if (check < 152) return "hyper large OO-cup";
			else if (check < 153) return "hyper P-cup";
			else if (check < 154) return "hyper large P-cup";
			else if (check < 155) return "hyper PP-cup";
			else if (check < 156) return "hyper large PP-cup";
			else if (check < 157) return "hyper Q-cup";
			else if (check < 158) return "hyper large Q-cup";
			else if (check < 159) return "hyper QQ-cup";
			else if (check < 160) return "hyper large QQ-cup";
			else if (check < 161) return "hyper QQQ-cup";
			else if (check < 162) return "hyper huge QQQ-cup";
			else if (check < 163) return "hyper R-cup";
			else if (check < 164) return "hyper huge R-cup";
			else if (check < 165) return "hyper RR-cup";
			else if (check < 166) return "hyper huge RR-cup";
			else if (check < 167) return "hyper S-cup";
			else if (check < 168) return "hyper huge S-cup";
			else if (check < 169) return "hyper SS-cup";
			else if (check < 170) return "hyper huge SS-cup";
			else if (check < 171) return "hyper T-cup";
			else if (check < 172) return "hyper huge T-cup";
			else if (check < 173) return "hyper TT-cup";
			else if (check < 174) return "hyper huge TT-cup";
			else if (check < 175) return "hyper U-cup";
			else if (check < 176) return "hyper huge U-cup";
			else if (check < 177) return "hyper UU-cup";
			else if (check < 178) return "hyper huge UU-cup";
			else if (check < 179) return "hyper V-cup";
			else if (check < 180) return "hyper huge V-cup";
			else if (check < 181) return "hyper VV-cup";
			else if (check < 182) return "hyper huge VV-cup";
			else if (check < 183) return "hyper W-cup";
			else if (check < 184) return "hyper huge W-cup";
			else if (check < 185) return "hyper WW-cup";
			else if (check < 186) return "hyper huge WW-cup";
			else if (check < 187) return "hyper X-cup";
			else if (check < 188) return "hyper huge X-cup";
			else if (check < 189) return "hyper XX-cup";
			else if (check < 190) return "hyper huge XX-cup";
			else if (check < 191) return "hyper Y-cup";
			else if (check < 192) return "hyper huge Y-cup";
			else if (check < 193) return "hyper YY-cup";
			else if (check < 194) return "hyper huge YY-cup";
			else if (check < 195) return "hyper Z-cup";
			else if (check < 196) return "hyper huge Z-cup";
			else if (check < 197) return "hyper ZZ-cup";
			else if (check < 198) return "hyper huge ZZ-cup";
			else if (check < 199) return "hyper ZZZ-cup";
