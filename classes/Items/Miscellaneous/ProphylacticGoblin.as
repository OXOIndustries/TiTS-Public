	...
	public class ProphylacticGoblin extends ItemSlotClass
	{
		...
		override public function useFunction(target:Creature, usingCreature:Creature = null):Boolean
		{
			...
			if(target is PlayerCharacter) {
				...
				if(!target.hasStatusEffect("Gabilani Prophylactic")) target.createStatusEffect("Gabilani Prophylactic", 0, 0, 0, 0, false, "Icon_Perfume", "The spray currently effecting you will reduce encounters with gabilani.", false, 1200,0xB793C4);
