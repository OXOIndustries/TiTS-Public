package classes.Items.Miscellaneous
{
	...
	public class ProphylacticRaskvel extends ItemSlotClass
	{
		
		//constructor
		public function ProphylacticRaskvel()
		{
			...
			this.shortName = "Rask P.";
			
			//Regular name
			this.longName = "raskvel prophylactic";
			
			TooltipManager.addFullName(this.shortName, StringUtil.toTitleCase(this.longName));
			
			//Longass shit, not sure what used for yet.
			this.description = "a prophylactic designed to repel raskvel";
			
			//Displayed on tooltips during mouseovers
			this.tooltip = "A tubular aerosol canister with the outline of a raskvel on it. Once sprayed on, it should detract any raskvel from approaching you for a time. It doesn’t feel particularly full; you suspect you’ll only get one use out of it.";
