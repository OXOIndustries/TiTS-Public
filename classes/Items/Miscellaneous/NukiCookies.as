		...
		override public function useFunction(target:Creature, usingCreature:Creature = null):Boolean
		{
			...
			if(target is PlayerCharacter) {
				...
				if(pc.nukiScore() >= 4 && rand(4) == 0 && !pc.hasPerk("'Nuki Drunk"))
				{
					...
					kGAMECLASS.output("\n\n(Perk Gained: ‘Nuki Drunk - Get drunk twice as slow and sober up four times slower.)");
				...
				if(pc.hasFur() && pc.faceType != GLOBAL.TYPE_HUMAN && pc.faceType != GLOBAL.TYPE_KUITAN && changes < changeLimit && rand(5) == 0)
				{
				...
				if(pc.armType != GLOBAL.TYPE_KUITAN)
				{
...
//Reqs 2 balls && !trap pouch
	...
	A surge of arousal hits you, perfectly timed with almost instantaneous engorgement of your crotch - and not just from your [pc.cocks] either. Your [pc.balls] are swelling larger by the minute. Interestingly, they seem a little bit less sensitive. Gently kneading them feels kind of nice, actually. You whimper and force yourself to stop. If you kept it up, you’d probably wind up blowing your load.
		//+2 libido, +15 lust
	//3.5 to 4
	There’s no hiding the way your [pc.sack] is swelling out with newfound mass, the microscopic robots causing your testicular tissue to divide seemingly endlessly. It’s getting pretty heavy now, and you’ve got to be careful when sitting down not to crush. At least they feel really nice to run your fingers across.
		//+1 libido
		//+5 lust
	//4 to 4.5
	...
	You break out in sweat all over, not from the heat but from your suddenly hammering heart. Your [pc.legs] wobble and dump you to the ground, which is for the best really. Your package visibly jiggles with each heartbeat, the orb-like sperm-producers expanding in almost imperceptible spurts. Ribbons of pre-cum roll out of your [pc.cocks] while you watch. followed shortly after by a few drops of [pc.cumNoun]. You feel fuller than you’ve ever been, made randy by overwhelming need.
		...
		//refil balls.
	//Rare: 5+
	The ‘Nuki Cookies must have some kind of unexpected reaction with your body, because you go from patiently watching and waiting to overwhelmed with lust. Your [pc.sack] grows tight. Muscles in your middle spasm, and you start hosing [pc.cum] out of your [pc.cocks] long before {it’s/they’re} even hard.
	//CrotchGurbed
	...
	The flow refuses to ebb or slow for what feels like hours, but it must have only been minutes. When it does finally come to an end, you’re left panting and [pc.cumNoun]-stained, and <b>your balls are even bigger.</b> Maybe you had best lay off the tanuki treats for a while{... and get a change of bottoms}.	
...
Crazy triknot shit.
	...
	//Sheathhas
	Your sheath pulls your [pc.cock “ + x + “] back into it out of the blue. You {were excited enough to be sticking out from the potential transformations, but it seems to have changed its mind./were really excited. Why would it do that?} Maybe... maybe the cookies are doing something to your dick? Your sheath 
//Merge. No new pg
confirms your suspicions when it starts pulling more of your [pc.cock “ + x + “] inside it. You can still feel yourself in there, somewhere inside the soft flesh of your own body, but your shape is definitely changing, twisted by the nanoscale machines engineering your body.
	...
	<b>{One of your penises/Your penis} is just like that of a kui-tan now.</b> You’ll have to take it for a spin sometime.

//Black Cunt Color
	A tickling, teasing sensation flutters across your nether-lips - {both sets/every single set of them}, leaving you intensely aware of your own movements. You peek down there to see what’s going on{, taking special care to move your [pc.lowerGarments] out of the way}. <b>Your [pc.vaginas] {is/are} black!</b> Everything from the lips to the clit is a dusky onyx that glistens in the light. Nothing else changed at least.
*/
				if(changes == 0)
				{
