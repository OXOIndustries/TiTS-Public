	...
	public class EMPGrenade extends ItemSlotClass
	{
		...
		public function throwGrenade(targetCreature:Creature, attacker:Creature):void 
		{
			...
			{	
				...
				if (!cTarget.hasStatusEffect("Stunned") && (cTarget.originalRace == "robot" || cTarget.originalRace == "Automaton") && cTarget.hasShields() && !cTarget.getHPResistances().hasFlag(DamageFlag.GROUNDED))
				{
