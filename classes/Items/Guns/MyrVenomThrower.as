package classes.Items.Guns
{
	...
	public class MyrVenomThrower extends ItemSlotClass
	{
		...
		public function MyrVenomThrower()
		{
			...
			this.tooltip = "A modified flamethrower converted to expel a gaseous form of the red myr’s venom. It appears to be based upon a repurposed gold myr design.";
			this.attackVerb = "gas";
