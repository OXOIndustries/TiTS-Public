package classes.Items.Toys.Bubbles
{
	...
	public class HugeCumBubble extends ItemSlotClass
	{
		//constructor
		public function HugeCumBubble()
		{
			...
			this.shortName = "H.Bubble";
			
			//Regular name
			this.longName = "huge cum bubble";
			
			TooltipManager.addFullName(this.shortName, StringUtil.toTitleCase(this.longName));
			
			//Longass shit, not sure what used for yet.
			this.description = "a huge bubble of cum";
			
			//Displayed on tooltips during mouseovers
			this.tooltip = "A massive lavender sphere, roughly the size of a swollen beachball, filled with your cum. Some trait of the latex casing preserves the warmth and potency of its squishy contents. The rubbery casing is slightly elastic, but sufficient force or a sharp point should pop the bubble.";
			...
			baseDamage.tease.damageValue = 25;
