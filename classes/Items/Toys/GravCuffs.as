	...
	public class GravCuffs extends ItemSlotClass
	{
		...
		override public function useFunction(target:Creature, usingCreature:Creature = null):Boolean
		{
			...
			if(target is PlayerCharacter) {
				if(kGAMECLASS.rooms[currentLocation].planet == "PLANET: NEW TEXAS" && kGAMECLASS.rooms[currentLocation].hasFlag(GLOBAL.PUBLIC) && kGAMECLASS.flags["NEW_TEXAS_GANGBANGED"] != undefined)
				{
