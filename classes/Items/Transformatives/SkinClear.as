			...
			switch(selTF)
			{
				...
				case 2:
					...
					if(!target.isBro())
					{
						...
						output("\n\nFinally, you feel a tingling sensation work its way up your spine, the sure sign that you’ve reached climax. Unable to keep up your pace, you stop, feeling your load of [pc.cum] push its way out of your [pc.balls] and up your flailing cock" + (uniCock ? "" : "s") + ". Flopping backwards, your body cums without your assistance, " + (uniCock ? "your single shaft pulses, pushing the whole load straight up in a tiny fountain spray that arcs over you, splattering down in large drops as you close your eyes in exhaustion" : "each cock head spasms as it shoots streamers of [pc.cum] into the air, falling back to coat you in hot stripes of your own jizz") + ".");
				...
				case 3:
					...
					else
					{
						...
						output("\n\nYou moan unintentionally, having stuck a finger or two back into your [pc.vagina " + vagIdx + "]");
						if(libidoGain) output(", enjoying the increased sensitivity more than you should");
						output(". As you pull them out, you notice that the inside is still glistening with a steady stream of the sticky stuff seeping right from the walls of your vag. <b>It looks like your " + (uniVag ? "pussy is" : "pussies are") + " now continually drooling lube</b>.");
		...
		private function badEndTF(arg:Array):void
		{
			...
			switch(pageNum)
			{
				...
				case 5:
					...
					output("\n\nThere’s a knock of the door of the spaceship. You grunt in frustration, stopping what you are doing and walking over to the door. Opening it, you are face to face with a plumed, avian biped. He - you assume it’s a he - blinks his eyes at the sight of you. <i>“Miss, your ship has been stationed here for a month. You need to leave. The other spaceport attendants have told you the same thing!”</i> He squawks, arms crossed over his chest. You grin slowly, leaning to one side, dick swinging between the two of you. Oh, yes, the station attendants. You were just finishing with one now. Maybe he’s likely to come and see? He blinks again, nervously, then nods, stepping through the door. As it slides closed behind him, you grin, dick hardening as you begin to fantasize about what you are going to do to his bony ass.");
					output("\n\nYou follow him as he walks through your ship, sniffing disparagingly at the thin coating of slime on everything. You apologize, saying it makes you and the crew feel more comfortable. When he gets to the opening in the next room, he freezes, eyes widening in shock. You’re on him in a moment, pushing him forward and tearing off his pants. He shrieks, trying to claw at you, but your body simply grabs his flailing limbs, holding him in place as your massive dick pokes gently at his back door. <i>“When I finish, the other attendants get a turn with you. They say that you’re kind of a prick”</i> You whisper to him, and the gooey attendants in front of him begin to giggle, dicks hardening as you slide him down your pseudo-penis.");
				...
				case 7:
					...
					kGAMECLASS.generateMap();
					kGAMECLASS.sleepHeal();
					kGAMECLASS.processTime(1051200 + rand(10080));
