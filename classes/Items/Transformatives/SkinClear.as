		...
		private function badEndTF(arg:Array):void
		{
			...
			switch(pageNum)
			{
				case 0:
					...
					output("You make yourself comfortable, used to the transformation taking some time to set in. You wonder what new part of you will become coated in a layer of shiny, oiled lubricant after this most recent dose, mind wandering as you wait for the changes to start. Time seems to stretch on and on, and you find your eyelids drooping slightly, a feeling of fatigue coming over you. Weird, you hadn’t felt so tired when you drank the peachy liquid, but whatever, a nap wouldn’t hurt. You close your eyes, settling back against a nearby " + (kGAMECLASS.rooms[kGAMECLASS.currentLocation].hasFlag(GLOBAL.OUTDOOR) ? "rock" : "wall") + ". Dimly, you’re aware of a warm heat starting to diffuse through you, but you can do nothing as sleep overtakes you, dragging you into the inky darkness of unconsciousness.");
