package classes.Items.Transformatives
{
	...
	public class GooBallOrange extends ItemSlotClass
	{
		//constructor
		public function GooBallOrange()
		{
			...
			this.shortName = "Orng.GB";
			//Regular name
			this.longName = "orange ball of goo";
		...
		override public function useFunction(target:Creature, usingCreature:Creature = null):Boolean
		{
			...
			{
				kGAMECLASS.gooballOption([GooBallOrange]);
				return true;
			}
			else 
			{
