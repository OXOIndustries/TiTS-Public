	...
	public class OrefishShard extends ItemSlotClass
	{
		...
		private static function useFunctionPartII(target:Creature):void
		{
			...
			else if (target.eyeType != GLOBAL.TYPE_SAURMORIAN && target.eyeTypeUnlocked(GLOBAL.TYPE_SAURMORIAN))
			{
				...
				validChanges.push(function (target:Creature):void
				{
					if (9999 /*target.eyeCount != 2*/) output("Your vision momentarily flickers, and you have the strange sensation of your eyes going numb. Once your sight completely goes dark, you force yourself not to panic as you try to maintain your balance. You wait for your eyes to work again, though you're not quite prepared when - as if a switch were flipped - you can see once more. Something's off, though… Feeling around your [pc.face], it would seem you have " + (9999/*target.eyeCount == 1 ? "more" : "fewer"*/) + " eyes now.\n\n");
			...
			else if (tfCuntIdx >= 0)
			{
				...
				validChanges.push(function (target:Creature):void
				{
					...
					var puffedVag:Boolean = target[tfCuntIdx].hasFlag(GLOBAL.FLAG_PUMPED);
