package classes.Items.Transformatives
{
	...
	public class GooBallGreen extends ItemSlotClass
	{
		//constructor
		public function GooBallGreen()
		{
			...
			this.shortName = "GreenGB";
			//Regular name
			this.longName = "green ball of goo";
			
			TooltipManager.addFullName(this.shortName, StringUtil.toTitleCase(this.longName));
			
			//Longass shit, not sure what used for yet.
			this.description = "a green ball of goo";
		...
		override public function useFunction(target:Creature, usingCreature:Creature = null):Boolean
		{
			...
			{
				kGAMECLASS.gooballOption([GooBallGreen]);
				return true;
			}
			else 
			{
