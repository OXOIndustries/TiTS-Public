package classes.Items.Transformatives
{
	...
	public class GooBallPurple extends ItemSlotClass
	{
		//constructor
		public function GooBallPurple()
		{
			...
			this.shortName = "Purp.GB";
			//Regular name
			this.longName = "purple ball of goo";
			
			TooltipManager.addFullName(this.shortName, StringUtil.toTitleCase(this.longName));
			
			//Longass shit, not sure what used for yet.
			this.description = "a purple ball of goo";
		...
		override public function useFunction(target:Creature, usingCreature:Creature = null):Boolean
		{
			...
			{
				kGAMECLASS.gooballOption([GooBallPurple]);
				return true;
			}
			else 
			{
