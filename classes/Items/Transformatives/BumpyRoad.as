package classes.Items.Transformatives
{
	...
	public class BumpyRoad extends ItemSlotClass
	{
		...
		private function cockTF(arg:Array):void
		{
			...
			output("\n\nTeasing your [pc.cockHead " + i + "] to make sure you remain at full mast, you wait a few good minutes before the first nub starts to appear. The spot where you initially injected suddenly grows painful, the flesh twisting and swelling with a small fatty bump. It soon plumps up as more and more pulsating prickles begin sprouting all around your shaft. You sigh in relief as the pain stops and the lumps finish their growth. That’s as fat as they’re gonna get.");
			output("\n\nTouching one of the nubs leaves you frowning, realizing that you can’t feel anything through them. You were promised hypersensitive nubs... these are nothing more than balls of spongy meat! Before you can think of complaining any further, a sudden rush of blood fills your turgid length - more firm and plump than ever before. The nodules light up in pain as new nerves begin to grow within them. Bringing a finger to the first nub, you gently massage it against your shaft and it answers back with an overwhelming wave of pleasure. Each nub grows a aet of nerve clusters and hot damn are they sensitive! You can’t hold it anymore and fully grab your meat, stroking it as gently as you can, feeling the receptive buds against the");
			...
			if(hasUnderwear) output(" Once your climax ends you pull up your [pc.lowerUndergarments] and wince as the fabric rubs against your new-found sensitivity, almost triggering a second orgasm.");
		...
		private function cuntTF(arg:Array):void
		{
			...
			output("\n\nYou discard the needle and shove your hand in your genital, testing the new sensitivity of each protrusion. It’s not long before you reach another mind-blowing climax, squirting a big dose of [pc.girlcum] all over your arm and hands, and even the floor.");
			if(hasUnderwear) output(" Once your climax ends you pull up your [pc.lowerUndergarments], the fabric rubbing against your new nubs.");
