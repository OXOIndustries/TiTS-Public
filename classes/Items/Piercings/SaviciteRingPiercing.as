...
package classes.Items.Piercings
{
	...
	public class SaviciteRingPiercing extends ItemSlotClass
	{
		public function SaviciteRingPiercing()
		{
			...
			this.shortName = "SavRing";
			this.longName = "Savicite Ring";
			
			TooltipManager.addFullName(this.shortName, StringUtil.toTitleCase(this.longName));
			
			this.description = "an obsidian ring lined with savicite";
