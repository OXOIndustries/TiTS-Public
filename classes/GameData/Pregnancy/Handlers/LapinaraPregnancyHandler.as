package classes.GameData.Pregnancy.Handlers 
{
	...
	public class LapinaraPregnancyHandler extends BasePregnancyHandler
	{
		...
		public function LapinaraPregnancyHandler() 
		{
			...
			*/
			...
			this.addStageProgression(30240,function(pregSlot:int):void
			{
				...
				buffer += "\n\nIn the past, you might've been upset about the changes forced upon your body. In your hormonal state, however, you're blissfully happy that you're turning into a better incubator. You wonder how much better you'll be at it by the time this pregnancy is over, and the thought of tracking down another futa lapinara results in a delightful shiver between your [pc.legs]. Soon your thoughts have drifted, and you're imagining one of those thick ovipositors pounding away inside you.... You snap out of it with a start, realizing you where you are. With a promise to consider it in private later, you set off again.";
			...
			this.addStageProgression(20160,function(pregSlot:int):void
			{
				...
				else buffer += "While you were carrying on a one-sided conversation with your tummy-bound babies, you asked how they liked it in mommy's tummy. That got you thinking, realizing your body should have gotten even nicer lately. Giving yourself a once-over, you scrutinize your [pc.race] body and are happy to see that it had indeed changed for the better.";
				...
				if(kGAMECLASS.pc.milkMultiplier < 40)
				{
					...
					buffer += " A drip of wetness earlier from your [pc.nipples] made you realize that <b>your [pc.breasts] are gearing up to start producing milk.</b>";
				}
			...
			this.addStageProgression(16000,function(pregSlot:int):void
			{
				...
				{
					kGAMECLASS.pc.buttRatingRaw += 1;
					buffer += " <b>Your [pc.butt] has gotten larger again</b>; you've noticed tabletops getting a little farther away when you sit down.";
				}
				//{IF pc.milkRate == 0 THEN pc.milkFullness = 60}
				if(kGAMECLASS.pc.milkMultiplier < 49)
				{
					kGAMECLASS.pc.milkMultiplier = 49;
					buffer += " The [pc.milk] has started dripping out of your [pc.nipples] more regularly. They definitely feel more full, your [pc.breasts] are going to be so sexy when your milk comes in for real.";
				}
				else if(kGAMECLASS.pc.milkFullness < 60)
				{
					kGAMECLASS.pc.milkFullness = 60;
					buffer += " Based on your recent boost in milk fullness in your [pc.breasts], it seems like the pregnancy will start enhancing your lactation soon.";
				}
			...
			this.addStageProgression(12960,function(pregSlot:int):void
			{
				...
				if(kGAMECLASS.pc.milkMultiplier < 70)
				{
					...
					buffer += "Your [pc.milkyNipples] have been leaking [pc.milk] regularly, <b>you've started lactating.</b> It doesn't seem like much yet, but based on the soreness in your [pc.breasts], you'll start producing more soon. ";
				}
				else if(kGAMECLASS.pc.milkRate < 10)
				{
					kGAMECLASS.pc.milkRate++;
					buffer += "You've noticed an <b>increase in your milk production,</b> your [pc.breasts] swelling with milk even faster than before. The extra production means that your [pc.milkyNipples] are almost never dry. ";
				}
				...
				if(kGAMECLASS.pc.hipRatingRaw < lapiPregModMax("hip"))
				{
					buffer += " It seems nothing will stop your growth, because <b>your [pc.hips] have managed to get even wider.</b> You've noticed that the extra room between your legs makes for easier access, which is certainly nice.";
					kGAMECLASS.pc.hipRatingRaw++;
				}
				//{IF pc.buttRatingRaw < lapipregButtMax(LapiTrain) THEN pc.buttRatingRaw += 1}
				if(kGAMECLASS.pc.buttRatingRaw < lapiPregModMax("ass"))
				{
					kGAMECLASS.pc.buttRatingRaw += 1;
					buffer += " <b>Your butt has even more bounce now,</b> and you've noticed plenty of stares at your [pc.butt] when you walk away.";
				}
				kGAMECLASS.pc.lust(3);
				AddLogEvent(buffer);
			}, true);
			...
			this.addStageProgression(7200,function(pregSlot:int):void
			{
				...
				buffer += "<b>your milk production has increased</b> to its maximum for this pregnancy. You don't mind a little soreness if it means you can feed your baby bunnies when the time comes. Besides, these [pc.breasts] of yours that are practically bursting with [pc.milk] might make finding a new lapinara easier.";
			...
			this.addStageProgression(4320,function(pregSlot:int):void
			{
				...
				if(kGAMECLASS.pc.hipRatingRaw < lapiPregModMax("hip"))
				{
					buffer += " You're glad that your <b>your [pc.hips] have managed to get even wider,</b> despite being near the end of your pregnancy.";
					kGAMECLASS.pc.hipRatingRaw++;
				}
				//{IF pc.buttRatingRaw < lapipregButtMax(LapiTrain) THEN pc.buttRatingRaw += 1}
				if(kGAMECLASS.pc.buttRatingRaw < lapiPregModMax("ass"))
			...
			this.addStageProgression(600,function(pregSlot:int):void
			{
				...
				buffer += "Your [pc.belly] has been feeling strange; you've been getting some cramps, and things seem to be shifting around inside you.";
			...
			this.addStageProgression(30,function(pregSlot:int):void
			{
				...
				buffer += "You feel a sudden rush of liquid down your [pc.legs].";
		...
		override public function pregBellyFragment(target:Creature, slot:int):String
		{
			...
			else if(pData.pregnancyIncubation <= 600) return "With the frequent cramping and discomfort emanating from your [pc.belly], there's no doubt that you'll be giving birth very soon.";
