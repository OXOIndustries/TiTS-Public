package classes.GameData.Pregnancy.Handlers 
{
	 ...
	 */
	public class RaskvelPregnancyHandler extends BasePregnancyHandler
	{
		public function RaskvelPregnancyHandler() 
		{
			_debugTrace = false;
			_handlesType = "RaskvelPregnancy";
			...
			_onSuccessfulImpregnation = raskvelSuccessfulImpregnation;
			_onDurationEnd = raskvelOnDurationEnd;
		...
		public static function raskvelOnDurationEnd(mother:Creature, pregSlot:int, thisPtr:BasePregnancyHandler):void
		{
			...
			if (!mother.hasStatusEffect("Raskvel Pregnancy Ends") && !kGAMECLASS.disableExploreEvents())
			{
		...
		public static function raskvelCleanupData(mother:Creature, pregSlot:int, thisPtr:BasePregnancyHandler):void
		{
