package classes.GameData.Pregnancy.Handlers 
{
	...
	public function convertPregnancy(father:Creature, mother:Creature, pregSlot:int):void
	{
		var pData:PregnancyData = mother.pregnancyData[pregSlot];
		pData.pregnancyType = _handlesType;
		pData.pregnancyIncubation = _basePregnancyIncubationTime;
		...
		if (flags["LAID VENUS PITCHER SEEDS"] != undefined) kGAMECLASS.eventBuffer += " Mmmm, another batch of pods are growing inside you.";
