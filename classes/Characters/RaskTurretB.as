package classes.Characters
{
	...
	//**************************************************
	public class RaskTurretB extends Creature
	{
		//constructor
		public function RaskTurretB()
		{
			...
			this.rangedWeapon.longName = "flamethrower";
			this.rangedWeapon.attack = 25;
			rangedWeapon.baseDamage.burning.damageValue = 10;
			rangedWeapon.baseDamage.addFlag(DamageFlag.NO_CRIT);
			rangedWeapon.baseDamage.addFlag(DamageFlag.ENERGY_WEAPON);
			rangedWeapon.addFlag(GLOBAL.ITEM_FLAG_ENERGY_WEAPON);
			rangedWeapon.addFlag(GLOBAL.ITEM_FLAG_BLIND_IGNORE);
			//rangedWeapon.baseDamage.burning.damageValue = 1;
			this.rangedWeapon.attackVerb = "shoot";
			this.rangedWeapon.attackNoun = "hellish inferno";
			...
			this.shield.resistances.freezing.resistanceValue = -50.0;
		...
		private function shootEmToys(target:Creature):void
		{
			...
			output("A gout of flame erupts from the flame-turret! ");
