	...
	public class Shizuya extends Creature 
	{
		...
		override public function CombatAI(alliedCreatures:Array, hostileCreatures:Array):void
		{
			...
			else if (lust() > 50 && combatMode == 0)
			{
				...
				output("\n\nHer entire demeanor shifts in an instant, her determined expression shifting to one of pure want, and her stance shifting to accentuate her <i>\"features\"</i>. Looks like this is turning into a different kind of fight!");
