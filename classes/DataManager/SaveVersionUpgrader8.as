package classes.DataManager 
{
	...
	{
		private const _newVersionValue = 9;
		...
		public function verify(data:Object):Boolean
		{
			...
			{
				throw new VersionUpgraderError("Upgrader Version 9 recieved data version " + data.version + " during a verification call. Wakka wakka.");
				return false;
			}
