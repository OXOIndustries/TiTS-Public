package classes.DataManager 
{
	...
	{
		private const _newVersionValue = 11;
		...
		public function verify(data:Object):Boolean
		{
			...
			{
				throw new VersionUpgraderError("Upgrader Version 11 recieved data version " + data.version + " during a verification call. Wakka wakka.");
				return false;
			}
