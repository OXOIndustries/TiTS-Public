package classes.DataManager 
{
	...
	{
		private const _newVersionValue = 18;
		...
		public function verify(data:Object):Boolean
		{
			...
			{
				throw new VersionUpgraderError("Upgrader Version 17 recieved data version " + data.version + " during a verification call. Wakka wakka.");
				return false;
			}
