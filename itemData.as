...
items[8].quantity = 1;
items[8].stackSize = 1;
items[8].type = LOWER_UNDERGARMENT;
//Used on inventory buttons
...
items[9].quantity = 1;
items[9].stackSize = 1;
items[9].type = LOWER_UNDERGARMENT;
//Used on inventory buttons
...
items[10].type = UPPER_UNDERGARMENT;
//Used on inventory buttons
...
items[11].type = UPPER_UNDERGARMENT;
//Used on inventory buttons
