function scrapyardMaintenance():void {
	...
	if(flags["SCRAPYARD_SEEN"] == undefined) {
		...
		output("\n\n<i>“Scrap</i>  dealer. <i>I don’t do anything so base as to buy scrap, I </i>deal<i> with it. Artie is my name, and scrap is my art. Now, my hardnosed friend...”</i>  He clasps his hands in a prayer-like fashion and gazes at you, lazy smile restored. <i>“If you’d like to sell me objects that have fallen into your possession, show them me and we will discuss their transient worth. If you would like to buy items that by unknowable grace have reconstructed themselves into working order, talk to my nephew Geoff. He’s in the back.”</i>  You were concentrating on the proprietor so much you’re slightly taken aback by the fact there’s somebody else in the shop. The young man cleaning what looks like the innards of a hovercraft is lanky, brown skinned and has dreads tied back in a loose knot, with a flat nose and amiable good looks. He gives you a slightly embarrassed wave.");
...
function talkToGeoff():void {
	...
	if(flags["SEXED_GEOFF"] == undefined) {
		...
		processTime(3);
		clearMenu();
		if(pc.lust() >= 33) addButton(0,"Flirt",flirtWithGeoff);
		else {
			output("\n\nIf you were more turned on, you could flirt with him.");
			addDisabledButton(0,"Flirt");
		}
		addButton(14,"Back",buyFromGeoff);
	}
	else {
		//Talk:
...
function flirtWithGeoff():void {
	...
	if(pc.hasCock() && !pc.hasVagina()) {
		...
		buttChange(geoff.biggestCockVolume());
	...
	if(pc.hasVagina()) {
		...
		//Herm:
		if(pc.hasCock()) output(" [EachCock], bumped and ground between you, responds to the pleasure gripping your body by surging to climax as well, spurting ropes of cum onto your groin and belly.");
...
function GeoffRepeatFuck():void {
	...
	if(pc.hasVagina()) {
		...
		if(pc.hasCock()) output("[EachCock] hardens and bulges to the sensations inundating your female sex.");
		
		output("\n\nYou play at each other, each working the other into a more furious lather until at last Geoff can’t take it anymore. His belt and let his faded jeans fall as he pushes into you, using his tight mass to force you against the wall, and you can’t help but cry out as he penetrates you in one go, his head pushing you wide before surging into your wet tunnel. The humidity and your own arousal make the sex liquid, his dick encountering barely any resistance as he rubs and fills you, and he almost immediately begins to fuck you with a frenetic eagerness, pushing you firmly into the wall as he thrusts his unyielding, lean hips into your softness, the flat lake of his stomach batting into your own. You thrust back into him, squeezing him with your [pc.hips], the wetness and pleasure you feel urging you to try and make him pound you even harder. When he tenses up moments later, gasping to your movements and clutching your back, you then feel a sudden wish you hadn’t gotten him as excited as you have; he is only a kid fresh out of college, after all.");
