package editor.Game.Wrapper {
    ...
    public class CreatureWrapper {
        ...
        public const breastCountIs__info: FunctionInfo = new FunctionInfo()
            .addArgResultValidator(Validators.range);
        ...
        private function breastCupSizeIs__validate(args: Array, results: Array): String {
            ...
            var err: String = Validators.range(args.slice(1), results);
            if (err) return err;
            return null;
        }

        public const breastCupSizeIs__info: FunctionInfo = new FunctionInfo()
            .addArgResultValidator(breastCupSizeIs__validate);
