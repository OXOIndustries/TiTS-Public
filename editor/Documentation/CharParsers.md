[Old TiTS Parser Doc](https://docs.google.com/document/d/1OI_BuyWxkAHno4yA7sGj1gCmLU62s9z6O1Gh40cfPt4/edit)
# Characters
Name | Args | Results | Description
-|-|-|-|-
cockOrStrapon|Up to 1||Description
cockOrHardlight|Up to 1||Description
cockOrStraponNoun|Up to 1||Description
cockOrHardlightNoun|Up to 1||Description
cockOrStraponFull|Up to 1||Description
cockOrHardlightFull|Up to 1||Description
cockOrStraponHead|Up to 1||Description
clitsNoun|Up to 1||Description
clits|Up to 1||Description
height|||Description
gear|||Description
clothes|||Description
ship|||Description
...
base, cockBase, sheath, sheathDescript, sheathOrBase|Up to 1||Description
biggestSheath, sheathBiggest|||Description
knot, knotOrBase|Up to 1||Description
knots|Up to 1||Description
knotBiggest|||Description
sheathOrKnot|Up to 1||Description
knotOrSheath|Up to 1||Description
knotBallsHilt|Up to 1||Description
multiCockDescript, multiCocks|||Description
cockLength, cocklength|Up to 1||Description
cockCount|||Description
cocks, cocksDescript, dicks|||Description
cocksDescriptLight, cocksLight, dicksLight|||Description
cocksIsAre, dicksIsAre|Up to 1||Description
cocksLightIsAre, dicksLightIsAre|Up to 1||Description
cocksSimple, cocksShort, cocksNoun, cocksNounSimple|||Description
cockComplex, cockNounComplex|Up to 1||Description
cockLight, cockSimple, cockNounSimple, cockShort, cockNoun|Up to 1||Description
dicksNounIsAre, cocksNounIsAre|Up to 1||Description
cockNounBiggest|||Description
cockSkin, dickSkin|Up to 1||Description
cockColor, dickColor|Up to 1||Description
vaginaColor, cuntColor, pussyColor|Up to 1||Description
cockHead, cockhead|Up to 1||Description
cockHeadNoun|Up to 1||Description
cockHeads, cockheads|Up to 1||Description
cockHeadsNoun|||Description
cockDescript, cock|Up to 1||Description
...
cockOrStrapon, cockOrHardlight|Up to 1||Description
cockOrStraponNoun, cockOrHardlightNoun|Up to 1||Description
cockOrStraponFull, cockOrHardlightFull|Up to 1||Description
hardlightCock|||Description
hardlightCockNoun|||Description
hardlightCockFull|||Description
cockOrStraponHead|Up to 1||Description
cockOrVag|||Description
nippleNoun|Up to 1||Description
nipplesNoun|Up to 1||Description
nippleNounSimple|Up to 1||Description
nipplesNounSimple|Up to 1||Description
nipple, nippleDescript, lipple|Up to 1||Description
nipples, nipplesDescript, lipples|Up to 1||Description
milkyNipple|Up to 1||Description
milkyNipples|Up to 1||Description
...
nippleHarden, nipplesHarden|Up to 1||Description
nippleHardening, nipplesHardening|Up to 1||Description
areola, areolaDescript|Up to 1||Description
areolae, areolaeDescript|||Description
eachCock|||Description
eachCockIsAre|||Description
oneCock|||Description
oneCockHead|||Description
erectCock, flaccidCock|Up to 1||Description
...
chestSimple, chestNoun, breastsNoun|Up to 1||Description
breastNoun, breast|Up to 1||Description
breastNounChaste, breastChaste, breastNounDry, breastDry|Up to 1||Description
cupSize, breastCup, breastCupSize|Up to 1||Description
allChestDescript, fullChest, chestFull|||Description
biggestBreastDescript|||Description
breastDescript, breasts, boobs, tits|Up to 1||Description
lowestBreasts|||Description
cockClit|Up to 1||Description
...
vagina, pussy, cunt|Up to 1||Description
vaginaNounComplex, pussyNounComplex|Up to 1||Description
vaginaSimple, pussySimple, cuntSimple, vaginaNounSimple|Up to 1||Description
vaginaNoun, pussyNoun, cuntNoun|Up to 1||Description
...
vaginasLightIsAre, cuntsLightIsAre, pussiesLightIsAre|||Description
vagOrAss, vagOrAsshole, vaginaOrAss, vaginaOrAsshole, pussyOrAss, pussyOrAsshole|Up to 1||Description
vagOrAssNoun, vagOrAssSimple|Up to 1||Description
womb, uterus|Up to 1||Description
wombs, uteruses, uteri|||Description
clit, clitoris|Up to 1||Description
clitNoun, clitorisNoun|Up to 1||Description
biggestCuntClit|||Description
eachClit, eachClitoris|||Description
oneClit, oneClitoris|||Description
oneClitPerVagina|Up to 1||Description
clits|Up to 1||Description
clitsNoun|Up to 1||Description
clitsIsAre|Up to 1||Description
...
cockShape, cockshape, cockType, cocktype|Up to 1||Description
accurateCockName|Up to 1||Description
...
femIs| Infinite | Up to `args` + 1 | `Is` operation on `femininity`
femRange| Infinite | Up to `args` + 1 | `Range` operation on `femininity`
tallnessIs| Infinite | Up to `args` + 1 | `Is` operation on `tallness`
tallnessRange| Infinite | Up to `args` + 1 | `Range` operation on `tallness`
thicknessIs| Infinite | Up to `args` + 1 | `Is` operation on `thickness`
thicknessRange| Infinite | Up to `args` + 1 | `Range` operation on `thickness`
toneIs| Infinite | Up to `args` + 1 | `Is` operation on `tone`
toneRange| Infinite | Up to `args` + 1 | `Range` operation on `tone`
hipRatingIs| Infinite | Up to `args` + 1 | `Is` operation on `hipRating`
hipRatingRange| Infinite | Up to `args` + 1 | `Range` operation on `hipRating`
buttRatingIs| Infinite | Up to `args` + 1 | `Is` operation on `buttRating`
buttRatingRange| Infinite | Up to `args` + 1 | `Range` operation on `buttRating`
skinTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `skinType`
hasAccentMarkings||Up to 2|
eyeTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `eyeType`
hairTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `hairType`
beardTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `beardType`
faceTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `faceType`
hasFaceFlag| Infinite | Up to `args` + 1 | `Is` operation on `faceFlags`
hasFaceFlags| Infinite | Up to 2 | All `args` are in `faceFlags`
tongueTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `tongueType`
hasTongueFlag| Infinite | Up to `args` + 1 | `Is` operation on `tongueFlags`
hasTongueFlags| Infinite | Up to 2 | All `args` are in `tongueFlags`
earTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `earType`
hasEarFlag| Infinite | Up to `args` + 1 | `Is` operation on `earFlags`
hasEarFlags| Infinite | Up to 2 | All `args` are in `earFlags`
antennaeTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `antennaeType`
hornTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `hornType`
armTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `armType`
hasArmFlag| Infinite | Up to `args` + 1 | `Is` operation on `armFlags`
hasArmFlags| Infinite | Up to 2 | All `args` are in `armFlags`
wingTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `wingType`
legTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `legType`
hasLegFlag| Infinite | Up to `args` + 1 | `Is` operation on `legFlags`
hasLegFlags| Infinite | Up to 2 | All `args` are in `legFlags`
...
tailTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `tailType`
hasTailFlag| Infinite | Up to `args` + 1 | `Is` operation on `tailFlags`
hasTailFlags| Infinite | Up to 2 | All `args` are in `tailFlags`
tailCountIs| Infinite | Up to `args` + 1 | `Is` operation on `tailCount`
tailCountRange| Infinite | Up to `args` + 1 | `Range` operation on `tailCount`
ballCountIs| Infinite | Up to `args` + 1 | `Is` operation on `ballCount`
ballSizeIs| Infinite | Up to `args` + 1 | `Is` operation on `ballSize`
milkTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `milkType`
milkQRange| Infinite | Up to `args` + 1 | `Range` operation on `milkQ`
cumTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `cumType`
cumQIs| Infinite | Up to `args` + 1 | `Is` operation on `cumQ`
cumQRange| Infinite | Up to `args` + 1 | `Range` operation on `cumQ`
girlCumTypeIs| Infinite | Up to `args` + 1 | `Is` operation on `girlCumType`
girlCumQIs| Infinite | Up to `args` + 1 | `Is` operation on `girlCumQ`
girlCumQRange| Infinite | Up to `args` + 1 | `Range` operation on `girlCumQ`
isNice|| Up to 2 |
isMisch|| Up to 2 |
isAss|| Up to 2 |
isExposed|| Up to 2 |
...
isFemHerm|| Up to 2 |
isManHerm|| Up to 2 |
lustIs| Infinite | Up to `args` + 1 | `Is` operation on `lust`
lustRange| Infinite | Up to `args` + 1 | `Range` operation on `lust`
physiqueIs| Infinite | Up to `args` + 1 | `Is` operation on `physique`
physiqueRange| Infinite | Up to `args` + 1 | `Range` operation on `physique`
reflexesIs| Infinite | Up to `args` + 1 | `Is` operation on `reflexes`
reflexesRange| Infinite | Up to `args` + 1 | `Range` operation on `reflexes`
aimIs| Infinite | Up to `args` + 1 | `Is` operation on `aim`
aimRange| Infinite | Up to `args` + 1 | `Range` operation on `aim`
intelligenceIs| Infinite | Up to `args` + 1 | `Is` operation on `intelligence`
intelligenceRange| Infinite | Up to `args` + 1 | `Range` operation on `intelligence`
willpowerIs| Infinite | Up to `args` + 1 | `Is` operation on `willpower`
willpowerRange| Infinite | Up to `args` + 1 | `Range` operation on `willpower`
libidoIs| Infinite | Up to `args` + 1 | `Is` operation on `libido`
libidoRange| Infinite | Up to `args` + 1 | `Range` operation on `libido`
taintIs| Infinite | Up to `args` + 1 | `Is` operation on `taint`
taintRange| Infinite | Up to `args` + 1 | `Range` operation on `taint`
inHeat|| Up to 2 |
inDeepHeat|| Up to 2 |
inRut|| Up to 2 |
isBimbo|| Up to 2 |
...
hasPerk| Infinite | Up to `args` + 1 | `Is` operation on `perk` list
hasStatusEffect| Infinite | Up to `args` + 1 | `Is` operation on `statusEffect` list
hasPiercing|| Up to 2 |
...
haskeyItem| Infinite | Up to `args` + 1 | `Is` operation on `keyItem` list
