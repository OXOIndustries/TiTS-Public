...
function multiCockFap():void {
	...
	if(pc.cockTotal() >= 2) {
		...
		else if(pc.tailCount >= pc.cockTotal() - 2 && pc.hasTailFlag(PREHENSILE) && pc.tailType != HUMAN) {
	...
	if(pc.cocks[x].cLength/pc.tallness >= 1/6 && (pc.hasCockFlag(PREHENSILE,x) || pc.cocks[x].cLength/pc.tallness <= 1/3)) 
