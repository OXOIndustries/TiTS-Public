...
:: Android packaging
set AND_CERT_NAME="AirTemplateProj"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AirTemplateProj.p12
...
set IOS_PROVISION=cert\AirTemplateProj.mobileprovision
...
set APP_XML=application-desktop.xml
