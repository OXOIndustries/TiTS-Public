...
{
	if (is_file($entry) && strcasecmp($entry, "TiTS_Preloader.swf") != 0 && strpos($entry, "TiTS_") !== false && strpos($entry, "InternalPreloader") === false && strpos($entry, ".swf") !== false && filemtime($entry) > $latest_time)
	{
