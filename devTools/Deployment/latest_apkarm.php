...
{
	if (is_file($entry) && strcasecmp($entry, "TiTS_RemotePreloader.swf") != 0 && strpos($entry, "TiTS_") !== false && strpos($entry, "arm") !== false && strpos($entry, ".apk") !== false && filemtime($entry) > $latest_time)
	{
