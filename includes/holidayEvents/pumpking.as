...
public function helpDrTrentMD():void
{
	...
	output("\n\n<b>Officer Trent’s impending panic attack notwithstanding, you know have the whole story. If you want to chicken out, it might be best to skip off planet until the whole mess blows over. You’re getting the sense that despite their goofy description, this ‘Pump-king’ is dynamite. U.G.C. S.W.A.T. could handle this one - eventually. Certainly nobody will judge you for being " + (silly ? "a little bitch":"careful") + ". Or... <b>you could go looking for this pumpkin-headed freak in the jungle.</b>");
	processTime(5);
