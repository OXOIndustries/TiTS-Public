...
public function krissyWrapUpByThird(x:int):void
{
	...
	output("\n\nVellynne half-heartedly struggles against the bindings, and to your surprise the ribbon lights up, like a series of Christmas lights were embedded into the fabric. The spool of extra fabric grows warm in your hand, and any part of your skin in contact with it seems to tingle. To you, it’s a minor curiosity, to your doe lover, however, it seems to be much more. Vellynne’s eyes immediately widen, and a low, throaty moan escapes her lips before she silences herself with an equally seductive lip bite. When the deer-girl ceases her struggling, both the tingling sensation and the colored lights begin to fade. Interesting.");
	...
	output("”</i> you " + (pc.isBimbo() ? "giggle":"laugh") + ", pressing the head of cock against Vellynne’s cocoa folds. Her slit is hot and moist with anticipation, which easily lubes up the tip of your [pc.cockOrStrapon " + x + "].");
	output("\n\n<i>“Oh yeah?”</i> she says, wiggling her body enticingly. The movement triggers the ribbon, which lights up with colorful merriment, no doubt sending pleasurable shocks throughout the doe’s body. Vellynne moans in response, her eyes rolling back in her head while she sinks further into the seat, and coincidentally right down onto the tip of your dick. Her hot folds envelop you, only serving to make her moan louder.");
	...
	output("\n\nHer warm, slick tunnel grips your " + (x < 0 ? "faux-":"") + "cock tightly, like a child unwilling to relinquish their favorite toy, as you slowly pull out, your thick rod glistening with pussy juices. Without missing a beat, you thrust back in, enjoying the sight of Vellynne struggle to keep still and failing miserably. The ribbon lights back up, sending waves of pleasure through her... and you apparently. As her needy cunt contracts around you, you receive a sudden shock of bliss, no doubt a watered down version of what she’s experiencing.");
	output("\n\nWith that in mind, you redouble your efforts to make her squirm as much as possible. Changing your stance, you angle your dick to thrust upwards, slamming into the deer-woman’s g-spot with reckless abandon. She twists in place and lets out a little cry. The ribbons activate again, blasting Vellynne’s body with near-orgasm inducing pleasure, which ebbs right into your [pc.cockOrStrapon " + x + "] in such a way your entire body shudders.");
	...
	if(x >= 0) 
	{
		output("abruptly unleashing jet after jet of [pc.cum] directly into Vellynne’s waiting womb");
	...
	output("\n\nVellynne shakes with yet another orgasm as <i>“Knotty or Nice”</i>, an Ausari Christmas classic begins to play. You stumble back a step, admiring your handiwork as ");
	if(x >= 0)
	{
...
public function KrissyKringleEpilogueThird(x:int = 0):void
{
	...
	showKrissy(true);
	author("Thirdgames");
	output("When you awake, Vellynne is just putting on her dress and getting her things together. Your ship alerts you that you’ve arrived at Canadia Station, so you head into the cockpit, flick the controls onto manual, and land the ship where you’re directed by the station.");
	...
	output("\n\n<i>“But I should get going. My roommate is going to be so worried about me. I think I’ll pick her up a roll of that ribbon too, I bet she’d enjoy it as much as I did.”</i> Vellynne giggles, seeming to lose herself in the memory before snapping back to reality.");
	...
	output("\n\nWith that she, Vellynne struts out of your ship... and you notice " + (x >= 0 ? "two things, first that there’s a small stream of suspiciously cum-colored fluid dripping down her leg, and second, ":"") + "she’s wearing a section of that bondage ribbon around her neck like a lace choker. It’s cute... and oddly the lights are on.");
