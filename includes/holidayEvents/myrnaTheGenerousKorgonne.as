...
public function myrnaBlowjob(pepperminted:Boolean = false):void
{
	...
	if(pc.hasCock() && pc.biggestCockLength() >= 20)
	{
		...
		else output(" bottom of your [pc.cockBiggest]");
		...
		if(pc.hasStatusEffect("Genital Slit") || pc.hasSheath(pc.biggestCockIndex())) output(" Her slick, sinuous muscle manages to find its way into the delicate flesh that holds your cock when not in use. She dives into the very foundation of your monolithic pole, reaching areas that are seldom played with. You shudder and gasp with every pass around your slit, relishing the feeling of her lubricative appendage brushing against spots you barely knew could feel so good!");
...
public function fuckMyrna(x:int):void
{
	...
	output("\n\nFor the next few minutes you hungrily suckle Myrna’s soft mammaries, occasionally switching back and forth between the two whenever one runs low. When you take a moment to run your nose in the cleft between her sizeable jugs, she begins to roll her wide hips into your lap. She grinds hard, almost dry humping you after a certain point. You can feel her arousal seeping through her panties and onto your crotch. The bittersweet smell of peppermint joins the sugary scent of her breast milk, creating an aromatic haze the likes you’ve never experienced before. You can feel ");
