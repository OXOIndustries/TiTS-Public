//Upon visiting The Dark Chrysalis on Halloween a special Halloween area text and Halloween opening is used (if the event was already triggered it can be repeated with a <i>“standard”</i> opening at any time of the year.)
//Requirements are a PC with at least A-cups that is currently receiving salary from Sera.

//In both openings, Sera forces the PC to eat a big handful of <i>“Halloween Candy”</i> which turns out to be Milk Caramel Gushers.

//After some oral fun for Sera, the PCs breasts are finally swollen with milk (increase size by 2 cups) from the high dosage of Milk Caramel Gushers and anal sex follows. The PC is pressed against the shop-window from the inside and <i>“cleans”</i> the window with swollen, milky breasts while taking Sera up the butt. Afterwards the PC has his/her breasts return to normal size after the effects of the Milk Gushers wear off.
...
/// use <i>“Halloween opening”</i> if systemdate is between 10/28 and 11/3
/// if the event has already been triggered once, it can be repeated with the <i>“standard opening”</i> as long as the PC is still receiving salary
...
public function seraTrickOrTreatEventIntro():void
{
	...
	if(isHalloweenish())
	{
		...
		output("\n\n<i>“But ADULTS? And they are asking for FREE MODS? Just because you wear a costume on Halloween doesn’t mean you can have anything, just because you shout ‘Trick or treat!’ like an asshole! </i>And they have the gall to ask me for furry mods!”");
...
public function canIHelpYouSeraImDumb():void
{
	...
	if(isHalloweenish())
	{
		...
		if(furScore == 0) output(" I mean, you look <i>nothing</i> like them, but it could work.”</i>");
		//if PC has a Badger, Bovine, Bunny, Canine, Deer, Feline, Horse, Huskar, Laquine, Lupine, Nuki, Panda, Sheep or Vulpine score of 1:
		else if(furScore < 2) output(" Could work though. You kinda look like them.”</i>");
		else output(" But it will probably work out fine. You look just like those guys.”</i>");
		...
		output("\n\n<i>So, about those free furrymod samples you all wanted...</i>, she says with a sickeningly sweet voice.");

		output("\n\n<i>Go on. Say it once more.</i>");

		output("\n\nDoes she mean...? You gulp again. But, like before, you dare not to disobey.");
		...
		output(" and your mouth onto your mistress's dick. Sheer physical force shoves the caramel-flavored candy down your throat only for bulging demon-dick to follow.");
		output("\n\n<i>“Trick or treat that, you pricks. Should have done that right away when you asked.”</i>");
	}
	//[continue with <i>“merge Halloween opening or standard opening here”</i>]
	//standard opening
	else
	{
...
public function roughFunsWithSeras(furScore:Number):void
{
	...
	output("\n\nEven in your current predicament you can’t help but imagine before your mental eye how Seras plump and sweat-drenched ass presses flat against the glass with every pull backwards and in return how with every thrust her dick explores your insides, pleasing your Mistress. And you want it even more now. To please her, receive her. You grab her hips and add to the motion. A strained giggle rewards your ears.");
	...
	output("\n\n<i>“No,”</i> you answer immediately, raising an eyebrow on your mistress’ face.");
	output("\n\n<i>“I love it,”</i> you add in your voice dripping with lust, earning you your first spurt of cum straight up your [pc.asshole]");
	...
	output("\n\nUnable to stand any longer, you slowly collapse to the floor, smearing one last trace of cum and milk across the glass and slipping off Seras demonic dick in the process. You helplessly leak cum from your gaping [pc.asshole] and milk from your [pc.breasts], the latter having returned to their original size.");
	output("\n\n<i>“And that’s your free treat, furry slut. Wasn’t so bad. For me at least. Almost makes me wish people would come in here and ask for free furrymods again.”</i>");
