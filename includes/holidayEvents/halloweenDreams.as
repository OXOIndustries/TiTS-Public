...
public function spookyHyenaDream():void
{
	...
	output("\n\nToo busy with your groin’s raucous transformation, you don’t notice that the rest of your body is shifting even more.");
	if(!pc.hasFur()) output(" Your [pc.skin] tickles and grows goosebumps as coarse fur starts to sprout from your skin. Your new coat is brown with dark splotches in it.");
	...
	if(pc.hasCock() && (pc.cocks[0].cType != GLOBAL.TYPE_CANINE || pc.cocks[0].cockColor != "black")) output(" Glancing down at your crotch, you’re taken back when you find that your cock has turned to a huge, turgid, black doggy dick, but somehow it feels right.");
...
public function dullahanSpoops5():void
{
	...
	output("\n\n<i>“Maybe if I somehow get to meet you again, I’d like to continue where we left off. I really owe you, " + pc.mf("Mr.","Ms.") + "...”</i> she pauses for you to introduce yourself.");
...
output("\n\nYour disbelieving [pc.eyes] watch as the creature’s head distorts, before it violently slams its face into your groin. You gasp as something phallic forms deep inside of you, combining with the rest of the creature. Yet even with that dick stretching your [pc.vagina] it never stops licking.");
