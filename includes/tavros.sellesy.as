...
public function firstDrinkFromSellesy(first:Boolean = true):void {
	...
	if(first)
	{
		...
		output("\n\nFollowing her with your gaze as you watch her leave on her way to the bar, you notice the swell of her two outer massive breasts from behind, jiggling with each step. It is an almost hypnotic view even from this angle. She is comparatively adept at moving on all three legs. Her supple butt-cheeks are round and show exaggeratedly from beneath the excessively short skirt she wears, and with amusement you realise that she must have three bountiful, bouncing buttocks.");
