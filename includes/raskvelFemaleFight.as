...
function raskVelBabeGetsDoggieStyled():void
{
	...
	if(pc.cockTotal() > 1)
	{
		...
		output(" through her blessedly slick thighs. Her horny, puffed-up pussy is blessedly wet with her pussy's copious secretions. Their unintentional trembling causes her deliciously warm thighs to vibrate your spare dick");
	...
	output("\n\nYou don't have intention of leaving the lizard-woman empty for long, but you do keep pulling back, releasing your girl-glossed fuck-pole from it's squeeze-happy prison long enough for it to shine in the open air a moment. Then, you push it back in, far faster than the first insertion. Your [pc.cock " + x + "] slides into pre-shaped passage with perfect, wet squelches. Dollops of slick cunt-juice squirt out around your penetrating pole, ");
	if(pc.cockTotal() > 1) 
	{
	...
	output("shining her thick thighs and your own [pc.legs] with moisture. Inside the raskvel's twat, you can feel the little folds as they slide over every ridge and vein of your manhood, all the way until you're hilted once more. Satisfied groans fill the air around the both of you.");
...
function hugeDicksGetForceWorshippedByFemRaskvel():void
{
	...
	if(select == 1)
	{
		...
		buttChange(pc.tailCockVolume(),true,true,false);
