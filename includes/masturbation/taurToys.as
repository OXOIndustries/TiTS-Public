...
public function masturbateWithTaurMilker():void
{
	...
	output("\n\nSoon you’re grunting and panting, sweat starting to run down your " + (pc.tone < 30 ? "soft ":"") + (pc.tone > 70 ? "finely chiselled ":"") + "body as you approach an orgasm that the milker seems to want every bit as much as you do. It sucks at your [pc.cockHead " + x + "], encouraging you to blow as soon as you can and endeavoring to bring you to to the point of climax. It doesn’t take too long.");
