...
public function rahnCumBubbleGift(item:ItemSlotClass):void
{
	...
	else if(item is MediumCumBubble)
	{
		...
		output("\n\nThe visitors appear to be a mixed pair of trouble makers. A dusky skinned dzaan alpha pushes her way to the front, her battle-scarred suit etched with any number of scorch marks. Curiously, caramel-skinned woman has removed the crotch plate of her armor, allowing her heavy, 11” cock to droop against her low-hanging, cum-fattened balls. Doesn’t seem like she’s had much in the way of relief recently. She catches you staring and meets your gaze with an imposing glare as if to invite you to say something about it. Flahne distracts the amazonian traveler with a perky greeting. <i>“Hello! Welcome to Mhen’ga! How may I help you?”</i>");
