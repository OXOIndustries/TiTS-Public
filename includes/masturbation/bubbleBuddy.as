...
public function popDatBubbleButtBubb(item:ItemSlotClass):void
{
	...
	else if(item is MediumCumBubble)
	{
		...
		if(pc.isGoo()) 
		{
			output(" You focus slightly and the spooge on your arms slowly sinks past your slimy skin, reincorporated into your gelatinous frame. Delicious!");
