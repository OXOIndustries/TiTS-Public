...
function takeShadesHardlightPenisInYerBoot():void
{
	...
	output(". Before she gets there, though, she hooks her arms under your [pc.legs] and gives you a rough pull, yanking you down and up; before you know it, your [pc.legs] are hiked over Shade’s shoulders, leaving your ");
	if(x >= 0) output("pussy");
	else output("ass");
...
function rimAndWankOrLickAndWankWhoKnowsSloot():void
{
	...
	output("\n\nShade shifts slightly, scooting down your prostrate body until she can get her hands around your [pc.hips] and pull you up, getting you on your hands and [pc.knees] and leaving your [pc.cock " + x + "] dangling between your [pc.legs]. Her fingers brush across your length, a simple touch that has you from half mast to diamond hard by the time she’s reached your [pc.cockHead " + x + "].");
	output("\n\n“<i>I love a woman with a nice, hard cock between her legs.");
	if(pc.isGoo() || pc.isNaga()) output(" Or [pc.legs], in your case.");
