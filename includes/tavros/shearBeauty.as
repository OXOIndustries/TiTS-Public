...
public function fuckCeriaDoggy(earTouch:Boolean = false):void
{
	...
	if (pc.cockTotal() > 1) output(" Not cumming is an impressive feat all told, what with " + (pc.cockTotal() > 2 ? num2Text(pc.cockTotal()-1) + " other dicks" : "your other dick") + " slapping her senseless and pouring out more and more hot spooge.");
