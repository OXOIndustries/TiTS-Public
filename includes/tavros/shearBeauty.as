...
//text output, used in game.as to update tavros room 9015's description
public function ceriaHyperCumHallwayText():String
{
	var desc:String = "";
	if (ceriaHyperCumActive()) desc = "A neon sign displaying a pair of scissors sits next to a small store entrance with a shut door and a closed sign displayed -- looks like Ceria's still cleaning up the evidence of your passing! The sign above the door labels it as “Shear Beauty.” The lifts aren’t too far down the merchant deck to the west, but if you follow the arcing thoroughfare east, you could visit the red light zone.";
	else desc = "A neon sign displaying a pair of scissors sits next to a small store entrance with its doors propped open to the east, allowing you a glimpse of the salon inside. The sign above the door labels it as “Shear Beauty.” The lifts aren’t too far down the merchant deck to the west, but if you follow the arcing thoroughfare east, you could visit the red light zone.";
