...
public function fadilTalk(topic:String):void
{
	...
	switch (topic)
	{
		case "Him":
			...
			output("\n\nNow that you think about it, dad brought you to various company workplaces as a wide-eyed young " + chars["PC_BABY"].mf("boy", "girl") + ". Your interest piqued by your own internal musing, you gaze thoughtfully at Fadil and ask, <i>“So, you mentioned serving out an indenture for a mining company. Do you mind if I ask what your specific occupation was?”</i>");
...
public function showFadilItsADogFuckDogWorld():void
{
	...
	output("You’re momentarily confused when he stands up and lifts you onto the bed so that you’re on your hands and knees, but when he climbs behind you realise what position you two are in. He bends over you, gently hotdogging your [pc.ass] while presenting his furred fingers to you. Not needing to be told what to do, you let him push his fingers into your mouth. You swirl your tongue around them, soaking them in saliva.");
