...
public function talkToGilAboutSnausages():void
{
	...
	output("\n\n<i>“Not by a long shot. There're still a lot of stories to write in this body of mine. So I think I’ll stay here a while, getting my stuff in order, and then hit someplace else. I heard there’s this planet where everyone takes a controversial transformative. I think I’ll hit that place next.”</i>");
	processTime(6);
	clearMenu();
	addButton(0,"Next",backToGilMenu);
}
...
public function getASloppyGrillBLowjorb(fromTrade:Boolean):void
{
	...
	else if(pc.hasStatusEffect("Genital Slit"))
	{
		...
		else output("their tips poking out of their protective slit");
