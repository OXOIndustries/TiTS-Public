...
public function ilariaCumSlurp():void
{
	...
	output("\n\n<i>“I’m all yours, babe,”</i> Ilaria says, leaning back against the milker’s mount with an easy grin. " + (flags["ILARIA_CUMSUCKED_URETHRAL"] ? "<i>“Show me your stuff!”</i>":"<i>“Still gettin’ used to the straw thing, but last time was so much fun I can’t say no!”</i>"));
	...
	output("\n\nFeeling overwhelmed, you let your concentration lapse for a moment and the straw slips past your lips and almost down your throat before you realize. Ilaria’s prodigious offering pumps straightdown your unresisting throat, your gag reflex long since subdued in the wake of her ridiculous outpouring. By the time you get yourself repositioned your stomach has swollen a few extra inches outward.");
