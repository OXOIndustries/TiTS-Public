...
public function looksFamiliarToRamis():Boolean
{
	...
	{
		case "girlee":
			if(pc.isWoman() || pc.isFemHerm() || pc.isSexless()) isSame = true;
			break;
		case "boyo":
			if(pc.isFemboy()) isSame = true;
			break;
		case "lad":
			if(pc.isMan() || pc.isMaleHerm()) isSame = true;
			break;
	}
...
public function approachRamis(special:String = "none"):void
{
	...
	if(pc.isWoman() || pc.isFemHerm() || pc.isSexless())
	{
	...
	switch(response)
	{
		...
		case "man":
			...
			else
			{
				...
				output("\n\nYou intend to, but not with your tongue. With a bestial, hungry growl, you clamber up her, exulting in the shifting textures of her washboard midriff and her soft, pliant boobs over your [pc.chest] as you grip her underneath the knees and sink your [pc.cockNoun " + x + "] into her dripping hot hole with a single, determined push of your [pc.thighs]. Her spreads lips part before your [pc.cockHead] gloriously, enabling you to surge deep into her wetness, spreading her tunnel with bulging, tender dick.");
