...
public function veltaTalkCollege(apt:Boolean = false):void
{
	...
	output("\n\n‘How many years you in for?’ you ask next, drawing a snicker out of Velta" + (apt ? "" : " as she finishes her squats and immediately drops onto all fours") + ". <i>“You make it sound like I’m in prison or something,”</i> she jokes" + (apt ? "" : ", tucking one arm behind her back and effortlessly beginning a set of one-armed pushups. Impressive") + ". <i>“Four years. I’m a freshman - just started a month ago,”</i> she says" + (apt ? "" : ", grunting quietly as she hits her tenth pushup") + ". ‘So you’re… how old are you?’ you ask.");
...
output("‘So what do you do in your free time?’ you ask" + (apt ? "" : "as Velta starts stretching again, pulling her canteen off her hip and taking a few deep gulps before replacing it") + ". <i>“Working out is a big one, obviously.”</i> she says");
...
public function veltaSexVag(kok:int=0):void
{
	...
	else if (pc.cumQ() >= 1000) output(" Some of your copious load overflows out of her despite the seal your [pc.cock " + kok + "] naturally forms, dribbling back down onto your crotch and hips as Velta whimpers at the intense sensation.");
...
public function veltaSexAnalYes():void
{
	...
	output("\n\nShe breaks your kiss, though her hand doesn’t leave your neck; her forehead comes to bump into yours, her sweat mingling with yours as the lemon-scented warmth of her breath washes over your face.");
