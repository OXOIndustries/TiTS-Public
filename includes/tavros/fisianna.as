...
public function approachGirls():void{
	...
	if (flags["FISI_MET"] == undefined)
	{
		...
		output("\n\nThe harpy-girl is the first to talk. <i>“Heya! What brings a ");
		if (pc.isMale()) output("hunk");
		else output("cutie");
		output(" like you to this place?”</i>");
		...
		output("\n\n<i>“What she <b>meant</b> to say was, it’s nice to meet a multi-billionaire magnate's ");
		if (pc.isMale()) output("son");
		else output("daughter");
		output(" and heir to his company all the way over here… in a seedy bar no less!”</i> ");
...
public function hangoutFisi():void
{
	...
	output("You turn in your seat towards Fisianna and ask if she would like to go somewhere else and pass the time doing something together.");
...
public function goShopping():void
{
	...
	switch (flags["FISI_HANG_SHOPPING"])
	{
		...
		case 2:	output("\n\nAfter a brief moment of thought, you suggest that the two of you could check out the local food shops and grab a bite to eat.");
				...
				output("\n\n<i>“Fair enough, Fisi… What about you Steele? You ");
				if (pc.isMale()) output("man");
				else output("woman");
				output(" enough for the challenge?”</i>");
...
public function fourthDateFisi():void
{
	...
	output("\n\n<i>“Greetings, ");
	if (pc.isMale()) output("Master");
	else output("Mistress");
	output(" Steele. I am the Inclusive Services Intelligence System, but you may call me I.S.I.S., for short. It is a pleasure to finally meet you!”</i> You chuckle and shoot Fisianna a sidelong smirk. Clever name.");
	...
	output("\n\n<i>“Apologies, Fisianna. I thought it would be polite in front of ");
	if (pc.isMale()) output("Mr.");
	else output("Ms.");
	output(" Steele to use such formalities, especially one of [pc.hisHer] import.”</i> Isis says in a very convincingly apologetic tone.");
	...
	output(" Steele, I have really wanted to meet you for a long while! Fisianna never stops talking about you while she works, and now I get to actually meet the individual that has her so enamored. I have several databases with your information, but I would love to learn about the ");
	if (pc.isMale()) output("man");
	else output("woman");
	output(" from the source, that is if you are willing?”</i> Little question mark indicators float above the avatar's head. You decide to humor the curious AI and tell her a brief rundown of your background, your upbringing, and your current adventures on the rush. After the inquisitive AI finishes processing this information, she smiles.");
	output(" <i>“Thank you, ");
	if (pc.isMale()) output("Mr.");
	else output("Ms.");
	output(" Steele! I can now certainly see why Fisianna is so infatuated with you. You are a very interesting being!”</i> You can see Fisianna blushing even harder than before. Apparently Isis notices this as well as her attention is now diverted towards Fisianna.");
...
public function sixthDateMerge():void
{
	...
	output("\n\nYou decide to alternate hands after a few more moments and bring your upper hand down to massage Fisianna's wet clitoris and box. You bring your previously lower hand up her mouth. The worked up kitty eagerly takes your wet fingers in her mouth after taking a brief sniff at them. She swirls her tongue around your fingers, deigning to taste herself, and you, in her mouth. Fisianna moans and purrs into your fingers, sending lovely vibrations down your arm. ");
...
public function eatOutFisi():void
{
	...
	output("\n\nAt Fisianna's approval, you rise up to unfasten and slowly take off Fisianna's jeans, revealing her lacy, white panties to you. You see that her panties are adorned with a cute pattern of cat paws on the trim of the lacy fabric. You laugh inwardly, unsurprised that even her undergarments are kitten themed. To your delight, you can see that her panties are fairly soaked, letting you faintly see the outline of her aroused labial lips. You lightly toss Fisianna's jeans aside and gently work your fingers under the top of Fisianna's panties. Once there, you ease them off, revealing her bare vagina to you for the first time. The potent smell of Fisianna's arousal from her now pantiless crotch tickles your nose in a pleasant way. You clear your head with a brief shake and move to dive in between her legs again. You lift both of Fisianna's legs over your shoulders and curl your arms under and around her thighs so that she will be as comfortable as possible while you munch on ");
	...
	else
	{
		...
		output("\n\nWhen you progress to the letter <i>“G”</i>, Fisianna's thighs clench around you. You can feel a pair of paws pushing the back of your head so deep into her snatch, that you can no longer properly breathe through your nose and you see nothing but stars. You can hear the vibrations of Fisianna's resounding moan echo through her thighs into your now muffled ears. ");
...
public function vaginalFisi():void
{
	...
	if (fisianna.vaginalVirgin)
	{
		...
		output("\n\n<i>“I-I don't think I could be any happier just laying next to you… to just be with you like this. I really, really love you, [pc.name]. With all my heart, I can't say enough that I'm so glad to have met you, and that you could be my first ");
		if (pc.isMale()) output("boyfriend");
		else output("girlfriend");
		output(".”</i> Fisianna's smile diminishes slightly while she looks away nervously. <i>“T-that's why… I think I'm ready…”</i> She says the last part in a barely audible whisper.");
