...
function condomOrNoCondomAlissButtfuck(x:int = -1, condom:Boolean = false):void
{
	...
	output("\n\nAs you retract your thumb you notice Aliss begin to relax. Acting quickly, you position yourself behind the horny alien and press the head of your ");
...
function offerPussyYouSloot():void
{
	...
	if(pc.totalVaginas() == 2) output("you other neglected pussy");
	else if(pc.totalVaginas() > 2) output("one of your other neglected pussies");
	else output("you sensitive asshole");
...
function suckAlissOffBecauseYouLikeToGulpDownLoadsOfJizzYouSlut():void
{
	...
	output("\n\nYou feel your face go flush as you ");
