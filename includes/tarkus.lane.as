...
function baseHypnosisWearsOff(effectToRemove:String):void
{
	...
	if (flags["HYPNO_EFFECT_SMALL_MESSAGES"] == undefined)
	{
		...
		{
			outputText("As you walk the biomes of "+ getPlanetName() +", you can’t help but feel something is a little... off. Different, from when it was just a few moments ago. You flex your ears, listening for anything out of the ordinary, but you can’t hear anything. You look down your body, for anything alien that might have attached itself to you, but you’re completely clean.");
		...
		{
			outputText("As you walk the biomes of Tarkus, you hear a beep and feel a vibration on your [pc.hip]. You reach for your codex; on it flashes a reminder you had programmed into it the day before about Lane’s hypnosis wearing off.");
...
function visitLaneWhilstDetoxing():void
{
	...
	output("You rush into Lane’s hut with all the haste you can. You were such a fool! How could you think to leave Lane – your lover, your hunger, your <i>world!</i> There [lane.heShe] sits, idly watching something on his codex, as you come barreling in, tears in your eyes and your mouth dry.");
	...
	output("\n\nYou hiccup your tears a few times, waiting for your love to say or do something, <i>anything</i> to make you feel welcomed and that [lane.heShe] wasn’t mad. Finally, after a heart-pounding eternity, you feel [lane.hisHer] soft, forgiving hands on your [pc.hair]. You immediately melt into {him}, feeling a relief you had never known before today. <i>“I forgive you, [pc.name],”</i> [lane.heShe] says to you, and you clutch at [lane.hisHer] legs tighter. <i>“You’re a good [if (pc.gender == 1)boy][if (pc.gender == 2)girl][if (pc.gender == 3)girl][if (pc.gender == 0)boy]. You’ve made the right decision to come back to me.”</i>");

	output("\n\nYou sigh out loud, and look up at {him}, across [lane.hisHer] flat stomach, [lane.hisHer] beautiful {chest/breasts}, and at [lane.hisHer] adoring eyes. <i>“Let’s make sure you never make that mistake again, [pc.name]. I want you to look deep into my eyes. Can you do that for me?”</i> You obey wordlessly, staring deep into [lane.hisHer] eyes as [lane.heShe] flairs [lane.hisHer] tassels wide open for you. The familiar, safe feeling of sinking into the swirls of his tattoos and the lights of his body wash over you. <i>Good. You’re doing good.</i>");
...
function visitLaneAfterDetoxing():void
{
	...
	if (pc.WQ() < 0.75)
	{
		if (pc.isNice())
		{
			output("You sigh. There [lane.heShe] is. Sitting inside that little hut of [lane.hisHer] in the middle of the desert.");
			...
			output("\n\nLane apparently doesn’t like your non-threatening yet confident tone. As [lane.heShe] sits, [lane.heShe] flares his tassels wide and assaults you with the light of [lane.hisHer] glowing blood, mixing with the bright swirls of his tattoos and piercings. <i>“We can go deeper if you’d like.”</i> [lane.HeShe] snickers.");

			output("\n\nYou feel a twinge of... something, deep in the back of your mind, as your eyes watch the patterns on [lane.hisHer] body, but you manage to swallow it back with a hard blink. You stare at {him} dead in the eye. <i>“That won’t work on me anymore, Lane.”</i>");
			...
			output("\n\n<i>“I’m honored to be the first,”</i> you say, <i>“and the last.”</i> Lane closes [lane.hisHer] tassels after another moment, and [lane.heShe] slumps in [lane.hisHer] chair, knowing [lane.heShe]’s been beaten. You tell {him} that you remember every last detail; how [lane.heShe] made you love {him}, and how [lane.heShe] used his power over you to abuse you sexually. You also remember how depleted your bank account was for a few days.");
			...
			output("\n\n<i>“I’m serious, [pc.name], come on,”</i> [lane.heShe] all but pleads. <i>“I specialize in</i> hypnotism, <i>and I live in a one-story mud-tent in the middle of a desert planet! At five-hundred credits a day, with the customers I get and the bills I pay, I’d be starving after a week! Please, I’m begging you–”</i> [lane.HeShe] clasps [lane.hisHer] hands together and reaches over his desk, pleading for mercy, <i>“I can do two-hundred credits. Two-hundred credits a day.”</i>");

			output("\n\nYou tilt your nose up, looking down at {him} as he begs for [lane.hisHer] financial security. <i>“If I remember right,”</i> you say threateningly, <i>“didn’t you once say that Daynarian blood was once highly valued? Do you think a black market for it exists?”</i> You’re bluffing, but watching the color literally drain from Lane’s face is worth the visit alone. You stand. <i>“Two-hundred credits a day, Lane. After what you did to me, you should be thankful. Be sure to not miss a payment.”</i> You turn towards the door, but you stop. <i>“And – don’t ever hypnotize another person like you did to me. I’ll find out.”</i>");

			output("\n\nYou hear Lane slump forward onto [lane.hisHer] desk as you victoriously leave [lane.hisHer] hut. With any luck, you won’t have to visit {him} again anytime soon. Not that you’d be welcomed with open arms, anyway.");

			// Remove ‘Lane’s Plane’ from the map; the PC gains 200 credits a day for the rest of the game
		}
		else
		{
			output("There [lane.heShe] is. That slippery [if {Lane is male}son of a ]bitch, sitting in that little mud-hut of {his/hers}, conning [lane.hisHer] next victim out of their money. You’re going to put a stop to that today.");

			output("\n\nIt’s not difficult to find Lane, sitting at [lane.hisHer] desk as [lane.heShe] lazily flips through something on his codex. [lane.HeShe] looks up, at first to greet a new customer into coming into [lane.hisHer] plane, but [lane.hisHer] emotion washes away the moment [lane.heShe] registers you.");

			output("\n\n<i>“Lane!</i> you shout, trying to sound as aggressive as you can. You march into [lane.hisHer] office, [if {melee weapon equipped}one hand on your [weapon]][if {no melee weapon}popping the joints in your neck] as you slap down on [lane.hisHer] table. You make it as obvious as you can that [lane.heShe]’s in trouble and that no amount of pleading is going to stop you.");
	...
	else
	{
		...
		output("\n\nYour ‘rampage’ against him ends as quickly as it starts. Your arms hang limp at your sides[if {melee weapon equipped} and you drop your [weapon] harmlessly] as [lane.heShe] absorbs you once again. [lane.HeShe] still looks afraid, pressed against the far wall, but when [lane.heShe] realizes why you’ve stopped, [lane.heShe] peels himself away.");

		output("\n\nYour mind’s voice screams at you to move, to thrash him and take back what belonged to you. You fought so hard to break away from Lane – you should be clean now! [lane.HeShe] should have no power over you anymore! But your body disobeys your every command, and, on its own volition, you drop to your knees, looking up at Lane helplessly.");

		output("\n\nFerociously, Lane clamps both [lane.hisHer] hands against your head, rocking your eyes in your skull from the blow, but you don’t look away. Lane leans in close until [lane.hisHer] ever-changing eyes are all you see. You feel his breath blow down your neck through clenched teeth, and you feel his claws dig into the roots of your [pc.hair] painfully. <i>“You’re a very special person, [pc.name],”</i> [lane.heShe] says disdainfully, forcing your head still to make sure your eyes never leave his. <i>“I’ve never heard of a person breaking out of their hypnosis before. You’re much stronger than I gave credit for.”</i>");
		...
		output("\n\n<i>“Watch the swirling lights,”</i> [lane.heShe] says, and it’s hard not to. Everything in your vision is moving and swimming: from the tattoos on [lane.hisHer] body to the lights in [lane.hisHer] eyes. The familiar sensation of being immersed in {him}, engrossed by {him}, overcomes you. <i>“You trust Lane. You can listen to Lane. Lane wants you to watch the swirling lights.”</i>");
...
function laneGonnaFuckYourDetoxinAssUp():void
{
	...
	output("\n\nYour [lane.master] instructed you to hide behind [lane.hisHer] chair in the hypnosis room as he works with another client of [lane.hisHer]. You sit, totally naked, as you await for your further instruction.");

	output("\n\nThis wouldn’t be the first time you’ve done this with your [lane.master] to a client of [lane.hisHer], but it is a relatively new idea. You are nonetheless eager to do it again; you’ve noticed some real changes in attitude in some of the clients after you’ve finished. You sit there[if (pc.hasCock = true), stroking [pc.eachCock] torturously, arousing yourself for what comes next][if (pc.isHerm = true) and][if (pc.hasVagina = true) jilling yourself, plunging your fingers into your [pc.vagina] as you await your {master’s/mistress’s} command]. You know this is a delicate procedure, but you’re just so anxious to get started!");

	output("\n\nA few minutes pass. You can see the light of Lane’s blood glowing off the far walls of the room you’re in, giving you a weak light show to entertain yourself with until you’re needed. Your heart leaps into your throat when you hear your [lane.master] say <i>“come forward, [if {Lane is male}Cocksucker][if {Lane is female}Cuntlicker].”</i>");
	...
	output("\n\nLane already has [if {Lane is male}his long, throbbing lizard cock][if {Lane is female}her puffy, needy lizard cunt] out in display. [lane.HeShe] does nothing to arouse himself further and keeps [lane.hisHer] hands to [lane.hisHer] sides, allowing you to do your job. Licking your [pc.lips], you crawl up your {master’s/mistress’s} legs slowly, and, without so much as a word, lunge forward, [if {Lane is male}swallowing his cock all the way to the base – just as you’re trained, and just as he likes][if {Lane is female}plunging your tongue into her as deep as you can – just as you know she likes.]");

	output("\n\n<i>“Watch closely,”</i> Lane says, not to you. <i>“This is {Cocksucker/Cuntlicker}. You are jealous of [him]. You would like for nothing more than to replace [him].”</i> That line always makes you shiver – your [lane.master] would never replace you, would [lane.heShe]? <i>“You want for nothing more than to be between Lane’s knees and pleasuring {him}.”</i>");

	output("\n\nThis continues for the better part of an hour, with Lane growing more and more aroused with each command. As your mouth begins to flood with [lane.hisHer] {cum/girlcum}, you’re reminded of what a simple, wonderful life you live, and how you’re so fortunate to live it. You do hope this woman succumbs soon – it’d be a crime to hoard your gifts to yourself.");
...
function laneTakesOverTheSteeleFortune():void
{
	...
	output("\n\nYou’re thrilled to see your [lane.master] so happy for your success. You entertain {him} and ask what it means. Rather than answer, a lascivious grin spreads across [lane.hisHer] lips as [lane.hisHer] tassels slowly expand, submerging you in the glowing swirls of [lane.hisHer] tattoos and piercings once again. You sigh languidly, submerging yourself in the lights. <i>“It means I won’t have to live in a little mud-tent in the middle of an empty desert anymore.”</i>");

	output("\n\nEven as you feel yourself beginning to slip lovingly into [lane.hisHer] control, you have enough sense to ask {him} what [lane.heShe] means. <i>“I mean that I’m about ready for new, lucrative business opportunities, [pc.name],”</i> [lane.heShe] says. [lane.HeShe] gently places [lane.hisHer] hands on the sides of your head, making sure your eyes don’t ever leave [lane.hisHer], not that you intended to. <i>“I’d like to work at Steele Tech. Would you happen to have any... ‘openings’?”</i>");

	output("\n\nYou pause before you realize it’s an actual question. You tell {him} that you’re in charge of the whole business – you can give {him} any job [lane.heShe] wants. [lane.HisHer] thin lips spread even wider, bearing [lane.hisHer] pointed teeth. <i>“Even yours?”</i>");
	...
	output("\n\nThe voice in your head, telling you to deny Lane or at least to ask for something else, grows quieter the longer you stare at {him}. You <i>do</i> trust Lane. [lane.HeShe] hasn’t done you wrong yet. You even come to realize that [lane.heShe] technically has more experience running a business than you do. Maybe Steele Tech would be better off in [lane.hisHer] soft, gentle, capable hands.");
	...
	output("\n\nAt hearing that, [if (pc.hasCock = true)[pc.eachCock] immediately begins to harden in your pants][if (pc.isHerm = true) and ][if (pc.hasVagina = true)your [pc.vagina] clenches and moistens almost immediately]. You’re still looking at Lane’s eyes, but as [lane.heShe] leads you to [lane.hisHer] room, out of the edges of your vision, you can see [if {Lane is male}his own cock tenting his undergarment furiously][if {Lane is female}a damp patch at the crotch of her undergarment, growing with each step], proof of [lane.hisHer] own excitement for the new direction your lives are taking.");
...
function laneTakesOverTheSteeleFortuneII():void
{
	...
	output("You’re underneath [lane.Master] Lane’s clean, massive desk, hidden completely from sight on all sides. The top is so high that you can sit straight up without any problems, and the edges are so far apart, you can lie down and still have a little bit of headroom to spare. You thank [lane.Master] Lane every day for it; it’d be so much harder to [if {Lane is male}suck his delicious, prodigious cock][if {Lane is female}lick her delicious, wonderful pussy] otherwise.");

	output("\n\nYou press your head forward, [if {Lane is male}deepthroating him][if {Lane is female}penetrating her as deep as you can with your [pc.tongue]] for the second time that morning. Your vision is surrounded by Lane’s meaty thighs, with [lane.hisHer] business pants hanging off [lane.hisHer] calves, as usual – ever since your [lane.Master] gave you the official, Steele Tech-approved position of {Cocksucker/Cuntlicker}, there’s not much else you do all day, or all night, or especially on weekends and holidays. You don’t deal with anybody else; you don’t sign any papers or approve any contracts; all you do at Steele Tech is service Lane whenever [lane.heShe] wants you. You don’t get many breaks, and you don’t get paid for it. You don’t even wear clothes anymore; they just get in the way of your work. You live, sleep, and eat underneath [lane.Master] Lane’s desk, or, if you need to be a bit more discreet, in a small cubbyhole your [lane.Master] graciously had built into the floor.");

	output("\n\nLane shivers at your work – perfect as it always is – and you feel [lane.hisHer] hand press on your [pc.hair]. <i>“Is everything alright, {Mister/Miss} Lane?”</i> you hear an older, very deep male voice say on the other side of the desk.");
	...
	output("\n\nThen, for another few minutes, the only sounds you hear are the gentle sucking of your mouth on Lane’s genitals. Despite Lane’s calm demeanor, [if {Lane is male}his cock is harder than you’ve ever seen it, and from the way he’s gently rocking back and forth, he’s moments away from cumming][if {Lane is female}her box is wetter than you’ve ever felt it before, and from the way her legs squeeze around your head, she’s moments away from cumming]. You hear the distinct sound of pen on paper as Lane signs the contract, and in that instant, [lane.heShe]’s delivering an explosive orgasm straight down your throat. Experienced as you are, you easily handle [lane.hisHer] entire, copious output, swallowing every drop and wanting more.");
	...
	output("\n\nThe hand on your head leaves your [pc.hair] and [lane.heShe] leans forward in [lane.hisHer] seat. <i>“Likewise. Ah, forgive me for not standing.”</i> You gently clean {his cock/her cunt}, lapping up whatever juices you may have missed. <i>“I’m afraid I’ve worked my legs stiff at the golf links the other day.”</i>");

	output("\n\n<i>“Think nothing of it.”</i> You feel [lane.Master] Lane give the male a strong, firm handshake above you as [lane.hisHer] genital slit slowly begins to retract and conceal {him}.");
...
function laneServices():void
{
	...
	if (flags["LANE_SHOWN_SERVICES"] == undefined)
	{
		...
		outputText("\n\nYou sit back in your seat, strongly considering Lane’s words. What the fuck, you decide – you’re here, you may as well. You tell {him} that you’re in. <i>“Excellent!”</i> [lane.HeShe] pulls up [lane.hisHer] own codex, and begins tapping at its screen. <i>“I charge one hundred credits per hypnosis. I am contractually obligated to remind you that there are no refunds. As soon as the payment goes through, we can begin.”</i>");
		...
		if (pc.credits < 100)
		{
			outputText("\n\nYou wince, looking at the codex, and you hand it back to {him}, sheepishly telling {him} that you can’t afford it. <i>“Oh.”</i> [lane.HeShe] wipes at its screen, and it goes blank. <i>“Not to worry, I don’t mind this being a social call. Is there anything else I can do for you?”</i>");
	...
	else
	{
		...
		if (!hasLaneHypnosis())
		{
			...
			{
				outputText("<i>“Of course,”</i> says Lane, already reaching for [lane.hisHer] codex and writing up your receipt. <i>“I’m glad that you enjoyed my service enough to come back, [pc.name].”</i> [lane.HeShe] passes you the codex. <i>“One hundred credits, as usual. Contract, no refunds, blah blah blah. What can I do for you this time?”</i>");
			}
			else
			{
				outputText("<i>“Of course,”</i> says Lane, already reaching for [lane.hisHer] codex and writing up your receipt. <i>“I’m glad to see that you're still interested in my services, [pc.name].”</i> [lane.HeShe] passes you the codex. <i>“One hundred credits, as usual. Contract, no refunds, blah blah blah. What can I do for you?”</i>")
			}

			if (pc.credits < 100)
			{
				outputText("\n\nYou wince, looking at the codex, and you hand it back to {him}, sheepishly telling {him} that you can’t afford it. <i>“Oh.”</i> [lane.HeShe] wipes at its screen, and it goes blank. <i>“I’m afraid I can’t give discounts to my regulars. Sorry. Is there anything else I can do for you, though? Shooting the breeze is always free.”</i>");
		...
		else
		{
			...
			outputText("[lane.HeShe] smiles at you, and [lane.heShe] reaches for his codex. <i>“Of course you do, [pc.name].”</i> [lane.HisHer] tassels flutter just enough so that you can get a taste of what’s to come. [lane.HisHer] claws are jittery on the codex’s screen, proof of [lane.hisHer] own excitement. <i>“I’m sure if I were to charge you three hundred credits, you wouldn’t object.”</i>");
			...
			outputText("\n\nYou shake your head, salivating, eager to get started. [lane.HeShe] hands you the codex – and to your surprise, [lane.heShe]’s only charging you the standard one hundred credits. <i>“I’m a little kinder than that, though.”</i> You blink, and thank {him} sincerely for [lane.hisHer] unprecedented generosity. <i>“Of course, this isn’t counting the ‘tax’ I’ll be charging you when we’re done.</i>");
...
function laneServicesBack():void
{
	...
	else
	{
		if (pc.credits >= 100)
		{
			outputText("You glance up from the codex, your finger hovering teasingly over the confirmation button, when you hand it back to {him}. He looks confused, before you tell {him} that you’d like to skip the foreplay. [lane.HeShe] smiles and stands from [lane.hisHer] chair; [lane.heShe] crooks a claw at you, ordering you to follow, as [lane.heShe] leads you behind the curtain and to the left, towards [lane.hisHer] bedroom.");
		}
		else
		{
			outputText("You grin mischievously, returning [lane.hisHer] codex to {him}, and you tell {him} that you just don’t have the funds. Is there, maybe, some other way you can compensate {him} for [lane.hisHer] time and [lane.hisHer] effort? <i>“No.”</i> [lane.HeShe] looks at you rather sternly, and your attempts at being " + pc.mf("suave", "coy") + " quickly fall flat. <i>“Sex with you doesn’t pay for my bills, [pc.name]. Once we’re done here, you’re going out and you’re making some money, I don’t care how.”</i> Just as you slump in your chair, [lane.heShe] rises from [lane.hisHer]. <i>“But that doesn’t mean I</i> won’t <i>fuck you. Follow me.”</i> Giddy again, you rise from your seat, following {him} like a horny dog as [lane.heShe] leads you into [lane.hisHer] bedroom.");
		}

		outputText("\n\nBy the time you enter behind your [lane.master], [lane.hisHer] shirt and pants have already been pulled off[if {Lane is female}, letting her heavy breasts bounce free in the wind – not that they were especially well concealed to begin with]. [lane.HeShe] turns to you and, with a predatory grin, slides a claw across the fabric of [lane.hisHer] undergarment, tearing it away and revealing " + lane.mf("his throbbing, pointed cock. It’s halfway hard, and you lick your lips as you watch it slide free from his genital slit, inflating in length and in girth", "her wet, puffy cunt. Her genital slit is open and malleable, ready for you to play with; her labia waves at you, waiting for your pleasure") + ".");

		outputText("\n\n<i>“Strip naked,”</i> [lane.heShe] commands, opening [lane.hisHer] tassels wide, letting you absorb yourself into {him}. You do as you’re commanded, with ease, excitement, and some flair, for [lane.hisHer] benefit. Naked, vulnerable, and horny, you’re completely at [lane.hisHer] mercy. The patterns on [lane.hisHer] tassels swirl in your vision, and you know you’re going to enjoy it.");
...
function laneServiceAim():void
{
	...
	outputText("\n\nYou tell {him} that it’s purely personal, and [lane.heShe] nods, waving to [lane.hisHer] codex. Lane certainly seems secure about it. Do you ask {him} to improve your aim, by sharpening your mental acuity?");
...
function laneConfirmService(selectedService:String):void
{
	...
	else
	{
		...
		outputText("\n\nWhen [lane.heShe] shuts the door behind you, it’s as dark as you remember it. The incense from the candles greets your nose, and already you feel yourself relaxing, your legs becoming languid as you walk. You turn to Lane, watching {him} remove his top");
		if (hasLaneHypnosis()) outputText(", your eyes lingering on the smoothness of [lane.hisHer] skin for a little longer than you mean");
		outputText(", and then [lane.heShe] walks past you, towards [lane.hisHer] seat");
		if (laneHypnosisLevel() >= 3) outputText(". Your eyes glue to {him}, trailing themselves from the ridges of [lane.hisHer] shoulders to where [lane.hisHer] tail meets the small of [lane.hisHer] back....");
	}

	outputText("\n\n");
	if (!pc.isTaur()) outputText("[lane.HeShe] takes the farther seat, and wordlessly invites you to take the one across from {him}.");
	else outputText("[lane.HeShe] picks up the closest seat and sets it aside, leaving you to sit on your haunches on the carpet.");
	outputText(" <i>“First, I want you to close your eyes.”</i> You do so, blocking what little vision you had of the room. The only thing you see is the dull pulse of [lane.hisHer] body through your eyelids.");
	...
	outputText("\n\nYour eyes open wider of their own accord as you absorb {him}. Adorned across the inside of [lane.hisHer] tassels are a number of black tattoos with swirling, almost tribal designs on them, and all throughout the skin of [lane.hisHer] membranes are light, glassy piercings. As [lane.hisHer] blood beats through {him}, they mingle with the tattoos and their light bounces all throughout the glass of [lane.hisHer] piercings: the lights distract your focus, and every time you move your eyes between them, the tattoos on {him} begin to swirl with each other in the corners of your eyes. With every movement your eyes make, the coursing blood, the bright trinkets pierced to Lane’s skin, and the moving tattoos draw you deeper and deeper into a trance – into <i>{him}</i>.");
...
function laneApplyService(selectedService:string):void
{
	...
	if (addHypnosisEffect(selectedService))
	{
		...
		if (laneHypnosisLevel() == 0)
		{
			msgs = 
			[
				"Lane bites [lane.hisHer] lip, [lane.hisHer] eyes roaming your body as you sit there, enthralled by {him}. <i>“You...”</i> [lane.heShe] says softly, unsure with {him}self. <i>“You do not mind Lane’s company. You like speaking with {him}.”</i> [lane.HeShe] reinforces that several more times, before [lane.heShe] sheepishly stops.",
				"Lane bites [lane.hisHer] lip, [lane.hisHer] eyes roaming your body as you sit there, enthralled by {him}. <i>“You...”</i> [lane.heShe] says softly, unsure with {him}self. <i>“You do not mind the way Lane looks. [lane.HeShe] is easy on your eyes.”</i> [lane.HeShe] reinforces that several more times, before [lane.heShe] sheepishly stops.",
				"Lane bites [lane.hisHer] lip, [lane.hisHer] eyes roaming your body as you sit there, enthralled by {him}. <i>“You...”</i> [lane.heShe] says softly, unsure with {him}self. <i>“You will recommend Lane to your friends and coworkers. You believe [lane.heShe] does a good job.”</i> [lane.HeShe] reinforces that several more times, before [lane.heShe] sheepishly stops.",
				"Lane bites [lane.hisHer] lip, [lane.hisHer] eyes roaming your body as you sit there, enthralled by {him}. <i>“You...”</i> [lane.heShe] says softly, unsure with {him}self. <i>“You find Lane mildly attractive. For a Daynar.”</i> [lane.HeShe] reinforces that several more times, before [lane.heShe] sheepishly stops.",
				"Lane bites [lane.hisHer] lip, [lane.hisHer] eyes roaming your body as you sit there, enthralled by {him}. <i>“You...”</i> [lane.heShe] says softly, unsure with {him}self. <i>“You like the way Lane keeps [lane.hisHer] business. You find {him} to be professionally approachable.”</i> [lane.HeShe] reinforces that several more times, before [lane.heShe] sheepishly stops."
			];
		}
		else if (laneHypnosisLevel() == 1)
		{
			msgs = 
			[
				"Lane hums to {him}self as [lane.heShe] looks at you, seeing you so open to {him} and [lane.hisHer] suggestions. [lane.HeShe] stutters, unsure if [lane.heShe] should proceed, but [lane.heShe] does. <i>“You like Lane. You think you’ll visit {him} more often, and not just for [lane.hisHer] business.”</i> [lane.HeShe] reinforces that several more times, and then stops {him}self.",
				"Lane hums to {him}self as [lane.heShe] looks at you, seeing you so open to {him} and [lane.hisHer] suggestions. [lane.HeShe] stutters, unsure if [lane.heShe] should proceed, but [lane.heShe] does. <i>“Your opinion of the Daynar is improved because of Lane. You enjoy their company and believe them to be a friendly, understanding species.”</i> [lane.HeShe] reinforces that several more times, and then stops {him}self.",
				"Lane hums to {him}self as [lane.heShe] looks at you, seeing you so open to {him} and [lane.hisHer] suggestions. [lane.HeShe] stutters, unsure if [lane.heShe] should proceed, but [lane.heShe] does. <i>“You think Lane is reasonably attractive. [lane.HeShe] is a " + lane.mf("handsome", "beautiful") + " Daynar.”</i> [lane.HeShe] reinforces that several more times, and then stops {him}self.",
				"Lane hums to {him}self as [lane.heShe] looks at you, seeing you so open to {him} and [lane.hisHer] suggestions. [lane.HeShe] stutters, unsure if [lane.heShe] should proceed, but [lane.heShe] does. <i>“You like the way Lane looks at you. You think it’s cute.”</i> [lane.HeShe] reinforces that several more times, and then stops {him}self.",
				"Lane hums to {him}self as [lane.heShe] looks at you, seeing you so open to {him} and [lane.hisHer] suggestions. [lane.HeShe] stutters, unsure if [lane.heShe] should proceed, but [lane.heShe] does. <i>“You consider Lane to be a dependable business" + lane.mf("", "wo") + "man and a good friend. You wonder if Lane could be more to you.”</i> [lane.HeShe] reinforces that several more times, and then stops {him}self."
			];
		}
		else if (laneHypnosisLevel() == 2)
		{
			msgs =
			[
				"Lane chews at [lane.hisHer] lip and [lane.hisHer] claw tacks on [lane.hisHer] chair. You’re so vulnerable, so malleable; [lane.heShe] begins to rub [lane.hisHer] knees together sensually as [lane.heShe] looks at you. <i>“You think Lane is sexy. You often fantasize about {him} when you’re by yourself.”</i> [lane.HeShe] reinforces that statement several more times, before [lane.heShe] forces {him}self to stop.",
				"Lane chews at [lane.hisHer] lip and [lane.hisHer] claw tacks on [lane.hisHer] chair. You’re so vulnerable, so malleable; [lane.heShe] begins to rub [lane.hisHer] knees together sensually as [lane.heShe] looks at you. <i>“You find yourself compelled to talk about Lane to your friends. You want to promote [lane.hisHer] business as much as you can.”</i> [lane.HeShe] reinforces that statement several more times, before [lane.heShe] forces {him}self to stop.",
				"Lane chews at [lane.hisHer] lip and [lane.hisHer] claw tacks on [lane.hisHer] chair. You’re so vulnerable, so malleable; [lane.heShe] begins to rub [lane.hisHer] knees together sensually as [lane.heShe] looks at you. <i>“You sometimes wonder what Lane looks like beneath the rest of [lane.hisHer] clothing.”</i> [lane.HeShe] reinforces that statement several more times, before [lane.heShe] forces {him}self to stop.",
				"Lane chews at [lane.hisHer] lip and [lane.hisHer] claw tacks on [lane.hisHer] chair. You’re so vulnerable, so malleable; [lane.heShe] begins to rub [lane.hisHer] knees together sensually as [lane.heShe] looks at you. <i>“You have an urge, an itch, to taste Lane. You resist, with some effort.”</i> [lane.HeShe] reinforces that statement several more times, before [lane.heShe] forces {him}self to stop.",
				"Lane chews at [lane.hisHer] lip and [lane.hisHer] claw tacks on [lane.hisHer] chair. You’re so vulnerable, so malleable; [lane.heShe] begins to rub [lane.hisHer] knees together sensually as [lane.heShe] looks at you. <i>“You want to touch Lane, to feel along the smoothness of [lane.hisHer] front scales. You want to touch {him} everywhere, in a sensual way.”</i> [lane.HeShe] reinforces that statement several more times, before [lane.heShe] forces {him}self to stop."
			];
		}
		else if (laneHypnosisLevel() == 3)
		{
			msgs = 
			[
				"Lane splays [lane.hisHer] legs. Now that the business is done, [lane.heShe] can proceed with the pleasure. [lane.HeShe] openly begins to rub at {him}self, enjoying the way [lane.heShe]’s displaying {him}self to you and you’re too brainwashed to even notice. <i>“You can’t get enough of Lane. You want to visit {him} every day to hypnotize you. You love the way [lane.heShe] controls you.”</i> When [lane.heShe] finally stops reinforcing that statement, [lane.heShe]’s spent more time hypnotizing you for {him}self than [lane.heShe] has doing what you paid {him} for.",
				...
				"Lane splays [lane.hisHer] legs. Now that the business is done, [lane.heShe] can proceed with the pleasure. [lane.HeShe] openly begins to rub at {him}self, enjoying the way [lane.heShe]’s displaying {him}self to you and you’re too brainwashed to even notice. <i>“Every time you see Lane, you fantasize about " + lane.mf("his cock and what it’ll take to get him to use it on you", "her cunt and what it would be like to finally taste her") + ".”</i> When [lane.heShe] finally stops reinforcing that statement, [lane.heShe]’s spent more time hypnotizing you for {him}self than [lane.heShe] has doing what you paid {him} for.",
				"Lane splays [lane.hisHer] legs. Now that the business is done, [lane.heShe] can proceed with the pleasure. [lane.HeShe] openly begins to rub at {him}self, enjoying the way [lane.heShe]’s displaying {him}self to you and you’re too brainwashed to even notice. <i>“You can no longer imagine life without Lane. Your days aren’t complete without worshiping {him} by giving him your body to mold.”</i> When [lane.heShe] finally stops reinforcing that statement, [lane.heShe]’s spent more time hypnotizing you for {him}self than [lane.heShe] has doing what you paid {him} for.",
				"Lane splays [lane.hisHer] legs. Now that the business is done, [lane.heShe] can proceed with the pleasure. [lane.HeShe] openly begins to rub at {him}self, enjoying the way [lane.heShe]’s displaying {him}self to you and you’re too brainwashed to even notice. <i>“Lane turns you on so much that each day " + lane.mf("he doesn’t bend you over his desk and take your ass, body, and soul with his cock", "she doesn’t throw you to the ground and claim you as hers with her sweet, sexy cunt") + " is a day that is wasted.”</i> When [lane.heShe] finally stops reinforcing that statement, [lane.heShe]’s spent more time hypnotizing you for {him}self than [lane.heShe] has doing what you paid {him} for."
			];
		}
...
function lanePostApplyEffect(selectedService:String):void
{
	...
	if (!hasLaneHypnosis())
	{
		outputText("\n\nYou sit and look at your hands. It was a strange, difficult-to-explain sensation: you knew you were different, but you didn’t really <i>feel</i> different. At the same time, you felt different, but you didn’t know if you really <i>were</i> different. Lane definitely did something to you, and whatever it was [lane.heShe] did, you like it. You tell {him} as much, and [lane.heShe] claps [lane.hisHer] four-fingered hands together. <i>“I’m happy that you’re happy with the results, [pc.name],”</i> [lane.heShe] tells you.");
		if (flags["LANE_TIMES_HYPNOTISED"] <= 1) outputText(" <i>“I hope this changes your perception on hypnotism.”</i> You tell {him} that it definitely does, and that you’ll be coming back for [lane.hisHer] service sometime in the future. You even ask {him} if you could sign [lane.hisHer] guestbook, to give {him} another testimonial to add to [lane.hisHer] collection, and [lane.heShe] happily hands you [lane.hisHer] codex.");
		...
		{
			if (laneHypnosisLevel() == 0) outputText("\n\nAs you leave [lane.hisHer] hut, your thoughts linger on Lane just a little while longer. [lane.HeShe]’s certainly an alright sort. You wouldn’t mind having a drink with {him} sometime later, or something.");
			else if (laneHypnosisLevel() == 1) outputText("\n\nYou’ve been getting rather friendly with Lane lately, and [lane.heShe] holds {him}self very professionally... and, you decide, [lane.heShe]’s a bit of a looker. For a bipedal lizard-person. You consider asking {him} out to dinner sometime, to get to know {him} outside of [lane.hisHer] profession.");
			else if (laneHypnosisLevel() == 2) outputText("\n\nYou spare a look back at [lane.hisHer] hut as you leave. Just... something <i>about</i> Lane really pushes all your kinky buttons. You idly fantasize about what it’d be like to get into bed with a sexy Daynar like {him}self...");
			else outputText("\n\nYou can’t seem to get that sexy lizard off your mind as you leave [lane.hisHer] hut. Images of yourself at [lane.hisHer] knees, servicing {him} like [lane.heShe] was your " + lane.mf("king", "queen") + " and it was your privilege, assault your mind, and you gladly let them. You’re itching to march right back in there and throw yourself at {him}, demanding [lane.heShe] take you then and there, but, after some struggle, you keep walking. You have others things that need doing.");
	...
	{
		outputText("\n\nYou’re happy that Lane, righteous and generous as [lane.heShe] is, kept up [lane.hisHer] end of the bargain and gave you what you paid for. But another part of you is ecstatic about what’s going to happen next. You thank {him} for [lane.hisHer] continued excellence, and that, if [lane.heShe]’s ready, you’re prepared to pay {him} your ‘taxes’ for the privilege of being [lane.hisHer] to own.");

		outputText("\n\n[lane.HeShe] smiles and stands. You stand with {him}, and with a deft, swift hand, [lane.heShe] grabs you by the collar of your [pc.armor] and pulls you in for an aggressive, dominant kiss. You melt into {him}, opening your mouth and inviting your {master’s/mistress’s} tongue to play with your [pc.eachTongue]. [lane.HeShe]’s grabbing at you roughly and possessively as [lane.heShe] suffocates you with [lane.hisHer] lips and [lane.hisHer] tongue, guiding you across the desk and to the curtains hiding the second half of the room.");

		outputText("\n\n[lane.HeShe] finally lets you go as [lane.heShe] opens [lane.hisHer] eyes and [lane.hisHer] tassels wide at you, letting you fall into {him} a second time. Your body sinks");
		...
		outputText(" while you consciously fall deeper into [lane.hisHer] control, but [lane.heShe] doesn’t let you zone out like before.");

		outputText("\n\n[lane.HeShe] leads you to [lane.hisHer] bedroom, across from [lane.hisHer] hypnosis room, and as soon as [lane.heShe] shuts the door behind you, [lane.heShe]’s stripped of both [lane.hisHer] airy shirt and [lane.hisHer] flowing pants, leaving {him} with only [lane.hisHer] underwear. " + lane.mf("The unmistakable bulge of his delicious, virile Daynarian cock pushes against the stubborn fabric, outlining the trail of his meat from his tip to his base, and it only gets more pronounced with each heartbeat.", "A small damp patch is clearly visible between the cleavage of her legs, but more than that, the musky scent of her needy, demanding sex penetrates the air, and your nostrils, with ease.") + " Your fingers fidget as you imagine just how Lane is going to use you today.");
...
function laneFullyHypnotisesYouDumbshit();void
{
	...
	outputText("Lane spreads [lane.hisHer] legs apart, already making {him}self comfortable before your hypnotized, immobile, impressionable, compliant self... [lane.heShe] doesn’t say anything as [lane.heShe] stares at you, rubbing {him}self through the fabric of [lane.hisHer] pants and undergarment, arousing {him}self as [lane.heShe] imagines the oh-so-delectable things [lane.heShe] could make [lane.hisHer] absolute favorite customer do...");

	outputText("\n\n[lane.HeShe] frowns to himself, and [lane.hisHer] eyes wander for a moment. [lane.HeShe] begins to fight with {him}self silently, trying to decide if [lane.heShe]’s gone too far already and if [lane.heShe] should just give you what it is you paid for... but that’s a short lived battle, and [lane.hisHer] eyes lock on yours once more, steeled with dangerous, predatory resolve." + lane.mf(" The nub of his penis slowly but determinately erecting underneath his clothing is plainly visible, and he paws at it with one hand.", "Moisture begins to dampen the center of her undergarment as she palms at herself idly, and her musk joins the incense of the candles in your nose."));

	outputText("\n\n<i>“[pc.name]”,</i> [lane.heShe] says, but of course, you don’t answer. <i>“You can no longer stand it. Lane is everything you ever wanted in life. You can’t bear the thought of leaving [lane.hisHer] hut today without fucking {him}. " + lane.mf("You want his dick in your mouth; the taste of his cock on your tongue and the feel of his cum in your throat is the greatest pleasure in your life. You want his dick in your ass; knowing that Lane is inside you, owning you, and dominating you, will forever be your wildest, most desirable indulgence.", "You want her cunt in your mouth; her cum is finer than any wine, sweeter than any honey, and smoother than any malt. You want her to dominate you; being underneath her as she asserts herself is where you belong, and nothing is more relieving, more thrilling, or more pleasurable than being where you belong.") + " You will surrender yourself, mentally, physically, and emotionally to Lane, and you will not object to whatever [lane.heShe] desires. [lane.HisHer] wishes, [lane.hisHer] kinks, and [lane.hisHer] desires are now yours.”</i>");
	...
	outputText("\n\n[lane.HeShe] hums to himself. <i>“Starting tomorrow, I want you to wire me five hundred credits each and every day that you are mine, [pc.name].”</i> You look up at {him}, surprised, mouth agape – your mind is racing with ways you could possibly afford that. <i>“That should be chump change for the heir");
