...
function visitLaneWhilstDetoxing():void
{
	...
	output("\n\nYou vault over [lane.hisHer] desk effortlessly and wrap your arms around [lane.hisHer] legs, burying your [pc.face] into [lane.hisHer] knees as you sob in delight that you’ve found your way back to your {master/mistress}. <i>“{Master/Mistress}! I...”</i> you begin, choking back your ecstatic tears. <i>“I told one of my crewmates about us, {master/mistress}. She saw my daily payments and started asking questions.”</i>");
...
function laneGonnaFuckYourDetoxinAssUp():void
{
	...
	output("\n\nYour {master/mistress} instructed you to hide behind [lane.hisHer] chair in the hypnosis room as he works with another client of [lane.hisHer]. You sit, totally naked, as you await for your further instruction.");

	output("\n\nThis wouldn’t be the first time you’ve done this with your {master/mistress} to a client of [lane.hisHer], but it is a relatively new idea. You are nonetheless eager to do it again; you’ve noticed some real changes in attitude in some of the clients after you’ve finished. You sit there[if (pc.hasCock = true), stroking [pc.eachCock] torturously, arousing yourself for what comes next][if (pc.isHerm = true) and][if (pc.hasVagina = true) jilling yourself, plunging your fingers into your [pc.vagina] as you await your {master’s/mistress’s} command]. You know this is a delicate procedure, but you’re just so anxious to get started!");
	...
	output("\n\n<i>“Watch closely,”</i> Lane says, not to you. <i>“This is {Cocksucker/Cuntlicker}. You are jealous of [him]. You would like for nothing more than to replace [him].”</i> That line always makes you shiver – your {master/mistress} would never replace you, would [lane.heShe]? <i>“You want for nothing more than to be between Lane’s knees and pleasuring {him}.”</i>");
...
function laneTakesOverTheSteeleFortune():void
{
	...
	output("\n\nYou’re thrilled to see your {master/mistress} so happy for your success. You entertain {him} and ask what it means. Rather than answer, a lascivious grin spreads across [lane.hisHer] lips as [lane.hisHer] tassels slowly expand, submerging you in the glowing swirls of [lane.hisHer] tattoos and piercings once again. You sigh languidly, submerging yourself in the lights. <i>“It means I won’t have to live in a little mud-tent in the middle of an empty desert anymore.”</i>");
...
function laneTakesOverTheSteeleFortuneII():void
{
	...
	output("\n\n<i>“Everything is perfect,”</i> {Master/Mistress} Lane answers, and [lane.hisHer] words flow like honey to your ears, making you sigh through your nose. <i>“It’s just been a long, exciting morning so far.”</i>");
	...
	output("\n\n<i>“Think nothing of it.”</i> You feel {Master/Mistress} Lane give the male a strong, firm handshake above you as [lane.hisHer] genital slit slowly begins to retract and conceal {him}.");
