...
public function appearance(target:Creature):void {
	...
	if(target == pc) {
		...
		if((target.isChestExposed() && pc.hasBreasts()) || target.isCrotchExposed() || target.isAssExposed())
		{
		...
		if(target.isNude() || (target.isChestExposed() && target.isCrotchExposed() && target.isAssExposed())) {
