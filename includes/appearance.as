...
public function appearance(forTarget:Creature):void
{
	...
	if(target == pc) {
		...
		if(target.hairLength == 0) {
			...
			else if(target.earType == GLOBAL.TYPE_DRACONIC || target.earType == GLOBAL.TYPE_GRYVAIN) output2(" A pair of rounded protrusions with small holes on the sides of your skull serve as your ears. Bony fins sprout behind them.");
		...
		if(target.wingType != GLOBAL.TYPE_HUMAN) {
			output2(", and");
			//WINGS!
			if(target.wingType == GLOBAL.TYPE_SMALLBEE || target.wingType == GLOBAL.TYPE_MYR)
			{
			...
			else if(target.wingType == GLOBAL.TYPE_BEE)
			{
				if (target.wingCount == 2) output2(" a pair of");
				else if (target.wingCount == 4) output2(" a quartet of");
				else if (target.wingCount > 1) output2(" " + num2Text(int(target.wingCount)));
			...
			else if(target.wingType == GLOBAL.TYPE_SMALLDEMONIC)
			{
				if (target.wingCount == 2) output2(" a pair of");
				else if (target.wingCount == 4) output2(" a quartet of");
				else if (target.wingCount > 1) output2(" " + num2Text(int(target.wingCount)));
			...
			else if(target.wingType == GLOBAL.TYPE_DEMONIC)
			{
				if (target.wingCount == 2) output2(" a pair of");
				else if (target.wingCount == 4) output2(" a quartet of");
				else if (target.wingCount > 1) output2(" " + num2Text(int(target.wingCount)));
			...
			else if(target.wingType == GLOBAL.TYPE_DARK_SYLVAN)
			{
				if (target.wingCount == 2) output2(" a pair of");
				else if (target.wingCount == 4) output2(" a quartet of");
				else if (target.wingCount > 1) output2(" " + num2Text(int(target.wingCount)));
			...
			else if(target.wingType == GLOBAL.TYPE_DOVE && target.wingCount == 2) output2(" a pair of " + target.furColor + " wings adorn your back, feathered like a dove’s and big enough to be worn like a cloak when folded over your body. They’re strong enough to glide with, but nice and soft to the touch.");
			else if(target.wingType == GLOBAL.TYPE_DOVE && target.wingCount == 4) output2(" four wings sprout from your back, each covered in wonderfully soft " + target.furColor + " feathers and big enough to be worn like a robe when all four are folded over your body. They’re arranged so they don’t get in each other’s way when spread, thus you can still glide with them.");
			else if (target.wingType == GLOBAL.TYPE_DOVE && target.wingCount == 6) output2(" six wings sprout from your back, each covered in wonderfully soft " + target.furColor + " feathers and big enough to be worn like a luxurious ceremonial robe when all six are folded over your body, which you often find yourself doing to help with getting through tight spaces. Despite their sheer bulk, you can still glide with them.");
...
public function crotchStuff(forTarget:Creature = null):void
{
	...
	if(target.balls > 0) {
		...
		if(target.hasStatusEffect("Uniball"))
		{
			...
			else if(target.skinType == GLOBAL.SKIN_TYPE_SCALES || (target.legType == GLOBAL.TYPE_GRYVAIN && target.hasLegFlag(GLOBAL.FLAG_SCALED))) output2("Your scaly " + target.sackDescript(true,true) + " hugs your " + sTesticleDesc + " tightly against your body.");
		...
		else if(target.cockTotal() == 0)
		{
			...
			else if(target.skinType == GLOBAL.SKIN_TYPE_SCALES || (target.legType == GLOBAL.TYPE_GRYVAIN && target.hasLegFlag(GLOBAL.FLAG_SCALED))) output2("A scaly " + target.sackDescript(true,true) + " filled with " + sTesticleDesc + " swings low under where a penis would normally grow.");
