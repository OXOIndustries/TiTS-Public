...
public function pippaYammiThreesomeDom(cockIndex:int):void
{
	...
	else
	{
		...
		output("....”</i> Despite what she’s saying, her pussy’s twitching with apparent anticipation. Too turned on to pass up the advance, she sighs. <i>“Get me ready first...and be gentle.”</i>");
	}
	
	output("\n\nPippa giggles and apologizes, <i>“Sorry, Yammi. I guess I got a little overeager.”</i> You pull Yammi into you, her perky breasts pressed into your [pc.chest], so that you can see over her shoulder, and down to her round behind. She again begins to gently ride you, face buried in your neck. Pippa places one hand on Yammi’s bouncing bottom, gently spreading her ass, and, with her other hand, she grasps the base of your [pc.cockOrStrapon " + cockIndex + "] below Yammi, briefly moving it along with the sparadat, wetting her hand with girl-cum. She takes a lubricated finger, gently runs it around Yammi’s asshole, and slowly slips it inside, coating the inside and outside with the sparadat’s own cum. Yammi’s moans are already picking up when Pippa slips another finger in, spreading your chef’s rim. The pig-morph looks at Yammi’s soft butt ravenously removes her fingers. She leans down, quickly replacing her fingers with her tongue. Or so you imagine. You can’t see with her face buried in Yammi’s plump behind, but options are limited and it’s easy to imagine her devouring the cute sparadat’s sexy ass. Yammi’s moaning into your neck and the convulsing of her pussy around your [pc.cockOrStrapon " + cockIndex + "] seem to support your theory. It doesn’t take long before she stands back up, tongue still out and looking pleased with herself.");
	...
	output("\n\nYammi, pussy practically spasming at this point, seems to be barely hanging on. You’re right behind her, and, judging from her accelerating thrusting and the sounds she’s making, so is Pippa. The cacophony of noises the three of you are making crescendos and finally hits a climax as Pippa’s goes over the edge first; she thrusts hard into Yammi, completely bottoming out and grasping the sparadat’s shapely hips from behind. You see and feel shuddesr run through her body. She’s the first domino, sending Yammi into climax when she bottoms out. Yammi’s tight, shivering pussy, in turn, finishes you off");
...
public function pippaYammiThreesomeSub(cockIndex:int):void
{
	...
	output(" At this point, you’re so on edge that a light breeze blowing the right way could tip you over; you body enveloped between the two lovely ladies, you only manage a few thrusts before you go over the edge.");
	...
	output(" They giggle through their kissing, grinding their hips and rubbing their wet pussies along your length, rubbing your [pc.cum] into each other’s bodies.");
