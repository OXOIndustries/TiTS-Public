...
public function pippaYammiThreesomeSub(cockIndex:int):void
{
	...
	output("\n\nYou pull yourself from between them, and Yammi rolls off of Pippa. The two of them are quite filthy, sweaty, flushed, and covered in pussy juice" + (cockIndex >= 0 ? " and cum" : "") + ". You tell the two of them to go take a shower, and you’ll clean up the kitchen");
