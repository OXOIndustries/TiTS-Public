...
public function approachJesse(back:Boolean = false):void
{
	...
	//Lust and Body requirements needed!!!
	if (flags["JESSE_TALK_BODY"] != undefined) addButton(3, "Sex", jesseSexMenu, undefined, "Sex", "Get at that eager booty!");
...
{
	clearMenu();
	addButton(0, "Office RP", jesseSexOfficeRPI, undefined, "Office RP", "Just another day in the office! Give her the hostile takeover she needs.");
	addButton(1, "Reverse Cowgirl", jesseSexReverseCowgirlI, undefined, "Reverse Cowgirl", "Make her work for that dick! Collar her and have her ride you.");
	if (pc.hasVagina()) addButton(2, "Her Face", jesseSexReverseHerFaceI, undefined, "Her Face", "And what a cute one it is! Use her mouth and tongue as your playthings.");
	else addDisabledButton(2,"Her Face","Her Face","You need a vagina for this scene.");
	addButton(2, "Her Face", jesseSexReverseHerFaceI, undefined, "Her Face", "And what a cute one it is! Use her mouth and tongue as your playthings.");
	addButton(3, "Bag O’ Tricks", jesseSexReverseBagOTricksI, undefined, "Bag O’ Tricks", "Kinky! Bend her, bind her, fill her with toys. Push her till she cums her brains out.");
	addButton(4, "Trap Fun", jesseTalkBody, undefined, "Trap Fun", "Face it, you’re as subby as she is! Use a special toy in her bag and get some mutual love.");
	addButton(5, "Role Reversal", jesseTalkBody, undefined, "Role Reversal", "Face it, you’re as subby as she is! Get her to do the buttfun, although it’ll be awkward...");
}
...
public function jesseSexOfficeRPII(x:int = -1):void
{
	...
	if (pc.cocks[x].cLength() < 8 || pc.hasHardLightEquipped()) {
		output(pc.cockOrStrapon(x) + " up to the ");
		if (pc.hasKnot(x)) output(pc.knotDescript(x));
		else output("base");
		output(", bashing down her resistance!");
	}
...
public function jesseSexReverseCowgirlII(x:int = -1):void
{
	...
	output("\n\nLeaning back against the pillows, with Jesse’s bare butt a short distance from your [pc.cockOrStrapon], it’s only logical what should happen next. You pull the chain gently, encouraging her to sit on her spit-lathered prize like a good buttslut. Her tensed hole gives way to your [pc.cockOrStapon] with ease and her impish moans form a chorus of cathartic joy. As her hot, soft, and tight asshole absorbs your [pc.cockOrStrapon] almost to the {ifKnot: [pc.knot] //else: base} with just enough room for her to bounce.");
	...
	output("\n\nShe’s so eager that she begins at peak pace. Every pull up brings your [pc.cockOrStrapon] to the edge of her entrance and every push down lets her take it up to your {ifKnot: [pc.knot] //else: base}! You help her along by pulling on the chain with each downward motion. With your free hand, you place it on her gyrating hip for guidance and encouragement, making sure she bends your shaft into all the right spots of her beautifuly tight sluthole. You grunt as the pleasurable feedback through your {pc.cockOrStrapon} brings you closer and closer to climax!");
	output("\n\nAs she lifts and pushes herself up again, you pull on the chain and her hip in turn so that she is practically impaled! She whines as the hard sensation of your [pc.cockOrStrapon] catches her off guard! You unleash a feral snarl as it does the same to you, her tight passage squeezing you in response. In sync with that moment, you feel that familiar rise of euphoric heat in your loins!");
	if (pc.hasCock()) {
		if (pc.cumQ() >= 1000) output("\n\nA veritable flood of [pc.cum] gushes through your [pc.cock] to the depths of Jesse’s roughly fucked sluthole. It has very little space to fill so in seconds, it already leaks and splurts out from the tight seal made from her hole and your [pc.cock]!");
		else output("\n\nA surge of [pc.cum] gushes through your [pc.cock] and into the needy insides of Jesse’s roughly fucked sluthole. It coats the inside fully, giving her a properly packed creampie that she’ll be taking home with her!");
	}
	output("\n\nYou both collapse backwards into the bed in a breathless pile, the diminutive wench on your lap going limp in your arms. ");
	if (pc.hasCock()) output("You feel your [pc.cock] shrink and recede from her loosened, gaping hole... and a comforting drizzle of [pc.cum] run down your lap");
...
public function jesseSexReverseHerFaceI():void
{
	clearOutput();
	author("SoAndSo");
	showJesse();
...
public function jesseSexReverseHerFaceII(x:int = -1):void
{
	clearOutput();
	author("SoAndSo");
	showJesse();
	...
	clearMenu();
	addButton(0, "Yes", jesseSexReverseHerFaceYes, x, "Yeah", "Play-for-play, as it were. She’s earned it.");
	addButton(1, "No", jesseSexReverseHerFaceNo, x, "No", "Her reward was the privilege of tasting your pussy, after all.");
}

public function jesseSexReverseHerFaceYes(x:int = -1):void
{
	clearOutput();
	author("SoAndSo");
	showJesse();
...
public function jesseSexReverseHerFaceNo(x:int = -1):void
{
	clearOutput();
	author("SoAndSo");
	showJesse();
...
public function jesseSexReverseBagOTricksI():void
{
	clearOutput();
	author("SoAndSo");
	showJesse();
...
public function jesseSexReverseBagOTricksII(x:int = -1):void
{
	clearOutput();
	author("SoAndSo");
	showJesse();
	...
	clearMenu();
	addButton(0, "Release", jesseSexReverseBagOTricksRelease, x, "Release", "She’s earned it, a nice light session for now.");
	addButton(1, "Continue", jesseSexReverseBagOTricksContinue, x, "Continue", "Nah, make her scream for it and see how much she can <i>really</i> cum.");
}

public function jesseSexReverseBagOTricksRelease(x:int = -1):void
{
	clearOutput();
	author("SoAndSo");
	showJesse();
...
public function jesseSexReverseBagOTricksContinue(x:int = -1):void
{
	clearOutput();
	author("SoAndSo");
	showJesse();
...
//tooltip: Face it, you’re as subby as she is! Use a special toy in her bag and get some mutual love.

Before you come to answer, Jesse raises her hand.
...
Fine, fuck it! You push down from your [pc.hips] and your eager [pc.asshole] is speared by the smooth, cold dildo. A pleasured, rising whine is muffled by you biting your lower [pc.lip] as a reaction to adjusting to the length and width. {pcAnalLooseness>2: It’s pretty easy going for your well trained [pc.asshole], letting you slide easily down to the base just like Jesse. //else: It’s a tough insertion, your [pc.asshole] clenching tightly around the fake cock like it was your first. You make it to the base with some pained effort.} Your prostate thanks you all the way: tingly, sharp, and pleasurable sensations fill your lower body in spite of your hole bearing the stretch.
...
{pcCock>13”</i>:
Your half hard, [pc.cockNounComplex] meets Jesses 10’’ fempecker in the middle, dwarfing it in size. Her femdink gets bent by the sheer amount of your dick mass! {silly: HO HO HO, MERRY DICKMAS.} Jesse giggles as she watches the meat rod mess. <i>“Mmm, Steele’s monster cock...”</i> she coos.
/pcCockBetween8’’-12’’:
Your half hard, [pc.cockNounComplex] meets Jesses 10’’ fempecker in the middle, two twin sizes rubbing their heads together. How cute!
<i>“Mmm, I love twin touching tips,”</i> giggles Jesse, her femcock twitching and pushing against yours.
//pcCock<7’’:
Your half hard, [pc.cockNounComplex] meets Jesses 10’’ fempecker in the middle but is immediately dwarfed by her size. Her slender pecker lilts against your [pc.cock]. <i>“Mmmmhaha, look at it! So </i>cute<i>!”</i> she giggles, trying very hard not to belly laugh. <i>M-mean...</i>
}
...
You give her a quick nod, your eyes focused on the dual meat-sticks in the strumpet’s hand. The grinding urethra send little pulses of discomfort through your [pc.cockNounSimple] and into your tender loins. {silly: So much at steak, Liara, I fckn <i>lurv</i> steak.}
...
Slowly, and with your additional grip, the eager buttslut pumps the onahole up and down. The tight squeeze around your [pc.cock] is rough at first but as [pc.cumVisc] pre-fluid seeps into and spreads around the insides, the tightness becomes sublime. Splodges of [pc.cumColor] mix with pearly cream to make a natural lube, certainly making it easier for Jesse to lead the pumping action.
As she continues, making bolder and longer pumps that pushes your [pc.cockNounComplex] in <i>deep</i>, the toys snugly lodged in your assholes seem to vibrate and whirr with increasing intensity. The constant, debilitating throb sends your sensitive prostate into pleasure overdrive! {pcHasBalls: Your [pc.balls] can’t hold out forever! Churning, hot [pc.cumNoun] swirls and builds inside, ready for a gooey release...}
...
The hot deluge of baby batter spurts and squirts from around the tight edges of the cum-dumped onahole, more than enough to cover both your [pc.belly] and Jesse’s 
midsection. It oozes and dribbles into the bed, soaking it with love juices. 
/pcNotSoMuchCum:
The hot mixture of baby batter dribbles and spurts from the edges of the cum-dumped onahole, slowly sliding down your [pc.cock] {pcHasBalls: and [pc.balls]} with a warm tickle.
}
...
//tooltip: Face it, you’re as subby as she is! Get her to do the buttfun, although it’ll be awkward...

Jesse pipes up before you come to an answer.
...
Oh how could you say no to that {silly: you goddamn monster}! Well, it’s probably very easy to but you’re still not really against the idea. You ask her for some details. She grins, points to her slowly hardening fempecker then points to your [pc.ass]. As clear as intent as any.
...
As she attaches then tugs on the taut leash, you find it yourself having to bend your upper body towards the ceiling. Truly, despite her small stature and lack of strength, Jesse knows a thing about submission holds and positioning. {silly: I also heard she’s a Dota 2 pro who plays a great Crystal Maiden. <i>TheMoreYouKnow</i>.}

<i>“F-feeling comfy, [pc.name]?”</i> she asks tentatively, sliding down your back towards your bare [pc.butt].
<i>“Mmmhm,”</i> you murmur, turning your head to her to give her a grin for confirmation. You wiggle your [pc.ass] as an invitation. {pcHasTail(s): You bend your [pc.tails] against your back to freely expose your [pc.asshole]: there’s something very satisfying about doing so, like unveiling a dirty secret.}
...
Your body is ready {silly: fils-aime face}. 
...
Her breath is quite heavy but you’re not sure that she’s actually tired out. Rather, it seems she isn’t willing to be the proper Domme she needs to be at the moment. You could encourage her to fuck you harder... or turn the tables. {silly: I AM THE TABLE, IHDFHUUHFUGDHGIH}

[Encourage] [Take Over]
Encourage
//tooltip: Pep her up, she’ll find away to make it work!

<i>“You can do it,”</i> you say in a needy tone, wishing for her to want it too. You give her firmly lodged femcock a few squeezes with your [pc.asshole] to remind her of just how <i>awesome</i> it feels to fuck a Steele’s ass.
...
<i>That’s it</i>. {silly: Let the hate flow through you.}
...
Her words and voice devolve into slurred syllables and expletives most unbecoming, her frantic penetration of your well-fucked butthole reaching its peak. From [pc.cockEachHead] to the base of your loins, a surge of tense and overwhelming feedback fills you up!

You cum: {pcLotsOfCum: a veritable torrent of [pc.cum] spouts straight into the bed fabrics like a debased fountain, coupling with your orgiastic, effeminate moans! /pcNotSoMuchCum: thick strings of [pc.cum] shoot into the awaiting bed fabrics, a debased pool of refuse seed and a lurid, effeminate moan leave your body!}
...
The mutual comedown is quite something. There’s a warm, shared glow that radiates from you to Jesse and back again. It’s so intimate {pcHasSexedJesseBefore: and <i>different</b>} from what you’d expect, the ‘flavor’ turning the experience into a memory of pure feeling.
...
Take Over
//tooltip: It’s no good, she’s just not Domme material. Power bottom the over-ambitious buttslut.

Damnit, you wanted cock and you’ll get some cock!
...
<i>“Now,”</i> you say sternly, guiding one of her hands around the {[pc.knot]/[pc.base]} of your [pc.cockBiggest].
<i>“Fuck me, you slut.”</i>
...
Jesse speeds up a little, making shorter, shallow thrusts that tenderize your strained hole all the more. She lets go of the mouth lock to breath more easily and you ease back on the leash tension just enough for her to do so. Her face is only half a few inches from your [pc.face] and the poor girl just cant take her eyes off of you: swirling, starry orbs detailed with glistening, black streams of ruined eye liner. You wrap your [pc.legs] right around her middle and use {them/it} to pull her just that bit closer, wishing for her to exceed.

But she’s close, you can feel it as her femcock continuously tenses and throbs within you.Hoping for a magical moment of unison, you furiously jerk at your [pc.cockBiggest] and feel your eyes roll back into your head as the pleasurable sensations take a toll on your body. Jesse helps you along, sensing your intent. In a few short, overwhelming seconds, the inevitable surge of hot, liquid love burns through your [pc.balls], your [pc.cock] and then {pcLotsOfCum: erupts all over your body //else: shoots in strings all over your body} to a chorus of your enraptured voices! Jesse’s whines climb higher and higher in pitch, squeals turning into moans, then cries, and then one final string of throat-breaking squeaks as she unloads her baby juice into your thoroughly fucked innards!
