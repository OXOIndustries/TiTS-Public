...
public function lucaFucksYourAss():void
{
	...
	output("\n\nYou release the headboard and shove your face into a pile of pillows. Luca begins to grope and knead your [pc.ass]. Once satisfied, she relents and pulls her hands away. You hear a bottle open and a squirting noise. Immediately a cold liquid is smeared around your backdoor. A finger starts to play with your {buttslut: needy} pucker. Luca probes at your ass liberally lubing you up for her monstrous member. She idly hums in tune with the background jazz as she slips two fingers into your " + (pc.isAssTight() ? "tight" : (pc.elasticity >= 5 ? "stretchy" : "open")) + " rear.");
