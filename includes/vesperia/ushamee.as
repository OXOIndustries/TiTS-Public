...
public function dateUsha():void
{
	...
	if (((flags["USHA_DATE"] == undefined || flags["USHA_DATE"] == 2) && pc.credits < 250) || pc.credits < 100) addDisabledButton(0, "Go For It", "Go For It", "You don't have enough credits to treat her.");
...
public function fuckUsha():void
{
	...
	if (pc.biggestCockLength() >= 24)
    {
		...
		output("\n\nYou can't go much slower, unless she wants you to cum before you're half way in. Then again, the way her pussy's clenching and squirting around your shaft, something tells you she doesn't <i>want</i> you to slow do. Quite the opposite. Giving her a reassuring rub on the haunch, you allow the buxom amazon a second of stillness to adjust to your pussy-stretching presence... before you grab two handfuls of ass and ram yourself in to the hilt.");
...
public function fuckUshaBumPart2():void
{
	...
	if (flags["USHA_BUMLOVE"] == undefined) flags["USHA_BUMLOVE"] = 0;
	flags["USHA_BUMLOVE"] += 1;
...
public function oralUsha2():void
{
	...
	if (flags["USHA_ORAL"] == undefined) flags["USHA_ORAL"] = 0;
	flags["USHA_ORAL"] += 1;
...
public function mountUsha():void
{
	...
	if (flags["USHA_MOUNT"] == undefined) flags["USHA_MOUNT"] = 0;
	flags["USHA_MOUNT"] += 1;
...
public function sexMerge():void
{
	...
	if (flags["USHA_SEXED"] == undefined) flags["USHA_SEXED"] = 0;
	flags["USHA_SEXED"] += 1;
