...
output("\n\nHaving gotten used to the stations more homey appearance, the redwood door with <i>“The Lotus Eater”</i> burned into the top of it doesn’t surprise you much. Next to the door is a sign that reads: <i>“Open All Hours.”</i>  There appears to be a much more recent handwritten sign as well: <i>“Please Treat The Help With Respect.”</i>");
...
//Introduction
public function approachLuca():void
{
	clearOutput();
	showLuca();
	//First Time
...
{
	//9999
	output("\n\n<i>“Can I see what you have for sale?”</i>");
...
public function lucasVRSims():void
{
	...
	{
		output("\n\n<i>“Of course [pc.Name]. Luca spins a hardlight screen towards you displaying a Terms & Conditions screen. <i>“But first I need you to read this, then sign and accept.”</i>");
...
public function simmRouting(arg:String):void
{
	clearOutput();
	showLuca();
	output("After selecting the simulation and paying her, Luca leads you to ");
	if(9999) output("a private room with a cushiony reclining chair.");
	...
	processTime(2);
	clearMenu();
	addButton(0,"Next",simmPlaying,arg);
}

public function simmPlaying(arg:String):void
{
	//9999 scene here
}
...
public function simmOutro(arg:String):void
{
	if(9999) output("\n\nThe simulation shuts down and you begin to regain your normal senses. As you try to remove your headset Luca places a warm hand on your shoulder and carefully removes the VR equipment. She makes sure your senses and perception of time have re-adjusted properly. Once you have fully rested you leave.");
	else output("\n\nThe simulation shuts down and you begin to regain your normal senses. You receive several cheers and hollers as Luca carefully removes the VR equipment. She makes sure your senses and perception of time have re-adjusted properly. Once you have fully rested you leave.");
	clearMenu();
...
//Experience another chapter of the infamous space spy Stella Goodhead as she takes on a new and dangerous mission. Stella’s goal is to board the flagship of the Pirate Queen Titania Fucklaw and capture or eliminate her. Will Stella be able to complete her mission or will she suffer defeat yet again and be added to the Pirate Queen’s harem?
public function thePirateQueenScenario():void
{
	clearOutput();
	showName("AUSAR\nGUARD");
	// Part 1 - Ausar Guard
	...
	//Public:
	if(9999) output(" A series of numbers and letters are displayed above the door: Views - " + (15+rand(4)));
...
public function testingChamberAhoy():void
{
	clearOutput();
	showName("TESTING\nCENTER");
	...
	//Public:
	if(9999) output(" A series of numbers and letters are displayed in front of the arms: Views - " + (26+rand(4)));
...
//Tooltip Bail: You’ve had enough of this simulation and you want out.
public function part3ADoorDildo():void
{
	clearOutput();
	showName("DOOR\nDILDO");
...
public function nutrientStallsWheee():void
{
	clearOutput();
	showName("NUTRIENT\nSTALLS");
	...
	output("\n\nYou don’t know how far you made it before your tongue started lapping up the alabaster slime you’re wading in. Somehow you manage to to keep moving straight despite your body slowly betraying you. You begin to revel in the flavor and fragrance as you continue to crawl.");
...
// Part 3B - Showers
public function showersSimmScene():void
{
	clearOutput();
	showName("THE\nSHOWERS");
...
public functionTheBadEndHappensNow():void
{
	clearOutput();
	showLuca();
	...
	//Path A:
	if(9999) output("thanking that huge door dildo that loosened your throat earlier");
...
output("\n\nAmazonia Prime (WIP)");
output("\n\n// Amazonia Prime takes four hours to complete. If the PC bails early skip one hour for each part that was completed.");
output("\n\n//Tooltip:");
output("\n\nAre you ready for another episode of the great space explorer Dixon Cider? While enroute to his destination, his ship malfunctioned and he was forced to land it on the dangerous jungle world AMAZONIA PRIME. Will Dixon be able to fix his ship or will he succumb to the dangers of the planet?");
output("\n\nContents: Bad End, Anal, Oral, Blowjob, Deep throat, Feminization,.");
output("\n\n// Part 1 - Exploration");
output("\n\nYou begin to lose feeling in you body as the VR Simulation loads up. You feel like you’re about to blackout once the simulation activates. Your avatar is Dixon Cider, a renowned space explorer. Dixon is a terran with fair, slightly tanned skin, a heroic muscle toned body, and an eight inch penis. You are wearing a white shirt, a leather vest, cargo pants filled with gadgets, and combat boots.");
...
output("\n\nYou place your prize into your satchel. Prize? You sigh, annoyed at the situation and it’s anticlimactic reward. As you leave the temple you prepare for a horde of burly amazonian warriors to ambush you, but no one does. As you enter the jungle you keep your eyes peeled for jungle cats trained to attack trespassers, but no animal gets close to you. When you return to your ship you expect something to be wrong, but the repairs went smoothly and you along with the crew should be able to leave tomorrow morning.");
output("\n\nOver dinner you tell the crew of your adventure into the amazon’s temple and the strange object you found within. All of you share a long laugh over the absurdity of your ‘prize.’ Chris in particular mocking it’s extreme proportions. After food and conversation you tell the crew to lock down the ship and get some rest.");
output("\n\n{Public: A series of numbers and letters are displayed in on your cabin ceiling.");
output("\n\nViews - [26-29]}");
...
output("\n\nYou slather the <i>divine silver cock</i> in lubrication. You get lost in your preparations just absentmindedly stroking the idol. When you realize how silly you’re acting you begin preparing your pucker for your new friend. You take your time stretching your backdoor, it won’t be the first time you’ve had something in your ass, but it will be the largest by far.");
...
output("\n\nOnly a few minutes into your delirious journey you find yourself panting and burning with need. You unbuckle your pants and fall to the ground trying to thrust the silver cock into your rectum, but it is getting hard to think or move. You lie down breathless and blackout with unfulfilled need.");
output("\n\n// Next Scene");
output("\n\n[Next] [Bail]");
output("\n\nTooltip Next: Proceed with the simulation.");
output("\n\nTooltip Bail: You’ve had enough of this simulation and you want out.");
...
output("\n\nSeylia leaves with an abrupt twirl. As you watch her asscheeks bounce while she walks away you realize just how hungry you are. Looking around your cage you see a basket filled with fruit has been provided for you to eat. You lunge upon them like a predator, each bite into the alien fruit is unique and reminds you of the great things you can find as an explorer. After you satiate your hunger you lie down on some makeshift bedding for nice nap.");
...
output("\n\n{Public: A series of numbers and letters are displayed above the guard.");
output("\n\nViews - [43-45]}");
...
output("\n\nThe next morning Seylia returns to you with news of your trial by combat.");
...
output("\n\n{Public: A series of numbers and letters are displayed on the gate.");
output("\n\nViews - [88-92]}");
...
output("\n\nDelerious from two back to back orgasms you offer no resistance as Hippolyta flips you back upwards. Hippolyta walks you towards the other stands, all the while keeping the head of her ribbed majesty teasing your deprived rear. When she finally reaches the stands she lowers you just enough for the crown of her dick to firmly press against your pucker.");
output("\n\nAs you’re about to cry out for her to fuck your ass you see your crew in the stands. Each of them are mounted atop an amazon, their faces caught in pleasure and agony, their bellies distended from being fucked full of cum. Though they see you being grappled by Hippolyta all they do is howl like animals in heat.");
...
output("\n\n{Public: A series of numbers and letters are displayed along one of the murals.");
output("\n\nViews - [26-29]}");
...
output("\n\nTooltip Bail: You’ve had enough of this simulation and you want out.");
output("\n\n// Part 3B - Training");
output("\n\nYour eyelids feel like lead as you struggle to open them. Your thoughts are cloudy, it’s really hard to think after such a long nap. You lie up on a wooden cot and look around the hut you’re in. You see your clothes in a pile next to the cot, but the pockets all appear to be empty.");
...
output("\n\n{Public: A series of numbers and letters are displayed around the ceiling of your hut.");
output("\n\nViews - [42-45]}");
...
output("\n\nSecond you were to eat only what they provided you; specific fruits and meats, along with a special brew which smelled heavily of semen. Quickly your skin became soft and smooth and your breasts grew into B cups. Sadly your chest didn’t come close to any of the amazons, especially the priestesses, but you well up with pride when you look at them.");
...
output("\n\n{Public: A series of numbers and letters are displayed above the Amazon.");
output("\n\nViews - [88-92]}");
