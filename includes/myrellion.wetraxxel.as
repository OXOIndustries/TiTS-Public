...
public function wetraHoundAI():void
{
	...
	attacks.push(wetraHoundPunch);
}

public function wetraHoundBite():void
{
	// 9999
	//Moderate piercing damage. Chance to inflict Bleeding (if shields are down only).

output("The wetra hound leaps forward, its fanged maw wide open. The creature slams into you, attempting to sink its dagger-like teeth into you. {hit: The hound bites your arm, bringing its jaws down around you with crushing weight. You yelp in pain as its fangs sink into you! (When the creature pries itself off of you, you watch in horror as blood spurts from the wound. <b>You're bleeding!</b>) //miss: You punch the bastard right in the nose, sending the beast tumbling back away just before it can bite into you!}");
}

public function wetraHoundPunch():void
{
	// 9999
	//Moderate bludgeoning damage, chance to knockdown. 

output("The wetra hound rises up onto its puny hind legs, bringings its meaty fists up and trying to sucker-punch you! {hit: Pow, right in the kisser! You stagger back under the massive weight of the blow(, and suddenly find yourself tripping on a rocky outcropping. <b>You're knocked prone</b>)! // miss: You put up your dukes and block the punch, deflecting the beast's mighty blow!}");
}

public function wetraHoundOverrun():void
{
	// 9999
	//Massive bludgeoning damage, low chance to hit unless knocked down already. 

output("The wetra hound bellows, a thunderous roar that echoes through the caverns, and charges at you at its full, loping speed. {hit: The beast slams into you head-first, its thick skull-plate acting like a battering ram that sends you flying against the cavern wall. You yelp in pain as the rib-cracking attack lands, and leaves you rolling in agony on the floor. // Miss: You tumble out of the way as quick as you can, letting the hound's momentum carry it past you. Its head slams into a wall with what should have been lethal force... but the beast just shakes it off and whirls around, ready to keep fighting!}");
}
...
output("The wetra hound leaps forward and rakes at you with its claws,{tearing into your flesh // narrowly missing you}!");
}
...
{
output("Yelping in pain, the wetra hound stumbles back and licks at its wounds. You take a threatening step forward, and the wounded hound yelps and starts loping away, hustling off into the shadows. The sounds of the beast yelping and howling echo back to you through the caverns. ");
...
public function wetraHoundPCLoss():void
{
	...
	output("\n\nOver the sounds of its snarling, you begin to hear footsteps rapidly approaching. {A huge, muscular, insectile creature // the wetraxxel male who masters these caves} steps out of the shadows, cracking his knuckles and scowling at you. {if not met: Your codex beeps out an identification, barely audible over the hound’s growling: this creature is a wetraxxel, a towering brawler who is dangerously territorial.} The wetraxxel whistles sharply, barking something in his guttural language that brings the hound off of you. The beast retreats, bounding off into the darkness, and leaving you at the mercy of its master...");
...
/*
The wetraxxel lunges forward, keeping his guard up until the very last second. He strikes out with a quick jab, followed up by a brutal left hook! {hit 1: You stagger back under the force of one of the blows, though you're able to dodge the other strike. // hit 2: You're thrown off balance by the force of the first punch, leaving you wide open for a thunderous blow that makes you see stars. You cry out in pain, staggering until you slump up against the cavern wall. Ouch! //2 misses: You nimbly duck out of the way, blocking and dodging his strikes.}
*/
}
...
/*
The brawler bug swings at you, making you duck back -- and immediately follows up by ducking down and trying to sweep your [pc.legs] out from under you. {if miss: You dodge the strike, leaping back out of the way. //if hit + taur/naga: His kick strikes you, hard, but due to your bestial anatomy, you're hardly affected in any way but for a sharp sting from the impact. He hits like a truck! //if hit + biped: The kick takes you completely by surprise, throwing you off your feet and sending you tumbling to the ground. You grunt as the wind's knocked out of you, narrowly avoiding cracking your head on a sharp stone nearby. <b>You're knocked down!</b>}
*/
}
...
/*
The brawler takes a running start, hurling himself feet-first at you. {miss: You duck the attack, letting his weight carry him over your head and into the wall! //hit: His feet slam into your [pc.chest], knocking the wind out of you and sending you stumbling back. It's agony to catch your breath after that, and you find yourself clutching at your chest, wheezing painfully. <b>Your aim and reflexes are temporarily reduced</b> while you catch your breath.}
*/
}
...
/*
The wetraxxel rushes at you, thrusting his arm out to the side and twisting his body, catching you in a clothesline! {Miss: You manage to keep your footing, blocking the worst of the brawler's strike. //Hit: His forearm catches you right on the chin, and the weight of the brawler's body slams you into the ground. You feel the weight of the world slam into the back of your head, rattling you to your core. <b>You're knocked down!</b>}
*/
}
...
/*
The wetraxxel stomps his feet, pounds his chest, and comes rushing at you with a blood-curdling battle-roar. He tucks one of his shoulders and rushes at you, trying to slam into you with the whole weight of his body behind him! {miss: You side-step the incoming attack, letting the brawler's charge carry him straight past you. He only just manages to slow himself down before slamming into a wall himself. //hit: The brawler body-slams you at full force, crashing into your [pc.chest] with rib-cracking impact! You'll be feeling that for days!}
*/
}
...
/*
Looking down at you with a scowl, the wetraxxel cracks his knuckles and lumbers forward. You try and scramble back, but find him much swifter from this position. After a moment of self-assured leering, the wetraxxel lunges forward with a leap, and drops down elbow-first on you! {miss: You manage to twist out of the way, letting him elbow-drop the floor. Oof, that's gotta hurt! //hit: He drops down on you like a hammer, cracking his elbow right into your gut! You cry out as the massive blow connects, leaving your writhing in pain.}
*/
}

public function wetraxxelBrawlerPCLoss():void
{
	output("\n\nYou collapse, too {battered/ turned on} to put up any further resistance to the huge bug-man. {if Submission 6-10: You assume the familiar position of submission, lowering your head meekly as the wetraxxel approaches you. // Submission 5 or less: You grunt, slumping to the ground. You pointedly avoid the wetraxxel’s leering gaze as he approaches you.} The brawler’s fists relax, coming to plant on his hips.");
	
	output("\n\n{if Submission 5 or less: <i>“You are not welcome here,”</i> he growls, his voice like grinding gravel that echoes through the cavern. <i>“I will teach you what happens to intruders.”</i>");
	output("\n\n{if Submission 6-7: <i>“Again and again you return,”</i> the wetraxxel growls, looming over you now. You pointedly avoid his gaze, already starting to pull away your burdensome gear. <i>“You must enjoy these lessons, then? You still have too much fire, though, alien. I will continue to break you.”</i>");
	output("\n\n{if Submission 8-9: <i>“You still return?”</i> the wetraxxel sighs, looming over you. You pointedly avoid his gaze, already starting to pull away your burdensome gear, shame-facedly trying to hide your mounting sexual excitement. <i>“You enjoy your submission, I see. As do I. Perhaps you would make a fine addition to my harem after all...”</i>");
	output("\n\n{if Submission 10: go to Bad End: Harem Slave.}");

//Go to randomly-determined PC loss scene, if not Bad Ended. 9999
clearMenu();
addButton(0, "Next", wetraxxelLossScene(false));
}

public function wetraxxelBrawlerPCLossPinnedAndFingered():void
{
	//PCs of any gender. Submission 6 or less.
	output("\n\nYou wince as the wetraxxel’s large, strong hand clenches around your neck - though rather than a chokehold, the giant brawler picks you up by the scruff of your neck. You quickly find yourself pinned against the stone wall of the cavern, the weight of your body resting against an outcropping of sand-colored, gritty rock. The wetraxxel male’s hand is firmly against your neck, using his forearm to press you into the rockface. Still, despite the man’s intimidating power and size, the hold he keeps you in is completely painless.");
	
	output("\n\nThe wetraxxel looks you over appraisingly, his small black eyes wandering across your body. Slowly, the hand not pinning you begins to strip your of your [pc.gear]. When you’re left bare by the bug-man’s hand, his smoothly chitinous fingers {wrap around your [pc.cockBiggest] // grab your [pc.crotch]}. It’s impossible to stifle a moan of fear and pleasure as {if submission 5+ you feel the familiar hand groping you // else: the wetraxxel explores your body}. It doesn’t take long before his roaming hand slips between your [pc.legs], and you gasp as a single long, smooth digit nears your [pc.vagOrAss]. You squirm, desperately writhing in the brawler’s grasp, but he holds you perfectly firm as his finger presses inexorably towards your clenching {cunt / asshole}.");
	
	output("\n\nConsidering his tremendous size, the wetraxxel’s digit is bigger and as thick around as a human cock. It feels like one, too - so smooth and hot as its rounded tip pushes against the {lips/rim} of your [pc.vagOrAss]. With a grunt of effort, the wetraxxel shoves himself inside you, spreading your hole wide around the rigid girth of his plated finger. You shiver in pleasure as the bug-man’s finger slides into you, teasing through your {tight / loose / ruined} passage until his palm is pressed against your thighs.");
	
	output("\n\nHe gives you the span of a heartbeat to get used to him before he starts to move. He starts to thrust quickly, hammering your hole with agonizing abandon. You scream in pleasure, throwing your head back in a primal gesture of ecstasy. The wetraxxel only moves faster, spurred on by your screams; he’s jackhammering you before long, pounding your [pc.vagOrAss] until you’re completely unable to hold back. A few moments later and you’re cumming, {spraying a thick gout of spooge across the brawler’s chest // gushing fem-cum out around his finger // crying out in agonizing pleasure as your sexless body convulses}.");
	...
	output("\n\nAnother finger slips in with the first, stretching your [pc.vagOrAss] wide. The wetraxxel makes a simple grunt in answer to your pleas and moans, his four-part insectile mouth contorting into a scowl. {if submission 5+: You whimper as you realize your captor is less than pleased, and quickly find yourself cupping your hands around your mouth, trying not to scream.} All you can do is try to hold on, desperately clenching around his pounding digits. Your squirming, now well-fucked hole can offer no resistance anymore, and you quickly find a third finger jamming its way in with the first pair.");
	
	output("\n\nThe insertion, now stretching you as wide as three cocks, wrenches another orgasm from you. {More spooge jettisons from your [pc.cock], smaller than the first load, and weaker too. // Your pussy squirms and soaks itself again around the wetraxxel’s thrusting fingers, soaking his plated hand in your girl-juices.} He makes an approving grunt, but the scowl on his features doesn’t relent - and neither does his hand. The wetraxxel keeps forcefully fingering you, his small black eyes intent upon you.");
...
{
	output("\n\nOrgasm after orgasm washes over you, wracking your mind and body with pleasure and that borders on pain. You’ve lost track of times, of pleasure, of anything but moaning weakly and writhing under your captor’s ceaseless ministrations. Your body is completely limp in his hands, overwhelmed to the point of nonresponse by the vigorous finger-fucking you’ve receieved.");
	
	output("\n\nThis wetraxxel male is utterly relentless, completely intent on sexually punishing you for your intrusion. His entire fist is inside you now, stretching your [pc.vagOrAss] to the absolute limit. You feel like you’re being fucked by a smooth, hard watermelon. Your gut strains around the massive insertion{if PC is 6 ft or less: , feeling like you’re about to be torn in half}.");
	
	output("\n\nFinally, on the tail of another dry orgasm - the most recent of so very, very many - the wetraxxel grunts and pulls himself out of you. Left suddenly empty, your body deflates in on itself, collapsing around your stretched-out {asshole / cunt}. When the bug-man’s hands release you, you slump lifelessly to the ground, barely conscious after the rigorous fucking you’ve just taken.");
	
	output("\n\nSeemingly satisfied with the punishment he’s meted out, the wetraxxel steps back and growls, <i>“Leave this place, alien. You are not welcome{ if PC is feminine: yet}.”</i>");
...
public function wetraxxelBrawlerPCLossButtfucking():void
{
	...
	output("\n\nLooming over you, the wetraxxel starts to tear away your [pc.gear] with rough, powerful motions. You cry out and squirm, trying to avoid his hands; in your state, though, there’s little you can do to resist his wishes. He makes quick work of your gear, throwing it aside until you’re bare-ass naked against the cold stone of the cavern.");
	...
	output("\n\n{if PC has a cunt: <i>“You are not worthy to bear my offspring,”</i> the bug grunts, sliding deep into your asshole. <i>“By right of conquest, I claim your barren hole until you are.”</i>}");
	...
	output("\n\nIt’s a wonderfully stretching sensation, feeling that mammothly long cock sliding into you. This bug is hung more like a bull, and has the strength to back it up! He moves inexorably onwards, shoving inch after inch of cockflesh into your helpless hole. {if PC is short: You feel your stomach bulging, distending to accommodate the tremendous mass of dickflesh.} The feeling of penetration seems to never end, as if he’ll be sliding into you for an eternity... Finally, when you’re sure you can take no more, his relentless advance stops. One of your hands manages to slip down from the rocks, and to your swollen belly full of dick.");
...
public function wetraxxelBrawlerPCVictory():void
{
	...
	output("\n\n{if by Lust: The wetraxxel’s simple loincloth is barely hanging on under the strain of his hardening alien cock. His breath grows heavy and fast, and his steps a little slower. The brawler’s eyes are wholly focused on your sensual movements - in the state he’s in, it’s all to easy for you to sidle on up close to him and, with a few caressing motions, have the brawler eating out of your hands. It’s easy to push him down onto his knees, completely at your mercy.}");

	output("\n\n{if by Damage: With a grunt, the brawler slumps to his knees, leaning heavily against the craggy rockface beside himself. <i>“I yield,”</i> he groans, relaxing his fists into raised hands. <i>“You fight with fire, alien. Fire and honor. Do with me as you will.”</i>}");
...
//PCs with dicks. Submission 6 or less. 
	...
	output("\n\nWith a big, bare, burly body on display like that, you feel your lust steadily rising - and your [pc.cock] stiffening{ beneath your {pc.lowerArmor}. You step slowly over to the defeated bug man, step by step discarding your [pc.gear] to leave yourself bare. The bug man’s eyes go a big wider when he sees what you’re packing, and he starts to try and scramble back. He comes upon a cavern wall quite quickly, though, leaving him nowhere to go. With a grunt, the brawler seems to submit himself over again, and doesn’t try to escape any further.");
...
public function wetraxxelBrawlerPCVictoryRideHim():void
{
//vagOrAss. Any Submission.
	...
	output("\n\nYour curiosity mixes with arousal, spurring you to get down on your [pc.knees] and wrap your fingers around his lengthy manhood. The wetraxxel’s cock throbs in your grasp, twitching to the thunderous beat heart, and his forked crowns swell with a rush of excitement. As he reaches full hardness under your experimental strokes, you can see he’s easily bigger than a human ought to be, even proportionally: he’s close to the length of your arm, though not quite as thick around.");
	...
	output("\n\nAs you move, the burly bug-man’s hands slip down your body, pulling at your [pc.gear]. You give him an approving nod, letting him start to peel your gear off of you, piece by piece until he’s got you completely bare{if submission 6+: and worshipping his cock, firmly planted in your rightful place}. With your [pc.lips] wrapped around the brawler’s cock, you’re left in the perfect place to look up across his broad chest and look into his black eyes at the apex of a suck. His cock throbs powerfully in your mouth, drooling a salty-sweet trickle of hot pre against your lips.");
	
	output("\n\nBefore it’s too late, you pull yourself off the delectable black cock you’ve been feasting on and sidle up to the wetraxxel’s waist, planting your [pc.knees] on either side of his body. Your captive bug-man looks up at your with a wry grin etched upon his mandibles, taking in the beauty of your naked body. While he’s busy gawking, you lick a pair of fingers and slip them down to your [pc.vagOrAss], caressing the {lips / rim} of your {pussy/ass}. One of your fingers glides in easily, teasing your tender muscles and spreading the coating of spit around. With a cock as big as the wetraxxel’s, every bit of lube is going to help for what you have in mind.");
	
	output("\n\nA moan escapes your lips, spurred on by the wonderful pleasure even a lone finger can bring while you’re so mind-numbingly horny. Finally, you can’t stand it anymore, and grab the brawler’s cock. He grunts, back rising from the stone floor while you angle his hefty member towards you. You have to stand way up to get his lengthy alien cockhead angled with your [pc.vagOrAss]. The forked heads press against your hungry hole, spreading you further open the more you press down on them until his crown is buried in your {cunt / ass}.");
	
	output("\n\nYou chew on your lip, trying to stifle a cry of pleasure as you sink down on the pillar of wetraxxel cockflesh. It’s an effort not to scream out, letting your voice echo through the corridors and announcing your ecstasy to the world. The wetraxxel makes that decision for you, grabbing your [pc.hips] and yanking you down on his rod: you can’t help but scream as he tries to ram feet of cockflesh into the straining {lips/ring} of your [pc.vagOrAss].");
	
	output("\n\nYour wrest yourself out of his grip and bat the brawler’s strong hands away from your waist. You get the feeling he’s just going along with it, allowing you to have your way with him. Smirking down at him, you figure you might as well take advantage of his acquiescence. You plant your hands on his plated chest and use it as support to start pulling yourself up and off his body. Shivers wrack your pleasure-sensitive body in response to his strange, thick, two-pointed prick dragged back through your [pc.vagOrAss] and rubbing against your tenderest parts. It’s hard to really bounce on the wetraxxel’s cock, massive as it is, so much as you’re able to rise and fall along his length, taking him as deep as you dare each time, {if not ruined hole: but never quite to the base of his tremendous shaft. //elseif massive gape: swallowing more and more cockflesh into your eager hole with every motion until you can feel your partner’s big, heavy balls pressing into your [pc.butt].}");
	
	output("\n\n{if PC has a cock: Your own [pc.cock] throbs, bouncing against the brawler’s belly with every wannabe-bounce you make. Pre is starting to bead on your [pc.cockHead], drooling onto the chitinous belly beneath you.} Straining your body to the limit, it doesn’t take long for the gut-straining alien cock to bring you agonizingly close to orgasm. Your motions become faster and faster, almost frenzied - your body becomes every more hungry for the brawler’s cock, hammering down on his hips until you’re groping at your [pc.chest] and moaning loud enough to let anybody in the caves for mile around hear you.");
	
	output("\n\nThe wetraxxel joins you with a gruff grunt of pleasure, and a sudden flood of wet heat into your [pc.vagOrAss] as he cums. With one final push, you take him as deep as you can and surrender yourself to pleasure, letting orgasm wash over your in tidal waves of ecstasy. Your [pc.vagOrAss] clenches powerfully around the wetraxxel’s dick, milking his hot seed out with your every orgasmic motion.");
	
	output("\n\nWhile you cum, you feel the brawler’s hands wrap around your hips, holding you steady until your climax has passed, and you slump down against his chest. You find your cheek resting against the lighter plates of the brawler’s abs while you catch your breath, letting the wetraxxel’s cock slowly wilt and slide out of you, leaving a sticky trail of seed that clings to your thighs. You slip off to sleep, held tight against the insectile brute’s chest{if Submission 6+: , right where you belong...}.");
...
{
	//PC gets beaten by the Wetraxxel (not the hound) with Submission 10+.

	output("\n\n<i>“You refuse to learn,”</i> the wetraxxel’s familiar, grinding voice booms throughout the caves, sending reverberations shivering up your spine. You meekly look up as the towering, ten-foot-tall bug-man approaches you with his hands firmly locked behind his back.");
	...
	output("\n\n{if PC has a cunt: <i>“You belong to me now,”</i> the brawler says sternly, looking down upon you with satisfaction. <i>“Your </i>womb<i> belongs to me. I will breed you again and again, like all my other wives.”</i>");
