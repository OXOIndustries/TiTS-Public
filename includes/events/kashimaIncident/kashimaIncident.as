...
KASHIMA_STATE:
	...
	1 				in progress
	2 				done, pc did the good shit
	3 				ended without curing shit
...
public function actuallyStartKashimaJob():void
{
	...
	output("\n\nThe Nova Securities ship is pulling up aside you now, having hailed you a few minutes past. They were alerted to your possible presence by headquarters, though the woman who you talked to didn’t seem overly thrilled by having a <i>“corporate tag-along”</i> with them. You cast a glance out your starboard viewport, getting a good look at the Nova ship: a sleek, orange-and-white vessel that just barely qualifies as a corvette, with a small shuttle bay in its back and a pair of light gun turrets mounted on either side of its prow. Swooping, sans-serif letters painted on her side identify her as the <i>Sunny Nebula</i>. A cheerful name for a warship.");
...
public function lustyBugponyNoDongleII():void
{
	...
	else output(" You did a pretty good number on me, Steele.\n\n");
...
public function kiHendersonMedbay():void
{
	...
	{
		output(" Your [pc.cunt] is a swamp of lusts, making your [pc.legs] quake beneath you.");
	}
...
public function kiHendersonSteeleTech():void
{
	...
	if (flags["KASHIMA_BRIDGE"] == undefined) output(" Chief Neykkar");
	else output(" Usha");
	output(". I promise.”</i>");
	...
	output("\n\nA couple of hours later, everyone aboard the Kashima has been secured in quarantine on the rescue ship, and a decontamination crew is sweeping through the decks, destroying the tentacles and securing the <i>Kashima</i>. It’ll be a while before she returns to duty, but according to the commander you talk to, she’ll be sailing the stars again someday. Perhaps even with her original captain, if your medical science department can in fact heal them.");
