...
public function turnTheTablesOnBadgertwat():void
{
	...
	if(!pcBimboedByBadger())
	{
		...
		if(pennyIsCumSlut()) output("\n\nThen, after a brief pause, she adds quietly, <i>“and, uh, </i>after<i> that, maybe we could find a way to make the whole cum-focused bimbo slut thing work on our terms. If, uh, if you want...”</i>");
	...
	else
	{
		...
		if(pennyIsCumSlut())
		{
			output(" She’s stops briefly as her cock gets all hard again, making her shudder with bliss as it pushes up between her breasts. <i>“Well, okay</i>, she adds, <i>“I was </i>mostly<i> hoping you’d say that. The thought of being a 100% cum-focused bimbo slut has... a definitely appeal, but no, this is a much better plan.”</i>");
		}
