...
public function extrameetEnchantingFaeDate():void
{
	...
	output("\n\nFae takes a deep breath. <i>“I don’t normally bring it up on a first date... But um... Well, I just think you’re nice and all, and I’d rather be upfront if things get serious.... It’s my age.”</i> An alarm goes off in your head. You recall his profile saying he was eighteen, and if that was a lie you might be dealing with a minor here. You scoot back your chair and prepare to bolt, ready for the bad news. <i>“I’m not really eighteen... I’m a hundred and eighteen.”</i>");
	output("\n\nYou blink. <i>“What?”</i>");
