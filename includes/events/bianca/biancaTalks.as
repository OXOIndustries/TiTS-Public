...
public function biancaWonderingAboutTheNextSteeles(inRandomEncounter:Boolean):void
{
	...
	if (StatTracking.getStat("pregnancy/total day care") > 0)
	{
		...
		// PC had kids
		output("\n\nFunny she should ask, as you've already had kids! The foxen physician's eyes size up to dinner plates when you go into detail about the nursery your father set up for you, which even now is taking care of the child{ren} you've brought into the galaxy. Regardless of how, it was bound to happen. It certainly assuages her when you tell her you're more interested than ever in claiming the company so that you'll be able to raise them right.");
