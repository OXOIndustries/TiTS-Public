...
public function biancaTreatmentSSTDFollowup(inBooth:Boolean):void
{
	...
	else if (pc.hasSSTD("Locofever", true))
	{
		...
		output("\n\nRight... you must have caught it from that Raskvel. {nonGelBody: <i>\"I'm... surprised... that the unknown microsurgeon suite in your body couldn't defeat it, and that means this strain is more virulent than most.\"</i>} Her torrid tone is as hot as you feel right now.");
