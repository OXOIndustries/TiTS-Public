...
public function storiesOfFloofAndStoriesOfDocs(inRandomEncounter:Boolean = false):void
{
	...
	else if (flags["BIANCA_STORIES_TOLD"] % 4 == 1)
	{
		...
		output("\n\nThat's damn impressive. You ask why he singled you out, aside from the starport incident.");
		...
		output("\n\n<i>\"He encouraged me to train myself like a soldier from time to time so that I would be more useful in those truly dangerous situations, just like Jim. He told me it wouldn't be the last time someone attacked a doctor. Thus he took me under his wing and promised to do right by me until he retired.\"</i>");
		...
		if (flags["BIANCA_STORIES_TOLD"] == 1) output("\n\nThis seems like a very cushy experience. You tell Bianca you're worried now that she's going to reveal some horrible twist. She just laughs at you, saying <i>\"It's the tamest of my stories, [pc.name]!\"</i>");
...
public function biancaAndPiros(inRandomEncounter:Boolean = false):void
{
	...
	output("\n\nAn ironic smirk crests the fox's face. <i>\"I thought to myself at the time, 'it's like the first horror movie I ever saw', where the down-on-their-luck scavenging team encounters a cosmic monstrosity aboard an abandoned station.\"</i> Her ears flatten in fear, though you can't tell if it's feigned. When she straightens to look directly into your [pc.eye], you lean on it being sincere, <i>\"It gives me chills still thinking about either of those today.\"</i>");
	output("\n\nWhen her speaking pauses, you can see a mite tremble on her lower lip. Her brow furrows, and dimming with it are her eyes. With a plaintive, lopsided smile, she finally figures out where to start. ");
	output("\n\n<i>\"Four teams - Gold, Red, Green, and Blue - were scrambled in standard hazard gear, only bringing what strictly benefited the soldiers. We had no idea what was going on; the power was down, not a single person answered hailings... so it was the standard preparation.\"</i> Bianca casts her mournful gaze upward toward the ceiling, doing her best not to trail off like she just did. <i>\"I was with Jim behind Captain Zach, the pointman for the operation. Green and Blue were ordered to secure the engineering deck, while Red and Gold - which I was part of - were tasked with securing the operations deck.\"</i>");
...
public function biancaAndTheHound(inRandomEncounter:Boolean = false):void
{
	...
	output("\n\n<i>\"To be honest, [pc.name], those were my most interesting days. After hearing his plans, having him bare his soul to me, and after our success together... I was his. I told Dian I would marry him. We kept in constant contact while he climbed his ladder and I worked my non-existent tails off in other Core systems!\"</i>");
