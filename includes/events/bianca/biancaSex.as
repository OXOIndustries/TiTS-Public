...
public function biancaBJTwo(cockIdx:int):void
{
	...
	output("\n\n amazes you is how her face is almost never detached from you, her fuck-drunk eyes aglow with intense phallic veneration. Bianca’s impish, coiling muscle ardently weaves about your rod, nurturing every vein into more efficient production, rubbing the spunk-tunnel in ways that maximize the flow of pre. It’s a tongue with clear intent and years of practice, it’s an organic cock-milker that could reduce you to a flaccid, spent pile if it were kicked into overdrive. For now, it blankets your mind with servile, submissive laps to [pc.dickSkin " + cockIdx + "].");
...
public function biancaFinishingMilkshot(cockIdx:int):void
{
	...
	output(" Faint stripes of ejaculate rain down on Bianca's head, and her knelt phantasm turns around, exposing a pregnable pussy that is definitely the stuff of your depraved dreams. Now when you hammer forward, you do so with euphoric aplomb; you do so without a wayward trumble, with the unfettered joy of fucking a");
