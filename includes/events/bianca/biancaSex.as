...
public function biancaSexings():void
{
	...
	else if (flags["BIANCA_SEXED"] == undefined)
	{
		...
		else
		{
			...
			output("\n\nThe sagacious fox spots the sweeping crimson shade curtaining your [pc.face] and the subtle changes in your breathing thereafter. Her nostrils flare for the faint scents emerging from your " + (pc.isCrotchExposed() ? "crotch" : "[pc.crotchCoverUnder]") + ". You're a horny [pc.raceShort] lusting after someone's wife, and it's becoming abundantly clear.");
			...
			else
			{
				...
				if (pc.isHerm()) output(" A veritable cocktail of powerful pheromones wafts up, saturating your ozone with the cloying smell of need. Reacting to her attention, your heartbeats add inches to your [pc.cocks], " + (pc.isCrotchExposed() ? "[pc.CumColor] pre-seed develops at the top, tilting and trickling down your exposed " + (pc.hasCocks() ? "undersides." : "underside.") : "tenting your clothes outward in blatant, darkening arousal."));
...
public function letBiancaHandleTheSituation():void
{
	...
	output("If this kind of foreplay were taking place in public, Bianca would land herself smack dab on the cover of every magazine as a sex-starved slut. Imaginations aside, you are just <i>in love</i> with the way she pokes, prods, and rubs your [pc.cocks]. Leaned back against a");
	...
	output("”</i> Bianca coos, her voice sparking a warm tingle that blossoms out from your torso. She straddles your sitting form, leaning in for a hot, fruit-flavored kiss while setting herself down atop your [pc.legOrLegs].");
	output("\n\nGraceful foxen hands jack <i>hard</i> around [pc.eachCockHead], always flourishing at the end of their tip-ringing squeezes. Rubs of spiraling pleasure make their way down your cum-vein, strings of thick stuff clinging to your " + (pc.hasCocks() ? "crests" : "crest") + ". Full, savory lips that taste of peach and faint, strawberry lipstick overpower yours, making way for a glossy pink tongue. Every second that passes in sensual");
	if (biancaFamiliarity() < 50) output(", taboo");
	output(" closeness reinforces Bianca's inherent nature as a lover, not a skank who'll pump you and dump you.");
	output("\n\nThe doctor's not fooling around: she's stroking your cheek and [pc.hairNoun] with a sex-glazed hand. Her jutting bosom gently smushes into your [pc.chestNoun], setting off cute gasps from the errant smushing. You think it's your heart beating so dangerously, but it's hers on top that plunges you into a void where the only senses that you get on by are touch and taste, bound in harmony by supernatural empathy.");
	...
	output(".");
	output("\n\nA sort of sovereignty exudes from Bianca when she looks down to your [pc.belly], analyzing you from stomach to sternum. Her expression is solid, determined. There's this sensual self-assurance in her that makes you quiver with anxious pleasure");
	if (!pc.isChestExposed()) output(", particularly as she pulls apart your top to " + (pc.hasBreasts() ? "let your [pc.breasts] spill out" : "reveal your [pc.chestNoun]"));
	output(".");
	output("\n\nYour foxy paramour's alluring exterior morphs into one of excitement and control. Those two forces are glued together by what's stuck in the considerable canyon of her fertile thighs.");
...
public function furtherBiancaHandies():void
{
	...
	output("\n\n<i>“Urggh!”</i>");
	output("\n\nImpending orgasm dimmed your face for a moment, only to be banished like a shadow under light when Bianca" + (!tentacle && pc.biggestCockLength() >= 20 ? "clamped down on your aching dong like an industrial press" : "exerted a deathly grip on your [pc.base " + bigCock + "]") + ". You look up, wincing and whimpering, to be greeted by a bright, predatory smile. <i>“I don't want my clothes dirty, [pc.name],”</i> she says, eyes closed. <i>“This position is really comfortable too... I'll be here a while.”</i>");
	// pc Cock Virgin
	...
	output("\n\n<i>“I'm very good at what I do, [pc.name],”</i> she opens her eyes; you squirm and lurch aggressively in the aftermath of your tectonic rejection, quaking [pc.cocksLight] imprisoned between her palms trembling towards stillness. Now her tails reveal their true purpose: to torment you, to wick away the bliss. The gold and white appendages break you into a puzzle for the domineering doctor to piece back together.");
	output("\n\n<i>“Treating the wounded is only one of my specialties.”</i> She lifts up, wrapping her arms like a shawl around your [pc.cocksLight], then falls, cradling " + (pc.hasCocks() ? "them" : "it") + " close, refusing " + (pc.hasCocks() ? "them" : "it") + " to produce even a single droplet of lube. You're not quite sure how, but she lets go at just the moment you feel an overstuffed discomfort, and even then, it's a slow seepage that offers little relief. <i>“" + (flags["BIANCA_SEXED_HAND"] == undefined ? "Taming a beast is another." : "But you already knew that.") + "”</i>");
	output("\n\nGone is the decorum in her violet eyes, and now, gone are her glasses. She yanks them off and shakes out her back-length hair with an enthusiastic flourish. Amorous animosity shines full-bore on you with the power-limiter removed. What you see in the sexy doctor's glimmering gaze is the look of a... not quite a domme, but something close. She handles you with overpowering authority, much like a beastmaster would an unruly kit, watching your sexual self-destruction with twinkling merriment.");
	output("\n\nYou thrust upward, [pc.tongue] spooling out of your mouth like a worn-down ribbon - you're helplessly realizing her strength");
	if (!tentacle && pc.biggestCockLength() >= 20) output(" even though the burdensome weight of your heaven-piercing schlong is enough to keep you in this shameful position");
	output(". You didn't budge more than an inch; you can't move at all, and it's a predicament she's happy to gently explain.");
	output("\n\n<i>“Being denied an orgasm isn't always pleasant, even if it is your kink. Your muscles tend to seize up. It throws your thoughts into chaos. It makes you... rather defenseless,”</i> her mouth hangs open at the last hissed syllable while she pets your [pc.cocksLight] to maintain hardness. The doctor's libido visibly magnifies in proportion to how broken down you feel. <i>“That's the way I want you right now, [pc.name],”</i> Bianca husks. <i>“In order to treat you, I have to use elaborate and sophisticated methods.”</i>");
	...
	{
		output("\n\nYou squirm about against Bianca's pressure. There's so much slippery penile presence for her to weigh down on. The taste of your juicy, glorified breeding organ makes her eyes roll halfway back. The fox is riding it like a carnival attraction, every part of her body slapping down on the oiled shaft. Her lust-puffed mons can be felt through the tightness of her pants, enamored by the proximity of a beastly boner. She knows how to court a cock, but it's clear she's given up on finesse in the face of this unwieldy fuck-club you're bearing, because she's tonguing your cumslit like the bulged-out phallic pussy it is.");
	...
	output("\n\nBianca's heavy breaths get hotter and more frequent; sweat jumps from her bangs in large beads, disembarking for your abdomen. You try to look away and cum, but you're inexorably drawn back to be disciplined. Clutched in her scissoring thighs you're strained, being trained. Once you tried to grab a tail, but you never had a chance. She can sit on you forever: it's up to her to get you off now. The expanding puddle of prejizz boiling from your hand-fucked " + (pc.hasCocks() ? "lengths" : "length") + " is proof that your [pc.cockNoun " + bigCock + "] belongs to her, and that she is fully responsible for your body's functions.");
	...
	output(" was kinda worth it! Only she could use her hands like fans, pawing at your flexing, [pc.cumNoun]-slathered " + (pc.hasCocks() ? "pricks" : "prick") + ", each successive touch wetter and easier. Curving palms cup " + (pc.hasCocks() ? "one" : "your") + " shaft in a semi-circular way and starts at the bottom, sliding up on a channel of lube, whipping beads of [pc.cumGem] gunk into the air and onto her face when it slaps off the peak. It's immediately followed by the other hand, and so forth. Her vigorous teasing stimulates a ceaseless flow of drooling pre-cum which smears her to the elbow.");
	...
	else
	{
		...
		// pc Cock Equine
		else if (pc.cocks[bigCock].cType == GLOBAL.TYPE_EQUINE) output("\n\nSlinking back, Bianca's tongue falls slack from her mouth. She drags it across the largest part of your horsecock, wedging her nostrils into your equine endowment's medial ring{hasBalls: and then the crease between your sheath and nutsack}. <i>“These cocks... these proud, bestial, <b>primal</b> cocks... their smell always comes so close to getting me. If only, [pc.name]...”</i> Bianca simpers, kissing your sheath imploringly, wiggling a finger into that hypersensitive locale, <i>“...if only you knew how much I want to <b>submit</b> to this musk. Maybe next time you'll get to see that?”</i> She takes another whiff of your stallion girth in open desire, teasing the flare into billowing. <i>“Feeling this between my hands is just as good as feeling it inside me. I'm holding something so valuable it radiates its wonderful glory...”</i>");
		// pc Cock Feline
	...
	if (pc.balls > 0)
	{
		...
		else if (pc.scrotumType() == GLOBAL.SKIN_TYPE_SKIN) output(" scaly");
		else output(" doughy");
		output(" nutsack, glistening with ballsweat, moaning softly after " + (pc.balls == 1 ? "the single testicle" : "one heavy ball") + " on her palm pulses and bounces with pure joy, ready to offer up its bubbling, sloshing contents. A [pc.cumColor] ropy prize squirts out from [pc.eachCockHead] when her curious fingers sink into the supremely soft pouch, arcing parabolically into the dirt. <i>“Ooh... hehe, a " + (pc.isHerm() ? "hermaphrodite" : pc.mf("man", "girl")) + "'s proof of virility is very important. It deserves ample attention...”</i> she kneads the roiling contents thirstily, <i>“...<b>it deserves respect.</b>”</i>");
		if (pc.ballSize() < 8)
		{
			output("\n\nYour trembling [pc.ballsNoun] fill her hand perfectly");
			if (pc.ballSize() >= 6) output(", their extra-large sizes spilling between the gaps of her wily fingers");
			output(". With both hands she can easily cup them in her dainty hands.");
		}
		else output("\n\nYour massive sack is too much for Bianca to possessively cup, even with both hands. When she tries to take possession of your slippery " + (pc.balls > 1 ? "jewels, they spill" : "jewel, it spill") + " through the gaps of her fingers and envelope her digits in copious nutflesh. Unclaimed seed splashes in her worshipful grip, actively brewing up a more filling load with each ecstatic contraction.");
		output(" When she's paid desperate homage to your cum-swollen orbs, she brings her hands up to her nose, inhaling giddily, licking up the musky liquid maleness clinging to them and achieving an instant contact high. <i>“Ahhhamazing...! Your cum will taste so good! I can tell... just from this smell...”</i>");
	}
	// Knot
	if (pc.hasKnot(bigCock)) output("\n\nWhen Bianca's not edging you, she's emphatically devoted to your [pc.knots]. If your " + (pc.isHerm() ? "herm" : "man") + "-hood was her family, then it's not hard to see who the favored member is. The more she plays with " + (pc.totalKnots() > 1 ? "them" : "it") + ", the more unstable " + (pc.totalKnots() > 1 ? "they become" : "it becomes") + ", growing until " + (pc.totalKnots() > 1 ? "they look" : "it looks") + " like balloons ready to burst. <i>“Knots are my favorite. My absolute favorite, [pc.name]!”</i> she rubs insistently, abandoning your handjob for a selfish, blissful moment. <i>“When I squeeze " + (pc.totalKnots() > 1 ? "these" : "this") + " again, you'll cum.”</i> You moan, believing every word. <i>“You may not think it possible, but this is so sensitive right now that you're going howl like a wolf when I want you to! It's going to be the best! Thank you for giving me this opportunity" + (flags["BIANCA_SEXED_HAND"] == undefined ? "" : " again") + "!”</i>");
	// Merge
	...
	if (pc.hasVagina()) output(" A sneaky trespass onto your overheated vaginal folds is all your [pc.girlCumNoun]-infused pussy needs to twitch, ready to join its manly counterparts in orgasm.");
	output("\n\nThe fox spreads her legs wide and stands as far as she can when a cortical-scrubbing orgasm shuts down everything all non-reproductive systems. Wracked by postponed breeding urges your screaming voice drowns in her slavering maw. She breaks the kiss");
...
public function biancaBJ(cockIdx:int):void
{
	...
	output("\n\nYou flush from head to [pc.footOrFeet], swallowing the lump she put in your throat. Being the object of an experienced woman's affections is so unbelievably hot that you scarcely believe you're getting to experience it");
	...
	else if (pc.isMisch()) output("\n\nExhaling through your nose, you reach up, stroke Bianca's cheek, casually pulling her glasses off in the same motion.");
	else output("\n\nWith a predator's speed you reach up and yank Bianca's glasses off, tossing them to the side.");
	output("\n\nAnd then, you take her bait.");
	output("\n\nPent-up desire rushes out; you grab Bianca's head and pull her into a kiss as forceful and deep as she will allow. Your [pc.tongue] thrusts into her saccharine maw and grapples with hers");
	if (pc.hasLongTongue()) output(", but your superior length affords you no advantage in making out with someone twice your age");
...
public function biancaBJTwo(cockIdx:int):void
{
	...
	else
	{
		...
		if (pc.hasVagina()) output(" and feminine scent");
		output(" flatten the doctor's vulpine ears to her scalp in blatant submission.");
	}
	output("\n\n[pc.FootOrFeet] firmly planted, your sight blurs when you sniff the air, too. A dizzying aroma permeates the area, succulently ripe with Bianca's signature too - her perfume rises on an estrus wind, mixing sweet propriety with agitated lust into a whorish blend. Freely-dribbling pre-cum dapples your " + (pc.hasCocks() ? "shafts" : "shaft") + "; inner contractions squirt out thin [pc.cumColor] ropes that plaster the fox-woman's face and the enormous mounds of her breasts.");
	output("\n\nThere's a certain physical element to seeing a woman supplicate to your [pc.cocksLight], licking her lips and smiling as your aroma runs through her system. Bianca is nose deep in your goods, hands pressed to your [pc.hips], nuzzled close to your stiffening firmness; her tongue rolls out an inch away from your [pc.cockHeads] and a meaty taste of raw, bare dick. Pride bubbles up inside watching her inspect and visually worship what you've got, calming your hammering urges to stuff her then and there.");
	...
	output("\n\nHer fluttering eyelashes send a thrill up your [pc.belly] and coax out another [pc.cumVisc] spurt. Her tongue springs out to curl around your [pc.cockHead " + cockIdx + "], agitating it moments before moist lips press heavily against it. Slobber dribbles down your meaty length, transforming it into a sweet, candied treat as it mixes prettily with the [pc.cumColor] coat it wears. You feel her lapping at your bulging cumslit and her hugging hands jacking the bottom of your mast, anointing her palate with fresh offerings.");
	output("\n\nDrowning in sensation, you didn't realize that you weren't fully stiff. Hot breaths tickle you from hard to <i>hardest.</i> Bianca's [pc.cockHead " + cockIdx + "]-filled swallows provoke you to twitch heavily on the bed of her tongue. For now, she's content to savor the buffet of [pc.cumFlavor] pre and absorb your aerial masculinity, happily exploring your sizzlingly hot [pc.cockNoun " + cockIdx + "] with both hands.");
	if (pc.hasKnot(cockIdx)) output(" Your bare, goo-slathered knot receives the brunt of her adoration, swelling to her squeezing encouragements.");
	...
	else if (pc.cocks[cockIdx].cType == GLOBAL.TYPE_EQUINE)
	{
		...
		output("\n\nHer sheer reverence for your dick is enough to make your [pc.thighs] tremble.");
	}
	// pc Cock Feline
	...
	output("\n\nMidway through another agonizingly pleasurable stroke, Bianca's tongue is trailing down one side of your [pc.cockNoun " + cockIdx + "] to the [pc.knotOrSheath " + cockIdx + "], then sweeping back from the other side, carrying long strings of saliva with it.");
	if (pc.hasSheath(cockIdx)) output(" She doesn't spend too long licking at your cock-pocket, but you identify an obscene adoration when your holster crinkles around her nose.");
	output(" She sounds desperate and thirsty; intensely aroused, she looks up the whole time she dutifully services, drinking in your gratified expressions with gulps of sticky slaver.");
	output("\n\nWhat amazes you is how her face is almost never detached from you, her fuck-drunk eyes aglow with intense phallic veneration. Her impish, coiling muscle ardently weaves about your sublime [pc.dickSkin " + cockIdx + "], nurturing every vein into more efficient production, rubbing it in ways that maximize the flow of pre. It works intently, an organic cock-milker that could reduce you to a flaccid, spent pile if it were kicked into overdrive. For now, it blankets your mind with servile, submissive laps to musky dickmeat.");
	output("\n\nWatching her ears flick at your cum-vein is pleasantly distracting. You're filled with desire to reach out and pet them, to feel her the same way she feels the wholeness of your masculinity. " + (flags["BIANCA_SEXED_BLOW"] == undefined ? "It comes as a shock when you place a [pc.hand] on her head that she doesn't recoil or push you away, but giggles out a pleasured note. That moment of surprise gives way to erotic fulfillment; she swivels her ears to better help you pet behind them; long strands of golden hair flow between your fingers like a river of gold. For as serious as she is, she can't hide how much she wants to be praised." : "There's no better time to start getting involved in your treatment plan. You grasp her head, fingers automatically scritching behind her triangular ears which flex to expose the most vulnerable parts of her scalp. Giddy moans filter out, lured by hair-tousling praise. It's still too difficult to believe that someone of Bianca's self-esteem is so willing to debase herself for cock."));
	...
	if (pc.balls > 0)
	{
		output("\n\n<i>“I want " + (pc.balls > 1 ? "these" : "this") + ",”</i> she coos, gliding down your rod until her keen nose sinks into your [pc.sack]. Short, high-pitched whimpers and squeals vibrate through your heated [pc.ballsNoun] seconds before her tongue lashes out for your slippery " + (pc.balls > 1 ? "orbs" : "orb") + ". Guided by your [pc.hands], her head bobs up and down, licking and lapping at your fluctuant pouch with the entirety of her desperate tongue. From churning underside to bulgy topside she mops your exquisitely soft " + (pc.balls > 1 ? "surfaces" : "surface") + " of the musk-laced ballsweat clinging to " + (pc.balls > 1 ? "them" : "it") + " until your ‘nad" + (pc.balls > 1 ? "s glisten" : " is glistening") + " irresistibly.");
		output("\n\nYou can't suppress your urge to hump her face, half-obscuring your vulpine ball-slut in cum-plump nut" + (pc.scrotumType() == GLOBAL.SKIN_TYPE_FUR ? "fuzz" : "skin"));
		...
		if (pc.ballSize() >= 14)
		{
			...
			output("\n\nBianca settles for burrowing her face in the center crevice of your majestic bulgehood" + (pc.ballSize() < 24 ? "," : " - it could easily smother her whole head if you pitched forward -"));
			output(" framing herself in your hyperproductive glory for almost an entire minute. She's shaking the whole time, unable to believe that you have such a bounty of churning nutflesh to love and adore. You feel the tip of her nose in the juicy, foggy heath between [pc.knotOrSheath " + cockIdx + "] and nutsack, breathing deeply, flooding her lungs with the rawest of your genital odor. When she does pull away (very reluctantly), she doesn't do so without giving " + (pc.balls > 1 ? "each ball" : "your ball") + " a vacuuming kiss or three.");
			output("\n\nIt's utterly endearing that she finds her affections lacking, looking frustrated by how little she seems to accomplish. Before she starts feeling bad, you bring her back to your eclipsing vale and encourage another minute of stress relief. The medic puts her thirsty tongue to the task of testicular polish, bathing her fruit-red lips in the supreme musk of your girthy sack.");
		}
	}
	...
	if (flags["BIANCA_SEXED_BLOW"] == undefined || (flags["BIANCA_SEXED_BLOW"] > 1 && rand(2) == 0))
	{
		...
		output(" She cranes her neck up and guides it in, exhaling on her downward descent. Your crown slides past her red lips at the same moment you howl in bliss and throw your head back so fast that you slam into the " + (getPlanetName().toLowerCase() == "mhen'ga" ? "tree." : "wall."));
		...
		output("\n\n<i>This</i> is what the vulpine whore wanted out of you. In fact, from the writhing bend of her suckling mouth, she's <i>trying</i> to keep you there!");
	...
	else
	{
		if (flags["BIANCA_SEXED_BLOW"] == 1 || (flags["BIANCA_SEXED_BLOW"] > 2 && rand(2) == 0))
		{
			...
			output("\n\nRelishing the opportunity, you [pc.walk] forward, bidding Bianca to sit up straight. She opens her mouth wide, extending her tongue in twitch-provoking obedience: <i>“Ahhh.”</i> You feel as hard as a fucking boulder, standing there with your [pc.cockHead " + cockIdx + "] hovering just above the bedding-like texture of her oral dais, staring into the wet, O-shaped hole ready to be fucked. It's not just the smut-saturated air, it's her shining serenity. You could do anything, tell her to do anything, and she would do it.");
			if (flags["BIANCA_SEXED_BLOW"] == 1) output(" Right?");
		...
		else
		{
			...
			output("\n\nReining in your libido takes a champion's endurance. Once your body's in check, a thought crosses your mind. Bianca's a woman to whom others are a series of buttons to be pressed until they're agitated, ready to take out their lusts on others. Another moan echoes up from her belly while you stand there, coating her tongue in dick-drool.");
			...
			output("\n\nInstead, you do what she's not expecting. You knead your [pc.dickSkin " + cockIdx + "] across her cheeks, smearing your lubed length from brow to chin. Her lips suckle at your broadness but never get the chance to wrap around it. Detecting a slight quiver in her arms and then her legs, you up your pace, humping her face until your " + (pc.balls > 0 ? "[pc.ballsNounIsAre]" : "[pc.base " + cockIdx + "]") + " resting square on her conflicted mouth. She licks slavishly at the [pc.knotOrSheath " + cockIdx + "] as it grinds past, but then you pull away, ordering her to stop.");
			output("\n\n<i>“H-Huh..?”</i>");
			output("\n\nAgain, you provide no answer, intent on mercilessly teasing the foxy mom. <i>“I wa...”</i> Her voice stops when you lurch back, pinning her in place. Her slitted eyes race from your leaking [pc.cockHead " + cockIdx + "] to your [pc.eyes]; they race back, they glance to your belly they're full of wonder and internal conflict-");
			...
			output("\n\n<i>“A-Ah...!”</i> Bianca swallows, sweating with realization. The ruby-red hue on her face darkens. <i>“Please let me suck your cock, [pc.name]. I want you to stretch my throat and cum in my stomach. That is my sincerest wish.”</i> Her tongue whips in your direction, a micro-centimeter away from indulging itself. <i>“Use me as you wish, " + (pc.balls > 0 && rand(2) == 0 ? "drain your balls into me" : "fill me with your seed") + ".”</i> Her mouth opens again and this time you step forward, sinking your lacquered girth inside her office.");
			output("\n\n<i>“Ahhh...”</i>");
		}
		output("\n\nThe crooning fox grips to your waist and bobs her head, thoroughly put in her place. Her O-shaped cockpillows move with you, vein-shaped depressions forming all over the luscious flesh. Getting a blowjob is good (in fact it's one of life's greatest pleasures");
...
public function doinBiancaInTheMouth(args:Array):void
{
	...
	{
		if (flags["BIANCA_SEXED_FACE"] == undefined) output("\n\nFor one last time you pause at Bianca's throat. She can handle herself... but can she handle <i>you?</i> There's only one way to find out.");
	...
	output("\n\nYou twitch passionately inside her, letting out a tremulous " + (pc.cLength(cockIdx) < 12 ? "sigh of contentment" : "gasp of victory") + ". You can't help but marvel at her composure");
	...
	output("\n\nA subtle, winning smile is all it takes for her to send you back to work. Your [pc.hips] haul with feral abandon, slamming your [pc.cock " + cockIdx + "] " + (pc.cLength(cockIdx) < 15 ? "to the hilt" : "to her belly") + " on every wet drag. Her tails are wagging happily behind her while you fuck her pole-polishing mouth, every inch of neck and throat compressing on your ponderous phallus.");
	...
	output("\n\nHer hands are on your [pc.butts], exploring your heiny until you feel a finger teasing your backdoor, lightly rimming the");
	if (pc.hasPlumpAsshole()) output(" donut-shaped");
	output(" pucker of your ass. When you feel a trespass coming on you put a stop to it, clapping into her trained throat and positioning yourself to loom a little higher over her. There will be none of that. Far be it from her to be disheartened, however. It's clear that she's happy to be swept up in the riptides of your uninhibited desire, spending her precious oxygen to give you an earful of pleasured groaning.");
	...
	output("\n\nBianca already looks the part too - her cheeks are a reservoir of overflowing precum she refuses to spit out. Hot slaver bubbles out from her flaring nostrils on the upper space of your lofty rod");
	if (pc.balls > 0 && pc.ballSize() >= 4) output(", and she's always fed a little more when your ballsack brutalizes her chin");
	output(". Her endurance is seemingly unaffected by the obdurate blockage plunging into her guthole. If anything, it just makes her work to keep it in, subtly curving your direction into her humid depths so that it's a little more parallel. In the midst of your throat-thumping pumps, her golden tails wrap around your [pc.legOrLegs] in a fluffy, supportive hug, some of the floof matted down by the syrupy excess of your scandalous " + (flags["BIANCA_CONFRONTED"] != 1 ? "affair." : "rendezvous."));
	output("\n\nAt that exact moment is where you can see something magical: her intelligence backing off from undoing any coarse tendency. In body, spirit, and mind... she's enjoying this, she's assumed the temporary role of your unthinking slut.");
	output("\n\nShort of breath, you hilt yourself and grind the fox-socket's head against your crotch. Rubbery lips undulate at the root of your [pc.cock " + cockIdx + "], foamy ejaculate creeping out whenever she tilts down. You growl out her name, panting like a dog. Once you catch your second wind, you're railing her harder than ever. Your crotch melts away on an ocean of white-hot liquid lust; you're not sure who's lost at sea while you carry her body head-first up and down your jackhammer. Numb everywhere, all you can do is hold tight and <i>thrust.</i>");
	output("\n\nTremors and convulsions run through Bianca's frame. When you look down, her hands are squirming on autopilot between her thighs, giving you a pretty good idea of what's happened. She goes insensate in your hands, leaving her, and your pleasure, a matter of self-satisfaction. Moans of asphyxiated bliss ripple through your [pc.cockNoun " + cockIdx + "], and the nose-tickling waft of feminine orgasm finally reaches you.");
...
public function doinBiancaInTheTits(cockIdx:int):void
{
	...
	output("\n\n<i>“Don't f-forget, your " + (pc.hasCocks() ? "cocks" : "cock") + " still need to cum,”</i> she dotes.");
	output("\n\nEmerging from her drool-slick mounds you arch back out of frustration. Not with her, but because you had to let go.");
	...
	output("\n\nFragrant feminine bliss tickles your nose, and what was once a titty-fuck evolves to a titty-<b>mauling.</b> Pressure builds in the back of your waist and your vision goes white, lost but not alone in the never-ending horizon of milfy tit. Your");
	if (pc.hasKnot(cockIdx) || pc.hasKnot(pc.biggestCockIndex())) output(" " + (pc.hasKnot(cockIdx) && pc.biggestCockIndex() != cockIdx && pc.hasKnot(pc.biggestCockIndex()) ? "[pc.knots]" : "[pc.knot " + (pc.hasKnot(cockIdx) ? cockIdx : pc.biggestCockIndex()) + "]") + " angrily swell at her underboob, making ready to breed unbreedable territory.");
...
public function biancaMilkPartTwo(cockIdx:int):void
{
	...
	output(". Her head is pressed up to your left glute, tickling your [pc.skinFurScalesNoun] with the twitching of her fuzzy ear -- her tails also add their support, weaving around your [pc.footOrFeet] and offering their rich, fluffy support.");
	output("\n\nAn index finger curls around your tender meat, beginning a physical diagnosis. Unsteady, thickly colored conduits of [pc.cumColor] preseed stream through your dilated urethral spillway like a crack in a dam. Venting all this liquid pressure provides no amount of pleasure, and even the lightest stroke of a deliberately slow and gentle finger is unpleasant - it burns. It burns in your sack and in your brain both.");
	output("\n\nYou let out a soft moan, wriggling in your doctor's grasp. Bianca waits until you're settled down before beginning, palming your [pc.butts] and gently encroaching on your precum stained groin. Feathery foxen fingertips land on your [pc.sackTexture] sack, tracing to from the top of your brimming [pc.ballsNoun] to the bottom, gradually applying more of their slender lengths to the examination, hushing and soothing with an authentic motherly tone.");
	output("\n\nBianca has an understanding of what she's doing, seeing to it gradually and slowly. Despite her meticulous and cautious approach, you can sort of feel the touches in your prostate. Thick gobs of spooge pass, pulsing or dribbling out in orgasmic amounts. If not for the sheen of slime you'd be <i>dry</i> as well as raw, and that could possibly be the absolute worst thing for anyone to deal with.");
	output("\n\nThe sunshine in her voice spreads through your lust-sore genitals. You moan for your doctor, enjoying anything and everything she does, kneading your tortured " + (pc.hasCocks() ? "manhoods" : "manhood") + " for steady squirts of forearm-length ribbons.");
...
public function biancaFinishingMilkshot(cockIdx:int):void
{
	...
	output("\n\nIt's indescribably erotic what she's doing to you. Fucking the manifest design of her lecherous description, drizzling pre all over it- no, <i>her,</i> scratching your itch between her red-hot lips. You're hanging in there, suspended in her embrace, helplessly pounding your engorged cock into something that's not even real... and loving it. You're so sensitive that the brush of wind to your [pc.skinFurScalesNoun] drives you to insensate distraction, only reinforcing the realness of something decidedly <b>un</b>real.");
	...
	output(" Faint stripes of ejaculate rain down on Bianca's head, and her knelt phantasm turns around, exposing a pregnable pussy that is definitely the stuff of your smutty dreams. Now when you hammer forward, you do so with euphoric aplomb; you do so without a wayward trumble, with the unfettered joy of fucking a");
...
public function biancaMilkingEnd(cum:Number):void
{
	...
	output(" as absolutely no surprise that you stumble backwards and fall on your butt with all the dignity of an old tree disconnecting from its roots, abandoned by the nourishing rays of sunlight. Your back plants to something solid and you fall bonelessly to the ground, heaving hard and in desperate need of your lungs to work again.");
	...
	output("\n\nShe comes up to you");
	if (!pc.isNude()) output(", helping you to redress");
	output(". <i>“You look tired.”</i>");
...
public function biancaGetsHerFingersOnThePC(vagIdx:int):void
{
	...
	output("\n\nHer rigorous inspection of your moistening twat winds an embarrassed thrill around your spine. A simple tug would crush you, leave you boneless and at the whims of her lusty manipulations. Not only are you blushing harder, your heartbeats have subtly thickened to the point that her nearness excites your [pc.vaginaColor " + vagIdx + "] pussy into");
	...
	else
	{
		...
		output("\n\nCumming is the next natural step; simmering vibrations beat through your [pc.pussiesLight] and Bianca doesn't let up, stroking your aching walls through mind-bending release until her whole hand is glazed in spectacularly hedonistic output. Your supple folds refuse to let her go, wanting to keep her mired inside. Your [pc.ears] twitch and you let out a wheeze, your sore lungs the only required proof of her talent. ");
...
public function biancaContinuesTheFingering(vagIdx:int):void
{
	...
	output("Bianca lets you shudder warmly in her grasp, knowing what makes you tick now that you've been brought to your first orgasm.  Errant caresses and strokes jerk your sensitive limbs around -- you're her puppet now, and she's playing with the many strings that compose you now. Your [pc.tongue] shamelessly hangs out, and it's as much an effort to keep your eyes open as it is not to lose control.");
	output("\n\nThe doctor's [pc.girlCumNoun]-coated meddlers are brought to her lips, which open eagerly to taste your [pc.girlCumFlavor] juices. Her throat audibly gulps down the fruits of her sapphic harvest. She derives considerable happiness from your orgasm; her brazen act deepens your blush and turns you right back on.");
	// pc Vaginal Virgin
	if (pc.vaginalVirgin)
	{
		...
		output("\n\nYour face is so deeply red now that you look like you've fallen prey to a rainbowtox prank.");
	...
	output("\n\nPassionate caresses at your [pc.thighs] renew your lust; they writhe with delight. Your [pc.pussies] are savaged by ardorous fingers that grind against the borders of your tunnel, avoiding the intense drives you crave. Devoid of conscious thought you breathe out and spread your legs wider in an attempt to persuade them back in. A twinge of penetrative expectance jabs you, but it's just her hand swimming through the slit. When she rings " + (pc.hasVaginas() ? "a" : "your") + " [pc.vaginaColor " + vagIdx + "] buzzer, you're left a melted, helplessly bucking wreck.");
	// pc Looseness <2
	if (pc.looseness() < 2)
	{
	...
	output("\n\nYour [pc.pussiesLightIsAre] so hot that they cum at the barest touches, trapped in a hellish loop of constant and easily triggered orgasm. No word adequately describes how trivial it is to turn you into a sodden slut just by playing across your clitoral hood. Numerous hyper-erotic fantasies play out in your eyes on each tug to your throbbing bud. " + (pc.balls > 0 ? "Your [pc.ballsNoun] churn with a heavy load on top of her busy knuckles, demanding service that will never come. Your feminine side is getting all of the attention this time, something your skyward-facing [pc.cocksLight] don't exactly approve of." : "Needy pulses of [pc.dickSkin] above Bianca's busy hand beg for service that will never come. Your [pc.cocksLightIsAre] not happy about this arrangement where only your feminine side gets the attention."));
	// pc Big Clit
...
public function biancasAFoxAndShesLickingAHole(vagIdx:int):void
{
	...
	output("\n\nIt begins in the blink of an eye: your entrance gives around Bianca's fleshy pink tongue, but it is not given what's on offer. That glorious, inquisitive muscle swims upwards through your sopping gash micro-centimeters away from penetration - until it hits climbs up to your [pc.clit " + vagIdx + "]. Slow, slimy, squelching swirls to your stiffened girl-boner recall the exhaustive bliss from moments ago, stopping just before it smashes your brain again. It throbs and vibrates bare in the air, a [pc.vaginaColor " + vagIdx + "]");
	...
	output("\n\nShe comes away with the sheerest bliss smeared across her face, reeking of orgasmic cunt. <i>“Is that all?”</i> she huffs, asking genuinely, tugging her fogged-up glasses off and lobbing them to the side. <i>“You're going to have to get rougher if you want to take my reins!”</i> she growls and huffs in a playful voice. <i>“How about just a little more build-up? I'll get you so agitated all you'll want to do is trap me in your thighs until you pass out from cumming so much!”</i>");
	output("\n\nAt her words there's a very real <b>tic</b> in your eye, a twitch that furls your brow and compels you to slide your thumbs into her ears and your fingers through the river of golden hair. Bianca squeals loudly from the intrusion on her inner-ear floof, distracting her from being rammed face-first into your wanton sex, suffocating her on the estrus heat radiating from your feminine furnace.");
	...
	output("\n\nYour thoughts are shattered in that moment of deep connection. Despite being an ordinary human tongue, Bianca's found ways to make it work harder than it has any right to. It has no qualms about stretching itself to the aching point, until it burns as hot and bright as the nerves it drags over in your spasming cunt, driving you to pleasure-seize, get even hotter, steal away the world until it's just her gliding through your love-hole on a curtain of spit and girl-jizz.");
	output("\n\nDoesn't take a genius to see that she has no intention of leaving until one of you is down for the count.");
	output("\n\nStepping forward, you scissor the pussy-obsessive fox in your [pc.thighs], clutching posessively. Now a permanent extension of your groin, she can perform to the best of her cunnilingual abilities. Swaddled like this, there's nothing she can see that isn't your [pc.pussiesLight]");
	if (pc.balls > 0)
	{
		...
		output("; there's no air that her flared nostrils can breathe that isn't filled with the young, healthy pheromones of her [pc.raceShort] [pc.master]. You press her forward all the harder, allowing her to explore new inches of unserviced pussy. Either way, she twirls and bounces with ease in your perverted playground.");
	}
	...
	output("\n\nThe ends justify the means by dragging you to the edge of ecstasy, swirling you around that lofty precipice. Orgasms that range from tremulous, delightful shivers to rumbling earthquakes stick it to your mind in every possible way. Bianca's sawing in two different places at once, channeling copious amounts of pleasure and roughness into your joy-inundated system. The extravagant fox then lowers her other hand, digging into implacably tight pants to tend a monstrous libido.");
	output("\n\nOnce she does, everything changes. There's this moment of unity, where your pace and hers match up and you moan with saliva-splattering happiness. You're leaking and dripping everywhere. You're a hot fucking mess, and she is too. Your [pc.pussies] greet the reinvigorated doctor's injections of wildly wagging maw-flesh. Bianca's shining, smiling eyes narrow and widen to the masturbating strokes of pronounced boobflesh and flushing milf-cunt, fucking herself while you fuck yourself with her upper body. A rich, sudden burst of dual orgasm strikes the two of you, again and again...");
	// Cock
	...
	if (pc.isSquirter())
	{
		...
		output("\n\nRubbing against Bianca's face for gushing orgasm is an experience you're keen on repeating. Sensational overload like what you're feeling now could only be experienced on dangerous VR trips. Maybe this one's not safe, but the visual overload is and twilight state of consciousness behind your hard-shut eyes ensures you're only able to get on by touch and sound, and those senses are suffused with your combined moans and the mind-splitting bliss of emptying your loads on a willing woman's face.");
	}
	// pc Not Squirter (wetness <3)
	else
	{
...
public function biancaHasFinishedHerMeal():void
{
	...
	{
		output("Bianca shuffles back and sinks lower to the ground, spreading her legs into a pretzel shape. She inhales deeply through her nose, wiping a bare arm over her eyes. She looks up to you with a pleased, content smile, and you know that part of it's thanks to the enjoyment she derived from this. Herface is a mess of ambrosial juices, smeared in a [pc.girlCumGem] lacquer.");
		if (pc.hasCock())
		{
...
public function milkyBoobsForBianca():void
{
	...
	if (flags["BIANCA_SEXED_MILK"] == undefined)
	{
		...
		output("\n\nShe crawls up over you and presses a hand to your forehead as soon as you display an obvious symptom. <i>“[pc.name], are you sick?”</i> she asks. <i>“Talk to me!”</i>");
...
public function biancaMilksThePCTheWayIMilkTheseFunctionNames(boobIdx:int):void
{
	...
	output("\n\nShe rubs your [pc.breasts " + boobIdx + "] until blissful contentment is all you know. There's mutual delight in the way you stroke the back of her head, scratching that wonderful bit of skin where her ears meet scalp. This little, physical reward goes a long way, encouraging the thankful fox to work harder... and harder, particularly when you ruffle her scintillating hair. Sometimes she opens her mouth for you to see the [pc.milkNoun] squirting inside, closing and swallowing seconds before it spills.");
	...
	output("\n\nRaising her hand to " + (pc.totalBreasts() == 2 ? "your other" : "another") + " tit, Bianca grasps the weighty jug, whispering affections and praises as your grateful body seems to gush out enthusiastic offerings from a seemingly infinite reservoir. All it takes is a flex of the wrist and clench of the hand to vent it of intense, [pc.milkVisc] pressure, redoubling the sticky tepid pleasure in the rest of your loopy body. Your [pc.nipples] are burning with raw, unfiltered sensation, and yet, the deluge up to this point has only been the beginning, a prelude to the sopping wet snack-stop you're on your way to becoming.");
	output("\n\nSimply breastfeeding her isn't enough, you need her to get dirtier and harder! You babble out something indecipherable, not intending to lose your train of thought trying to ask a simple question, but the intent is perfectly clear in your lust-glazed eyes. Bianca shifts back and rests her head in the center of your cleavage, looking up your yet-undrenched channel, letting go of your [pc.breasts " + boobIdx + "] to grab at something. <i>“I have to get my fun, too!”</i> ");
	...
	if (!pc.isCrotchExposed())
	{
		...
		if (pc.isHerm()) output(", allowing your [pc.cocks] to burst forth into proud tumescence, followed by the dual scent of your [pc.pussiesLight].");
	...
	output("\n\nLest you begin to calm down, Bianca glides forward, burrowing greedily into your [pc.fullChest]. Her chest grinds against your chest, her crotch to your crotch, her abdomen to your [pc.belly] - she bucks and twists about disjointedly. The sudden intensity and the firm, manhandling squeezes on " + (pc.totalBreasts() == 2 ? "both saturated boobs" : "every saturated boob") + " leads you to spurting the largest columns of [pc.milkNoun] yet, and with your abused titties snugly nestled into her body, the [pc.milkVisc] juice can only obey the rules of nature by splattering in every which direction.");
	...
	output("\n\nFinally, your [pc.hands] join hers, focusing on the back halfs while she strums them from the front. You're a malfunctioning milk machine that a confused customer is struggling to control, making all the wrong moves and getting hosed down in the process. Well, there's nothing confused about her elegant motions. Everything going on is designed to carry you away on the oceanic quantity of [pc.milkNoun] pouring out with all the gentleness of a hurricane. You've gotten so slippery that gripping your slippery swells is a hopeless endeavor... but hey, when tits flop around like crazy? That's consolation.");
	...
	output("\n\n<i>“Aaah... Ach!”</i>");
	output("\n\nOrgasm costs Bianca her balance, and she falls headfirst into your canyon of cleavage, straight into a [pc.milkVisc] pocket. The sloughed liquid, now overpowered, bursts out in all vacant directions, staining her glasses and launching into your nose. Full-throated groans vibrate against your hammering heart, and barbaric graspings to your [pc.breastsNoun " + boobIdx + "] give you a thorough seeing to. [pc.Fingers] scraping at the ground,wet, wringing fox clambers and thrashes against you, imploring you to have a big, hard cum. Her climax, and the extremely vigorous shift of her body, triggers a tit-based climax that makes your packed breasts jiggle energetically in the midst of resonant sexual cascade.");
	// pc Hermgasm
...
public function biancaNomNomNom():void
{
	...
	else
	{
		...
		// imagePack: embed octomush Bianca Bent Over pic here 9999
		output("\n\nBianca walks within an inch of where you once sat, bowing at the waist to push her butt towards you. The slight wobbles snatch your breath away. Swaddled in criminally tight pants, her blessed, burgeoning buns withstand the cruel compression. Both halves of her vast, soft, round ass push out in rebellious fashion, slowly sawing at the stitches of her military-grade fatigues. Seeing her begin to liberate her ponderous tush from its prison produces every thrill your brain chemicals can concoct.");
...
public function lickingAtAFoxDoctor():void
{
	...
	output(" and fuck her.");
	if (pc.isHerm()) output(" Her position is one of the most procreative there is, second only to being pressed into the ground being drilled with [pc.cockNoun]. You could even grind your [pc.pussiesLight] into hers" + (pc.balls > 0 ? " while your nutsack massages her clit." : "."));
	...
	output("\n\nBianca's nerves react masochistically to the impromptu tanning, her whole body tensing in stunningly pleasurable pain. An orgasmic moan looses from her agape lips, and from her sdopping pussy foams a thick, flowing tidal wave that gushes uncontrollably. She liked that.");
	output("\n\nAnd even better?");
	output("\n\n<i>She came.</i> ");
	...
	output("\n\nBy now, the her legs are connected by a cascade of fresh, webbed cream");
	...
	output("\n\nThe irony of Bianca's request is not lost to you on your descent. Knitting your [pc.hands] around her waist is " + (pc.tallness < 64 ? "is hard to do, considering there's so much woman and not so much [pc.name], but you do settle into a lovely if awkward position" : "is an easy enough task, even with the amount of lush thigh there is to grope on the way") + ". Perfectly aligned with her saturated delta, you lean forward, pressing your [pc.lipsChaste] to the center of her slit, planting a long, wet kiss against it. Moisture leaps to your [pc.face] , " + (pc.hasFur() ? "absorbing into your [pc.furColor] coat." : "becoming the first layers of a sticky mask you'll be wearing at the end."));
	output("\n\nElephantine hips squirm on autopilot, struggling against the gradual savoring of your [pc.tongue]. Your unshakable grip ensures that your mouth stays firmly planted on the hypnotically large slopes of her deliciously aroused flesh, keeping her sensitive sex set in place for fat, adoring, dog-like licks from north to south. Her clit is fatter than the average woman's, a solid gumball of flexing nerves that you take extra care to bathe in tireless affection.");
	output("\n\nYour oral muscle stretches to the width of her pussy, leaving no divine drop unsuckled. Bianca's muff is <i>huge.</i> The vulva is capable of suckling all on its own, fit tight around a large, sprinkling seam of blissful goodness. They're utterly slathered in pleasure-juice, and that sweaty lather transfers to your visage as you mold her blushing exterior with your jaw and cheekbones. Slight little mindless humps carry her fat and visceral hole up and down, demanding greater affection that is given in spate.");
	...
	output("\n\nA sincerely sublime sense of satisfaction washes over your heart after hearing her cry out so loud. " + (flags["BIANCA_SEXED_LICK_HER"] == undefined ? "This is the first time she's been able to be treated, to be loved back. It's almost enough to bring a tear of happiness to your eye!" : "The fire rises to volcanic proportions, even, all because you feel a genuine pleasure just to be on your knees, snuggled deep into this landmark to all things feminine and motherly, showing her that she can feel good too."));
	...
	output("\n\n<i>“Ahhh!!!”</i> she squeals again, the impact of your [pc.face] to her dilapidated dam of a cunt lurching her forward. <i>“Is... is it really... Eek!”</i>");
	...
	output("\n\nSpanking and suckling away, you spare one of your last thoughts: you really love eating pussy. Fuck, dining on cunt is fucking amazing. Moreso, having the privilege of drowning in " + (flags["BIANCA_CONFRONTED"] != 1 ? "a married woman's" : "Bianca's") + " aroused acres is, to you, a badge of honor. Who else could she trust with this important job? Who else could make her pant so madly? Whose face would she hump, obscure in a glade of feverish, torrenting climax?");
	output("\n\nYou're unable to see now that her tails have obscured the few honeyed strands of sunlight that poked. In darkness, you find your own path. Orgasm-amplified warmth gallops across your box-packing tongue, oiling it well enough to finally plunge through tensed depths that refuse to part for anything except a girthy cock.");
	...
	else output(" You lower your other hand to fidget with your gear long enough to allow your " + (pc.hasCock() ? "[pc.cocks] to spill out." : "your [pc.pussies] to taste air."));
...
public function downTheFoxGoesOntoPCTongue():void
{
	...
	output("\n\n<i>“Ah!”</i> she yelps cutely, scrabbling at the " + (getPlanetName().toLowerCase() == "mhen'ga" ? "tree" : "wall") + " before stumbling back with you -- there's a <b>very</b> deep sense of satisfaction that her ass has nowhere to go but on and around your face in the seconds before impact");
	if (pc.hasWings()) output(", spreading your [pc.wings] before they bend inappropriately");
	output(". The shock of stopping a moon from colliding with its planet is totally absorbed by your chivalrous head. Both of Bianca's aft quarters have firmly slammed your throbbing skull into the ground, cratering your cheeks under their superlative and intensely arousing weight.");
	...
	output("\n\nThis is even better than sex. It took a little while to get used to having your freedoms restricted in sensuous posterior bondage, but when you did your tongue and lips began working harder. Bianca's getting used to it too, assuming her newly acquired dominance in ways that make your body squirm automatically. " + (silly ? "Bianca's binaculars" : "Those huge, epically dense cheeks") + " bless you with their movements, keeping everything pitch black and full of her overpoweringly erotic scent. Her scent is legendary, spurring your body like a drug to into more servile actions.");
	...
	output("\n\nEffervescent curtains of femme-cum collect into shimmering puddles in the tiny divots on your face. It's reaching up to your firmly shut eyes, pooling over the shut lids. The deluge of pheromones and being totally marked summons the sinfullest of pleasures. The motherly fox is as much a treat for you as you are for her. Nothing makes you happier than to prove yourself a dutiful stress-relief nurse and to be tongue-deep in her wellspring.");
	output("\n\n<i>“Yes! [pc.name]! Lick, right there!”</i> she screams, pushing forty-some years worth of weight into your head. If you weren't so drunk on cunt, you'd feel yourself sinking into the ground. <i>“I'm so close... it's so hot! You're a gifted [pc.boyGirl], you really are! Please endure it just a little... mmm... mmmmm... a little longer... [pc.name]... [pc.name]...”</i>");
	...
	if (pc.hasCock()) output(" A hand has wrapped around " + (pc.hasCocks() ? "a" : "your") + " [pc.cock] with a crushingly strong grip. It tugs on your member so hard that you feel like someone is absconding with your manhood! It's Bianca, returning the favor, allowing you to cum!");
...
public function doneEatingFoxMilfForNow(fromAllIn:Boolean):void
{
	...
	{
		output("Bianca takes her time calming down, tensing and squeaking when you lazily lick at her backside, thoughtlessly horny. When she deigns to lift her ass from your face, it makes you feel like a hole has been ripped through your soul, or that there was always a hole and her battleship of a butt was plugging it. In short, you've got things to do in this life, no matter how reluctantly you agree with them.");
...
public function thiiiiiiiiiiiiiiiiighsAndAlsoBianca(cockIdx:int):void
{
	...
	{
		output("\n\nBianca wiggles into your drooling hardon, squirming each of her legs around it in opposing up-and-down patterns. You don't emerge on the other side of her canyon");
	...
	output("\n\nThe inaugural thrusts into her squeezing shallows are pleasurably difficult. You fight against the heavenly friction");
	...
	output("\n\nYou slow your inflamed pace for only a second, gently pumping in and out of her slimy cavern. She dips a hand to her crotch and into her black and pink panties, pulling them aside so that the defenselessly swollen lips of her moist muff can rub against your shaft. Premature ejaculation hits, a single rope, maybe more, of [pc.cumNoun] throbbing out from your trembling [pc.cockHead]. <i>“It'll feel better. I need to feel your cock, [pc.name]...”</i> Her clit thumbs against your veins on each bliss-blinded plunge through her seething tunnel.");
	...
	// Equine
	else if (pc.cocks[cockIdx].cType == GLOBAL.TYPE_EQUINE) output("\n\nNearing orgasm, your the fleshy flare of your stallion girth fattens and spreads outward in anticipation of sealing cum. The umbrella of widening flesh bends in and out on the entrance and exit to her celestial nethers. <i>“You're flaring! Y-You're going to cum, [pc.name]... ah... I wish... I wish I could...”</i> You pull back and slam into her again, a small spurt of ejaculate squirting out. You know how badly she wants to be bred, but this is what you agreed upon. She's the mare mounted on your studly stallion, and she's going to get to cum like one very soon. <i>“Yeeeessss... cummmm...”</i> Bianca moans. <i>“[pc.name]... cummm!”</i>");
	...
	output(" Full-bodied shudders wrack the milf-doctor, ending her contributions by turning her into little more than a person-shaped vibrator. You take a series of rapid strokes through her curvesome frame until your engorged shaft{s} throb at the beckoning of your heartbeat.");
	output("\n\nThe hollow moment precluding orgasm strikes, and in one breathless stride, you slide back, igniting your virility. The first eager prize of [pc.cum] surges through your distended " + (pc.hasCocks() ? "veins" : "vein") + ", parting her cock-molded vale with streams of onrushing spunk. When you thrust forward, fondling her unburdened by restraint and inhibition, you cum ‘inside’ the fox-slut’s suffocating thighs, the rhythmic ejaculations teasing her pussy with a [pc.cumVisc], pulsing prize that it cannot claim. Bitter but not ingracious, it still squirts your crotch in exuberance.");
	var cum:Number = pc.cumQ();
	// pc Cum Low (<4000mL)
	if (cum < 4000)
	{
...
public function rutTheFoxDoItNow():void
{
	...
	// imagePack: embed octomush Bianca Thigh Sex pic here 9999
	output("\n\nClapping into Bianca's waist, you howl in a mix of sweet agony and sinful pleasure, breaths turning to half-gasps and hyperventilations that'd get you mistaken for choking. In the haze of thought-depriving pleasure you smush yourself against the doctor's spine, contouring to her frame and planting your hands at her tummy, struggling to cope with clenching tension of meaty, inescapable haunches.");
	...
	output("\n\nHauling ferociously in and out of her thigh-pussy smears her sex and stomach with [pc.cumVisc] slime, creating a slick, frictiously blissful pathway. Her broad booty is put through its proper paces too, graciously accepting the impacts of your lust-thickened firmness. Premature gouts of [pc.cumNoun] squirt out, often times into her depraved hand. " + (pc.cLength(cockIdx) < 12 ? "Sadly, with your size, you aren't able to emerge on the other side of her matronly thighs. Your ecstatic jackhammering instead impregnates her legs with [pc.cumColor] spooge. Pockets of the stuff form that subsequent thrusts burst like water balloons, the messy liquid arcing out front and back." : "It takes you longer than you'd care to admit to realize Bianca's palm caressing your [pc.cockHeads] on their emergence beyond her crushing vale. The narrow terminus of her hand awaits the peak of your stride, simulating the feeling of battering against the natural limits of a partner's biology. A jet of [pc.cumColor] seed impregnates her hand, and the lewd suckling you hear near her mouth is something you don't miss."));
