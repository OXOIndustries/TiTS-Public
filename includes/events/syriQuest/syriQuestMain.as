...
public function syriQuestJobInterviewSpitroast(x:int):void {
	...
	output("\n\nWhile Syri's busying blowing her load, the huskar's attention turns back to you, focusing those big blue eyes on your " + pc.cockDescript(x) + ". She lets her tongue play across your glans, circling your crown before she slurps down the first inches of dickmeat. After the first oral session, you're already on edge: it doesn't take long for the hungry moans and slurping sucks coming from down low to make your [pc.cockOrStraponNoun " + x + "] throb with urgent need, swelling in Myrra's mouth. ");
	...
	else output("\n\n<i>“Ooooh! How sweet!”</i> Myrra giggles, licking her lips. <i>“You sure know how to state your... qualifications... [pc.name]. I think you'll be an excellent fit here at Haskarn's.”</i>");
