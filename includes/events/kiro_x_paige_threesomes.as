...
public function kiroPaigeIntro2():void
{
	...
	if(flags["PAIGE_KIRO_THREESOMES"] != undefined)
	{
		...
		if(!paigeIsCrew())
		{
			output("You arrive at your ship, and you settle Kiro into your personal quarters. She begins to lounge, making herself at home, as you make your way back through Tavros and all the way back to Paige’s unit.");
...
public function PKTSI():void
{
	...
	//First time
	if(flags["PAIGE_KIRO_THREESOMES"] == undefined) output("\n\n<i>“You still carry that oil stuff of yours around, Kiro?”</i>");
