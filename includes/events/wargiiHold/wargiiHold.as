...
public function wargiiBadEnds():void
{
	...
	if(pc.hasCock() && (!pc.hasVagina() || rand(2) == 0))
	{
		...
		if(pc.cockTotal() > 1) 
		{
			output("\n\nThe gaggle of groggy girls pour over your multitude of members. They yip and bark mindlessly as they squabble over your sausages. Eventually one decides to say 'screw it' and rams [pc.oneCock] down her throat, keeping it all to herself. The others seemed a bit surprised, but soon snap out of it as they ram each other in order to slam your other cock" + (pc.cockTotal() > 2 ? "s":"") + " down.");
			output("\n\nYou let out a whorishly loud groan as the feeling of each of your over-stimulated " + pc.mf("","wo") + "manhoods being sucked deep into the unnaturally warm and tight maws of the korg bitches. Whatever she gave them seems to have turned their mouths into perfect fuck-holes! The others cry out in disappointment as their sisters refuse to give them even an inch of your meat.");
			...
			else output(" With nothing else for you to offer them, they settle in to eating out their luckier sisters. Exceedingly wet noises ring out from in the cage, both from the ones receiving and the ones giving. It seems like these girls have been chemically groomed to orgasmically enjoy oral.");
		}
		else
		{
		...
		output("\n\nYou largely ignore everything the little twerp is saying at this point, but there’s one word in there that seems to catch your imagination: Potent. Just the word alone triggers the most debased fantasies. Visions of being a virile sex god, knocking up droves of women with a single orgasm, somehow being so virile that the <i>smell</i> of your cum can put a bun in their oven. The fantasies feel so real that it almost feels like your [pc.balls] " + (pc.balls <= 1 ? "is":"are") + " actually plumping up!");
		output("\n\nThe drug has hit some kind of second wind, and it’s making you feel like a wild animal. You buck against the bars and the sucking slut-mouths, feeling your body growing stronger and more virile as your mind grows more and more distant. As you hurdle toward orgasm, you hear a faint creaking. It doesn’t register until you feel the cage wall you’re up against start to give way. You cum as the wall comes down, the korgonne sluts on your cock" + (pc.hasCocks() ? "s":"") + " unfortunately scattering as to not get crushed.");
		output("\n\nThat doesn’t mean they’re done with you - far from it. You cum like a firehose, splattering the cold ground with what feels like gallons of supercharged [pc.cumNoun]. The resourceful little pups quickly flip you over and start scooping up every drop of ejaculate, stuffing their needy little pussies with every last sperm.");
		output("\n\nThey don’t even give you time to rest! In seconds you feel their overheating bodies crawling all over you; Their massive breasts feel like plush, pre-heated pillows; their fat little pussies drag across your bare [pc.skinFurScales], feeling almost like hot irons as they drool boiling pussy juice all over you. They waste no time in seizing" + (pc.hasCocks() ? " each of":"") + " your still raging-hard [pc.cocks] and ride " + (!pc.hasCocks() ? "it":"them") + " down to the base. The rest make do with the rest of your body, planting their fat pussies and fatter asses on your face. You start eating them out with the eagerness of a starving animal, enough so that, by the time you blow your load in one" + (pc.hasCocks() ? " set of":"") + " sluts, you’ve primed at least three more with a series of oral-induced orgasms.");
