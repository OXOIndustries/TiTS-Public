...
public function kimberQuestWormBonus(btnSlot:int = 0):Boolean
{
	if (flags["KIMBER_QUEST"] != undefined)
	{
		...
		output(".");
		addButton(btnSlot, "Enter Cave", function ():void
		{
			moveTo("KIMBER10");
			mainGameMenu();
		});
...
{
	clearOutput();
	if (flags["KIMBER_QUEST"] != undefined && flags["KIMBER_QUEST"]%4 == 1) output("The wormling’s attack sends you staggering, and you tumble to the ground. Before you can force yourself to rise, you hear the skittering creature draw closer, and its claws prod at your neck, scraping across your [pc.skinFurScales].\n\nOut of the corner of your [pc.eye], you see its jaws open, revealing three rows of sharp, jagged teeth. The last thing you feel is those teeth snapping shut around your neck.");
	else
	{
