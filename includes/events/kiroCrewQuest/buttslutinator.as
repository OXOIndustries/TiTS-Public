...
public function useTheButtslutinator():void
{
	...
	else if(flags["BUTTSLUTINATOR"] == 1)
	{
		...
		if(pc.hasCock())
		{
			...
			output(" for anal pleasure, something to let the people using you just how much you love being fucked.");
		}
		//Else /Vagina
		else if(pc.hasVagina())
		{
...
public function firstButtSlutPart2():void
{
	...
	output("\n\nAnyone could walk up and thrust inside you. Anyone could fuck your ass without so much as a <i>“how do you do?”</i> Your cheeks flush a deeper scarlet than you ever thought possible, and your [pc.asshole] clenches. No matter how repugnant the idea, there’s a certain appeal to it, a certain sort of sense to being anally taken. An upraised ass is meant to fucked, isn’t it? Why else would be displayed so brazenly? Sure, in your case, you’re being forced into such a compromising position, but anyone who voluntarily adopted such a pose would surely be doing it to incite sexual gratification.");
