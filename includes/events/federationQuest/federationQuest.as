...
public function selleraQueen():void
{
	...
	output("\n\nSellera nods, picking a file up from her desk. <i>“Queen Estallia. Dubbed ‘the War Queen’ by her soldiers. Unlike most of the overgrown cows, Estallia at least had the plates to fight with the thousands of her children she sent into the grinder. She actually lead from the front like a proper commander, even fought in the trenches. About as close as a gold can be to respectable. Which of course means that her fellow queens wanted nothing to do with her once the ceasefire was declared.”</i>");
