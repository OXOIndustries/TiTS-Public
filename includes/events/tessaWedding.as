...
public function tessaShowsHerDearFriends(drink:int):void
{
	...
	addButton(3, "Perfer Tessa", tessaAsksIsThereSomeoneElseYouHoldDear, 3);
	tessaWedCheckBlackout();
}
...
public function nowAllICanHangOutWithIsTessasLoveThatWasOnce(fromClark:Boolean):void
{
	...
	if (fromClark) output("You turn Clark down and the big blonde man shrugs. “Alright. Suit yourself. If you change your mind I’ll be close by.” He gives you a lewd wink then enters the men’s room, leaving you alone in the hall.\n\n");
...
public function tessaLeadsTheThreesome():void
{
	...
	output("\n\nYour");
	if (pc.hasCock()) output(" cock pulses then explodes, pumping thick [pc.cumColour] spunk deep inside of Tessa’s cunt. The ovir seems to clamp down on you, squeezing your manhood and almost seeming to milk you for every last drop.");
...
public function tessaFollowsAdrasLead():void
{
	...
	if (!pc.isNude() || tessaHandler.outfit)
	{
		output(" Mind losing the clothes?.”</i>");
		output("\n\nYou remove your " + (tessaHandler.outfit ? tessaHandler.outfit : "[pc.gear]") + ", wiggling out of it the best you can while still seated on the floor. Adra smiles down at you, patiently waiting for you to fully disrobe. To the side you notice Tessa tapping her foot, more than a little impatient with your pace. You finish stripping down, now sitting naked on your [pc.ass].");
	}
	...
	output("\n\nYour");
	if (pc.hasCock()) output(" cock pulse then explodes, pumping ropes of thick [pc.cumColour] spunk deep inside of Adra’s cunt. You feel it fill her up to the brim and then some, with the excess oozing out down your shaft.");
...
public function tessaThreesomeOver():void
{
	...
	output("Your eyes stay closed when you wake, consciousness coming back to you slowly. As your senses start to sharpen, you realize you are still on the floor of Tessa’s ship. You open your eyes carefully, the light in the hold feeling nearly blinding. As you start to shift, you notice something is off, your naked. On top of that your completely spent and pleasurably sore.. Examining yourself you see your covered in a mix of dried fluids; cum, sweat, and you suspect something else you can’t quite place. It coats your [pc.skinFurScales] like a film, reaching from your head to your thighs. As you sit up, you feel it cracking and breaking on your body. Something about this is wrong, and the sex juices should not be covering you nearly this much.");
...
public function tessaWithTessaWithTessaNowWithMoreTessa():void
{
	...
	if (pc.hasCock())
	{
		...
		output("\n\nYour [pc.balls] churn, and your bury yourself deep into Tessa’s cunt as a surge of liquid bliss mounts, demanding release from your burning hot rod. A shudder of pleasure racks your body as thick globs of [pc.cumColour] spunk erupts from your [pc.cockHead] filling the pulsating confines of Tessa’s sex. Above, you feel your pale lover tense, her powerful scaled thighs squeezing tight to your hips. Her sensual juices ooze from her cunt, soon intermixed with spools of your cum, leaving you soaked in a mix of warm fluids.");
	}
...
public function tessaBridefuckFuckFuctionNameThingAHPartTwo():void
{
	...
	output("\n\nYour [pc.balls] churn, and your bury yourself deep into Karen’s cunt as a surge of pure liquid bliss fires up your burning hot rod. A shudder of pleasure runs through your body as thick [pc.cumColour] spunk erupts from your [pc.cockHead]");
