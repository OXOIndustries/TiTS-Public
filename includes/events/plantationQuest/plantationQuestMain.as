...
public function manerLahTurnInProc():void
{
	...
	output("\n\n<i>“Captivating stuff!”</i> declares Darnock, eyes and teeth flashing. <i>“This will make fine material for your autobiography one day Steele - keep seeking out swashbuckling adventures like this and you’ll even overshadow your dear old dad!");
	if(flags["PQ_RESOLUTION"] == 1) output(" Things are looking remarkably peachy up there,”</i> he remarks. <i>“How did you ever manage to nab our friend Remi away from them?");
	output("”</i>");
...
public function queenieDickingsAllHolesBonanzoBoBanzaWhyAmIStillWriting2(x:int):void
{
	...
	else output(" <i>“So meaty and salty in comparison to our own,”</i> she proclaims, a delicate frown appearing on her face after rolling the flavor around her mouth. <i>“Not unpleasant, exactly, but... you star-people are so <i>strange.</i>”</i>");
...
public function queenie3HoleNumbah3(x:int):void
{
	...
	output("\n\nIt feels like the seed is practically being suctioned out of you in there, and after a minute or so of gentle but profoundly satisfying thrusting, you stop denying it. You wrap one arm around Quinn’s round abdomen, the other two playing with the warm, sucking tip of her tongue as you hilt your [pc.cock " + x + "] in a warm, clenching hole you’ve made your own, allow it to bulge up and then gush [pc.cum] deep inside her.");
...
public function zilOnTopOfPC():void
{
	...
	output("\n\n<i>“Keep them there,”</i> Quinn murmurs. The pheromone fug seems to intensify, blood reaching up to your [pc.skin], and another wordless sound of pained joy escapes your [pc.lipsChaste] as she begins to move her hips, stirring you within her oozing, limber warmth. She may as well have tied your hands to her grisly headboard; the thought of disobeying has no chance of trespassing the eager, summery yellowness of your mind. All your attention is upon how wonderful it feels when she finds her rhythm and begins to briskly ride you, tightening her strong athletic thighs around your waist, locking herself into you enthusiastically.");
	...
	if(pc.cumQ() < 10) output(" You are still pumping up into her, [pc.butt] clenching up, long after you have, your dick still pulsing dryly and [pc.cumVisc] trailers working their way down your [pc.thighs].");
