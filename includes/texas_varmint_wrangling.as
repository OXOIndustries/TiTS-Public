...
function fuckCamsButt(camCame:Boolean = false):void
{
	...
	output(" A few more thrusts into Cameron is all you can manage before you feel the tell-tale tightness start in your [pc.balls]. You feel the surge of [pc.cumNoun] rushing up your [pc.cock " + x + "], and into the faux-cow’s tailhole. Cam’s breath catches as he feels the first squirt of spunk basting his bowels, and his fingers lock around your [pc.arms], holding you tight. You grunt in effort, hammering yourself home into Cameron’s warm, welcoming hole.");
	pc.cockChange();
