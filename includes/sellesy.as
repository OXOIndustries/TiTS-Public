...
function firstDrinkFromSellesy(first:Boolean = true):void {
	...
	output("\n\n\"<i>Aaaahhh...</i>\"  she sighs in utter satisfaction as her massive, swollen breasts are just beginning to relieve the pressure of so much additional volume. You feel her hands return to their relaxing, gentle stroking, just as her breasts roll back just enough to let you breathe. \"<i>That's it... gooooood" + pc.mfn(" boy"," girl","") + "...</i>\"");
...
function firstTimeWithSellesyForVagoos():void {
	...
	userInterface.showBust("SELLESY");
	author("Mr. Writer");
	output("The gyration of her hips increases in intensity. A series of delicate little moans escape her, making her bite her lip in ecstasy. Your own pussy, hot and moist, experiences the simmering, wet feeling of her as she grinds your crotch. You can tell she's close, but can only exhale in shock as her legs clamp even tighter around you, and her pussy begins to frantically rub against your moistening slit. Your own orgasm builds steadily, this incredibly sensual friction driving you towards the edge until you cum uncontrollably, trapped you in the vice-grip of three orgasmically-clenched thighs.");
