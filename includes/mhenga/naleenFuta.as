...
{
	showNaleenFuta(true);
	output("\n\nWith a deliberate slowness, she wraps her fingers around your [pc.cocks] and starts to stroke you. <i>“What a gorgeous looking dick you have, offworlder. If I my cocks weren’t doing all my thinking, I'd ride you all night long, but these beauties disagree.”</i> She giggles while stroking her own dicks. Your [pc.asshole] clenches in worry as she speaks. <i>“Aww, don’t worry, I’ll make your asshole feel amazing, and once we’re done you won’t have any complaints... well, aside of a sore ass,”</i> she says with a wink.");
	output("\n\nWithout waiting, she flips you onto your face so that your ass is high in the air. ");
	if(pc.buttRating() < 6) output("She lets out a disappointed grunt as she gropes your behind. <i>“Geez, I thought you outworlders had wonderful drugs to make yourself sexy, but you have such a disappointing ass.”</i>");
	else if(pc.buttRating() < 13) output("You hear a satisfied grunt from behind you as she starts to grope your ass. <i>“What a nice ass you have, outworlder.”</i>");
...
public function fuckDatHermyHooHa(x:int):void
{
	...
	output("\n\n<i>“Lay on your back so I can give it to you,”</i> you say. She’s quick to obey your command, curling her tail against a fallen tree and laying down on her own scaled body. She crooks her finger at you while lifting her fuzzy nuts out of the way, providing her slut as your clear and sensuous target.");
