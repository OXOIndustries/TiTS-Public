...
public function hasCockLossForForgGirls():void
{
	...
	if(pc.cockVolume(x) <= enemy.vaginalCapacity(0))
	{
		...
		output("\n\n<i>“That’s... good babymaker. Enough for now, I’m sure theres plenty of them in here now,”</i> she states, a pleased smile on her face. The " + enemy.skinTone + " girl scoots back to the water, kicking away on her back and leaving you to recover yourself.");
	}
	else
	{
