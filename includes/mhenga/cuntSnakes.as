	...
	switch(response)
	{
		...
		case "accept":
			...
			if(!pc.isTaur())
			{
				...
				{
					output("\n\nYou smirk. It really likes your ass, apparently. You caress the scaly length coiled around your arm and glance over your shoulder just in time to see the cunt snake pop open its jaw and send its fangs into your [pc.skinFurScales].");
