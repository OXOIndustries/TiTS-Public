...
public function yomaShakeHands(handshake:Boolean = true):void
{
	...
	if (handshake) {
		...
		output("\n\nYou ");
		if (pc.isNice() || pc.isMischievous()) output("apologise, saying");
		else output("say")
		output(" you’re just not a very touchy person");
		if (pc.isNice() || pc.isMischievous()) output(" and that you didn’t mean to offend him");
		output(".");
...
//output("\n\n{//Greyed out until you’ve discussed his [Master] with him, display tooltip <i>“You probably should find out who this android belongs to first, unless your kink is lawsuits.”</i>}");
//	addButton(2,"Sex",yomaAppearance);

//Available if the time is between 21:00 and 3:00
//	addButton(3,"Hugs",yomaAppearance);
	addButton(14,"Leave",yomaLeave);
}

public function yomaBase():void
{
	clearOutput();
	showYoma();
	author("-GothPastel");
...
public function yomaTalkGame():void
{
	...
	processTime(60);
	//increased gain to 1, 0.2 seems really pointless
...
output("\n\nSex");
output("\n\n");
output("\n\nYou’re not here to talk, you tell him, {//If PC does not have any SSTDs: and he beams, stripping out of his shirt and hooking his thumbs into the waistband of his shorts before you can even process what’s happening.");
output("\n\n<i>“So, what do you want to do?”</i>} {//If PC has an SSTD: but he shakes his head.");
...
output("\n\n");
output("\n\n[Next] {return to talk menu, gray out sex menu until SSTD is treated/gone} }");
output("\n\n");
output("\n\n[Get oral][Give oral][Vaginal][Cocktail][Back]");
output("\n\n");
output("\n\n[Get oral]");
output("\n\n");
output("\n\nDick:");
...
output("\n\n[Give Oral]");
output("\n\n");
output("\n\nYou wait for Yoma to finish stripping off before you gesture him closer, dropping to your knees in front of him. You look at his cute, human pussy and the heart shaped patch of hair above it almost hungrily.");
output("\n\n<i>“Oh?”</i> He starts, <i>“You want to eat me out down there? Well, it would be rude to refuse you.”</i> He places his hand on your head, {//If PC has animal ears: but not before petting your ears gently,} and pulls you closer.");
output("\n\nHe’s already slightly wet, you notice, beads of translucent fluid clinging to his hairless outer lips, and you lap them up {//PC isn’t at full health: noticing a faint but ignorable, mildly cherry flavoured, medicinal taste}. The android gasps quietly as your greedy tongue slips into his folds. That’s no good, you want him a <i>lot</i> louder than that.");
...
output("\n\nHis thighs press against the side of your head in attempt to stabilize himself, shaky hands finding their way {//If PC has hair: into your [pc.hair] //Else: onto your head} as he’s caught off guard by the sudden doubling of your efforts. You take his swollen clit into your mouth, sucking it gently at first, but soon, emboldened by the cries of pleasure he’s letting out, you step up the intensity.");
output("\n\nVoid, he’s absolutely gushing.");
output("\n\nAll of this is affecting you too, it’s hard not to be swept up in the moment with a cute android moaning out your name like this.You can feel {//If PC has a cock: your cock{{s}} stiffening {{//If PC has both cock and vagina: and}} {{//If PC has a vagina: your cunt{{s}} starting to leak.}} {{//PC has no genitals: a warmth rush to the empty expanse between your legs}}}. At this rate, Yoma isn’t the only one who’s going to get off here, you’re close to cumming //If PC is not nude: in your own [pc.lower garments]}!");
output("\n\nYou ease off a bit in an attempt to calm yourself, pulling your mouth off his clit and hooking two fingers into his vagina, sliding them in and out gently until he shudders and you know you’ve found his g-spot. Your fingers stay in place as you return back to sliding your tongue against his folds, circling his button. He mewls in approval, clearly loving the internal attention.");
...
output("\n\nYoma proves to be no match for the sudden attack on his clit, soon spasming in orgasm, but you’re not any better off. Despite your efforts to calm down earlier, you’re gasping out your own reciprocal orgasm {//If PC has genitals: soaking {{//If PC is not nude: your lower garments //If PC is nude: the jungle floor}} in your [pc.cum]}.");
output("\n\nAfter a while, the two of you calm down enough {//If PC wears clothing/equipment: to redress,} and head back on your separate ways.");
output("\n\n");
output("\n\n[Next]{return to map}{//If PC was wounded: gains 5-10 HP}");
output("\n\n");
output("\n\n[Vaginal]");
output("\n\n{Requires a cock}");
output("\n\n{//PC isn’t nude: You join Yoma in stripping off, carefully putting your [pc.garments]/[pc.gear] somewhere you’ll be able to find them later and set down your codex.} {//PC is nude: Already naked, you wait for Yoma to finish undressing before you step closer to him.} He looks you up and down before speaking, <i>“I can definitely show you a good time. How about you lie down?”</i>");
...
output("\n\n<i>“I am going to have to redouble my efforts to get you off, am I not?”</i> he asks, and it’s the only warning you get before {//If PC has high tone: even }your grip can’t hold him still. Yoma’s tail stands ramrod straight now, letting you get a glimpse of a very welcoming looking asshole, as he rapidly slams himself up and down on your [pc.biggestCock]. {//If PC has a vagina: He doesn’t leave your [pc.oneVagina] out either, reaching down between your legs to stroke your throbbing clit expertly, the sensation bringing you ever closer to orgasm.} His hot, wet cunt grips you tight, and the fast, rippling motion brings you closer and closer to your climax.");
output("\n\nEventually, you can’t hold back any longer and slam your hips up{//If PC has a knot: ,forcing your knot into him}, spraying cum into his waiting passage just as he peaks to a second orgasm, crying out loudly. {If PC has multiple cocks and/or a vagina: {//If PC has multiple cocks: Your other cock{{s}} unload onto the jungle floor} {and} {//If PC has a vagina: {F/f}emcum sprays over Yoma’s hand} in your orgasm, and finally, finally your climax draws to a close.}");
output("\n\n");
output("\n\n{//If PC has a knot: For just a moment, he tries to pull himself back off your cock, but you hold him steady so that he doesn’t try and get your knot out until it goes down. Said deflation takes some time, what with Yoma’s pussy convulsing around you even now. At some point you sit up to wrap your arms around his waist, pressing gentle kisses to his neck. Eventually though, your knot goes down just enough for him to safely get off it and you release him.}");
output("\n\n");
...
output("\n\n{//PC wasn’t nude: It doesn’t take long to put back on your [pc.clothes]/[pc.gear] and }{t/T}he two of you soon say your goodbyes.");
output("\n\n");
output("\n\n[Next] {return to map}{gain the femcum soaked status affect or whatever it’s called}");
output("\n\n");
output("\n\n[Cocktail]");
output("\n\n");
output("\n\nYour tail has been acting up recently with no relief to be found, but it looks like you’ve just found the perfect victim. Seemingly sensing your thoughts, it coils itself around your hip, in plain view of the fennec android.");
...
output("\n\nIt would be, you tell him stepping closer, your tail also shuffling closer to him.");
...
output("\n\nAfter a moment of consideration, you tell him to stand against the nearest tree, ass facing you. He does it without a moment's hesitation, putting his hands against it and lifting his tail out of the way. You don’t waste a moment, {//If PC not nude: stripping off your clothes and} stepping closer, taking his hips in your hands. Your cockvine snaps to attention, tucking itself through your legs to brush against {//If PC has a vagina: your own vagina //Else: your taint} for just a little extra stimulation, and wastes no time in sliding against his sweltering cunt.");
...
output("\n\nFuck, that’s good. The parasite attached to you shoots wave after wave of pleasure up your spine and you buck your hips forward. The two of you moan out in unison, Yoma as the parasite pushes hard against his simulated G-spot, and you as it rewards you with a flow of ecstasy that goes straight to your {//If PC has a vagina/cock/none: own vagina{s}/cock{s}/lower regions}.");
output("\n\nYou have no idea how long the two of you are at it, the pleasure coursing through you blurs your judgement, but unfortunately it can’t last forever. The rubbing of your long tail against your {//If PC has a vagina: cunt //Else: taint} starts to become erratic, along with the rhythm of its thrusting.");
output("\n\nYoma goes first, his cunt spasming around your cocktail, and that’s all it can take, soon unloading it’s citrusy payload into the android’s waiting channel. {//If PC has a cock/vagina: Your non-parasitic genitals follow soon after, spraying {cum/{and}femcum} everywhere.}");
...
output("\n\nAfter a while, the two of you settle enough to separate, and you soon find yourself handing Yoma his clothes {//If PC wears clothing: and being handed your own back}.");
output("\n\n{//If first time doing this scene: <i>“Thank you for the new experience, [pc.name], I hope to see you around!”</i>}");
...
output("\n\n[Back]");
output("\n\n");
output("\n\nOn second thoughts, you change your mind, telling him to put his shirt back on.");
...
output("\n\n");
output("\n\n[Next] {Go back to talk menu}{gray out sex menu for the rest of this encounter}");
output("\n\n");
output("\n\nHugs");
output("\n\n{only accessible between 21:00 and 3:00}");
output("\n\n");
output("\n\nIt’s getting late, you notice, barely stifling a yawn. Yoma’s large ears swivel, catching the sound and he speaks, <i>“Are you tired, [pc.name]?”</i>");
output("\n\nNow that he mentions it, yeah, you are.");
output("\n\nHe smiles, wrapping an arm around your {//If PC less than 4 foot 5: shoulders //Else: waist} and pulls you in. <i>“Do not worry, you can stay with me for the night, if you would like,”</i> he suggests. He sounds genuine.");
...
output("\n\nYou let your eyes drift shut, unable to stop a{//If PC is Hard: hint of a} smile spreading across your features are you feel his long fingers card{//If PC has hair: through your hair //Else: across your scalp}. It’s not long before you fall asleep completely.");
output("\n\n");
output("\n\n[Next] {Set time to 6:00, max out energy}");
output("\n\n");
output("\n\nYou wake up several hours later to Yoma grinning down at you, trilling out a, <i>“Good morning, [pc.name]!”</i>");
output("\n\nIt takes a little effort, but you soon extricate yourself from the android’s grip, climbing to your feet. Morning? It’s barely daybreak, you grumble {//If PC is not Hard: goodnaturedly}, but he laughs you off, getting to his feet too.");
