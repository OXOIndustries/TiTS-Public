...
public function myrellionManorAdminRoom():Boolean
{
	if (flags["MANOR_ADMINROOM_ENTERED"] == undefined)
	{
		...
		output("\n\nWow. A real bigshot, then. If what she says is true, than the imposing woman walking in your direction is a noble among the ruling class of the Scarlet Federation, someone who commands generals and determines the course of an entire war. Her importance would be comparable to one of the highest queens among her enemy’s culture. Most of all, she doesn’t even appear that <i>old</i>, though you’ve already noticed that myr age somewhat differently from humans. She’s either got friends in very high places, or she’s some sort of prodigy.");
...
public function selleraOccupation():void
{
	...
	output("\n\n<i>“Not well,”</i> she answers immediately. <i>“They’re restless, and itching for a fight. Occupation is nothing like waging war. In war, you sight the enemy and engage. Sometimes you walk into an ambush, sometimes you’re the ambusher, and sometimes you’re taken completely unawares, but war is war at the end of the day. It’s what we know. Occupation is... it’s sitting and waiting for some damn rebel to murder you in your sleep or attack you in the street before disappearing into the crowds and backroads. All you can do is try to keep some semblance of order among a populace that just wants you dead or gone and hope you foil the next resistance plot before it blows up in your face... quite possibly in a literal fashion. It’s tempting to just round up every bleeding heart would-be rebel up and shoot them, but that would just turn every single civilian into a potential combatant. It’d be even more costly.”</i>");
