...
public function girlyCompassionVictoryWithInfectedMyr():void
{
	...
	else output("Stop crying. You still have a pussy dont you?");
...
public function infestedVictoryOrLossMaleScene(loss:Boolean = true):void
{
	...
	if(x >= 0)
	{
		...
		output("\n\nOnce her torrent stops, the fungal entity pulls itself off her cock and gives you a smile. A series of happy images flash through your mind, and you give it a hesitant grin in return. You gather your [pc.gear], leaving the two of them to recover while you return to your previous endeavours.");
	}
	//dicktoobig
	else
	{
...
output("\n\nIn the end you don’t need to accelerate your pace much. As the purple skinned cave-dweller fucks the golden ant-man, her anal passage gyrates around you like an exceptionally tight onahole. She hums pridefully as you squeeze her ample tits, kneading the pale mounds with both hands, and you follow up by moving a hand down her chest, cascading over the corset-like carapace that covers her stomach till you touch skin again. You tickle her knot as it tugs at the gold myr’s backside, setting her chitinous legs to quivering.");
...
output("\n\nThe lilac skinned prisoner pauses in front of you, looking at once afraid and resilient. The ant-man nudges her on, a ghostly aura emanating from his shoulders. The nyrea bares her fangs, finally digging them into one of your arms, and you feel the paralytic poison almost immediately begin to stiffen your muscles, starting in your arm and spreading till you are unable to move beyond twitches. As if to add insult to injury, the toxin also leaves you feeling incredibly horny.");
...
output("\n\n<i>“It’s all the way in now, only a matter of time till you’re swimming in fertilized eggs. What should we do with them, eh? Maybe I should masturbate you till they all come out and then stuff them into your warm, welcoming ass. I bet you it’ll feel absolutely orgasmic when I do it,”</i> he whispers in her ear. Up till then the nyrea had been doing a good job keeping her footing, but as soon as he reaches the word orgasmic her knees buckle and she begins to fall.");
...
public function queenFungusBoobsuck():void
{
	...
	//(/, but it seems something like that is already inside you,”</i>)
...
public function beatUpConstructoBot():void
{
	...
	output("\n\n<i>“Thank you. You make take your material now. Please help this girl back to the surface if you wouldn’t mind,”</i> she says through the eager redhead. You walk behind her to find the material she was talking about. A few meters back is a small spire of crystalline rock. Your codex scans the formation and identifies it as crystallized sophinol, a prized fuel source. If that robot’s flames had touched it you might not be standing here right now. In a few minutes you’ve filed a claim on the fuel crystals through SteeleTech’s central servers.");
