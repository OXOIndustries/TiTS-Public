...
public function genesModsTalkYou():void
{
	...
	else
	{
		...
		output("\n\n<i>“A [pc.race], if I’m not mistaken. I’ve got some things that could help with that.”</i> He gestures politely at his computerized list of mods.");
...
public function genesModsBlowjob():void
{
	...
	if (!isGeneSubmissionLevelMaxed() || flags["GENE_BLOWJOB"] == undefined)
	{
		...
		output("\n\n<i>“That is exceptional,”</i> he murmurs, the tremors of his rich voice travelling down his cock and then your spine. <i>“The myr aren’t anywhere near as good as you at this, Steele. Too much teeth... no practice, you see...”</i> You make him trail off into a heartfelt rumble with a well-timed squeeze of the testicle.");
