...
public function discountFlirtsFromPolyants():void
{
	...
	else
	{
		...
		output("\n\n<i>“Well, [pc.misterMiss] Steele. What did you have in mind?”</i>");
		processTime(4);
		pc.lust(5);
	}
	survivalShopSexMenu();
...
public function milkingShiareCuckoldBullshit():void
{
	...
	output("\n\nShe dumps the contents of the chest onto the bed, revealing a wide array of kinky sex toys. Looking through the variety of choices, your eyes fall on a Tamani-corp multi-function bondage ball. These things can work like simple ball or ring gags, but can also form varying levels of latex coverings up to a full body-suit. You’ve seen a few video’s extolling their virtues in the bedroom. For now, though, you think a simple ball gag will be good enough.");
