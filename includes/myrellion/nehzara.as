...
public function sexUnderDeskWithNehzara(fromMissionTalk:Boolean = false):void
{
	...
	output("\n\nYou couldn’t be happier. Down here between the Red Myr officer’s legs, [pc.face] buried in her warm cunt so firmly you’re practically making out with it, you’re practically overwhelmed by a tingly, electric excitement that you can’t fully describe. Though you started out trying to make the cool, dismissive woman lose her cool and descend into moaning ecstasy, you are quickly realizing that the tables have turned. You reach down ");
...
public function sexWivNehzaraInStorageCloset(fromMissionTalk:Boolean = false):void
{
	...
	output("\n\nShe draws back from the desk in her rolling chair and gets to her feet, eyes fixed on your face this time. <i>“I know just the place,”</i> she announces. The ant-like woman hooks a finger into your [pc.gear] to lead you along toward the doorway. A little taken aback, you follow along, feeling almost like you’re on a leash.");
	...
	output("\n\nMerely hearing Nehzara use such a commanding tone has brought a faint blush to your face. You can’t help but imagine her fucking you in the same way: forceful, firm, and in control. You follow along behind you, [pc.eachCock] slowly growing in arousal and anticipation. ");
	if(pc.isNude()) 
	{
	...
	if(flags["NEHZARA_CLOSET_FUKKED"] != undefined) output(" even though you’d been expecting it");
...
public function nehzaraClosetPartII():void
{
	...
	else
	{
		...
		output("\n\n<i>“Come on, Steele,”</i> she murmurs. <i>“I know you’ve got more of that. Give it all to me.”</i> The myr colonel fiercely grips your cock and redoubles her forceful stroking. Both of those strong hands are tightly holding the throbbing shaft of your [pc.cockBiggest], jerking at the swollen meat with a fervent need to milk you for everything you’ve got.");
