...
public function lirielTalkResponse(arg:Array):void
{
	...
	else if (response == 1)
	{
		...
		output("\n\nThis makes her jump up and down on the spot, her bare breasts bouncing in the process, <i>“Because it’s just the cutest little planet!”</i> You look around at the mostly barren red earth of the planet and figure that beauty must really be in the eye of the beholder, <i>“And with the planet rush going on, what better way to try and revive an awesome retro fashion craze than to come to a new planet and tap a fresh market?”</i>");
	...
	else if (response == 4)
	{
		...
		output("\n\n<i>“Ok, so like you know how occasionally there will be a clothing fad from yester-year? Like when people start dressing the way their parents or grandparents did back when they were little...? Well, the clothing we sell is an extreme version of that. The clothes here are so retro that they predate terran use of the warp gates. However, they’ve been revamped and updated to align with current galactic standards. The designs are completely 100% the same though--just like what terrans wore during my favorite part of history: the colonization of our original solar system. You see, right as space flight technology was becoming a commercial enterprise, people were curious about the possibility of life on our sister planet, The Red Planet. My family made a fortune in those early days, trade-marking the little green alien and selling stylish black and green clothes,”</i> she says while absently mindedly bouncing.");
...
public function lirielButtSex(myrWomen:Boolean = false):void
{
	...
	if (pc.hasCock())
	{
		...
		else
		{
			...
			if (pc.cockTotal() == 1) output("ing");
			output(". You yell to the heavens as you violent climax sends blasts of [pc.cum] crashing onto the mushroom like mini-tsunamis of your own creation. She continues to fuck the cum out of you as your ejaculate covers the mushroom. Even then your orgasm rages on until you feel the mess flooding your [pc.feet]. You roar and scream in a way that only seems to make Liriel even happier.");
