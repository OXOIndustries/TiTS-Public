...
public function encourageWhatsHerButtNotToBeRobocop():void
{
	...
	output("You put a hand over her strained fingers, and she jumps before relaxing. A hand-shaped mark is left over the smooth scar before it slowly fades back to a uniform waxy pink. You tell her if she really doesn’t want to fix the arm there’s no need to do so. She shouldn’t think about it so hard if it makes her this stressed. She still has three perfectly good arms, Which is one more than </i>you’ve<i> Unless she’s decided on an offworld heavy lifting career while you were away. You also tell her that sometimes you wish you had even one extra arm to help with various tasks. She laughs at this and gives you a smile.");
