...
public function ulaHasToWaitCauseYouHaveSlutsToDo():void
{
	...
	output("\n\nThe fluffy Chieftess nods solemnly. <i>\"" + (korgiTranslate() ?"9999" : "Ula understand. Many tasks and troubles in stars needing [pc.name] helpings. Korg'ii Hold strong.") + "\"</i> She slaps her fist proudly into the armrest of her chair. <i>\"" + (korgiTranslate() ? "9999" : "Handling prisoners fine. If feedings become problems, can tradings the extra gems milodans finding for more foods. Battle leave us stronger. Just wishing for last problem be fixed.") + "\"</i>");
...
public function heyUlaCanYouLetTheMilosBreathe():void
{
	...
	output("\n\n<i>\"No.\"</i> Ula's response is fast and frank. <i>\"" + (korgiTranslate() ? "9999" : "Having secret door opening all day, sending cat-dogs in and out one at time. Korg'ii Hold not strong enough for reveal self to rest of world all times.") + "\"</i> She must see the crestfallen look on your face, because stretches out from her throne to ruffle your hair, giggling softly. <i>\"" + (korgiTranslate() ?"Don't worry. There are small openings higher up in the hold. Aliens call them... balconies? Like balconies. The Milodans can go there if they need sun for their health" : "Not worry. Small openings higher up in hold. Alien have word for... balcony? Like balcony. Milodan can go there for sunning, if need sunning for health.") + "\"</i>");
	output("\n\nThat... sounds like an agreeable compromise, and you say as much.");
	output("\n\n<i>\"Good.\"</i> Ula folds her stubby arms across her sizeable chest. <i>\"" + (korgiTranslate() ? "9999" : "Milos be thanking-full Ula have such charity.") + "\"</i>");
...
public function theCatsWantWaterAndUlaIsBewildered():void
{
	...
	if (pc.isAss() || pc.isBro()) output("More water for the milodan.");
	output("The milodan need more water.");
	output("\"</i>");
	...
	output("\n\nUla's eyes wander the room as she considers it. <i>\"" + (korgiTranslate() ? "9999" : "Am admitting, [pc.name]... Ula not want fang-cats happy. Maybe thinking thirst-having and hunger-panged is good payment for what to do to Korg'ii.") + "\"</i> Her jaw sets, and her eyes dart back to you, ice-hard. <i>\"" + (korgiTranslate() ? "9999" : "But Ula not rule from anger. Chief, chieftess... any good leader do what right for people. Even if hard or hurt own heart to do.") + "\"</i> She nods. <i>\"" + (korgiTranslate() ? "9999" : "Milodan having waters, and Ula glad know you, [pc.name]. You best alien.") + "\"</i>");
