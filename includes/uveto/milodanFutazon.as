...
public function encounterMilodanFutazon():void
{
	...
	{
		output("Your codex suddenly starts blaring out an alarm. You silence it and take a look.");
	...
	{
		output("Familiar growls echos out across the icy tundra. You turn your head and see the hulking figure of a milodan amazon charging at you with her fangs and claws bared, ready to dig into you. Seeing nowhere to escape to, you draw your [pc.weapon] and get ready to engage.");
		output("\n\n<b>It’s a fight!</b>");
	}
...
public function encounterMilodanBruiser():void
{
	...
	{
		output("A beast-like howl rings out over the icy tundra. It sounds like a massive wild animal but you soon find out that it’s far worse than that. Emerging out of the dense blizzard is an absolutely mammoth figure. She looks like the amazon milodans you’ve been encountering up until now only far, <i>far</i> larger!");
	...
	{
		output("Loud stomps ring out over the Uvetan wastes. Looking behind you, you see the imposing silhouette of an extra-large milodan amazon stomping toward you. She grins down at you and lets out a low snarl as she extends her claws and gets ready to tear you down!");
		output("\n\n<b>It’s a fight!</b>");
...
public function milodanFutazonWin():void
{
  ...
  clearMenu();
  if (pc.hasCocks()) addButton (0, "Fuck Her", winAgainstMilodanFutazonFuckHerChoice);
  else if (pc.hasCock())addButton (0, "Fuck Her", winAgainstMilodanFutazonFuckHerOneCock);
  else addDisabledButton (0, "Fuck Her", "Fuck Her", "You need a phallus for this!");

  addButton (1, "Oral", winAgainstMilodanFutazonOralChoice);

  if (pc.cuntThatFits(enemy.biggestCockVolume()/2) < 0 && enemy.biggestCockVolume()/2 > pc.analCapacity()) addDisabledButton(2, "Get Fucked", "Get Fucked", "You’d rather keep your organs right now!");
  else addButton (2, "GetFucked", vaginaRouter, [winAgainstMilodanFutazonGetFucked, enemy.cockVolume(0)/2, 1, -1], "Get Fucked", "Let her take the lead and make her fuck you on your terms.");
...
public function winAgainstMilodanFutazonFuckHerChoice():void
{
  clearOutput();
  output("You’ve got some options here. How do you want to do this?");
  clearMenu();
  addButton (0, "One Cock", winAgainstMilodanFutazonFuckHerOneCock);
  addButton (1, "Two Cocks", winAgainstMilodanFutazonFuckHerTwoCocks);
}
//Oral
//Choose Between Eating out and Blowjob
//Normal and Bruiser blowjob are different
//Must have Snakebyte for Bruiser blowjob.
public function winAgainstMilodanFutazonOralChoice():void
{
  clearOutput();
  output("Which way do you want to take her?");
  clearMenu();
  addButton (0, "Eat Out", winAgainstMilodanFutazonEatHerPussy);
  if (enemy is MilodanFutazon) addButton (1, "Suck Off", winAgainstMilodanFutazonSuckHerOff);
  else if (flags["USED_SNAKEBYTE"] != undefined) addButton (1, "Hyper Suck", winAgainstMilodanFutazonHyperSuckHer, "Hyper Suck Off", "Use your extra-stretchy mouth to tame her titanic totem.");
  else addDisabledButton (1, "Hyper Suck", "Hyper Suck Off", "You’d need some heavy-duty jaw mods in order to pull that off.");
}
//Fuck Her One Cock
public function winAgainstMilodanFutazonFuckHerOneCock(): void
{
  clearOutput();
  showMilodanFutazon(true);
  output("You whip out your [pc.cock] and present it to the Amazon. Without any hesitation or resistance, she practically leaps onto your crotch and starts taking it into her mouth. ");
  //Normal sized cock
  ...
  {
    output("The cock-craving amazon slowly works down your sizable member, devouring inch after inch until she inevitably reaches the base. She sits there for a good minute, slowly wrapping and unwrapping your [pc.cockNounSimple] in her rough, cat-like tongue while her muzzle remains almost glued in place.");
  ...
  {
    output("The cock-obsessed milodan seems almost in awe of the size of your member. She takes several tentative licks of your [pc.cockHead] before she even begins to take it into her mouth. Even as large as she is she still has trouble taming your sheer size. It’s obvious that she’s not the type to be deterred though, and she soon begins hammering her face into your member, forcing down as much of it as possible and then telling possible to go fuck itself and shoving even more down. ");
  ...
  //Merge
  output("\n\nThe now-submissive milodan slams back down on your [pc.cock], devouring it all in one quick motion. ");
  if (pc.biggestCockLength() > 12) output("She looks up at you defiantly, full of pride at being able to take you all the way.");
...
//Fuck Her Two Cocks
public function winAgainstMilodanFutazonFuckHerTwoCocks():void
{
  clearOutput();
  showMilodanFutazon(true);
  ...
  else if(pc.hasVagina()) output("While she’s working on your cocks, she takes notice of your other set of sex organs. Testing her flexibility, she leans down and laps at your [pc.pussy " + x + "] all the while she continues to stroke you almost perfectly.");
...
public function winandGetFuckedByBruiser(vIdx:int):void
{
  ...
  pc.holeChange(vIdx,enemy.cockVolume(0)/8,true,true,true);
