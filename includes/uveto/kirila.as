...
public function kirilasDiet():void
{
	...
	output("\n\nThe spinarran nods. <i>“Mmhmm, it’s all metal, well, almost all. There is a little bit of organic matter laced throughout, but for the most part I am covered head to toe in a lovely, nearly an alloy of 90% copper plus a bunch of other stuff.”</i> She lifts her chin and smiles, clearly proud of her chitin.");
	output("\n\n<i>“");
	...
	output("\n\nShe notice your looks. <i>“Well it’s not quite like that, but you’re sort of on the right track. Let’s just say that driders make it and some are even payed to maintain a steady diet and get milked for others to eat. It’s kind of neat looking actually, like your average fruit jam but shiny and metallic in color, like liquid chrome in a lot of cases.”</i>");
...
public function kirilaRushTalk():void
{
	...
	else if(story == 2)
	{
		...
		output("\n\n<i>“Well, one of the races there, the sydians. They are... well, they’re a lot like you actually: buggy, exoskeleton covering their whole body. They even have a metallic diet like your people,”</i> you explain to her, just about to get to the part she won’t like. <i>“This is going to be a bit umm... horrific, I suppose is the word. You guys are lithiophages, you eat rock and minerals, the sidians however are ferrovores, they corrode and eat refined metal. You spinarrans are kind of made of it; probably a place you wouldn’t like to go to.”</i>");
