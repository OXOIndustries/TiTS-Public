...
public function frostwyrmWhyDoesMommyLookDifferent():void
{
	...
	var eldestKipName:String = frostwyrmGetEldestKipName(false);
	var eldestKipNameCap:String = frostwyrmGetEldestKipName(true);

	output("You ask " + eldestKipName + " if she’s ever really wondered why her Qim and her Qal look so differently. [frostwyrm.name] is very large, and you’re... well, you’re not. [frostwyrm.name] has six limbs, and you only have four. There’s a lot of differences.");
	...
	if (pc.biggestTitSize() > 0 && pc.biggestTitSize() < 6) output("\n\nYou grit your teeth at " + eldestKipName + " reminding you that your boobs are smaller than hers, and tell yourself that she meant nothing by it.");
	...
	if (pc.isLactating()){
		...
		output("\n\n" + eldestKipNameCap + " gasps in surprise at the sight, then a giddy grin crosses her face. This liquid, called ‘[pc.milk]’,  is what the young of your kind sustain on until they’re older for other, solid foods.");
		if (flags["FROSTWYRM_INCEST_OPTION"] == 0) output("\n\n<i>“May I have some?”</i> she asks. You reply that she’s... a little above being breastfed at her age, and you lower your [pc.nipple] away from her. She pouts, but respects your decision.");
			...
			output("\n\n<i>“Like this?”</i> she asks, then leans forward and clamps her lips onto your right nipple. You shudder in surprise as her cheeks compress, suckling the [pc.milk] straight from your breast, and you melt on the spot; this is unsolicited, but the relief you feel from releasing the pent up pressure and weight on your boob is enough to blank your mind momentarily.");
			output("\n\n" + eldestKipNameCap + " gulps down your [pc.milk] eagerly, humming in ascension as it washes over her tongue and fills her cheeks before swallowing. She uses her hands to gently massage your boob, using her psionic connection with you to learn the best way to handle you and how much pressure to apply. ");
			if (flags["FROSTWYRM_KIP_COUNT"] == 1) output("\n\nWhen your nipple goes dry, she switches to the other, leaning over your body to stick the other in her mouth.");
			else output("\n\nWith her psionics, she calls out to her next-eldest sibling, cuddling on your other side, to take your other side and drink your delicious, nurturing [pc.milk]. She doesn’t hesitate and leans over, taking your other nipple into her mouth and suckling gently.");
			output("\n\nWhen you’re dry, ");
			if (flags["FROSTWYRM_KIP_COUNT"] == 1) output("she pulls");
			else output("they pull");
			output("back, smiling at you while a bit of your [pc.milk] dribbles down the side of ");
	...
	if (flags["FROSTWYRM_INCEST_OPTION"] == 0) output("\n\nYou do so, leaning in to give her another quick peck on her lips. She sighs in delight when your [pc.lipsChaste] meet hers once more. <i>“Can you... can we do that again?”</i> she asks, but you stay firm and tell her that that’s enough for now. She pouts, but respects your decision as her Qal.");
		...
		output("\n\nAs soon as you open your mouth, it’s invaded by " + eldestKipName + "’s tongue, eagerly licking and exploring your maw. You moan as her huge, flat, inhuman tongue draws along your cheeks and across the roof of your mouth; you taste her, and you purse your [pc.lips], suckling on her tongue and twisting your head just slightly. You press your tongue as flat against hers as you can, pushing against her, and she mimics your every action precisely.");
		output("\n\nWhen you finally pull away, " + eldestKipName + "’s sparkling [baby.eyeColor] eyes look into yours: lustful, loving, and a bit impish. Her tongue snakes out of her mouth and licks at her lips exaggeratingly, wriggling just before you.");
...
public function frostwyrmShinyShit():void
{
	...
	output("your call is automatically answered by your ship, and you’re given a view of the cockpit, but there’s nobody there to answer. You explain that this is your ship, and you use it to travel vast distances at high speeds – almost like a set of wings. " + eldestKipNameCap + " scrunches her nose as she studies the Codex, and she looks around the metal box, trying to see more into the ship. She presses her nose against the glass, trying to go through it to get into the ship, but she’s stopped by the glass screen.");
	...
	output("\n\n" + eldestKipNameCap + " watches, enraptured. She’s totally taken in by the programming going on in front of her. <i>“What’s going on here?”</i> she asks you innocently, and you explain who Steph is and what her goal is – or, rather, what it’s <i>supposed</i> to be, but more often than not, it always devolves into... exactly what’s happening right now. Her audience tends to prefer it this way.");
	output("\n\n" + eldestKipNameCap + " probes your mind once again. <i>“You mean there are individuals that enjoy watching others mate for their entertainment?”</i> You answer that yes, that’s about the long and short of it. <i>“Wow.”</i>");
...
public function frostwyrmBlessedBeOurSmutlords():void
{
	...
	output("You ask " + eldestKipName + " what she thinks of the standards and traditions that are upheld here in [frostwyrm.name]’s lair. <i>“I don’t think I understand the question,”</i> she says, so you elaborate, one step at a time: what does she think about mating with you and [frostwyrm.name]?");
...
public function frostwyrmIChangeMyMind():void
{
	...
	output("You nudge at " + eldestKipName + ", getting her attention. <i>“Yes, my Qal?”</i> she says attentively, her eyes locking onto yours. You get the feeling that she already knows what you’re going to talk about.");
...
public function frostwyrmIDontChangeMyMind():void
{
	...
	output("You tell " + eldestKipName + " that it’s nothing, and for her to never mind herself.");
...
public function frostwyrmYesIDoChangeMyMind():void
{
	...
	if (flags["FROSTWYRM_INCEST_OPTION"] == 0){
		output("You tell " + eldestKipName + " that you’ve changed your mind: it feels inappropriate to be surrounded by Frostwyrms, in a Frostwyrm lair, and not be a part of their traditions. You’d like your family to include you in their future ‘inner circle couplings.’");
		...
		output("You tell " + eldestKipName + " that, as much as you enjoyed participating in the Frostwyrm tradition of ‘inner circle coupling’ up until this point, you think you need a bit of a break from it, and to not include you in the act for the time being.");
...
public function frostwyrmlingSexMenu():void
{
	...
	if (!pc.lust() > 50){
		output("As you sit, your back to [frostwyrm.name]’s belly and with " + eldestKipName + " curled and cuddled up against you, you start to feel a little... randy. Pent - up, even; like you could really go for a good fucking.");
		if(pc.hasGenitals()) {
			output(" Y");
		...
		output("\n\nYou’re startled when " + eldestKipName + " grinds her body against you, her huge, F-cup breasts squishing against you, her pebbly-hard nipples pressing against your flesh as she pulls in and lavishes your neck with a long, thick swipe of her tongue. <i>“Our connection may not be as refined as our Qim’s, my Qal,”</i> she whispers, <i>“but with emotions as strong as yours, I can tell that you’re feeling particularly... needy. Just say the word, my Qal, and we can celebrate the union of our clutch with our inner circle coupling.”</i>");
		output("\n\nYour emotions are feeding into " + eldestKipName + ", and they’ll be spilling out into the rest of the clutch unchecked if you don’t do something soon. You’ve already agreed to participate in the tradition of the Frostwyrms - you consent to your kip’s invitation.");
...
public function frostwyrmlingCatchGangbang():void
{
	...
	output("\n\nJoining you is " + eldestKipName + ", gracefully laying herself atop you, her own mountainous F-cups resting against your [pc.chest]. Her eyes lock onto yours lustfully; she licks her lips before kissing yours, her tongue snaking out and invading your mouth. She hums in delight as she tastes you and your tongue; her hand reaches behind your head to keep you in place until she’s counted each of your teeth several times over.");
	output("\n\nThe kip beneath you frots against you, her dick growing all the while, inflating slowly against your warm body, driving itself deeper and deeper into the cleavage of your ass. You hear footsteps, and you and " + eldestKipName + " are joined by a third; her tall, muscular legs spread apart and her draconian testicles dangling above you, quivering with seed. She palms gently at her own vent, massaging her cock through her scales as it too grows in length, a drip of pearly pre-cum forming at the tip.");
	output("\n\n" + eldestKipNameCap + "");
	...
	output("\n\nAlready, the sensation is torturous: to be so close to release and have release elude you constantly. Like water overflowing a dam, the results are going to be monumental once the dam finally breaks: " + eldestKipName + " couldn’t be more lubricated, with the feminine juices you’re coating her blunt dick with , and you’re ready to squirt a fountain as soon as she releases her damnable block on you[if (pc.isHerm()). And, just northward, ");
	...
	output("\n\nYou and " + eldestKipName + " orgasm simultaneously as soon as you think the thoughts. With another, herculean push, you’re inexorably tied at the knot with her, and the one place you wanted cum the most is suddenly quenched with a veritable torrent of draconic cum. Her load is second only to [frostwyrm.name]’s");
...
public function frostwyrmlingPitchGangbang():void
{
	...
	output("\n\nYour kips, including " + eldestKipName + ", make their way to their knees, slurping and kissing at your rod, bathing it in a strictly non - platonic way");
	...
	output(". Your [pc.cock] was already half - mast when you had started, and now that it’s lodged firmly in the maw of " + eldestKipName + "");
	...
	output("\n\nEach of your kips focus their attention on you and your body, and the myriad of ways that it reacts to being pleasured, but " + eldestKipName + ", with her mouth full of your cock, focuses her [baby.eyeColor] eyes purely on your own. Your mind is inundated with so many kips providing you with so much lust, it’s difficult to focus on any of them, but " + eldestKipName + ", with her psionics being more developed than the rest, stands out like a torch next to a candle. And if her own thoughts and emotions are anything to go by, she’s probably going to fuck you the most today.");
	if (flags["FROSTWYRM_KIP_COUNT"] >= 5)
	...
	output("\n\nAnd that’s the rhythm that you settle into for the moment: you fuck her into the ice while " + eldestKipName + " stimulates you both, and each time you pull back to thrust again, your third kip pushes deeper into you. ");
	...
	output("\n\n<i>I want to look you in the eyes,</i> she says as she crooks her finger to you, " + eldestKipName + " beckoning you to mate with her. <i>Mate with your Qer of a kip, and punish her by giving her all your kips. Satisfy her, and she’ll let you cum.</i> ");
...
public function frostwyrmlingBathing():void
{
	...
	output("\n\nHer two siblings, your third- and first-oldest, crawl forward, their hands trailing up your [pc.legs] seductively, and stopping just before your [pc.crotch]; with almost practiced unison, the very tips of their fingers wisp over your pelvis, before landing back on your stomach. <i>“Someone is an awfully dirty [pc.boyGirl], aren’t they?”</i> " + eldestKipName + " asks, her nose against yours while your third-oldest begins working on the other side of your neck. <i>“Let’s get you nice and </i>clean<i>.”</i>");
	...
	if(pc.hasGenitals()) {
		output("\n\nWhile they both work you over, " + eldestKipName + "’s eyes also lock onto yours, and she narrows hers deviously:");
	...
	output("\n\n<i>Tut, tut,</i> " + eldestKipName + " says, and, even though you’re ready to blow any second now, there’s something stopping you: the edge that rapidly approached quickly recedes");
	output(", and no matter how deeply " + eldestKipName + " ");
	if(pc.hasGenitals()) {
		if (pc.hasCock()){
	...
	if(pc.hasGenitals()) {
		...
		if (pc.hasCock()) {
			output("you grip " + eldestKipName + " by the horns on her head and thrust forward – not that you could go any deeper, seeing as she had already taken you as deep as you had – and you gush your load into her throat");
...
public function frostwyrmGiveThemABath():void
{
	...
	output("\n\n<i>“Damn, girl,”</i> " + eldestKipName + " laughs, wrapping her arm around her sister’s shoulders and underneath her folded wings. <i>“You sure are putting a lot of effort into fucking our Qal’s face. Enjoying yourself?”</i>");
	...
	output("\n\n" + eldestKipNameCap + "’s words seem to have a visible effect on her sister: her cock lurches in your mouth, and a spurt of pre jets from her, caking the back of your tongue and your tastebuds with her tart, smooth flavor. <i>“Is that right, my Qal?”</i> she asks, her eyes wide and hopeful. Your mouth is full of cock, so you don’t try to answer, but you do nod.");
	...
	output("\n\n<i>“Settle down!”</i> " + eldestKipName + " says good-naturedly. <i>“I said our Qal wants to provide for us; that doesn’t mean you should choke [pc.himHer]! As much as [pc.heShe] may enjoy it, [pc.heShe] still needs to breathe!”</i> Her sister freezes in place, and she notices how your eyes are squinted and watering in effort to contain the force in your mouth. <i>“Why don’t you pull out for now? I have an idea, but I need you to show some restraint.”</i>");
	output("\n\n" + eldestKipNameCap + " crooks her finger at your second-oldest, motioning for her to approach and take her sister’s place. As she does, she whispers something to the third-in-line; something you can’t make out and is being blocked through your psionic connection. When she pulls back, your third-oldest smiles widely. <i>“That sounds like fun!”</i> she says. <i>“I’ll do it. It’ll be hard, but I’ll do it, if you think our Qal would like it.”</i>");
	output("\n\n<i>“Please, look at [pc.himHer],”</i> " + eldestKipName + " says. <i>“[pc.HeShe]’d love</i> anything <i>you did for [pc.himHer].”</i>");
	...
	output("\n\n<i>“Go ahead,”</i> " + eldestKipName + " says lovingly. <i>“[pc.HeShe] won’t say no.”</i>");
	...
	output("\n\n" + eldestKipNameCap + " watches with amusement at the way her next-oldest sibling rides your face like a mutt in heat. She idly strokes herself, keeping herself nice and hard and ready for when it’s her turn; her ears perk up with every little gasp and moan her younger sister makes whenever you hit something particularly sensitive. <i>“Feels good, doesn’t it?”</i> she asks, just loud enough for you to hear.");
	output("\n\n<i>“Yes!”</i> she shouts, then remembers herself and where she is. <i>“Y-Yes,”</i> she repeats, much quieter.");
	output("\n\n<i>“You should say it louder,”</i> " + eldestKipName + " continues. <i>“This is your </i>Qal<i> we’re talking about. The most virile, the most eligible mate in all the world, and it’s [pc.hisHer] tongue you’re fucking right now. I’m sure [pc.heShe] would love to hear you say how satisfied you are with [pc.himHer].”</i>");
	...
	output("\n\nYour second-oldest shakes her head, silently begging for her senior to not do it, but her pleas go ignored. <i>“Hey, my Qal,”</i> " + eldestKipName + " calls to you, <i>“do you enjoy eating out your kip?”</i>");
	...
	if (pc.hasCock()) output("our [pc.cock] swells once, and your load shoots from you, flying a small distance before colliding with " + eldestKipName + "’s ankles, bathing them in pearly cum. You thrust into nothing, and with each impious rock of your hips, you deposit another load at her feet submissively");
	...
	if (flags["FROSTWYRM_KIP_COUNT"] >= 5){
		output("\n\nOf course, a good Qal’s job is never done. Satiated, " + eldestKipName + " withdraws, her spent cock flopping from your mouth and in front of your nose. You give it a loving lick before she steps away – and she’s replaced by another of her sisters, looking for some relief herself.");
...
public function frostwyrmGoodGodImHurtAgain():void
{
	...
	output("\n\nYou give " + eldestKipName + " another, quick kiss on the nose, and tell her, and each of them, that you love them, too. Then, you lay your head down – it’s time to recuperate.");
...
public function frostwyrmItsMineAllMine():void
{
	...
	output("You’re cuddled warmly against [frostwyrm.name] and " + eldestKipName + " spooning up against you, both of them sharing your body heat, as you stare out to the village of Frostwyrmlings you and [frostwyrm.name] have created. It’s been many years since your firstborn, and not only do you feel as young as ever, and not only do you not intend to stop breeding with your Qim, but you feel as though your adventure as the Qal to your race of hybrids is only beginning.");
...
//used for text output of either "your eldest kip" or "Nykke"
public function frostwyrmGetEldestKipName(cap:Boolean = false):String
{
	var eldestKipName:String;
	...
	{
	  if (cap) eldestKipName = "Your eldest kip";
	  else eldestKipName = "your eldest kip";
	}
	return eldestKipName;
}