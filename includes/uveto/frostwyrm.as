...
public function frostwyrmWhyDoesMommyLookDifferent():void
{
	...
	output("You ask Nykke if she’s ever really wondered why her Qim and her Qal look so differently. [frostwyrm.name] is very large, and you’re... well, you’re not. [frostwyrm.name] has six limbs, and you only have four. There’s a lot of differences.");
	...
	if (pc.isLactating()){
		...
		output("\n\nNykke gasps in surprise at the sight, then a giddy grin crosses her face. This liquid, called ‘milk, ’ is what the young of your kind sustain on until they’re older for other, solid foods.");
		if (flags["FROSTWYRM_INCEST_OPTION"] == 0) output("\n\n<i>“May I have some?”</i> she asks. You reply that she’s... a little above being breastfed at her age, and you lower your [pc.nipple] away from her. She pouts, but respects your decision.");
			...
			output("\n\nNykke gulps down your [pc.milk] eagerly, humming in ascension as it washes over her tongue and fills her cheeks before swallowing. She uses her hands to gently massage your boob, using her psionic connection with you to learn the best way to handle you and how much pressure to apply. ");
	...
	if (flags["FROSTWYRM_INCEST_OPTION"] == 0) output("\n\nYou do so, leaning in to give her another quick peck on her lips. She sighs in delight when your [pc.lipsChaste] meet hers once more. <i>“Can you... can we do that again?”</i> she asks, but you stay firm and tell her that that’s enough for now. She pouts, but respects your decision as her Qal.");
		...
		output("\n\nAs soon as you open your mouth, it’s invaded by your Nykke’s tongue, eagerly licking and exploring your maw. You moan as her huge, flat, inhuman tongue draws along your cheeks and across the roof of your mouth; you taste her, and you purse your [pc.lips], suckling on her tongue and twisting your head just slightly. You press your tongue as flat against hers as you can, pushing against her, and she mimics your every action precisely.");
		output("\n\nWhen you finally pull away, your Nykke’s sparkling [baby.eyeColor] eyes look into yours: lustful, loving, and a bit impish. Her tongue snakes out of her mouth and licks at her lips exaggeratingly, wriggling just before you.");
...
public function frostwyrmShinyShit():void
{
	...
	output("\n\nNykke watches, enraptured. She’s totally taken in by the programming going on in front of her. <i>“What’s going on here?”</i> she asks you innocently, and you explain who Steph is and what her goal is – or, rather, what it’s <i>supposed</i> to be, but more often than not, it always devolves into... exactly what’s happening right now. Her audience tends to prefer it this way.");
	output("\n\nNykke probes your mind once again. <i>“You mean there are individuals that enjoy watching others mate for their entertainment?”</i> You answer that yes, that’s about the long and short of it. <i>“Wow.”</i>");
...
public function frostwyrmBlessedBeOurSmutlords():void
{
	...
	output("You ask Nykke what she thinks of the standards and traditions that are upheld here in [frostwyrm.name]’s lair. <i>“I don’t think I understand the question,”</i> she says, so you elaborate, one step at a time: what does she think about mating with you and [frostwyrm.name]?");
	...
	if (flags["FROSTWYRM_INCEST_OPTION"] == 0){
		...
		if (flags["FROSTWYRM_KIP_COUNT"] >= 2) output("\n\nUsing her psionics, Nykke reaches out to the rest of the clutch, exclaiming that, as far as their Qal’s society is concerned, they’re all married to [frostwyrm.name]! The exclamation is met almost entirely with confusion, but when she explains that it’s a good thing, they all cheer in delight. This is her life now, you guess.");
	}
	else{
		output(" <i>“Does that mean we’re married?”</i> Well – suddenly, you’ve gotten yourself in a bit of a situation. You want to tell her that, if you’re married to anyone in the lair, it would be [frostwyrm.name], but you just said that two married people only mate with their mates. So... in a sense, yes, you suppose, you’re married Nykke");
		if (flags["FROSTWYRM_KIP_COUNT"] >= 2) output(". To all your kips");
		if (silly) output(". You feel like you’re suddenly starring in a sitcom.");
		if (flags["FROSTWYRM_KIP_COUNT"] >= 2) output("\n\nUsing her psionics, Nykke reaches out to the rest of the clutch, exclaiming that, as far as their Qal’s society is concerned, they’re all married to you! The exclamation is met almost entirely with confusion, but when she explains that it’s a good thing and it means you’re only allowed to mate with [frostwyrm.name] and the clutch, they all cheer in delight. This is your life now, you guess.");
		...
		output("\n\nYou tell Nykke that there’s no rush - you two can enjoy each other the next time you involve yourselves in another celebration of inner circle coupling. Satisfied with your answer, she collapses back onto your side, cuddling platonically, and a little possessively, against you.");
	}
...
public function frostwyrmYesIDoChangeMyMind():void
{
	...
	if (flags["FROSTWYRM_INCEST_OPTION"] == 0){
		output("You tell Nykke that you’ve changed your mind: it feels inappropriate to be surrounded by Frostwyrms, in a Frostwyrm lair, and not be a part of their traditions. You’d like your family to include you in their future ‘inner circle couplings.’");
		...
		output("You tell Nykke that, as much as you enjoyed participating in the Frostwyrm tradition of ‘inner circle coupling’ up until this point, you think you need a bit of a break from it, and to not include you in the act for the time being.");
...
public function frostwyrmItsMineAllMine():void
{
	...
	output("You’re cuddled warmly against [frostwyrm.name] and Nykke spooning up against you, both of them sharing your body heat, as you stare out to the village of Frostwyrmlings you and [frostwyrm.name] have created. It’s been many years since your firstborn, and not only do you feel as young as ever, and not only do you not intend to stop breeding with your Qim, but you feel as though your adventure as the Qal to your race of hybrids is only beginning.");
