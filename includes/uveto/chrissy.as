 ...
 */
 ...
 public function approachChrissy():void
 {
	 ...
	 if (flags["CHRISSY_MET"] == undefined)
	 {
		 ...
		 output("\n\nLeaning forward onto the table just like she is, you start to explain how you're “friends” with one of the people who competed in that tournament she was in, causing the tanuki's eyes to widen a bit before you continue your story. You tell her of your own personal journey, all those trials that brought you all the way out to this frozen moon, your ship, ");
  ...
  public function playChrissy2():void
 {
	 ...
	 if (flags["CHRISSY_VIDYA"] == undefined) flags["CHRISSY_VIDYA"] = 0;
	 flags["CHRISSY_VIDYA"] += 1;
 ...
 public function buttFuckChrissy():void
 {
	 ...
	 output("\n\n<i>“S- sorry if I'm too noisey,”</i> Chrissy says shakily, your finger still lodged in her pucker, <i>“It's just- ah! I'm a little sensitive back there.”</i>");
	 ...
	 else output("Your [pc.cockBiggest] spasms inside your lover, leaking [pc.cum] into her depths until she whimpers, feeling your molten heat fill her. You paint her inner walls [pc.cumColour] as your climax continues, making Chrissy whimper and whine as she's utterly filled with your seed. ");
	 ...
	 if (flags["CHRISSY_ANAL"] == undefined) flags["CHRISSY_ANAL"] = 0;
	 flags["CHRISSY_ANAL"] += 1;
 ...
 public function vagFuckChrissy():void
 {
	 ...
	 if (flags["CHRISSY_VAG"] == undefined) flags["CHRISSY_VAG"] = 0;
	 flags["CHRISSY_VAG"] += 1;
 ...
 public function rideChrissy():void
 {
	 ...
	 if (flags["CHRISSY_RIDDEN"] == undefined) flags["CHRISSY_RIDDEN"] = 0;
 ...
 public function getFuckedChrissy():void
 {
	 ...
	 else if (pc.hasCock()) output("Your [pc.cocks] convulse" + (pc.cocks.length > 1 ? "s" : "") + " alongside Chrissy's, coating your [pc.chest] and cum-swollen tummy with a healthy amount of [pc.cumNoun].");
	 ...
	 if (flags["CHRISSY_GTFKD"] == undefined) flags["CHRISSY_GTFKD"] = 0;
	 flags["CHRISSY_GTFKD"] += 1;
