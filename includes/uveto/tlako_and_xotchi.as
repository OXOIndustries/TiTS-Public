...
public function tlakoMenu(arg:* = undefined):void
{
	...
	if(pc.credits >= 200) addButton(3,"W. Basket",buyAStupidSluttyWhaleCumBasket);
...
public function xotchiTzallMeeting():void
{
	...
	else
	{
		...
		output("\n\n<i>\"I'm so sorry,\"</i> she says with visible relief. <i>\"Sub-Madan Xotchi Tzall is unavailable for the rest of the day. She won't be able to meet with you.\"</i>");
		processTime(1);
	}
