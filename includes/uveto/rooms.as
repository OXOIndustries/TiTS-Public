...
public function initUvetoRoomsII():void
{
	...
	//rooms["KORGII F8"].runOnEnter = korgiD12Bonus;
	...
	*/
	...
	rooms["KORGII PLACEHOLDIE"].description = "";
	rooms["KORGII PLACEHOLDIE"].planet = "PLANET: UVETO VII";
	rooms["KORGII PLACEHOLDIE"].system = "SYSTEM: SIRETTA";
	rooms["KORGII PLACEHOLDIE"].moveMinutes = 2;
	rooms["KORGII PLACEHOLDIE"].northExit = "";
	rooms["KORGII PLACEHOLDIE"].eastExit = "";
	rooms["KORGII PLACEHOLDIE"].southExit = "";
	rooms["KORGII PLACEHOLDIE"].westExit = "";
	rooms["KORGII PLACEHOLDIE"].outExit = "";
	rooms["KORGII PLACEHOLDIE"].outText = "Down";
	rooms["KORGII PLACEHOLDIE"].inExit = "";
	rooms["KORGII PLACEHOLDIE"].inText = "Up";
	rooms["KORGII PLACEHOLDIE"].addFlag(GLOBAL.INDOOR);
	rooms["KORGII PLACEHOLDIE"].addFlag(GLOBAL.PUBLIC);
	//rooms["KORGII PLACEHOLDIE"].runOnEnter = korgiD12Bonus;
