...
public function enterThatPirateLord():void
{
	...
	output("\n\nGrinning, you use the [pc.cockHead] of your dick to lift up Amara’s balls before nestling it into the gulf of her quim, smearing her juices around the entrance. Taking it nice and slow, you keep on teasing the pirate lord’s pussy and clit ‘till she’s thrashing and moaning and leaking all over her thighs. Only then do you finally push forward, spearing the dread lord in one " + (pc.hasBalls() ? "[pc.ballsNounSimple]" : "[pc.knot]") + "-deep thrust. Her whole body arches off the bed, tits thrusting to the ceiling with a whorish moan held back by her drool-covered gag.");
