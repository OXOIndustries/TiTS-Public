...
public function wargiiRewardTTSqzrs3():void
{
	...
	if(pc.hasCock())
	{
		...
		output("\n\nYou three are a tangled mess of [pc.skinFurScales] and Korgonne fur; of mouths kissing and tongues swirling; of one cock thrusting between a pair of hot, warm mouths each looking for another hit of your delicious [pc.cumFlavor]; and another cock ");
		...
		output("\n\n<i>“Stay,”</i> she commands, bopping Tuuva’s nose, and, vulnerable to suggestion, she does. Nenne replaces her mouth with her paw, and her fingers close around your shaft, giving you a harsh tug – harder than is pleasurable, but not hard enough to be painful. Her eyes are on yours, with a mischievous glint in them, and you follow her unspoken command, shuffling your hips forward until they’re damn-near hanging off the side of the bed.");
		output("\n\n");
		showImage("9999Busteridoodah");
		output("With some more repositioning, Nenne hefts her right tit up and around the thick of your [pc.cock "
		...
		if(pc.cocks[x].cLength() <= 10)
		{
			output("your seed soaking into the valley of their mounds" + (pc.cumQ() >= 1000 ? " momentarily, caught and diluted by their fur, but your output won’t be denied, and soon, your seed bubbles, then spurts, into the air between the ladies, followed by another":"") + ". Your [pc.cum] drips down the underside of their tits, soaking down their bellies, before splattering onto their own union, lubing Tuuva’s exposed cock and dripping onto the floor from there");
			 ...
			 + x + "] throbs with every juicy gout, your length fighting to break free from the confines of the women’s fuzzy prison; Nenne’s eyes widen in delight at the sight of it, and she dips her head down to suck your own into her mouth and slurp and swallow the next few shots, whereas Tuuva is more focused on you and your expression");
		output(".");
	...
	else
	{
		...
		output("\n\nNenne, the more cognizant of the two Korgonne underneath you, muffles a moan through your quivering mons, and her own body goes stiff; inadvertently, Tuuva " + (!tuuva.hasCock(GLOBAL.TYPE_EQUINE) ? "knotted herself to the MILF, locking her nice and tight, wrapping her experienced body around her stiff cock so she can plant her own jizz as deeply as she can into that hot pocket of hers. Nenne shuffles and rocks beneath them, trying her best to eke out as much pleasure as possible, although, pinned beneath a [pc.race] and a horny, lust-drunk Korgonne, she doesn’t have the strength to move about much":"bottomed out inside the MILF, thrusting as deeply as she’s going to get into the motherly box. You can only imagine what that flare of hers is doing to Nenne, or how much cum she’s pumping into her; you imagine Nenne’s belly positively gravid with seed, just as you’re sure the depraved girl wants. You can feel Nenne try to move about, to try and get as much pleasure from that massive horse cock as she can, but between a [pc.race] and a lust-drunk Korgonne, and impaled as she is on a cock as thick as Tuuva’s, she’s not going anywhere") + ".");
