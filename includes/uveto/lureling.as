...
public function marionsDenSexMenu():void
{
	...
	addButton(0, "Fuck Vag", penisRouter,[marionsDenSexFuckMarion,marion.vaginalCapacity(),true,0], "Fuck Vag", "Stick your [pc.cockOrStrapon] in the essyra's pretty blue pussy and let her ride you.");
	addButton(1, "Mutual Masturbation", marionsDenSexMutualMasturbation, undefined, "Mutual Masturbation", "There’s no way you’re fitting inside her, but sharing is caring./Well, you’re a little bit cockless, but company always makes a good time better.");
	addButton(2, "Get Fucked", marionsDenSexGetFucked, undefined, "Get Fucked", "?????");
}
...
public function marionsDenSexFuckMarion(x:int):void
{
	...
	if (x >= 0) {
		...
		if (marion.hasCock()) output(" and thrusting her own "+ (marion.hasCocks() ? "members" : "member") +" against your belly");
		output(".");
	}
	...
	else if (pc.cocks[x].cLength() >= 28) output("so deep that you can see your cockhead straining her belly");
	else {
	...
	if (pc.hasKnot(x)) {
		...
		output(". The essyra only seems to grow desperate, trying to draw her cunt from your engorged base. You hurry your ministrations up until the fox is audibly squealing on you until finally your work has her wet enough to slip free, eyes rolling back for a brief moment. Now when she starts to bounce in your lap she’s able to land on your knot without taking it.");
	}
	else {
		...
		output(". The essyra whimpers and squeals in pleasure, bouncing in your lap until she’s almost too wet to cling to your " + pc.cockDescript(x) +".");
	}
	...
	if (pc.cocks[x].cLength() >= 28) output(working the head of your "+ pc.cockDescript(x) +" within her womb and straining the walls of her cunt to their limits");
	else if (pc.cocks[x].cLength() >= 6) || x == -1 output("momentarily kissing her depths before grinding against sensitive walls");
	...
	if (pc.hasCock()) output("cum-coated stomach and "+ (marion.hasCocks() ? "cocks" : "cock"));
	...
	output("\n\n");
	if (x >= 0 && pc.hasBalls(x)) output("Your balls feel thick and heavy, following the movement of your hips with audible slaps against the fox girl’s bouncing booty. Her tails wiggle beneath you, stroking them with fluffy tenderness entirely at odds with the sweating fuck-hungry body that otherwise bounces against your prick. It’s all the approval you need, and you practically drop your body onto hers, delighting in the "+ (pc.hasBreasts() ? "squish of her tits against your own" : "way her soft tits cushion your chest") +". Her mouth opens wide and she makes whimpering barks that you recognize as a request to kiss her. Once morfe your mouth lays into hers a moment before she wraps her legs around you until her feet cross around your [pc.ass]. Your [pc.balls] slap home one last time, and the floodgates break.");
	else if (x >= 0) output("There’s an almost painful tightening in your backdoor button in time with every thrust, swelling with "+ (silly ? "a need to seed (™)" : "need") +". Her tails wiggle beneath you and stroke the insides of your thighs with a fluffy tenderness entirely at odds with the sweating fuck-hungry body that otherwise bounces against your prick. Her wordless urgings are all you need and you practically drop your body onto hers, delighting in the "+ (pc.hasBreasts() ? "squish of her tits against your own" : "way her soft tits cushion your chest") +". Her mouth opens wide and she makes whimpering barks that you recognize as a request to kiss her. Once morfe your mouth lays into hers a moment before she wraps her legs around you until her feet cross around your [pc.ass]. There’s one last tightening in time with the peristaltic squeezing of her cunt before the floodgates break.");
	else output("The way your [pc.hardlight] is squeezed in the grip of the essyra’s perfect twat is enough to have your [pc.chest] heaving, and your legs to shake as your need to orgasm starts to insist itself upon you. It becomes harder to keep up a steady pace, and you come entirely to a halt when you’re pulled down onto her, delighting in the "+ (pc.hasBreasts() ? "squish of her tits against your own" : "way her soft tits cushion your chest") +". Her mouth opens wide and she makes whimpering barks that you recognize as a request to kiss her. Once more your mouth lays into hers a moment before she wraps her legs around you until her feet cross around your [pc.ass]. It’s a tougher position to fuck her from, but you fight your way through the task; failing to cum now would be such "+ (pc.isNice() ? "sweet" : "agonizing") +" torture. The term ‘floodgates' feels rather literal judging by how juicy your [pc.pussies] "+ (pc.hasVaginas() ? "feel" : "feels") +".");
	...
	output("\n\nThe "+ marionName() +" gasps around your lips, spasming loosely as her own orgasm comes to an end"+ (marion.hasCock() ? ", painting her abdomen (and yours) in watery aftershocks of her last load" : "") +". Her cunt sprays across the floor and the bases of her fluffy tails, and her toes curl up while she chews on her lip. At the same time the trembling of the cavern seems to come to a close "+ (flags["MET_LURELING"] == 2 ? "; it would seem the Lureling is quite done after your efforts" : "... was <i>she</i> the one causing it to happen? That’s a stunning coincidence otherwise") +".");
	...
	if (x >= 0 && pc.hasKnot(x)) {
		...
		if (pc.cumQ() >= 2000) output(", pressed up against her cum-inflated tummy.");
		else if (pc.cumQ() >= 500) output(" atop her squirming cum-stuffed body.");
		else output(" hugged by her yet-unfilled-twat.");
	}
	else if (x >= 0) {
		output("When you roll off of her the ");
		if (pc.cumQ() >= 2000) output("seemingly endless quantities of your cum pool from her well-used snatch.");
		else if (pc.cumQ() >= 500) output("tightness of her pussy seems to restore itself, trapping at least the majority of your orgasm.");
		output("essyra’s tight slit clenches and doesn’t let a single drop of your "+ (pc.cumQ() < 5 ? "admittedly limited" : "") +" load out.");
	}
...
/*
Mutual Masturbation
//{There’s no way you’re fitting inside her, but sharing is caring./Well, you’re a little bit cockless, but company always makes a good time better.}
//By Skow

{hascock:It looks like if you tried to cram your mammoth [pc.cocktype] into this bubblegum cutie you’d probably break her./nocock:Sadly without a prick to fuck her with you’re a bit out of luck.} Still, it wouldn’t do to leave this lady wanting. Considering the heat coursing through your loins a simple “oh well then” isn’t going to cut it. Luckily the "+ marionName() +" seems to have a pretty good idea of what to do next.

She guides you back towards the fire and nudges you towards a comfortable set of furs before the loss of her body-heat can afford time to give you chill, and you settle your {[pc.rear]/tauric body} down before watching eagerly as the foxy minx makes her move. Her tails shift like a dancer’s veil, revealing and obscuring her nude form in equal measure as she settles to her knees. Her ass looks more heart-shaped than ever when she rolls onto all-fours and presents herself... for a moment you’re worried that she expects you to {fuck her without a cock/break her with your ogre-length member}, but she drops down onto her cushiony tits and sinks her face into a fluffy animal rug before sneaking a dainty finger up to her slit. Catching on, you position yourself a little better so that she can see you past her shoulder as you begin to please yourself in tandem.

Her moans and coos are sweet little sounds, and she wiggles her bum from side-to-side while questing digits hunt out the cute little nub of her clit. Increasing slickness wets the insides of soft thighs and a gentle aroma wafts in your direction each time her tails swish enticingly. The pounding of your chest heralds a fresh twitch from your {"+ pc.cockDescript(x) +"/[pc.pussy]} until {pre/juices} drip to the soft fur beneath you. She purrs at the sight and spreads her pussy wide with two fingers while her middle diddles her clit teasingly, showing off her cunt’s winking depths like a lurid come-hither kiss straight to the womb.

*/
...
/*
Get Fucked
//Requires Essyra to have cock(s)
//Note: I’m just gonna refer to the three cock options as “tenta/ tentas /dog” inside {variable} stuff or I’ma go insane.
//By Skow

Considering this bubblegum-fox beauty is rather avidly waving around her [essyra.cocks] it would be rude not to {drop to your hands and knees/cast your tauric mass to the ground} and polish {that dick/those dicks} before introducing her to your {[pc.vag]/[pc.asshole]}. She wordlessly tracks the direction your eyes drift towards before bouncing on the spot, setting her quaking tits to jiggling ferociously in time with the bobbing of her dong{s}.

It would seem she’s down with the prospect too.

Running your [pc.fingers] {across your bald head/through your [pc.hair]}, you settle yourself down before her, kneeling in the lush carpet while the essyra has herself a luxurious stretch. Her prick{s} twitch{es} in time with a couple of happy wordless squeaks as she works some unseen tension out of her squishable frame. Apparently that was all the preparation she needs, as she places her hands on your head{ and fondly scratches your [pc.ears] before /, }drawing your [pc.lips] in range of her member{s}.

You give {one of }her tip{s} a testing lick, sampling the pre that beads from its cumslit. The moment you’re graced with a mixture of sweet and salty it seems to send a sympathetic heat coursing into your loins. The essyra coos, grinding the teased head against your lips in a silent request for entry. You open wide and unfurl your {seemingly-endless }tongue, providing a landing strip that she takes immediate advantage of. {tenta:It’s a girthy beast of a tentacle, and as she pushes it past the barrier of your [pc.lips] you realize that exterior is actually a sheathe. You swallow on her loudly and reach up, helping to roll back the flexible, sensitive flesh until the near-foot pointed tenta-prick is fully unveiled./tentas:She’s got so many more cocks than you’re prepared to swallow at once, so you quickly spit into your palms to give a few more of those members somewhere to go. She squeals happily at your sexually-inclusive antics and two of them immediately slip into your grasp, even as she devotes the remainder to your gullet./dog:Her knotty prick all but slams its way into your mouth in two short humps, pressing into your throat while her meaty nuts bounces off of your chin. Smiling against her cock you reach up and give her balls a nice slow rub, feeling them churn in approval.}

By the time her {knot is/knots are/crotch is} bumping into your nose the pink fox-slut’s practically drooling... and to be fair her cock{s} {*is* /*are*} drooling. She withdraws her length{s} with a shudder that tracks from top-to-tails, revealing plenty of spit-slick sex organ ready for action. Honestly it’s rather surprising; she looks like she’s about ready to facefuck you to orgasm, but instead she waits patiently. It takes a couple of heartbeats to realize she’s far more interested in penetrating {a }different aspect{s} of your biology. It’s kind of a shame considering she’s actually delicious and you’ve not gotten a chance to show off your [pc.tongue] to its best.

Still, it wouldn’t do to let her down. Just a brief interlude of cock-sucking has you feeling {moist as all fucking hell/hellishly hot under the collar} at odds with icy cave’s walls. You’re urged on with happy little throat-noises from the essyra when you turn yourself around and {sink your upper body in the fur to display the full extent of your [pc.taurbody]/prop yourself up with your hands to wiggle your [pc.butt] at her}.

//Pc is taur
    When the bubblegum fox leaps onto your flanks and starts trying to line herself up with your {cunt/ring} you’re suddenly inclined to think of some kind of animalistic mounting frenzy. She may have to stretch quite hard to reach the rest of your body but she manages to get a decent grip on you, and the heat of her flesh sinks into you even as more heat radiates off of her {glans/many tentacular cocks} until your {pussy lips are feeling flushed and dewy/asshole is winking invitingly}.
//Else
    Her weight drops onto you with surprising speed now that she’s properly ready, and her hips keep waving as she attempts to get herself lined up with your {cunt/ring}. The waving of her tails is almost canid, and the weight of them is throwing her hips a little off target even as they occasionally curl up and tickle your thighs. Heat radiates from her cock{s} in a way that has your {pussy moistening ever-further and parting/asshole winking invitingly} at {its/their} closeness.
