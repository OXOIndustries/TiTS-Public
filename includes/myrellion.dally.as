...
public function talkMilkAnAntGuy():void
{
	...
	output("\n\nThe harder (and larger) he gets, the more your tail has to stimulate. The hollow parasite undulates around its prey, slowly inching down to devour more and more. If you didn’t know better, you’d think it attached to you backwards and that the snake half was trying to eat him starting with his cock.");
