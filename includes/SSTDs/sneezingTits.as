	...
	if (target is PlayerCharacter)
	{
		switch(sneezes)
		{
			case 1:
				...
				else if (newBoobRating < 25) msg += "Your " + breasts + " have grown, and your chest is large enough to draw notice. You’re not in ultraporn-star territory, but your new growth has pushed you past what’s considered average to most people. <b>You are now " + indefiniteArticle(target.breastCup(biggestTitRow)) + ".</b>";
