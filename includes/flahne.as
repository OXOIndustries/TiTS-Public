...
function meetingFlahne():void {
	this.userInterface.showBust(GLOBAL.FLAHNE);
	...
	if(flags["MET_FLAHNE"] == undefined) {
		...
		output("\n\nYou nod and produce your codex, busily filling out forms as Flahne makes small talk. Seeing the odd looks you give her, she explains that she is a rahn, specifically a loo’rahn, as determined by her coloration. Numerous interruptions dot the conversation as she produces stick after stick of candy, sucking long and hard on it and then resuming her instructions as if she had never paused at all. Flahne apparently has a monstrous sweet tooth.");
...
function bendFlahneOver():void {
	...
	output(" You sink into Flahne's yielding flesh, and she gives a little gasp as your hands disappear into her butt, pulling her so close to you that your [pc.eachCock] is prodding her belly through her clothes.");
	...
	output("grab the curvy rahne under her arms instead, pulling her off your " + pc.cockDescript(x) + " and pushing her back against her desk. She gives a surprised yelp as you turn her around, bending her over until her ass is on full display, two huge mounds of butt tilting up at you with her wide and ready cunt poking out between them, just begging for dick. But not yet...");
	...
	output(" Her body's quick to engulf the offering, never letting a drop escape her slick depths.");
...
function flahneMunchesBoxesMetalBawkses():void {
	...
	//Merge, no new PG.
	output(" Your hands drift away from your [pc.fullChest] towards her shoulders, and you squeeze them encouragingly. Flahne gives you a knowing look and circles one arm around you to hold you still. With the other, she reaches up to your [nipple], ");
