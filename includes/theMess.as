...
function orderFoodFromTheMess():void
{
	...
	output("\n\nFor fuck's sake. You spend a few minutes looking through the menu, find the closest thing to terran food you can see, and grab a different waiter walking buy to place your order when it's clear the first isn't coming back today. He nods, scribbling it down before bolting off to another table, utterly ignoring the clamoring family of raskvel around you.");
...
function sitOnDelilahsFace():void
{
	...
	output(". You step forward, tossing your [pc.gear] onto the bar and hopping up behind the effeminate bartender, giving her a little push onto her back. She gives a little gasp as she flops down, legs spreading reflexively, giving you easy access to the tight, dark hole between them. But that's just an added bonus to you.");
