...
function daneOmniExplanation():void {
	...
	output("\n\nShrugging, [rival.name] resumes [rival.eir] walk away. <i>\"If you say so. Just don't don't take too long. I'm not waiting to leave just because you've tied yourself deep in " + pc.mfn("his","her","its") + " ass.\"</i> [rival.Ey] vanishes with a bemused laugh.");
