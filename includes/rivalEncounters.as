...
function fightYerRivalOnMhenga():void {
	...
	output("\n\nYou draw your [pc.rangedWeapon], resolute.");
...
function daneOmniExplanation():void {
	...
	output("\n\nShrugging, [rival.name] resumes [rival.eir] walk away. <i>\"If you say so. Just don't don't take too long. I'm not waiting to leave just because you've tied yourself deep in " + pc.mfn("his","her","its") + " ass.\"</i> He vanishes with a bemused laugh.");
...
function loseToDane():void {
	...
	if(pc.HP() <= 0) 
	{
		output("You slump down, unable to fight anymore. Dane laughs, <i>\"Well, that wasn't too hard. You crumpled like a house of cards.\"</i> He holsters his weapons so that he can scratch his chin with one hand. <i>\"I guess the boss must not be very tough " + chars["RIVAL"].mf("him","her") + "self he didn't feel like dealing with you.\"</i> The ausar thug laughs, a rumbling baritone thing that you can feel in your bones. <i>\"There's no point in wasting time then; he'll be back shortly.\"</i>");
	}
	//Lust
	else
	{
