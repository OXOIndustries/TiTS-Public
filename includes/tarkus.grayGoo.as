...
public function grayGooRestrain():void
{
	...
	else
	{
		...
		{
			output("The goo-girl wraps herself around you, pinning your [pc.legs] together before slithering around and burying her face in your [pc.butt], motorboating your ass-cheeks as her gooey limbs try to peel off your [pc.gear]");
		}
		pc.lustDamage(10+rand(6));
	}
	processCombat();
...
public function multiCockMayhem():void
{
	...
	output("\n\nWell, what's the harm? You swing around and lower yourself onto the prostrate goo's level, shuddering a bit as one of your cocks touches her shimmering surface, slipped easily into the gulf between her tits, pressing into the open gash between them. Her soft, wet fingers wrap around your [pc.legs] as you settle in, spreading them wide as a long, languidly moving tongue slithered out from her mouth and straight up into your undercarriage.");
	output("\n\n");
...
public function divideAndConquerGinasWithGoos():void
{
	...
	output("\n\nWhat must be an hour passes like that. The first goo sister holds you tenderly as her sister fucks your ass again until you cum once more, then switching to your pussy, joining her sister's cock to stretching until you're screaming into your bed of boob-flesh. A third and fourth orgasm are wrung out of you, your pussy-fluids drooling into the waiting pool of goo between your [pc.legs], swallowed eagerly by the cyber-babes between fuckings.");
...
public function pcDefeatByGooBitch():void
{
	...
	else output("flows across your bare skin");
	...
	else if(pc.hasVagina()) output(" And she's not the only one who's wet! You let a hand slip back to [pc.oneVagina], fingers digging into the hot box between your [pc.legs], desperate for a little relief. Sensing your rising tension, the goo giggles, <i>\"Don't worry, babe, I've got something nice and hard for that slutty little hole of yours!\"</i>");
	...
	output("\n\nA few more paces brings you around a nearby pile of junk and right into the waiting wrench of a diminutive brown raskvel girl. Seeing what's coming for her, though, she gives a terrified yelp and drops her wrench, trying to escape. You and your gooey captor are much too fast for the little thing, though, and in a flash she's been barreled to the ground, pinned beneath your [pc.legs] as your massive prick slaps down onto her belly, half as large as she is!");
...
public function bodySuitedKirbuDefeat():void
{
	...
	else if(pc.biggestTitSize() <= 3) output("<i>“These mosquito bites could use some work,”</i> she chides. Regardless, its plain to see how much she enjoys your little mounds by her fondling.");
...
public function gooGooEnvelopsCunts():void
{
	...
	output("to be quivering and dripping in anticipation to you. Whether or not its spurred on by your jiggling friend, you have no clue. What you do know is that there’s a electric anticipation teasing [pc.eachVagina] to no end, making your mind beg for some closure.");
	...
	output("\n\nYour joy buzzer is deep in the middle of some oral assault. Your eyes only see it wiggling and wobbling to some unseen force, but the sensation is spot-on sucking, licking and even a little nipping. The gooey storyteller is losing her words, but she fights on. It’s too soon for her to drop the act.");
