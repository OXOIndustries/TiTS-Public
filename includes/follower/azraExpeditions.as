...
output("\n\nThat sounds like a terrible plan, but there aren’t many other options. How do you want to play this? You could try to distract him with conversation, attack him, {offer to feed him your delightful off-world seed, }or try to lead him into the jungle on a wild zil chase.");
output("\n\n[Talk] [Attack] [Feed] [Jungle]");

output("\n\n//All choices intro:");
output("\n\nYou nod to Azra and circle closer to the village, distancing yourself to give her some cover before you emerge. Dessicated flowers crackle under your [pc.feet] as you close in, and the infested zil sultrily spins about. He’s handsome, for a zil, his armor plates fully retracted to expose as much of his svelte form as possible.");
...
output("\n\n//Feed - reqs penor");
output("\n\n<i>“But I have so much to feed you.”</i>{ You thrust your hips at him./ You pull your [pc.crotchCovers] open.} <i>“The way I see it, you could use all the dick you can get.”</i>");
output("\n\n//1 penor fail:");
...
output("\n\nYou drop to your knees as you are bid. There’s no hint of deception in the zil’s expression, only lust. Stroking your [pc.cocks] slowly, you tease the poor guy, caressing one hard dick-tip, then another{, and so on}, feeding him one enticing visual after another.");
...
output("\n\n{You lick your [pc.lips]. His sweet-smelling dick is right in front of your nose. How could you <i>not</i> suck it? He gasps in that delightful way that boys do when you seal your mouth around his manhood, but he doesn’t protest. They never do, especially not when you’re slipping your tongue out to lovingly cradle their balls. Mmm... balls./ His sweet-smelling dick is right in front of your face, practically swimming in weaponized pheromones. If you thought you were hard before, you were wrong. Your [pc.cocks] are iron bars, heaving powerfully with each breath of the zil’s powerful aroma. Whatever your thoughts on dicks, you find yourself quite liking this one. You rub your cheek against it, sniffing deep into his crotch. The super-concentrated pheromones leave you dizzy and whimpering.}");
output("\n\nIt comes as a small surprise when a tight tunnel of warm, wet tailcunt envelops your [pc.cock]. Not enough to stop you{ from bobbing back and forth on his yummy honey-cock, of course. You just moan into the dick, letting your ecstatic vibrations help him along on his journey to a thick, creamy orgasm./ from nuzzling into his crotch, though you do let out a brazen moan.} You tip your head back as a second coils around your [pc.cock <i>“ + 1 + <i>“].{ A third slithers over your [pc.cock <i>“ + 2 + <i>“].}{ You lose count not soon after, aware that succulent folds are sliding over your [pc.cocks] but unable to identify any particular sensation as the arrival out of the all-consuming pleasure.} They pound back and forth on your manhoods with zero coordination. Each of the snakes has its own rhythm, listening to nothing but its individual desire to swallow your jizz. Inside, their flesh undulates in incredible waves, rolling from the bases of your tail-bound phalli to their throbbing tips, milking you as only a creature that evolved to harvest seed possibly could.");
output("\n\nYou try to hold out as long as possible, but there’s no chance. Not with your nose full of the zil’s scintillatingly erotic scent and dicks pumping your [pc.cocks] with near-mechanical efficiency. Dribbles of girlish goo{ roll down your [pc.sack]/ trickle down your thighs} from the frenzied snake-sucking. Your [pc.cocks] do what they were meant to do: throb and ache. Cumming is inevitable. They flex, drooling pre, and the urge to dump a huge load of [pc.cumNoun] into the slithering succubi manifests in one penultimate spasm.");
output("\n\n//Less than ‘uge");
...
output("\n\n//Ech");
output("\n\nYou’re too spent to care when the infested zil has an orgasm of his own, painting your cheek in amber honey. You blink your eyes closed before his neck rope splashes across your nose and forehead. He finishes himself off by dumping a thick wad of the stuff {into your [pc.hair]/on your head}, a satisfied smile on his face. He pumps his foreskin along his length as his orgasm winds down. Some of  the seed collects inside, only to be devoured moments later when a snake throws itself onto his leaking dong.");
output("\n\n//Merge");
output("\n\n[next]");
output("\n\n<i>“Not bad,”</i> the infested zil pants as he attempts to master himself. <i>“Perhaps you could be of use. My pets could use a plentiful food source for their children... and you fit the bill perf-”</i>");
...
output("\n\n<i>“Uh....”</i> You rack your brain for something to say. <i>“Well... uh... Huh. I really should have thought about this in advance.{ You’re sexy, though!}”</i>");
...
output("\n\nYou’ll have to fight!");
output("\n\n//Success!");
output("\n\n<i>“I had to get a closer look at you. I’ve never seen anyone quite like you before.”</i> You gesture at him, waving your hand at his tails. <i>“What you have done with those snakes... it’s incredible. How did you get so many? I thought they limited themselves to one to a host?”</i>");
...
output("\n\n//Shock");
output("\n\nThe infested zil fires his stun-gun at you, releasing an arc of blinding blue electricity!{");
output("\n\n//Miss");
output("\n\nHe misses!");
...
output("\n\n//Salve, 1x");
output("\n\nThe snake-infested zil produces a salve from a pouch on his hip and smears it across his injured carapace. The greasy substance leaves smooth, unblemished chitin in its wake, but he’s apparently used it all. - and an empty pouch the zil discards. <b>He won’t be healing again.</b>");

output("\n\nLose to Snaek Bad End");
output("\n\nYou collapse{ in a heap of writhing, unsatisfied need/ under the weight of your injuries}.");
...
output("\n\n[next]");
output("\n\nOverwhelming sweetness greets your return to wakefulness - that and the remnants of a nasty headache. More pressingly, you are aroused. Achingly, monstrously aroused, though you lack any understanding as to <i>why</i>. Gasping on your way to full wakefulness, you suck in a lungful so impregnated with rampant honey musk that it makes you cough.{ Your [pc.cocks] trembles{s} in response./A {trickle/stream/gush} of girlish excitement leaks out from the scent alone.} You moan and reach for your loins{, finding them to be quite bare/, discovering your body to be completely bare}.");
...
output("\n\n//Any genitals");
output("\n\nFamiliar wetness splashes on your [pc.legs] in the aftermath of the first of what is sure to be many orgasms.{ You came so hard you squirted, and still you keep sucking.} Any relief it provides is short lived. In your next breath, you slide right back into the grip of desperate lust. Your eyes cross from the overwhelming potency of zilmusk, and your cum-filled mouth sags open, allowing the satisfied male to exit.");
...
output("\n\n//Merge");
output("\n\nThe zil on your left cums, and you cum right along with him. His sweet spooge splatters across your naked body. You smear it across your [pc.skinFurScales] in ecstasy. Looking at yourself in the dim light, you look like a glittering golden god{dess}, an image that solidifies itself when more cum spills onto you from the right. Excess honeyspunk slides between your knuckles, the better to rub onto your other side.");
output("\n\n<i>“Good pet,”</i> the nameless, nine-tailed zil coos as he too goes off, pulling himself out of your mouth so that he can be the one to paint your face, anointing you with waves of amber ambrosia. He does you the favor of smearing his musky tool over your features, spreading his seed into every crease and pore.{ Your [pc.hair] slicks back under its weight.} A mask of golden cum slowly hardens on your face as he withdraws, and it makes the pounding you’re taking from behind so much hotter.");
output("\n\nYou pant like a dog in heat.{ For that matter you <b>are in heat</b>/ For that matter, you sink deeper into your heat. You aren’t sure if you’ll ever find your way out, no matter how much dick you take.} You want to get fucked, and suck, more than anything. Dicks in your mouth, cum in your hair. You want to get up in the morning smelling like half the tribe’s crotches and screw until you smell like the other half’s.");
...
output("\n\n[Next]");
output("\n\nWhen you regain consciousness, you’re somewhere else. Your belly is bloated from all the honey you swallowed, and your tail is swollen and leaking, so fattened that you can only imagine how many eggs are stuffed inside it. With that thought comes a sense of pride, and idle lust.");
...
output("\n\nAs the infested zil {sinks to the ground, overwhelmed by the passionate impulses you’ve stirred within him/drops to the ground, too well and truly beaten to remain upright}, Azra trots up, satchel of samples in hand. <i>“Let’s get out of here before any more show up.”</i>");
output("\n\nShe’s right{, much as it pains you to admit it. You’ll have to put your needs on hold till after you get back to safety}. The entire village could descend upon you in an angry swarm at any time, and that fight was far from silent.");
output("\n\n<i>“All right, let’s go.”</i>");
output("\n\n[Next] - ZIL FEEDING EPILOGUE JOINS HERE.");
output("\n\nTogether, you and Azra beat a hasty retreat through the jungle. Most of the natives seem hesitant to tangle with a pair, and the few that do rise to the challenge are left in the dust. As for the tribe, {you see neither chitin nor hair of the aggressive zil. Either they didn’t care to pursue you or haven’t noticed./you doubt anyone will know to look for you for a few hours yet.}");
output("\n\nWhen the clearing surrounding Esbeth comes into view, you both gasp sighs of relief, silently thankful to be under the watchful gaze of {Penny’s auto turrets/Esbeth’s automated turrets. Whoever put those up is a saint}.");
...
output("\n\n[Next]");
output("\n\nAzra unpacks efficiently. Her bag of supplies is dropped into an empty corner. The sample pouch is placed into a vacant spot on her desk perfectly shaped to accept it. You get the impression that she’s spent more than a little time organizing her room to make the most of every meter. She sighs contently once her things are stored and turns to face you, smiling beatifically. <i>“{You were magnificent. I never could’ve done this without you./It means a lot to me that you were willing to do... that for my research. I couldn’t have.”</i> Her eyes flit to your well-used crotch as her cheeks color. <i>“I’d be too embarrassed.}”</i>");
output("\n\nSavoring the compliment, you reply, <i>“{Ooooh, you’re just too cute! Like, isn’t exploring sexy jungles what I’m supposed to be doing anyway? Did you see the dicks on those naleen? Wow. If we get to meet guys like that on every trip, I am sold, sister!/No problem. I get to try those flowers out, right?/It was my pleasure. Somebody has to watch out for the little guys.”</i> You look back at the nine-foot tall giant of a scientist. <i>“And the not-so-little girls./I’m only a part-time rusher. The rest of the time I’m a certified badass, adventure hero, and {handsome/talented} escort to beautiful science-maidens. It’s basically my job to help you out./You’d be surprised what you can do, but don’t sweat it. Having fuckable flowers onboard is sure to be a treat.}”</i>");
...
output("\n\n//Resist:");
output("\n\nYou break away before things can get any more heated. <i>“Whoah, whoah! I didn’t intend... I didn’t want this.”</i>");
output("\n\nAzra’s arms go limp, dropping you{ to the floor}. <i>“Of course. How foolish of me.”</i> She looks away. <i>“It was nothing anyway. I was just a little too excited over our success. Give me some time to make sure the samples are in good shape for transport, and you’re welcome to inspect them yourself.”</i>");
...
output("\n\nYou kiss her once more, with enthusiasm{, grinding your exposed member{s} against her armor/, grinding your well-moistened loins against her armor}, then step back, face flushed red enough to match her own.");
output("\n\n<i>“Wow.”</i> Azra smoothes her tousled hair. <i>“I liked that. I liked that a lot, but... ummm...”</i> She giggles. <i>“Wow. You must have a lot of practice at that.”</i> The suula coughs and tries to master her surging hormones long enough to properly express her feelings. <i>“But we can’t just start fucking like animals in here{, even if you’ve got enough fur to be counted among the animal kingdom}. For one, I’m not that kind of girl. Secondly, these samples need proper care and nutrition to keep them from dying. I won’t risk extinction for a fling, no matter how pleasant.”</i>");
output("\n\nThat sounds perfectly reasonable no matter how your base impulses disagree.");
output("\n\n<i>“Finally, neither of us will accomplish anything if our faces are glued together for the entire rush, so I propose a more measured solution,”</i> Azra calms, back on familiar ground. Sadly, the cute blush she was wearing for so long has faded like a passing sunset. <i>“We continue to work together for the duration of the rush. Celebratory kisses are fine, but idle salaciousness is a waste of time.”</i>");
...
output("\n\nYou {jump up to }grab her by the neck and forcefully kiss her once more, though only for a few seconds this time.");
...
output("\n\n//Disabled for 1 hour.");
output("\n\n//Disabled crew button <i>“Azra is busy giving your latest samples a more permanent home on the ship, lest the rare flora die out.”</i>");

output("\n\nAzra fight texts:");
output("\n\n//Desc:");
output("\n\nAzra stands by your side, garbed in a suit of heavy armor that makes the otherwise unarmed siren seem even more imposing than her nine foot stature alone. Still, she moves with grace and purpose, and her armored fists could pack quite a wallop.{ She’d be far more imposing if it wasn’t for the fact that her 20”</i> dick and soft-ball sized balls are swinging in the open, doing their best to dribble pre everywhere she goes.}");
...
output("\n\n<i>“Hiya!”</i> Azra snaps her leg nearly eight feet into the air and drops it on [target.possessiveCombatName] head.”</i>");
output("\n\n//+10 kinetic damage + stun chance!");
output("\n\n//Miss:");
output("\n\n<i>“Hiya!”</i> Azra cries, snapping her foot into the air before bringing it down. {Standard miss message!}");

output("\n\nConsecutive normal punches");
output("\n\n<i>“Stay back!”</i> Azra cries, lashing out with her fists in rapid succession.");
output("\n\n{3x flurry paunch}");

output("\n\n//Uppercut (only on foes 6’ or taller)");
output("\n\nAzra slides by you, springing up under [target.combatName] to bring her fist into [target.hisHer] chin.");
output("\n\n//Normal dodgetext");
output("\n\n//Hit for 1.5x damage and applies Sunder :3");
output("\n\nThe blow makes an audible crack as it connects!");

output("\n\n//Normal Punch");
output("\n\n<i>“I hope that one semester learning karate paid off!”</i> Azra hesitantly takes a swing at [target.name].");

output("\n\n//Collapsing Star - must be in non-indoor room and Azra level 4+");
output("\n\nAzra soars into the air on angelic wings. A moment later, you hear the sound of rushing wind as she barrels toward the ground, armored-heels first.");
output("\n\n//Miss");
output("\n\n[target.combatName] slips aside, leaving Azra to slam into the ground hard enough to kick up a cloud of dust. She looks pissed.");
output("\n\n//Hit");
output("\n\n[target.combatName] takes one foot square in the face and the other on the chest as [target.heShe] is crushed beneath Azra’s gravity-accelerated weight. Ouch!");
output("\n\n(4x damage)");

output("\n\n//Wingkick - Level 3+ Azra");
output("\n\nAzra hops into the air and flaps her wings hard, setting herself spinning like a top. She lashes out with her heel as she closes on [target.combatName]!");
output("\n\n//Normal damage.");
output("\n\n//Trip chance:");
output("\n\nThe impact sends [target.himHer] sprawling on the ground.");

output("\n\n//Dust storm");
output("\n\nAzra beats her wings until a gusting gale-force wind is blowing through the battle, hurling bits of dust and detritus into the eyes of your enem{y/ies}!");
output("\n\n[target.combatName] is blinded!");
output("\n\n[target.combatName] closes [target.hisHer] eyes in time to avoid being blinded!");

output("\n\n//Tail whip");
output("\n\n<i>“Back off!”</i> Azra shouts. She spins herself around, tail outstretched. Her posterior protuberance {misses [target.combatName] by a mile, unfortunately. The siren wobbles, blushing at her failure. <i>“Sorry!”</i>/slams into [target.combatName]! <i>“Take that!”</i>}");
output("\n\n//Chance of staggered.");

output("\n\n//Sharklust - At 60+ lust - 1x per combat");
output("\n\n<i>“Oh... oh snap!”</i> Azra cries, pawing at her crotch plate. Her face curls up in pain for a moment, then her scrabbling fingers release the groin-guard, allowing a tremendously erect siren-cock to spill free of the constricting garment. The air fills with her long-denied musky scent, though she fans most of it toward [target.combatName] with her wings. <i>“This is your fault! Is this what you wanted?”</i> The tendrils that wring her member squirm excitedly. <i>“Well how do you like it?!”</i>");
output("\n\n<i>“AZRA_SEX_KNOWN”</i> = 1;");

output("\n\n//Cock grapple");
output("\n\nAzra tries to grab [target.combatName]!");
output("\n\n[target.HeShe] squirms out of her impressive reach.");
output("\n\n[target.HeShe] can’t escape, not even as she presses [target.hisHer] face against her turgid, alien cock, smearing her potent musk over every inch of him.{ [pc.HeShe] stumbles free, dazed{ and aroused/ though not very aroused}./ [target.HeShe] sags to the ground, overwhelmed by the weight of [pc.hisHer] own arousal.}");

output("\n\n//Cunny tease");
output("\n\nAzra bends over, presenting her unguarded cunt to [target.combatName]. <i>“Like what you see?”</i> She digs her fingers into it and spreads her lips wide, fanning sweet smelling pussy-musk directly at [target.himHer]. Under her breath she mumbles, <i>“Pervert.”</i>");

output("\n\n//Embarassment");
output("\n\n<i>“Oh, this is too much!”</i> Azra tries to cover up her dick with her hands, but it does nothing to conceal her balls or the wanton scents pouring off of her. <i>“Captain [pc.name]! Help!”</i>");

output("\n\n//Aphro!");
output("\n\n<i>“F-f-fuck you!”</i> Azra pulls a vial out of her collection kit and tosses it at [target.combatName]. It shatters into a million pieces, releasing a cloud of pink mist. <i>“Let’s see how you like being too fucking turned on to think!”</i> She jerks her other hand away from your crotch. <i>“Jerk.”</i>");
output("\n\n//As the PC affecting Aphro Gas attack.");

output("\n\nAzra’s Samples~!");
output("\n\n//Plant Samples:");
output("\n\nYou let Azra know that you’d like to take a look at some of her samples.");
output("\n\n//Kissy Azra:");
...
output("\n\nIt’s enough to make your [pc.legs] quake, and you slowly slide to the ground.  The flower, now a tightly-sealed bulb, sucks hard enough to stay latched onto you as you recline.  It bends the stem double, but the resilient plant seems to handle the strain with ease.  Rivulets of clear slime escape from the tight seal to run down your {[pc.balls]/[pc.legs]} and form a sticky puddle.  Now moaning, you grab the stem and start to pump the sheath up and down, using the plant like the cock-toy it was bred to be.  Lewd, wet squishes ring out through the air,{ and you timidly look around, hoping the sounds don’t carry through the door./ and you worriedly glance around, hoping yet terrified that Azra will walk in on you at your most depraved./ and you glance around, hoping Azra will walk in on the sexy show you’re making.}");
output("\n\nNow panting with unbearable lust and undeniable levels of pleasure, you give up all sense of propriety and resort to fucking wildly, [hips] jumping inches off into the air.  The flower’s interior is a slick, silky heaven for your [pc.cock <i>“ + x + <i>“], a sucking, squeezing hole of seemingly infinite pleasure.  Inside its gluttonous gullet, the numerous tentacles twist around, the longest ones circling the base of your shaft{ inside your violated sheath}.  With so much blood trapped in your [pc.cock <i>“ + x + <i>“], it’s bigger and harder than ever, twitching valiantly against its restraints with every beat of your heart.");
output("\n\nOne of the tentacles circles your [pc.cockHead <i>“ + x + <i>“] for a moment, and without much warning or pause, it lances forward to bury itself into your vulnerable cum-slit.  Your preconceptions are turned on their head when there’s a complete lack of pain from the abrupt penetration.  If anything, it actually feels kind of good... like there’s a warm, slippery finger caressing your penis from the inside out.  It slithers in and out of you, pumping you inside, burrowing pleasure into your center even while stroking you from without.  Your body, burning from the exertion of fucking the flower’s pod and the constantly-rising tidal wave of lust, begins to twitch spasmodically,");
output("\n\nThe internal suction spikes as your dick bloats larger, and with a roar of bestial pleasure, you arch your back, hands pushing your [pc.cock <i>“ + x + <i>“] as deep into the plant’s gullet as possible.  {Your [pc.balls] gurgle, a surprisingly happy sound, and cling tight to your loins.}  Inside you, you can feel the liquid heat of your spurting release exploding out, melting everything before it with liquid, orgasmic bliss.  A low moan bursts from your lips when the sounding tentacle pulls out of your sloppy cock-slot, and the rushing tide of bubbling cum follows it, bursting into the sweet, suckling nectar-pot.{  You pour forth your prodigious essence without pause or fail, and the plant immediately begins to drink it down, the stem bulging with rounded balls of sperm that it carries into its root system.{  Soon, the meager stem cannot swallow it all.  Spunk froths and squirts out around the base of your tool for a moment, and then a veritable tide of the stuff gushes out to soak you and Azra’s floor. Whoops.}}");
...
output("\n\nDriven mercilessly by the sudden onslaught of sensation, you flop back onto the ground, but the flower comes with you, latched onto your [pc.hips] with no sign of releasing.  The swirling tentacles twist around inside you in a tornado of ecstasy, and the pleasure, that awful, unstoppable pleasure, it twists your muscles into knots, instinctively convulsing to raise your lower lips higher, as if that would somehow propagate even deeper penetration.  One of the tentacles retracts, drawing a burst of slick cunt-lube with it.  Then, it twists around [pc.oneClit], tightening up on the over-sensitive bud until it feels like it could pop.{  Your heavy buzzer is so big that the flexible plant-cock has plenty of room to curl around it, and if you could see it, your clit would look look almost like a candy-cane (if one set of stripes was jerking off the cane beneath).}{  [pc.EachCock] soon has its own partner twisting around it, a pussy-slicked vine to jerk and twine about its girth.}");
output("\n\nWith nothing to occupy your roving hands, you let the slide up your [pc.skinFurScales] to your {lowest row of tits, cupping them before going to your top row of breasts/[pc.chest]}, caressing the swell as you search for the lust-tightened skin of your [pc.nipples].  They seem almost as sensitive as little clits, and as soon as you find them, you immediately set to circling them slowly, occasionally tugging and twisting when you a particularly powerful sensation works through your pleasure-wracked body.{  One after the other, they begin to {trickle/leak/spray torrents of} milk.}  You moan in unabashed delight, your mouth hanging open in a mindless, blissful ‘o’ in between vocalizations.  If your Azra could see you know, writhing on the deck, face open in simple, animal pleasure, and perhaps worst of all, fucking a plant, you’d die of {embarrassment/lust}.");
output("\n\nWith that thought somehow staying firmly in your battered consciousness, you reach a climax of mind-breaking proportion, eyes rolling wildly as every muscle locks in one united twitch of rapture.{  [pc.EachCock] explodes in release, pumping heavy flows of seed into the petals, even as y/Y}our quivering pussy, already sopping wet, releases the last of your juices in a soaked {drizzle/stream/spray/torrent}.  The tentacles inside you curl in on themselves and slowly pull back from the well-creamed quim, scraping out as much fluid as possible from your oversensitive honey-pot.  The binding on your [pc.clit] releases, which of course sets off a whole new wave of rippling pleasure-contractions in your cunt.");
