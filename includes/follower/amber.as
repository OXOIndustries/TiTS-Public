...
public function amberOnShipSexDrainHerInAss(hole:int):void
{
	...
	if (pc.isTaur()){
		...
		else if(pc.isFemale()) output("and you cum as hard as she is, " + (pc.isSquirter() ? "hot translucent femcum squirting from your spasming cunt"+ (pc.hasVaginas() ? "s" : "") +" and coating her pulsing testes in bliss" : "hot translucent femcum dripping from your spasming cunt"+ (pc.hasVaginas() ? "s" : "") +" and running down your underside") + ". You soak your shaking [pc.legs] with arousal, trying to resist the sheer strength of your orgasm and failing. Unable to stop yourself, you grunt and throw your head back over her shoulder as your back arches with the ecstasy of release.");
		...
		else if(pc.isHerm()) output("and you squirt [pc.cum] all over the floor, splattering your forelegs with your own spunk. Each throb of <i>her</i> swollen dick inside you sets you off once more, her cumvein pulsing against your prostate and forcing you to ejaculate for as long as she is. " + (pc.isSquirter() ? "Hot translucent femcum sprays from your spasming cunt"+ (pc.hasVaginas() ? "s" : "") + " and coats her pulsing testes in bliss" : "Hot translucent femcum drips from your spasming cunt"+ (pc.hasVaginas() ? "s" : "") +" and runs down your underside") + " while you soak your shaking [pc.legs] with arousal, trying to resist the sheer strength of your orgasm and failing. Unable to stop yourself, you grunt and throw your head back over her shoulder as your back arches with the ecstasy of release.");
