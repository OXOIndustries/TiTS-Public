...
public function isEitanExcitedAboutCatchingTheBigRedDotInTheSky():void
{
	...
	output("\n\nHe remains respectfully silent when you bring him to the ship’s hanger, and you introduce him to your own ship, the {ship.name9999}. You tell him that this is what you two will be traveling in, and this is how you’ll be going from planet to planet.");
