...
public function kaseSex():void
{
	...
	if(!pc.isTaur() && pc.hasGenitals()) addButton(1, "ReceiveOral", kaseSexRecOral, undefined, "Receive Oral", "Get Kase's mouth between your legs.");
	else addDisabledButton(1, "ReceiveOral", "Receive Oral", "You need to have genitals and not be a taur for this.")
	if(pc.hasCock()) addButton(2, "PitchAnal", kaseSexPitchAnal, undefined, "Pitch Anal", "Fuck Kase's tight tailhole.");
	else addDisabledButton(2, "PitchAnal", "Pitch Anal", "You need a cock for this.");
	if(!pc.isTaur()) addButton(3, "GetFucked", kaseSexGetFuck, undefined, "Get Fucked", "Lie back and have your crewmate go at you with his nubby cock.");
	else addDisabledButton(3, "GetFucked", "Get Fucked", "You need to not be a taur for this.");
	if(!pc.isTaur() && pc.hasCock()) addButton(4, "Frottage", kaseSexFrott, undefined, "Frottage", "Nothing says fun like rubbin' on some kitty dick.");
	else addDisabledButton(4, "Frottage", "Frottage", "You need to have a cock and not be a taur for this.");
	addButton(5, "Threesome?", kaseSexThreesome, undefined, "Threesome?", "Maybe Kase would be up for a threesome?");
...
public function kaseSexGiveOral():void
{
	...
	output("\n\nSmiling at his compliance, you " + (pc.isNaga() ? "slither" : "saunter") + " towards him, giving him a wink and reaching for the zipper of his suit while his breath goes ragged. Kase fidgets slightly in his place as you start to open his " + (flags["KASE_STEELETECH"] == 0 ? "Pyrite uniform, parting its latex and plate" : "SteeleTech uniform, parting its latex") + " to reveal his flat chest and pale skin. All the way down to his stomach the zipper goes, with you following it down onto ");
...
public function kaseSexRecOral():void
{
	...
	if(pc.hasCock()) output("stiffening [pc.cockNoun]");
	...
	{
		output("suck.");
		output("\n\nHe does just that, taking his tongue and dragging it across the underside of your [pc.cockNoun], all the way up to your to your tip. The soft barbs lining his oral organ caress your cockflesh, making if feel like an exotic sextoy is wrapping its lips around your [pc.cockhead], rather than Kase. He licks at your glans, slowly lowering himself onto your shaft, encasing it in the warm, wet embrace of his mouth. Once he's got it all between his supple cockpillows, the kaithrit begins to bob his head, hollowing his cheeks  and lifting himself off and onto your rock-hard tool.");
		output("\n\nKase whines slightly when your your cockhead touches the back of his throat, but continues his cocksucking all the same, taking things nice and slow. His nubby tongue swirls around your [pc.cock], slathering it with a layer kitty-spit and teasing you with his wonderfully textured tongue. He knows math, logistics, and how to suck a dick, a skilled and “qualified” employee if there ever was one.");
		output("\n\nIn fact, you feel as if the kaithrit deserve a little reward for all these oral pleasures he's giving you. Grinning, you reach down and place your hand right between Kase's feline ears. They twitch in response to your nearness, but their owner whimpers as you start to move your fingers, gently scritching at the base of his sensitive aural organs. His pleasured tones are quickly muffled by the [pc.cockNoun] in his mouth, the vibrations of his blissful noises on your cockflesh sending ripples of ecstacy shooting up your spine. You run your digits through his pine green locks to the edges of his ears, gingerly tracing along their most sensitive spots. ");
		output("\n\nThat's all enough to make Kase moan onto your [pc.cock], encouraging him to speed up his once gentle bobbing and licking. It's all pulling you closer to your inevitable orgasm, your [pc.legs] tensing and squeezing around your subordinate's head uncontrollably. You feel the need to give into pleasure and let your willpower slip away, and you have to admit, giving this kitty a mouth full of cum certainly wouldn't be the worst thing in the void. So, you let your climax well to the point where all you can feel is the need for release, and allow everything else fall by the wayside.");
		output("\n\nYou grunt hard as your orgasm ensues, your grip on Kase's head and ears tightening and your back arching. Your [pc.cock] spasms between the kaithrit's supple lips, " + (pc.balls > 0 ? "[pc.balls]" : "prostate") + " letting " + (pc.balls > 1 ? "their" : "its") + "load empty onto his tongue. Kase coos happily as you fill his mouth with your seed, eagerly gulping down all the [pc.cumflavour] [pc.cumnoun] you'll give him" + (pc.cumQ() >= 5000 ? " until his stomach starts to swell" : "") + ". Your hips buck up into the catboy's face with a mind of their own, forcing your convulsing cock down his throat.");
...
public function kaseSexPitchAnal():void
{
	...
	output("\n\nPlanning to give him what he needs, you pull back, emptying Kase's asshole, leaving it slightly agape and its owner whining at the sudden void he's been left with. He looks over his shoulder expectantly, but a quick swat on the kaithrit's ass has him wincing and his head darting forward again. Now that your subordinate's been put in place, you can get down to business, keeping his cheeks spread with one hand and grabbing at your [pc.cockBiggest] with the other. You line your [pc.cockheadBiggest] up with Kase's winking pucker, drawing a little gasp from the catboy as he feels your girth pressing into him. Then, all it takes is a little pressure behind your hips to penetrate the kaithrit's ass, spreading his asshole and eliciting a pleasured whimper from the femboy.");
	output("\n\nThere's no point in stopping there, though. You continue your push into Kase, letting him moan into his pillow while your cockflesh rubs at his inner walls. He’s relaxed enough to let you slide into him easy enough, but still tight enough to the point where you find yourself suppressing lustful groans. You bury yourself inside Kase to the " + (pc.hasKnot(pc.biggestCockIndex()) ? "knot" : "hilt") + " in one long stroke, leaving his backdoor spasming around your [pc.cockBiggest], moaning quietly. Thinking he might need a few moments to adjust to your length, you still your hips, listening to him breath heavy as he recovers from your unyielding penetration. You smile at the panting femboy and bend yourself over, just enough that you can kiss the kaithrit on the back of his neck, earning a happy smile from your lover.");
	...
	output("\n\nEcstasy dulls your other senses to the point where you're all but operating on autopilot, hips bucking forward in jerky, mindless movement as [pc.cumNoun] floods your urethra. Your [pc.cockBiggest] spasms inside Kase, hot seed pouring out and painting his inner walls [pc.cumColour]. ");
...
public function kaseSexFrott():void
{
	...
	if(!pc.isNude()) 
	{
		...
		output(", letting your [pc.cockBiggest] fall free of its confines and drop right onto Kase's barb-covered shaft.");
	}	
	else output("Grinning back at the kaithrit, you use your free hand take hold of your [pc.cockBiggest] and drop it right onto Kase's barb-covered shaft.");
