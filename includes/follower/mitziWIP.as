...
public function mitziPutsYouInHeat2():void
{
	...
	pc.taint(2);
	pc.orgasm();
	//9999 increase count of times mitzi hypnoed :3
	clearMenu();
...
public function mitziMakesYouABimboIV():void
{
	...
	//Reduce intelligence by 20% and willpower by 20%. (More on successive times?)
	//Increase reflexes and aim by 2, libido by 3.
	//pc.reflexes(2);
	//pc.aim(2);
	//9999

	//Gain weak willed and Ditz speech fork!	
	if(!pc.hasPerk("Weak Willed") && !pc.hasPerk("Ditz Speech"))
	{
