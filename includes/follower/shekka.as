...
public function shekkaBJsByWillIAm(fromDickGrow:Boolean = false):void
{
	...
	else if(flags["SHEKKA_BLOWN"] == undefined)
	{
		...
		output("\n\n<i>“Hohhh fffffuck...”</i> Shekka groans. Her suit was already halfway to undone, but the next throb of her bound dick breaks the clasp holding it together. Not only does the onesie split open like a banana peel, but her spectacular dick springs out and gives your [pc.face] a cummy boop! Gripping it by the sheath, she regains control of her stubborn stallion for only a few short seconds. <i>“Gonna be a shame to plug a mouth that dirty up...”</i> she murmurs, shooting a solid rope of lube across your cheek. <i>“But, gotta say, the things I’ve heard from people getting sucked off around Novahome’s corners is getting me real fired up! Get " + ((pc.isNaga() || pc.isTaur()) ? "down":"on all fours") + ", [pc.name], I’m gonna <b>use</b> your face.");
	...
	else if(flags["SHEKKA_BLOWN"] > 3)
	{
		...
		output(". All she has to do is rub the flare across your brow, over your cheeks, press it against your lips, and you’re babbling for it. Then she steps forward, grinning, silencing you in one motion. <i>“I fucking love the way you act, <b>Captain.</b>”</i> Her thickly-scented nutsack rests encouragingly against your nose, muffling your whimpers in the swirling warmth of virility. The bloated girth of her crimson orbs dominates your minimal field of view. <i>“Meeting you really was the best thing that’s happened to me. Getting this dick? Second best.”</i> She giggles, humping higher, smearing her ballmusk across your [pc.skinFurScales]. <i>“Getting to use it on you?”</i> She grabs your head. <i>“Worth everything. Now get started, babe");
		// myrVenom:
