...
public function shekkaCrewText():void
{
	output("\n\nAlthough it seems that Shekka doesn’t notice you on her approach, one of those floor-touching ears is flipped back, and her tail squirms nervously from side-to-side. She does a good job of looking busy... or maybe she actually <i>is<i> busy, thinking about it. She’s done a good job of converting your engine-room to an impromptu workshop. Although having a chest of tools has made a warm room even warmer, the body-suited Rask seems to be coping just fine.");
...
//Next: Back to Shekka Menu

output("\n\nTalk");

output("\n\nYou let her know that you’re just down for a chat, and she puts down some miscellaneous machined-piece down on the floor–hopefully that didn’t come from your engine.");

output("\n\nPlaces");

output("\n\nTarkus");
output("\n\n”</i>Soooo...”</i> you begin, wondering where to start with such a question. ”</i>What do you think about Tarkus these days?”</i>");
...
output("\n\n ”</i>There are less of those Goos than before, and the ones still out there are occasionally being given... uh, memory chits I think? I know that the Galotian queen wanted to try and lend a hand with their being-recognized as a race. Sounds neat to me! {//gave bodies//Especially since their Captain’s doing well, she’s able to turn some heads... what with being a technically-ancient, mortal-turned-immortal sentient.//Goo bodies// There <i>is<i> a little issue with the fact that the queen is more than a little horrified that an entire ship’s worth emergent, innocent intelligences got wiped out and replaced by functionally dead people.}\”</i>");
...
output("\n\nIt’s the first time you’ve ever seen her properly express her distaste about someone. It’s kind of scary. {//Domme//The urge to break her in has your fingers twitching///subby//Mnf.}");
...
output("\n\n//Normie//”</i>It certainly sounds like a glowing endorsement to me then.”</i>");
output("\n\n//Bro//”</i>Yeah, I think it’s a cool place too.”</i>");
output("\n\n//Bimbo//”</i>Ohmigosh, I love it too Shekka!”</i>");

output("\n\nShekka smirks, shaking her head a little. ”</i>It <i>is<i> still scary though. I’m a small girl and there is so much I don’t know about the UGC. I’m like an oil-pit to a scrak-lizard for all manner of fast-talking scammers. I wasn’t aware that so many of the various humanities were total pieces of shit.”</i>");
...
output("\n\nAlright, the curiosity is too much; what does Shekka think about New Texas? Fun? Sexy? Exciting?");
...
output("\n\nHow does she feel about Myrellion? Plenty of sexy addictive Reds and squishable Honey-pot Golds there.");
...
output("\n\nShekka reflexively shivers, rubbing at her arms. ”</i>Something I learned from my first visit there? Rasks are not built for that level of cold. Seeing snow for the first time was awesome, but I damn-near froze my scales off just standing around.”</i> The cold was an obvious thing to mention, but you push her for a little more info.");
...
output("\n\n”</i>Alright”</i> you begin, sizing the little Raskvel up. ”</i>What do you think about Anno?”</i>");
...
output("\n\n”</i>Azra, huh? Well... it would be intimidating how she’s as tall as four of me stood on my shoulders. But she’s been nothing but cool. I admire that she’s determined to learn more about the Galaxy.”</i> She hesitates for a moment, looking up at you carefully. ”</i>That said, it does seem like an awful lot of danger is involved. I’d never forgive her if she got you hurt chasing after some kind of fuckable lilypad.”</i>");
...
output("\n\nWhen you bring up the issue of Celise to her, Shekka’s head immediately whips around. ”</i>She’s not here, is she? Last time I took a nap at the engines I woke up to find myself totally spotless.”</i>");
...
output("\n\n//If wearing Nova");
output("\n\n	”</i>Heeeey... I’m right here!”</i> your armor says, forming a face to look up at you with a pout. The little Raskvel flinches in surprise before struggling to fight down snorts and giggles.");
...
output("\n\n//Else");
output("\n\n	”</i>If I’d been told one of those rapey little monsters could turn out to be a wearable, weaponized bimbo-armor, I would have said that was crazy. But no...  She is a total sweetheart. Sadly a bit out of my technological expertise or I’d have a poke around inside of her.”</i>");
output("\n\n//Next: back to People menu");

output("\n\nReaha");

output("\n\nShekka looks down at her chest with a frown. ”</i>I’m jealous of those big ol’ milky tits of hers. I’m happy to admit that much. Also she dodged getting herself retardulated by The Treatment, which I suppose I approve of... I can’t imagine how guilty she must have felt knowing she still wanted to look like a curvy milk-tank. I said something kind of rude to her when we first spoke, I assumed she was Treated... she took it well, and made me feel like an asshole. Which I deserved.”</i>");
...
output("\n\n”</i>You have a habit for trying to rescue people with money, don’t you?”</i> Shekka asks, grinning. ”</i>I don’t know that I have much to say about her, but sweet scrap and stars she cooks an awesome meal... do you think my thighs look fat?”</i>");
...
output("\n\nYou ask if Shekka would like to take a break from... whatever it is she’s doing and hang out with you for a while. ”</i>Hmmm, you’re asking me without that mischievous eyebrow wiggle, I assume you don’t mean sex?”</i>");
...
output("\n\nOf course, the best place to go before anywhere else is Anon’s bar!");

output("\n\nYou quickly discover that Shekka can put down a surprisingly decent amount of alcohol. {More than you, actually/It’s nothing to your own expertly-trained liver, but impressive nonetheless}. By the time shots have started to be ordered your table has a good card game going. The pink-haired Rask took a few rounds to figure out what’s going on, but by round six the pot is practically cascading into her little arms. ”</i>Read ‘em and weep, suckers!”</i>");
...
output("\n\n	Maybe it’s lacking in the romantic-hangout angle, but there’s a perfectly useable stripclub.");

output("\n\nAlthough Shekka makes a face at your suggestion, she seems happy to be led along to Beth’s Busty Broads. Her hands squeeze at yours tighter at the sight of a towering, latex-coated Gryvain Futa. {Terensha; hard not to miss that girl../You’ll have to see her later...} She gives you both a wink, and then walks right past... just in time for her nethers to give you a wink too, planted between two expansive asscheeks.");

output("\n\n”</i>Okay [pc.name]... I think this place is pretty great.”</i>");

output("\n\nThe two of you grab a spot at the back, and Shekka climbs into your lap {hotdogging your burgeoning erection between her own cushiony backside/grinding her tail between your thighs for a teasing rub against your [pc.pussy]}. A few drinks come, and the both of you while away a few hours admiring men and women of various kinds as they dance and strut...");
...
output("\n\n”</i>Hey, Shekka... about your, uh... addiction?”</i> you begin, looking the curvy girl up and down. Shekka blinks a few times, staring at your face.");

output("\n\n”</i>...You don’t smell like it anymore. Oh. Oooh...”</i> she mutters, sniffing a few times.");

output("\n\nIgnoring the fact that she can apparently pick up that scent on your lips, you squat down to get {eye-to-eye/closer to eye level}. ”</i>Are you going to be okay?”</i> you ask.");
...
output("\n\nThat easy?! You stare, aghast. {Just thinking about how long it took for Reaha to recover makes this seem a little unlikely.} Shekka shrugs helplessly ”</i>I was addicted to you because it was fun. Fuck. Fuck it was so hot to crave you...”</i>");

output("\n\n”</i>And you just had the cure around because you were enjoying it?”</i>");

output("\n\nThe Raskvel smiles, taking another slow, deep breath. ”</i>Yup, a different kind of addictive aphrodisiac, and a shit ton of caffeine. They’ll do battle in my brain or whatever for a while. Then I’m fine. {It’s not like Reaha’s case, that girl spent fuck knows how long on synthetic lust drugs.}”</i>");
...
output("\n\nYou bite the bullet and ask her outright; ”</i>Shekka, are you addicted to me?”</i>");
...
output("\n\nThere is no doubt about it. When it comes to women, the whole deal is immediately altered by a liberal application of dicks. It’s not a conversation you’ve ever breached with Shekka before, and when you do so, she squints at you.");
...
output("\n\n”</i>Honestly...”</i> you begin, a wicked grin creeping across your [pc.face]. <i>“I’ve gotta say, it would be pretty hot...”</i>");
...
output("\n\nIt’s not the first time you’ve seen such a thing. Sounds good at the very least; Shekka certainly has the bottom-half necessary to support a big{silly: ol’ floppy horsey-donger/ equine member}.");

output("\n\n//Three Options: Not Yet, SynthSheath and Throbb");
output("\n\nSynthSheath");
output("\n\n	You haul out a big floppy equine phallus, complete with balls. The small Rask’s eyes are drawn to the way it sways from side-to-side.");
...
output("\n\nThrobb");
output("\n\n	Well, it isn’t a horse-cock, but when it comes to dick-fixing juices, you have the hookup to hand...");
