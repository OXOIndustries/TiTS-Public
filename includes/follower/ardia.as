...
public function itsStillPartyTimeAndStillArdiasMom():void
{
	...
	output("You turn to a set of stairs leading up, just in time to see Ardia coming down. She’s " + (ardia.hasArmor() ? "shed her [ardia.armor]" : "fully nude") + " and taken one hell of a bath, blue hair hanging wetly onto the shoulders of a pretty burgundy dress that’s trying its darndest to wrap around the prodigious expanse of her bosom.");
...
public function ardiaSexMenu():void
{
	...
	{
		if (!pc.hasCock()) addDisabledButton(1, "Prone Bone", "Prone Bone", "You need a penis for this!");
	...
	if (!pc.hasCock()) addDisabledButton(3, "Get Titfuck", "Get Titfuck", "You need a penis for this!");
	else addButton(3, "Get Titfuck", penisRouter, [doinSomeDzaanTiddies, pc.biggestCockVolume() + 1, false, 0], "Get Titfuck", "Ask Ardia to wrap those pillowy jugs around your dick.");
	addButton(4, "GetMissionary", ardiaShutsTheLightForProcreation, rand(pc.vaginas.length+1)-1, "Get Missionary", "Snuggle into Ardia’s bed, spread your [pc.legs] for her, and let your thick-as-a-brick alpha fuck you full of her intoxicating semen.");
...
public function ardiaOnTheGroundReadyToGetPound(cockIdx:int):void
{
	...
	ardia.buttChange(pc.cockVolume(cockIdx));
	pc.cockChange();
...
public function ardiaShutsTheLightForProcreation(vagIdx:int):void
{
	...
	output("\n\n<i>“Oh, well, this hole’s awfully eager!”</i> Ardia grins, running her hands up and down your hips. <i>“Feel like you’re sucking me in. " + (ardiaDomLevel() < 4 ? "What a good beta, making your alpha feel so welcome inside you. I’m going to reward you so, so handsomely..." : "Do you want to be my beta that badly... or are you just love fat alpha cock that much?") + "”</i>");
	...
	output("\n\nWhen she finally manages to get your [pc.lips] entangled with her own, your bodies are pressed so tight together that you can hardly tell where yours ends and hers begins. All you know is pleasure, the wonderful submission of being hammered by your alpha over and over again, of being used like her personal fuckdoll. You can’t help but cum,");
	if(pc.hasCock()) output(" painting the underside of Ardia’s stomach [pc.cumColor]. Thick ropes squirt up between the dzaan-babe’s tits, enough to make her giggle obscenely between kisses.");
	else if(vagIdx >= 0) output(" Your pussy draws her in as deep as it can, craving her cum even as your own juices are spattering her thighs.");
...
public function areYouPCEnoughToBeArdiasChair():void
{
	...
	else
	{
		...
		output("\n\nYour eyes barely have time to widen from the glee of being ordered around: a taste of your Mistress’ pussy?");
		if(pc.isBimbo()) output(" Yay!");
		else if(pc.isBro()) output(" Fuck yeah.");
		else output(" Wouldn’t miss it!");
...
public function fuckThatAlphaArdiaWhileSheStillLetsYou(cockIdx:int):void
{
	...
	ardia.cuntChange(0, pc.cockVolume(cockIdx));
	pc.cockChange();
