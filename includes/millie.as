...
function getMilkedWithMillie():void
{
	...
	if(pc.isChestGarbed()) 
	{
		output(" Shaking her head, she grabs you by the [pc.chestGarment] and tugs. “<i>This’ll have to come off. Can’t get your boobs pumped if they’re all squished up in some kind of titty-prison. You should really consider letting the girls breathe a little.</i>”");
...
function millieMilkersPartDues():void
{
	...
	if(!pc.isTreated())
	{
		...
		output("\n\nAs more and more [pc.milk] is drawn from your increasingly tender nipples, Millie’s hands spend more and more time caressing your [pc.chest], rubbing and squeezing, spreading motes of desire through your supple flesh. She has you feeling like you’re melting one moment and full of erotic tension the next. Your [pc.legs] tremble, and the flow of [pc.milk] redoubles. Exhaling hotly, the cow-girl nibbles around the outer edge of your ear, licking and kissing. Her hands give another furtive squeeze. You gush and moan in response");
		...
		else if(pc.hasVagina())
		{
			...
			output("\n\nMillie breaks the kiss, still connected to you by an errant strand of saliva, her fingers still industrially wiggling, her heavy, milk-seeping nipples dragged up and down your emptying tits by the force of her rapid breathing. She twists those wonderful, [pc.girlCumNoun]-stained digits inside you, arching them just so. Her thumb finally presses on [pc.oneClit] in just the right way, shaking just enough that it’s practically vibrating. Your abdomen clenches. Your [pc.legs] quiver on the table, and you cum. You cum like like water pours from a shattered dam. You cum like like an avalanche down a mountain.");
	...
	else
	{
		...
		else if(pc.hasVagina())
		{
			...
			output("\n\nIt isn’t the kind of quivering climax you’re used to, though. It’s a controlled demolition of your consciousness, set off by every sensitive place in your body in unison. The pleasure from your [pc.vaginas] rebounds off the wonderful release your tits are experiencing. Even your [pc.asshole] is clenching with every boneless jerk of your [pc.legs]. Someone is mooing, again and again, each louder than the one before. It sounds so wonderful and right - the perfect vocalization of what you need and feel distilled into a single, awesome sound.");
