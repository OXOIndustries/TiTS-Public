...
public function spinarranCodexEntry():void
{
	...
	outputCodex("\n\nIn modern times, spinarrans work together in combat. Arachne commonly ride driders into combat as heavily armoured mounts, carrying heavy armor, laser weapons, and mono-molecular sabers. Some particularly strong driders are decked out in enough armor to serve as biological tanks - complete with abdomen-mounted canons.");
