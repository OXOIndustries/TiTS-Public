...
function kuitanCodexEntry():void
{
	...
	outputCodex(blockHeader("Appearance"));
	outputCodex("The kui-tan are a humanoid species native to the moon of Florus, which orbits the planet \\\[REDACTED\\\], who visually call to mind the mythical 'tanuki' of Japanese lore. Their bodies are typical of most intelligent humanoids - two legs, a torso, two arms, and a single head atop the torso. Kui-tan faces are striking similar to galactic norms, except that nose and jaws grow together and extend into a short but expressive muzzle, containing prominent canines but altogether omnivorous teeth. A single pair of ears, just pointy enough at the top to be oval-shaped rather than circular, sits atop the head, with limited mobility.");
	...
	outputCodex("The kui-tan species evolved in lush forests prone to balmy summers and harsh winters. Naturally adept at climbing, the kui-tan still have a fondness for forest environments, and often build their homes into trees when given the choice. As their technology has advanced, more urban cities have sprung forth, though all kui-tan try to at least keep some plants around the place for decoration if nothing else.\n\n");

	outputCodex(blockHeader("Reproduction"));
	outputCodex("By preference, kui-tan form monogamous pairings. There is a tradition of parents taking steps to introduce their children to potential partners, but arranging marriages for political reasons has been illegal for generations.\n\n");
	outputCodex("While capable of sexual intercourse at any point in time and also of conceiving on a monthly basis, hermaphrodite kui-tan retain the aspect from their more primitive ancestors of entering a state of heat approximately every six to seven months. During this time, typically about a week long, their hormonessurge, giving them a marked increase in libido and a small, but noticeable, boost in passive semen production. This makes them markedly more interested in sex, though not so much so that they can't resist the urge, as well as making it more likely for them to conceive.");
	...
	outputCodex("The initial news of a viral breakout and it’s effects weren’t necessarily treated as a maximum level priority. Most males had no problem with having to find release more often. This incident only got its due importance when the virus mutated and began to affect the females, making them grow male genitalia of their own. The world’s top researchers were tasked with finding a cure, but by the time a cure was devised it was too late. The virus had infected nearly the entire population, and within a few decades females disappeared entirely, replaced by herms.\n\n");
	outputCodex("As is widely documented in their own planet's histories, it was shortly after the kui-tan developed powerful radio receivers that they accidentally made contact with the sionach, who had reached a similar stage of development on their own world. It is something of a friendly argument between the two species about who holds the more important role in their mutual histories; the Sionach, for inventing the radio transmitters that allowed them to properly greet their lunar neighbors and allow for verbal and eventually visual contact between them to begin with, or the kui-tan, for inventing the first reliable space-vessels that made physical contact between their species possible.\n\n");

	outputCodex(blockHeader("Other Notes"));
	outputCodex("Kui-tan of all sexes attempt to keep their balls small and manageable, so they can be tucked away discreetly with some skill. Oversized balls are seen as sexually provocative and crude, a vulgar symbol of the kui-tan's desire or readiness to fuck.");
	outputCodex("\n\nBecause all kui-tan have penises, all kui-tan are technically what humans would call bisexual, with no social stigmata of any kind given to an individual pleasure the phallus of another with hands, mouth or anus. While most 'homosexual' kui-tan males classify more accurately as male-preferring bisexuals, true homosexual males do exist. Whether an individual prefers to catch, pitch or swing generally takes the place of conventional sexuality in kui-tan society.");
	outputCodex("\n\nBecause of the excessive productivity of kui-tan balls, it is a natural thing in their culture to need to release frequently. Restrooms are modified to be capable of handling frequent loads of semen as well as other wastes, and most cities have designated 'milking stations' where a pent-up individual can find their member quickly and efficiently stimulated to climax by mechanical devices with the mess vacuum-pumped away without hassle.");
	...
	outputCodex("\n\nActually swallowing the semen, though, is regarded as a highly intimate act, perhaps even more so than among humans due to the semen-cascade it set off in their balls. Thusly, swallowing has come to symbolically mean that one partner is quite literally taking on the burdens of the other. As a consequence, it's a great sign of respect or love to do so.");
