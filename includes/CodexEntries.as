...
public function mechanicsCodex():void
{
	...
	outputCodex("\n<b>Easy:</b> As the name implies, armor that is label ‘easy’ makes physical combat less difficult by giving an extra 50% resistance, up to a maximum of 100% resistance, to any given damage type.");
	outputCodex("\n\n");
