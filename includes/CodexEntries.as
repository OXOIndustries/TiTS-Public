...
public function rahnCodexEntry():void
{
	...
	outputCodex("\n\nWhen a rahn is both well fed and satisfied with the quality of her biomass sources, she can choose to begin forming eggs. These eggs will grow within her for a month before it is time for birth, during which the selected biological compounds are used to guide and shape the development of the embryo. Once ready to be birthed, development will be halted while the rahn tries to find a suitable mother, believing that incubating inside another being will be good for the resulting young.");
...
public function redMyrmedionCodexEntry():void
{
	...
	// 9999
	outputCodex("\n<b>Arms:</b> Two narrow but strong limbs ending with three fingers and a single thumb.");
