...
public function throbbCodexEntry():void
{
	...
	outputCodex("\n\nThrobb’s synthesis was leaked to the extranet, and now most back-alley chemists can whip up a batch in a few days. Most newer model fabricators and molecule assemblers prevent its manufacture at a firmware level, citing UGC <i>“Deleterious Drugs”</i> statute, section 7, paragraph 4. Hacks to circumvent these restrictions are commonplace and easily attainable.\n\n");
	outputCodex(blockHeader("Method of Application"));
	outputCodex("Throbb requires injection into the area to be affected. Injecting it non-reproductive areas may result in unwanted growths or bizarre sensitivity.\n\n");
