...
public function configureCodex():void
{
	...
	CodexManager.addCodexEntry(CodexManager.CODEX_TYPE_RACE, "Core Worlds","Leitha",leithanCodexEntry);
...
function leithanCodexEntry():void
{
	...
	outputCodex("After the U.G.C. \"uplifted\" the Leithan race during the early stages of the Planet Rush scheme, the race's reproductive habits have changed somewhat -- especially among those living away from the homeworld. With a dramatically higher survival rate off-world, Leithan males and females have become more comfortable in being selective with their partners, and recreational sex drive has become much higher. While Leitha still have a difficult time with the concept of monogamy, and most freely move between several partners, the idea of a female allowing any male to approach her in her \"heat\" period is nearly nonexistent now.\n\n");
	outputCodex("Unlike many sapient species, Leitha have a nearly 0% fertility rate when coupling with other species. Halfbreed Leitha are nearly unheard of, and almost always the result of genetic manipulation and non-natural fertilization. Because of this, and the higher sex drive among offworld Leitha, many Leitha of both sexes find themselves to be easy \"swingers,\" and eagerly skip the courting and dating process to open themselves up to several attractive partners of other species, since their couplings are virtually no-risk.\n\n");
	...
	outputCodex("Some Leitha attempted to protect themselves in high-walled cities, and because of this protection and stability, were marginally more successful and advanced than their roaming cousins when First Contact happened. Many of the walled cities had developed primitive flintlock-era firearms and cannons, with which they were able to fend off predator attacks -- one city even created primitive rockets to guard against aerial attacks. Since their uplifting by the U.G.C. in the Third Great Planet Rush, Leithan cities have become veritable fortresses against their one-time predators, and the race has eagerly adapted to the advanced technology the Confederacy brought with it. They have adapted so well, in fact, that in the modern day Leitha are valued as exceptional engineers and technicians, especially in regards to machine maintenance and robotic tech. Many top of the line drones, turrets, and unmanned vehicles are produced in Alpha Centauri or on Leithan colonies.\n\n");
	outputCodex("Societally, Leitha are regarded as being very open, friendly, and cooperative. When teamwork and group loyalty are the biggest defense you have against being eaten by a six-story tall monster, it pays to be easy to work with. Most Leitha are highly empathetic, making them keenly aware of others' emotive states, and are most comfortable in small, close-knit groups of friends. Solitary Leitha are almost unheard of, and most revel in social activity - especially in the core words, where Leitha are constant features of nightclubs, dance halls, and just about any party they can find.\n");
