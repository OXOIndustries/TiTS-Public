	...
	switch(response)
	{
		...
		case "get oral":
			...
			else
			{
				...
				output(" use my tongue, [pc.master]?”</i> the cybernetic pup murmurs, tracing her smooth fingertips around the edge of your [pc.vagOrAss " + i + "]. She blinks those big red eyes up at you expectantly, waiting until you manage a needy nod before brushing closer to you winking hole, flicking her wet, red tongue out across your [pc.skinFurScales]. You gasp, sucking in a sharp breath as [wulfe.name] plants a puppy-dog kiss right on the " + (i >= 0 ? "lips" : "ring") + " of your [pc.vagOrAss " + i + "]. The tip of her tongue stays planted there for a long moment, putting on just enough pressure to slowly, steadily sink inside.");
