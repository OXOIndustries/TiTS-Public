...
public function justSnuggleWithGobblesUSloot():void
{
	...
	output("\n\nYou task your tongue and pile a little extra hay under her head as a makeshift pillow before you stand up, content to leave her snoozing for now. You gather your gear and head back downstairs.");
	processTime(6);
	clearMenu();
	gobblesRepeatSexEndCleanup();
	addButton(0,"Next",mainGameMenu);
...
public function buttBasteDatTurkey():void
{
	...
	output("\n\n<i>“Like that?”</i> she giggles. You answer by drilling your first deeper into her cunt, pushing in until you can feel the her wide channel bottom out against your knuckles. <i>“I guess so...”</i>");
	...
	if(!pc.hasStatusEffect("CreamedGobbleCunt")) output(" I’d feel bad if I didn’t at least play with your pussy a little, too, after what you did to me.");
	output("”</i>");
	processTime(16);
	pc.orgasm();
	//[Finish] [Pussy Gobble]
...
public function pussyGobble():void
{
	...
	output("\n\nShudders and shocks of pleasure burst through you, echoing up your spine in crashing waves - and out of your cunt in wet squirts, bathing Canada’s cheeks in [pc.girlCumNoun]. She squeals excitedly, eagerly lapping up every drop you can give her like a starving woman. Even when, panting and gasping, you roll off of her, just eagerly licks her cheeks until they’re spotless, then slips down and buries her face between your legs, silently confident you can go again. You whine and dig your fingers into the hay as your lover’s tongue probes back into you, happy to clean you inside and out.");
