	...
	switch(response)
	{
		...
		case "you":
			...
			if(rand(2) == 0)
			{
				...
				output("\n\nIt takes a second to focus, but you shift your grip on Betsy’s round ass, and slide your fingers further until you feel – there. Her tight little asshole is right at the edge of your grip. You press her harder against the wall, making sure she doesn’t fall, then move your hand farther in and slide a finger up Besty’s ass.");
