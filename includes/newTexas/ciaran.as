...
public function ciaranVanilla2(anal:Boolean = true)
{
	...
	if (!anal)
	{
		...
		else if (pc.wetness() < 7) output("squirts a huge volume of femcum, soaking Ciaran's hot knot and massive balls and wetting your thighs as the [pc.girlCumColor] puddle under you [pc.ass] expands.");
