...
public function mirrinBabesAllOverThePlace():void
{
	...
	output("\n\nA thick, far-reaching deluge of smokey dragon cream erupts from the flaring tip, shooting over your prone form to the end of the bed! Simultaneously, the cervix-locked twelve incher within you unloads a strong flood of the dragon’s baby batter directly into your womb!");
...
public function timeToStartADragonBreedingShow(vagIdx:int):void
{
	...
	output("\n\n<i>“Round two...”</i> she says under her breath, pulling her softened horse-cock from your [pc.pussy " + vagIdx + "] in one slick motion. In its place, the thicker, tooled up beast member is lowered, dribbling smokey smelling pre-cum all over your [pc.belly]. With some sloppy fiddling, she dismantles her double cock-rings and vibe arrangement, leaving a fully hard, perverse and twitchy stallion cock.");
...
public function mirrinSterkurHusBonus():Boolean
{
	...
	else if (flags["MIRRIN_DEPREG_TALK"] == undefined && flags["MIRRIN_PREGSTAGE"] != 10 && flags["MIRRIN_PREG_TIME_LEFT"] == undefined)
	{
		...
		output("”</i> she says with the usual pep in her smokey voice.");
...
public function yeMirrinLetsTryOutDemNooDicks():void
{
	...
	if (pc.cockThatFits(mirrinMaxButtSize) < 0 && !(pc.hasHardLightUpgraded() && pc.hasHardLightEquipped())) addDisabledButton(2,"OtherGoodOlAnal","Other Good Ol’ Anal","You’re gonna need something that fits in her butt.");
	else addButton(2,"OtherGoodOlAnal",penisRouter,[doanMirranUpTheBum,mirrinMaxButtSize,true],"Other Good Ol’ Anal","You know what? How about you get the action this time... buy a ticket to Ass Mountain and ride it all day.");
}
...
public function mirrinPostNTButtfuggin():void
{
	...
	output("\n\n<i>“Myah, you’re ready,”</i> she chuckles in her smokey tone, wiping away her mouth as she stares at your slathered-up [pc.asshole]. <i>“I’ll remind this hole who truly owns it...”</i>");
...
public function mirrinTooBusyFuggingYouToNoticeThatMyPokemonJokeDidntWork(vags:Object):void
{
	...
	output("\n\n<i>“Oh my, boys and girls... I couldn’t hide something so gorgeous from you. Look at this... <b>bulge</b>,”</i> says the husky qilin, a pornstar lilt to her smokey tones. You groan and your [pc.belly] grumbles as the soft indent of her flares bulge through your [pc.skinFurScales]. Your " + (vagIdx2 < 0 ? "womb is" : "wombs are") + " so stuffed with seed that you could be mistaken for being pregnant. <i>“Get ready for the pop, here it comes...”</i>"); 
...
public function doanMirranUpTheBum(cockIdx:int):void
{
	...
	if (cockIdx >= 0 && pc.cLength(cockIdx)) output(" You can only imagine the bulging your length is doing to her abdominals, the thought keeping you steady as you plough your way through.");
