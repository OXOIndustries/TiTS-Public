...
public function brandyIntroductions():void
{
	...
	output("\n\nYou smile contentedly at the cowgirl. Maybe now that the ice is broken you can get to know each other a bit better.");
	flags["MET_BRANDY"] = 1;
	processTime(6);
	brandyMenu();
}
