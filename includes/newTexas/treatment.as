...
public function treatmentHourProcs(totalHours:int):void
{
	...
	if(pc.statusEffectv1("The Treatment") == 4)
	{
		...
		if(treatedHours >= 49 && pc.breastRows[0].breastRating() < (Math.min(pc.statusEffectv1("Treated"), 23)))
		{
			...
			if (numGains > 0)
			{
				for (i = 0; i < numGains; i++)
				{
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + ParseText(" Your chest feels strange. It's all puffy, and your [pc.nipples] are a little swollen. Oh snap, are you getting boobs?");
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " You idly squeeze your chest; just to check, you assure yourself. It seems a wise thing to do after taking the Treatment. After all, how else are you supposed to chart your progress from teensy teats to mouthwatering melons? You cup and caress them like favored pets. Yup, they're definitely bigger. You squeeze again - definitely B-cups. They feel warm in your hands, alight with hormones and metabolic energies, pulsing bigger with every beat of your lusty heart.";
						pc.breastRows[0].breastRatingRaw = 2;
					}
					//B-C
					else if(pc.breastRows[0].breastRatingRaw < 3)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + ParseText(" Whenever you move, your [pc.chest] move along with you. That's no surprise. What does come as a shock is just how much they move - jiggling and shaking about whenever you twist or hop.");
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + ParseText(" Your [pc.chest] feel so nice and warm");
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " You give a squeal of surprise when you realize how big your tits are getting. They're way more bouncy and squishy than before. If you got measured for a cheap bra, you'd definitely be an E-cup, but you don't think you need one.";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + ParseText(" You let your hand play across your [pc.nipple] during an idle moment, just to check if your sensitivity is getting crazy or anything. The cow-girls seem to enjoy it, but while it gives you a fluttery thrill, it doesn't make you weak in the knees. It doesn't make you moo and moan in equal measure, though the thought of squeezing on some slutty cow till she does makes your nips perk quite nicely. Kneading your pillowy mammaries and smiling, you admire how big they're getting, reveling in how the pliant flesh bulges between your questing fingers. It's the only part of you that's getting softer, and you're completely okay with that.");
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " You look down, at first surprised and then pleased to see a little bit less of the ground than before. Yep, your chest is still growing.";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + ParseText(" Every movement you make is accompanied by a lovely bounce and jiggle. Your breasts are the kind display a fetching amount of kinetic movement without bouncing around so hard as to strain your back - that or your back is too tough to be bothered by a bit of boobalicious bouncing. The thought of every eye in the area watching your [pc.chest] has them feeling fuzzy with heat and swelling with pride - and an assortment of mammary-enhancing hormones. They're bigger than the last time you checked. How much are they going to grow?");
						if(pc.bRows() > 1)
						{
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " A warm, tingly feeling spreads through your chest as your breasts expand";
		...
		if(!pc.hasCuntTail() && !pc.hasCockTail() && pc.tailType != GLOBAL.TYPE_BOVINE && startHours < 112 && treatedHours >= 112 && rand(10) != 0)
		{
			...
			else if(pc.tailCount > 1)
			{
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (treatedHours - startHours) * 60) + ParseText(" Your [pc.tails] brush against your [pc.leg] as you walk. Wait - your [pc.leg]? When did.... You twist around, staring down in shock. Where once you had [pc.tails], now you've got gently-swaying, bovine tails, complete with fuzzy puffs at the tips.");
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (treatedHours - startHours) * 60) + ParseText(" Your [pc.tails] feel increasingly warm, moment to moment, and not from the ambient temperature either. The heat is internal, a calefaction that seems ready to set your posterior extremities alight with incredible energy. You twist around, concerned at first, but you smile lazily at what you find.");
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (treatedHours - startHours) * 60) + ParseText(" Your tail brushes against your [pc.leg] as you walk. Wait - your [pc.leg]? When did.... You twist around, staring down in shock. Where once you had a [pc.tail], now you've got a gently-swaying, bovine tail, complete with a fuzzy puff at the tip.");
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (treatedHours - startHours) * 60) + ParseText(" Your [pc.tail] feels increasingly warm, moment to moment, and not from the ambient temperature either. The heat is internal, a calefaction that seems ready to set your posterior extremity alight with incredible energy. You twist around, concerned at first, but you smile lazily at what you find.");
		...
		if(numHipGains > 0 && pc.hipRatingRaw < 11)
		{
			for (i = 0; i < numHipGains; i++)
			{
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) - (i * 14)) * 60) + " You look yourself over, discovering that your hips have widened, giving you a more feminine look.";
					pc.hipRatingRaw = 3;
				}
				//Not so smallish Sub 6 to 6
				else if(pc.hipRatingRaw < 6)
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) - (i * 14)) * 60) + " Whoah! Your hips have gotten wider. Nobody is going to mistake you for a boy when you can swivel these back and forth. You sashay them around a few times, just to try it out.";
					pc.hipRatingRaw = 6;
				}
				//Biggish (Sub max to max)
				else
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) - (i * 14)) * 60) + ParseText(" Moving around, you’re pleased to discover a little extra wiggle in you walk. Your [pc.butt] sways hypnotically as you go, automatically borne on a sinuous back and forth motion by your expanding [pc.hips]. You wonder if anyone will notice.");
		...
		if(startHours < 156 && treatedHours >= 156 && pc.buttRatingRaw < 9)
		{
			...
			if(!pc.isAssExposed()) eBuffer += "\n\n" + logTimeStamp("passive", (156 - startHours) * 60) + ParseText(" An increase in the tightness of your [pc.lowerGarments] gradually comes to your attention, forcing you to shift and adjust them.");
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (129 - startHours) * 60) + " Oh fuck! Something is happening, something that shatters your confident facade with aplomb. You can feel it, wriggling and squirming ";
			if(pc.legCount == 1) eBuffer += ParseText("between your [pc.legs]");
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (153 - startHours) * 60) + ParseText(" Oh-ohh-ohhh-stars! Quivers of pleasure slap into you, one after another, robbing the strength from your [pc.legs] until the quivering limb");
	...
	else if(pc.statusEffectv1("The Treatment") == 0 || pc.statusEffectv1("The Treatment") == 2)
	{
		...
		if(startHours < 4 && treatedHours >= 4)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (4 - startHours) * 60) + " You feel pretty good actually - nothing exceptional, just a general wellness. You stretch and smile. It's turning out to be a pretty good day!";
		}
		
		//3
		if(startHours < 6 && treatedHours >= 6)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (6 - startHours) * 60) + " Feeling a little hungry, you reach into your equipment and grab one of the cheap ration bars that came with your first ship. You're staring at an empty wrapper and burping before you know it. Where did the time go?";
		}
		
		//4
		if(startHours < 8 && treatedHours >= 8)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (8 - startHours) * 60) + " It's been over eight hours since you took the treatment. Shouldn't it have done something by now?";
			if(pc.hasVagina())
			{
		...
		if(startHours < 14 && treatedHours >= 14)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (14 - startHours) * 60) + ParseText(" You spend a few moments running your hands over your [pc.chest] and down your [pc.belly], attempting to ignore the way your [pc.nipples] harden in an attempt to catch under your fingers. It feels REALLY good.");
		...
		if(startHours < 16 && treatedHours >= 16)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (16 - startHours) * 60) + " This is turning out pretty nice. You run your hands across your chest, wondering how big you'll get before it has its way with you.";
		...
		if(startHours < 18 && treatedHours >= 18)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (18 - startHours) * 60) + " After blinking, the colors around you seem to almost pop into greater vibrancy. You gasp and marvel at them. How could such a change be possible? You look around yourself in awe, reveling in the odd, ocular sensation. What were you thinking about again?";
		}
		
		//10
		if(startHours < 20 && treatedHours >= 20)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (20 - startHours) * 60) + " You eat another ration bar and burp. Just how many will you eat before the Treatment works its way out of your system?";
		}
		...
		if(startHours < 22 && treatedHours >= 22)
		{
			if(pc.hasHair())
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (22 - startHours) * 60) + ParseText(" Ugh! Your [pc.hair] is all wrong! Using the codex as a mirror, you spend a few minutes arranging it for maximum effect. It frames your face just so, and you purse your [pc.lips] invitingly. Yeah, that's better.");
			}
			//No Hair
			else eBuffer += "\n\n" + logTimeStamp("passive", (22 - startHours) * 60) + " Ugh! You don't have any hair to accessorize with. Still, you could do something. You pull out your codex to use as a mirror and look over yourself. Maybe some cute earrings and some lip gloss would look on you. Pursed, inviting lips would complete the look.";
			//Libido +1
			pc.libido(1);
		}
		...
		if(startHours < 24 && treatedHours >= 24)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (24 - startHours) * 60) + ParseText(" You catch one of your hands rubbing your [pc.chest] out of the blue. You probably shouldn't be walking around idly groping yourself, but it feels really good, you know? Using your other hand, you squeeze from both sides at once. A ragged moan slips from your lips, and you release yourself, contented for now. You'll need to spend some time with the girls later.");
			//+7 lust.
			pc.lust(7);
			//Libido +2
			pc.libido(2);
		...
		if(startHours < 26 && treatedHours >= 26)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (26 - startHours) * 60) + " You ";
		...
		if(startHours < 30 && treatedHours >= 30)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (30 - startHours) * 60) + ParseText(" This time, when you find your hands on your [pc.chest], you let them play. You aren't masturbating, per-se, just letting your fingers play a little. Hot jolts of ecstasy emanate from your [pc.nipples], and that's just fine. By the time something else distracts you, your face is as flush as your teats are hard.");
			//lust +7
			pc.lust(7);
			//Libido to 35 or +5
		...
		if(startHours < 36 && treatedHours >= 36)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (36 - startHours) * 60) + " You rub your nipple and smile. With how good this feels, you should be whimpering on the floor in a puddle of your own ";
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (38 - startHours) * 60) + " You giggle, ";
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (44 - startHours) * 60) + " Talking isn't quite as easy as it used to be. There's so many different words and concepts and ways to arrange them that by the time you get halfway through a sentence you've forgotten what you were trying to talk about. It's way easier to just start talking with whatever words come to mind. Yeah, that'll work!";
			//Ditz Speech
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (46 - startHours) * 60) + ParseText(" A welcome flush rolls across your [pc.skin] as you consider your body. Your nerve endings seem alight with potential pleasure, just waiting to be touched and set off. Every part of your body begs for your attention and hands to tend to it. You idly rub your arms, [pc.hips], and [pc.legOrLegs] before letting go, tingling hotly. It's all you can do to keep from touching yourself, but at the same time, you feel so good! Your overheated body can handle so much pleasure; it's amazing! You've got to take your enhanced form for a spin and try some sex, just to see how incredible your orgasms will be. Maybe a few times in a row...");
			//+5 lust
			pc.lust(5);
		...
		if(pc.statusEffectv1("The Treatment") == 2)
		{
			...
			if(startHours < 49 && treatedHours >= 49)
			{
				if(!pc.hasCock())
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (49 - startHours) * 60) + " Whoah, your crotch feels all... warm and tingly!";
				...
				else
				{
					...
					if(pc.lust() < 75)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (49 - startHours) * 60) + ParseText(" Out of nowhere, you feel your [pc.cocks] erect, filling to a full tumescent state in a matter of seconds.");
					...
					//Else
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (49 - startHours) * 60) + ParseText(" [pc.EachCock], already hard, somehow seems to grow even harder. The full flesh tightens. The veins bulge. And the skin is pulled so taut by your tumescence that it gleams like the polished skin of a god.");
					}
					//Merge
			...
			if(startHours < 57 && treatedHours >= 57 && pc.hasCock())
			{
				if(pc.cockTotal() == 1)
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (57 - startHours) * 60) + " Your cock fattens deliciously one moment, then surges forward the next, straining as it adds an inch, then two to its length. More and more cock pours forth from your loins, the growth aided by budding tumescence until your boner is bigger than ever before";
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (64 - startHours) * 60) + ParseText(" A flush warms your cheeks out of nowhere, accompanied by a sudden surge in blood down below, making your [pc.cocks]");
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (80 - startHours) * 60) + ParseText(" You were just thinking about how amazing your [pc.cocks] ");
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (100 - startHours) * 60) + ParseText(" The worst part of being a cummy, constantly ready-to-go cow-[pc.boyGirl] is definitely the fluid problem. If you think about someone pretty, or the taste of your own dickskin, or fucking a cow-girl until she’s dopey and mooing, you inevitably start to leak pre-cum all over yourself");
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (110 - startHours) * 60) + ParseText(" The strangest thing happens while you’re walking. You trip - but that isn’t the strange part. As you’re falling, flailing in absolute panic, your [pc.cocks] start");
				if(pc.cockTotal() == 1) eBuffer += "s";
			...
			if(startHours < 125 && treatedHours >= 125 && pc.hasCock() && pc.genitalLocation() <= 1)
			{
				...
				if(pc.canAutoFellate(-1))
				{
					...
					eBuffer += "\n\n" + logTimeStamp("passive", (125 - startHours) * 60) + ParseText(" [pc.OneCock] slaps accusingly against your [pc.chest]");
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (130 - startHours) * 60) + ParseText(" Ooh, your [pc.balls] feel so warm they’re practically glowing! You dance in place, feeling them wobbling back and forth");
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (160 - startHours) * 60) + ParseText(" Your [pc.nipples] feel warm and... wet. You reach up to feel, ");
		...
		if(treatedHours >= 48 && pc.breastRows[0].breastRating() < pc.statusEffectv1("Treated") && treatedHours % 3 == 0)
		{
			...
			if (numGains > 0)
			{
				for (i = 0; i < numGains; i++)
				{
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + ParseText(" Your chest feels strange. It's all puffy, and your [pc.nipples] are a little swollen. Weird.");
						pc.breastRows[0].breastRatingRaw += .5;
					}
					//.5 cup to A cup
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " You give a squeal of surprise when you realize how big your boobies are getting. They're way more bouncy and squishy than before. If you got measured for a cheap bra, you'd definitely be an E-cup, but you don't think you need one.";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " You look down, at first surprised and then pleased to see a little bit less of the ground than before. Your titties are still growing!";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " Looking down, you smile. Your " + pc.feet() + " are totally gone from view.";
						if(pc.hasCock()) 
						{
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " You start to adjust the girls again. They're easy to pose just right for the maximum amount of eye-catching wobble, but sometimes you've just gotta have an excuse to heft and weigh them. There's nothing wrong with being comfortable with your own body or how soft and squishy and warm and wet your jugs are getting. You sigh, rubbing fingers around your enhanced areolae as you squeeze your breasts. They didn't quit growing yet. You're sure of it. Tits like these barely fit into an F-cup. You briefly consider kissing them.";
						//+5 lust
						pc.lust(5);
						pc.breastRows[0].breastRatingRaw++
					}
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " You stumble, setting off a small earthquake in your breasts. Giggling, you mentally categorize it as a class five boobquake and grab hold for stability, stilling your boobs with a supportive grope. There! You knead them a few times, weighing their mass. It feels plenty good, and, you figure, you've got a pretty head-turning rack now. An F-cup bra wouldn't fit you any more. Boobs like yours are a job for a double F... or a big, thick cock. These would be great for a titfuck, especially with how big and sensitive your nipples have gotten. They're like built-in handholds!";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " Every movement sends quakes of happy feelings through your mountainous melons, the feminine orbs entirely too delighted to bounce and jiggle for the whole world to see. And you can't blame them either. They're big, delicious tits. They deserve to be grabbed and squeezed and pulled until you're whimpering and drooling all over them... just like now. You moo quietly under your breath and pull your hands away, trying not to cum. You're pretty sure they're at least J-cups by now, but it's a far less pressing concern than the needy itch between your ";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " Looking down, you barely suppress a giggle. Your titties are just so gosh darned big! They're all wobbly and completely obscure your " + pc.feet() + "; why, you're pretty sure that without some serious effort you won't be able to make out your own groin. It's a good thing your fingers already know just where to go, but you're pretty sure they'd be manhandling these delicious knockers. You start squeezing them together, letting your eyes drift closed, imagining that strong, calloused fingers are doing the work. Having such big J-cups is nice.";
						//+10 lust
						pc.lust(10);
						pc.breastRows[0].breastRatingRaw++
					}
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (i * 3) * 60) + " Ooooh! A throaty moan rips through the air around you as you feel something come over your tits. It feels like a wave of tingling is hitting you. Your [pc.nipples] instantly ";
			...
			for (i = 0; i < lubeGainStarts.length; i++)
			{
				if (startHours < lubeGainStarts[i] && treatedHours >= lubeGainStarts[i])
				{
					...
					if(pc.driestVaginalWetness() <= 0)
					{
						...
						{
							eBuffer += "\n\n" + logTimeStamp("passive", (lubeGainStarts[i] - startHours) * 60) + " You suddenly feel... wet, ";
						...
						{
							eBuffer += "\n\n" + logTimeStamp("passive", (lubeGainStarts[i] - startHours) * 60) + " Your dry pussy - the one that didn't self-lubricate - suddenly feels decidedly... <i>moist.</i> You thrill at the discovery. Now all your vaginas are just as fuckable!";
						}
						//Multipuss multiple changed
						else
						{
							eBuffer += "\n\n" + logTimeStamp("passive", (lubeGainStarts[i] - startHours) * 60) + " All at once, you feel moist all over your crotch. The strange sensation won't go away, leaving you with nothing to do but press a pair of fingertips inside yourself, just to check. It's slippery and wet - ";
					...
					{
						//Singlepuss
						if(pc.totalVaginas()) eBuffer += "\n\n" + logTimeStamp("passive", (lubeGainStarts[i] - startHours) * 60) + " Whenever you get thinking too hard about what the Treatment is doing to your body, you find yourself getting wet, and not just wet, but slick enough that trickles of it can run down your thighs when you get all hot and bothered. It'll be way easier to handle insertions from dildos... or big dicks... or anything really.";
						//Multipuss but only 1 changed
						else if(cuntsBelowWetnessThreshold(2) == 1)
						{
							eBuffer += "\n\n" + logTimeStamp("passive", (lubeGainStarts[i] - startHours) * 60) + ParseText(" Oooh, you feel a long overdue change in [pc.oneVagina]. It's palpably wetter, just like its sister");
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (78 - startHours) * 60) + ParseText(" You grow increasingly aware of how productive and wonderful your [pc.breasts] are. The Treatment has given you the ability to produce so much!");
			if(pc.milkType == GLOBAL.FLUID_TYPE_MILK) eBuffer += " You squeeze a droplet onto a finger and try it, just to sample it. It tastes exactly like the freshest, most delicious milk you've ever tasted - way better than normal. No wonder New Texas is able to export so much milk; Texan cow-milk is amazing!";
			//Perk Unlocked: Treated Milk - Your milk tastes delicious, and milk production takes much longer to slow. The only way you'd stop producing is if you made a conscious effort to keep your roving hands off your milky nipples.
			eBuffer += "\n\n(<b>Perk Gained: Treated Milk</b> - Your milk tastes delicious, and milk production takes much longer to slow. The only way you'd stop producing is if you made a conscious effort to keep your roving hands off your milky nipples.)";
	 		pc.createPerk("Treated Milk",0,0,0,0,"Any milk you lactate tastes better, and you are less likely to stop lactating.");
		...
		if((pc.horns == 0 || (pc.hornType != GLOBAL.TYPE_BOVINE && pc.hornType != GLOBAL.TYPE_GOAT) || pc.hornLength < pc.statusEffectv2("Treated")) && treatedHours >= 82)
		{
			...
			for (i = 0; i < numHornGains; i++)
			{
				...
				if(pc.horns > 0 && (pc.hornType != GLOBAL.TYPE_BOVINE && pc.hornType != GLOBAL.TYPE_GOAT))
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) + (hornPerTick * (i + 1))) * 60) + " There is a crackling, rustling sound coming from above you. You look up, but nothing is there. Instead, you hear the same sound from behind you. This time, you twist around to try and identify the source, but to no avail. A minute later a piece of horn bounces off your nose on the way to the ground.\n\n<b>Your horns are breaking apart!</b> Dazedly, you feel at the crumbling totems, feeling them come apart in your fingers. Chalky dust clings to your hand, but more importantly, two little nubs remain on your head. They're small and pointed, like little cow horns.";
					pc.horns = 2;
					pc.hornLength = .5;
					pc.hornType = GLOBAL.TYPE_BOVINE;
				}
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) + (hornPerTick * (i + 1))) * 60) + " Ugh. Your head itches! Reaching up to take a scratch, you wince when you come across a painful bump on your forehead. A quick check with the Codex confirms that it's red and irritated, though you haven't seen a head form on the zit yet. You've never had such prominent acne before, and there's a matching lump on the either side. Maybe something stung you? It could always be a pair of bug bites. Gross.";
					pc.createStatusEffect("Horn Bumps");
				}
				//Breaking Skin
				else if(pc.horns == 0)
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) + (hornPerTick * (i + 1))) * 60) + " The pain from those irritating red bumps on your forehead is getting worse and worse with each passing moment, matched by a sudden desire to scratch madly at them until you flay the skin away. You resist as long as you can, but the need to tend to the maddening itch overwhelms your subpar self-control. Besides, if something itches, why not scratch it?";
					eBuffer += "\n\nTo your horror, your first scratch peels away a patch of offending skin, but with it comes a sense of relief. Helpless to stop yourself, you scratch and scratch until the desire is completely gone - and a pile of discarded skin has built up before your " + pc.feet() + ".";
					eBuffer += "\n\nWhat have you done to yourself!? Pulling out your Codex, you use the camera to check.";
				...
				{
					eBuffer +="\n\n" + logTimeStamp("passive", ((treatedHours - startHours) + (hornPerTick * (i + 1))) * 60) + " For the past few minutes, a nasty little headache has been brewing. You squeeze your eyes closed, flexing your jaw in an effort to deal with it, when it abruptly fades, vanishing in the span of a second.";
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) + (hornPerTick * (i + 1))) * 60) + " A wave of discomfort strikes just behind your forehead, growing worse by the second. There's really only one thing it can be - your horns getting bigger! You whip out your Codex, wincing from the sudden motion, and flick it on, getting yourself a ticket to your own horny transformation show. You giggle to yourself and watch.";
					eBuffer += "\n\nYour formerly one-inch horns have already pushed a little further out, perhaps a quarter inch. The longer they get, the wider their bases are becoming, and they're growing fast enough now that you can actually see them slowly sliding out, revealing bit after bit of gleaming white ivory.";
					if(pc.hasHair() && pc.hairLength >= 2) eBuffer += " You brush your bangs to one side, hooking them around one of the horns in the cutest way.";
					eBuffer += " The process is fascinating enough for you to forget your earlier discomfort. You watch, spellbound, as your horns continue to expand, growing ever more prominent on your face until they stop at around two inches long.";
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) + (hornPerTick * (i + 1))) * 60) + " Your jaw clenches, a low growl escaping your throat entirely uncontrollably. There's a powerful shifting and sliding going on in your skull. It leaves you seeing stars with your eyes half-crossed. There's blessedly little pain, but when it passes, you're very aware of additional weight tugging on your head. Your horns have grown: they're now three inches of gleaming white bovine beauty. You resolve to polish them at the first opportunity, maybe even buy some jewelry for them once you're sure they're done growing.";
					pc.hornLength = 3;
				}
				//3" horns to 4" horns - prolly gonna reuse some of this for guys.
				else if(pc.hornLength < 4)
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) + (hornPerTick * (i + 1))) * 60) + " Your eyes suddenly cross, and you drop yourself to the ground, lest you run into something or worse. The rumbling sense of movement is working on your skull once more, like giant boulders rolling around the inside of your head. It doesn't hurt, but it is very disconcerting, making it next to impossible to think.";
					eBuffer += "\n\nYou grunt and groan, feeling the sensation slide <i>outside</i> of your head as your horns expand, growing thicker and heavier.";
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((treatedHours - startHours) + (hornPerTick * (i + 1))) * 60) + " You feel a sense of... potential building within your head, expanding until it changes from a kind of nebulous energy into an unstoppable pressure. You feel your horns giving under the weight of it all, slowly sliding forward, expanding outward, growing heavier by the moment. You wrap your hands around them, feeling the change against your palms. When it's all over, you're left holding two big, strong five-inch horns.";
					pc.hornLength = 5;
					break;
				}
			}
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (treatedHours - startHours) * 60) + " You go to scratch at one of your " + pc.earsDescript() + ParseText(", only to find it differently shaped - and in a new location - than before. Gingerly feeling it, you discover that your aural organs are soft and leathery, with a fine coat of [pc.furColor] across their outer edges. You can still hear just fine; you're just listening through a pair of floppy cow-ears now. Briefly, you consider how good it would feel to have someone scratch them.");
			pc.earType = GLOBAL.TYPE_BOVINE;
		}
		//Hooves (Rarish) - requires biped minimum. No change for goo/nagaPCs
		...
		if(pc.totalClits() > 0 && pc.clitLength < .75 && ((startHours < 113 && treatedHours >= 113) || (startHours < 127 && treatedHours >= 127)))
		{
			if(startHours < 113)
			{
				...
				if(pc.isCrotchGarbed())
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (113 - startHours) * 60) + ParseText(" With every movement you make, you become increasingly aware of your [pc.clits] rubbing against your [pc.lowerGarment]. It’s impossible to ignore the constant, distracting friction on your nub");
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (113 - startHours) * 60) + " With every movement you make, you find your " + possessive(pc.vaginasDescript()) + ParseText(" [pc.clits] rubbing on your netherlips as if constantly aroused and swollen. It’s a nagging, constant sensation of friction on your nub");
					if(pc.totalClits() > 1) eBuffer += "s";
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (127 - startHours) * 60) + " You wonder if the best way to handle your enlarged clit";
				if(pc.totalClits() > 1) eBuffer += "s";
		...
		if(pc.hipRating() < 7 && treatedHours > 55)
		{
			...
			for (i = 0; i < numHipGains; i++)
			{
				...
				if(pc.hipRatingRaw < 3)
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((55 - startHours) + (hipsPerTick * (i + 1))) * 60) + " You look yourself over, discovering that your hips have widened, giving you a more feminine look.";
					pc.hipRatingRaw = 3;
				}
				//Not so smallish Sub 6 to 6
				else if(pc.hipRatingRaw < 6)
				{
					eBuffer += "\n\n" + logTimeStamp("passive", ((55 - startHours) + (hipsPerTick * (i + 1))) * 60) + " Whoah! Your hips have gotten wider. Nobody is going to mistake you for a boy when you can swivel these back and forth. You sashay them around a few times, just to try it out.";
					pc.hipRatingRaw = 6;
				}
				//Biggish (Sub max to max)
				else
				{
					...
					eBuffer += "\n\n" + logTimeStamp("passive", ((55 - startHours) + (hipsPerTick * (i + 1))) * 60) + ParseText(" Moving around, you’re pleased to discover a little extra wiggle in you walk. Your [pc.butt] sways hypnotically as you go, automatically borne on a sinuous back and forth motion by your expanding [pc.hips]. You wonder if anyone will notice.");
					break;
				}
			}
		}
		...
		if(pc.buttRatingRaw < 7 && treatedHours > 49)
		{
			...
			{
				if(pc.isCrotchGarbed()) eBuffer += "\n\n" + logTimeStamp("passive", ((55 - startHours) + (hipsPerTick * (i + 1))) * 60) + ParseText(" An increase in the tightness of your [pc.lowerGarments] gradually comes to your attention, forcing you to shift and adjust them.");
	...
	else if(pc.statusEffectv1("The Treatment") == 1)
	{
		...
		if(startHours < 8 && treatedHours >= 8)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (8 - startHours) * 60) + " Rubbing your chin, you consider the evidence stacking up around you in the form of empty wrappers. The Treatment is definitely doing something to you, though it’s still way too soon for it to be ";
		...
		if(startHours < 14 && treatedHours >= 14)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (14 - startHours) * 60) + " You frown. It’s already been the better part of a day and you’re no closer to being a ";
		...
		if(startHours < 34 && treatedHours >= 34)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (34 - startHours) * 60) + " You idly wonder how hard it would be to fit some gym equipment onto your ship so that you can stay in shape on the road. It’d be an entertaining diversion from the monotony of waiting for light drive to carry you to the next jump gate.";
		...
		if(startHours < 36 && treatedHours >= 36)
		{
			...
			if(pc.hasCock())
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (36 - startHours) * 60) + " You growl in dissatisfaction. You can’t seem to quell the rioting heat in your loins or the way it keeps your " + pc.cocksDescript() + ParseText(" so iron-hard with thoughts of near-constant sex. Even your [pc.nipples] are ");
				if(pc.hasDickNipples()) eBuffer += "jutting out of their sheaths, ready to be thrust inside something";
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (36 - startHours) * 60) + " You growl in dissatisfaction. You can’t seem to quell the rioting heat in your loins or the constant dripping.";
		...
		if(startHours < 38 && treatedHours >= 38)
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (38 - startHours) * 60) + " You crack your knuckles a few times, admiring the rich sound, powerful sound it makes. You can’t be far from getting your real rewards for taking the Treatment - muscles";
		...
		if(startHours < 44 && treatedHours >= 44 && pc.hasPerk("Inhuman Desire"))
		{
			...
			if(pc.hasCock())
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (44 - startHours) * 60) + " You find yourself just kind of idly rubbing at " + pc.oneCock() + " whenever you have a spare moment. At first, you’d stop yourself whenever it happened, but more and more, you don’t see the logic in stopping. It feels really good to have a little friction on your length, and if it keeps your body churning up a fresh load faster, who are you to complain? Your ";
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (44 - startHours) * 60) + " You find yourself just kind of idly rubbing at";
		...
		if(pc.balls > 0 && !pc.hasStatusEffect("Ballgrow Done Notice") && treatedHours >= 49 && startHours < 150)
		{
			...
			for (i = 0; i < numBallSizeGains; i++)
			{
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (ballSizeGains[firstBallSizeGain + i] - startHours) * 60) + ParseText(" A fateful tingle runs from one side of your [pc.sack] to the other, drawing your attention to the ") + pc.ballsDescript() + " within. They don’t look to have gotten any bigger this time. In fact, they’re probably done growing now. Well, ";
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (ballSizeGains[firstBallSizeGain + i] - startHours) * 60) + " You feel a sort of effervescent heat pooling down in your loins, all warm and bubbly, like champagne inside you. It’s most concentrated in your " + pc.ballsDescript() + ParseText(", which you are very aware of pressing on the [pc.skinFurScales] of your [pc.thighs] through your [pc.sack].");
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (ballSizeGains[firstBallSizeGain + i] - startHours) * 60) + " A pleasant, swaying weightiness accompanies your every stride, a potent reminder of your masculinity just a few inches below your crotch. And you think it’s getting heavier. Pausing with a grin the size of old Texas on your face, you reach down and cradle your " + pc.ballsDescript() + ". ";
					if(pc.balls == 1) eBuffer += "It’s ";
					else eBuffer += "They’re ";
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (ballSizeGains[firstBallSizeGain + i] - startHours) * 60) + " The sensation of heat and warmth throbbing through your " + pc.ballsDescript() + " is increasingly common, hour to hour, as ";
					if(pc.balls == 1) eBuffer += "it";
					else eBuffer += "they";
					eBuffer += " swell";
					if(pc.balls == 1) eBuffer += "s";
		...
		if(pc.tallness < 96 && treatedHours >= 72 && startHours < 168)
		{
			...
			if (numTallnessGains > 0)
			{
				for (i = 0; i < numTallnessGains; i++)
				{
					...
					{
						pc.createStatusEffect("Treatment Height Boosted",0,0,0,0,true,"","",false,10080);
						eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + ParseText(" A kind of all-over ache has been bothering you off and on all day. It’s a deep pain, below the skin and muscles; you figure it’s your very bones. You were expecting to get taller. This must be what they mean by ‘growing pains’. A quick measurement confirms it. You’re [pc.height] tall now.");
					}
					//Less than 6’
					else if(pc.tallness < 72)
					{
						...
						if(rand(2) == 0) eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + " The ground seems a little further away than before. At first, you think it’s your head playing tricks on you, but when you whack your head on something that you should have passed harmlessly underneath, you have to admit it. You’re getting taller. Pretty soon, nobody is going to call you short!";
						//2
						else eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + ParseText(" You stop to measure yourself with a cocky smile. There’s nothing like getting bigger and stronger to make you feel like a million creds. The Codex beeps, informing you that you’re [pc.height] tall. Now that’s more like it!");
					}
					//Less than 7’
					else if(pc.tallness < 84)
					{
						//1
						if(rand(3) == 0) eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + ParseText(" Your back abruptly pops. It doesn’t hurt or anything, but you twist and stretch to limber up, feeling it pop a few more times in different places. The ever-present dull ache of growing bones underlies it all, promising that you’re still getting bigger and taller. Right now, you’re [pc.height] tall.");
						//2
						else if(rand(2) == 0) eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + " Things that used to pass right on by your head are getting closer and closer these days. Sometimes you even have to duck to avoid them. The ground seems farther away with every passing minute, a constant reminder of your Treatment-enhanced physique.";
						//3
						else eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + ParseText(" You snap out the Codex for a quick check on your amplified tallness. It beeps, displaying your new height on screen. You’re [pc.height] tall now. If this keeps up, you’re going to wind up taller than most normal terrans. And New Texans? Well... maybe you’ll catch up to the taller bulls.");
					}
					//Less than 7’6”
					else if(pc.tallness < 90)
					{
						...
						if(rand(3) == 0) 
						{
							eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + " You’re definitely still growing in spite of being well past the seven foot threshold. You could pass for average on New Texas right now, if you wanted to stick around there. Elsewhere, you must look awful tall.";
							if(CodexManager.entryUnlocked("Raskvel")) eBuffer += " Heck, the raskvel on Tarkus will probably think you a giant.";
						}
						//2
						else if(rand(2) == 0) eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + ParseText(" You stretch your arms out high over your head and arch your back, working your sore joints. It’s one thing to revel in your added stature. It’s quite another to suffer from the constant aches and pains that come with your expanding physique. You do a quick measurement. You’re [pc.height] tall now.");
						//3
						else eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + ParseText(" Your smile broadens while you look around. Your viewpoint is still rising, slowly but surely. Though it isn’t fast enough to be truly perceptible, you still find yourself taking note of your increasing height every few hours. Right now, you’re up to [pc.height] tall.");
					}
					//Less than 8”
					else
					{
						//1
						if(rand(3) == 0) eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + " There’s no hiding the way the Treatment is changing you. You’re definitely taller than you were yesterday - at least an inch, maybe more. With your augmented stature comes a boost to confidence; nobody is going to mess with a huge " + pc.mf("guy","gal") + " like you.";
						//2
						else if(rand(2) == 0) eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + ParseText(" More and more, you have to duck to keep from whacking your head of objects of all shapes and sizes. It’s quite onerous to always have to duck and cower all the time, but at least everyone is always looking up to you. You’re [pc.height] tall now.");
					}
					
					//It’s over - hit dat cap or day 6.5
					if(treatedHours >= 168 || pc.tallness >= 96)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (tallnessGainStarts[firstTallnessGain + i] - startHours) * 60) + ParseText(" The familiar, dull ache to which you have grown accustomed diminishes moment by moment. You frown when it vanishes entirely; the Treatment won’t be making you any taller. You’ll have to settle for being [pc.height] tall.");
					}
				}
			}
		}
		...
		if(pc.tone < 100 && treatedHours >= 55 && startHours < 135)
		{
			...
			if (numSwoleGains > 0)
			{
				for (i = 0; i < numSwoleGains; i++)
				{
					...
					if(pc.tone < 10)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " You flex one of your arms and smile when you see a little muscle there. It isn’t much, but it’s a start. In fact... you drop to the ground and do a few push-ups, just to get your blood flowing.";
						pc.tone = 10;
					}
					//10 to 20
					else if(pc.tone < 20)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " Your arms, chest... all of you, really.... You’re looking a little less squeezably soft. Of course, you’re still a long way from well-defined muscles, but you’re not quite the creampuff you used to be either.";
						pc.tone = 20;
					}
					//20 - 30
					else if(pc.tone < 30)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " You feel... solid. On a whim, you do a couple push-ups and crunches, just to see how many you can do. They almost get easier the more you do them, but that can’t be right... can it? Whatever. You’re finally starting to fill out and pack on some muscle.";
						pc.tone = 30;
					}
					//30 - 40
					else if(pc.tone < 40)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " You’re tightening up in some places and swelling up in others, even if your overall broadness remains unchanged. Still, you no longer look like a soft, easy target. You’re starting to show a little muscle in places without flexing, but not much yet. You comfort yourself with the knowledge that a few hours racking weights ought to finish the job.";
						pc.tone = 40;
					}
					//40 - 50
					else if(pc.tone < 50)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " You go ahead and flex one more time, just for fun. There’s something delightful about watching your form swell with latent power. You could probably do a few pull-ups without breaking a sweat if you had a bar around.";
						pc.tone = 50;
					}
					//50 - 60
					else if(pc.tone < 60)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " You admire yourself in your Codex’s screen. The body of the " + pc.mf("guy","girl") + " in the screen is starting to look pretty good. Muscles are making themselves known all over. If you keep it up, you might even get a pretty nice looking six pack.";
						pc.tone = 60;
					}
					//60 - 70
					else if(pc.tone < 70)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " You pick up a rock and toss it around, anything to keep your hands busy and blow off some of this excess energy. No matter how active you are, you always seem to have more fuel in your tank, and despite the glistening sheen of sweat that you break out in, your expanding muscles don’t seem to mind in the slightest.";
						pc.tone = 70;
					}
					//70 - 80
					else if(pc.tone < 80)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " Everyday tasks that once seemed exhausting or tiring are getting easier by the hour. Long walks? Piece of cake. Hefting some cargo? Not something a little elbow grease can’t take care of. You’re breaking out in muscle all over, and it feels good.";
						pc.tone = 80;
					}
					//80 - 90
					else if(pc.tone < 90)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + ParseText(" You do a few one-handed pushups, watching your muscles ripple under your [pc.skinFurScales] with a smile on your face. The physical exertion is calming. It helps you think and plan. When you stop, you’re covered in a light sheen of sweat that only makes your muscles stand out that much more clearly.");
						pc.tone = 90;
					}
					//90-100
					else
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (swoleGainStarts[firstSwoleGain + i] - startHours) * 60) + " You look at yourself in your Codex’s screen and marvel at the chiseled adonis looking back at you. There isn’t a single part of your body that doesn’t display the unbridled physical power you have lurking just under the surface. You can’t imagine getting any more muscular than you already are, but that’s fine. Chicks dig it.";
						pc.tone = 100;
					}
				}
			}
		...
		if(startHours < 63 && treatedHours >= 63 && pc.hasCock() && pc.maxCum() < 1000)
		{
			...
			if(pc.balls > 0)
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (63 - startHours) * 60) + ParseText(" You feel the inside of your [pc.sack] clench and release. The feeling repeats two or three times in quick succession, each time leaving you feeling a little heavier... a little denser, like your ") + pc.ballsDescript() + " ";
		...
		if(pc.hasCock() && pc.refractoryRate < 50 && treatedHours >= 69 && startHours < 69)
		{
			...
			if (numRefGains > 0)
			{
				for (i = 0; i < numRefGains; i++)
				{
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (refGainStarts[firstRefGain + i] - startHours) * 60) + " One thing that you’re increasingly aware of is just how fast your " + pc.ballsDescript() + " feel";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (refGainStarts[firstRefGain + i] - startHours) * 60) + " Wincing, you realize that you feel... fuller than you should. Like your body has gone into overtime, producing sperm in record quantities. This could come in handy....";
						pc.refractoryRate = 25;
					}
					//RefractoryRate to 50! & minimum cumQ of 15
					else if(pc.refractoryRate < 50)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", (refGainStarts[firstRefGain + i] - startHours) * 60) + " There’s no doubt about it. Your " + pc.ballsDescript() + " ";
		...
		if((pc.horns == 0 || (pc.hornType != GLOBAL.TYPE_BOVINE && pc.hornType != GLOBAL.TYPE_GOAT) || pc.hornLength < pc.statusEffectv2("Treated")) && treatedHours >= 82)
		{
			...
			if (numHornGains > 0)
			{
				for (i = 0; i < numHornGains; i++)
				{
					...
					if(pc.horns > 0 && pc.hornType != GLOBAL.TYPE_BOVINE && pc.hornType != GLOBAL.TYPE_GOAT)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " There is a crackling, rustling sound coming from above you. You look up, but nothing is there. Instead, you hear the same sound from behind you. This time, you twist around to try and identify the source, but to no avail. A minute later a piece of horn bounces off your nose on the way to the ground.\n\n<b>Your horns are breaking apart!</b> Dazedly, you feel at the crumbling totems, feeling them come apart in your fingers. Chalky dust clings to your hand, but more importantly, two little nubs remain on your head. They're small and pointed, like little cow horns.";
						pc.horns = 2;
						pc.hornLength = .5;
						pc.hornType = GLOBAL.TYPE_BOVINE;
					}
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " Ugh. Your head itches! Reaching up to take a scratch, you wince when you come across a painful bump on your forehead. A quick check with the Codex confirms that it's red and irritated, though you haven't seen a head form on the zit yet. You've never had such prominent acne before, and there's a matching lump on the either side. Maybe something stung you? It could always be a pair of bug bites. Gross.";
						pc.createStatusEffect("Horn Bumps");
					}
					//Breaking Skin
					else if(pc.horns == 0)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " The pain from those irritating red bumps on your forehead is getting worse and worse with each passing moment, matched by a sudden desire to scratch madly at them until you flay the skin away. You resist as long as you can, but the need to tend to the maddening itch overwhelms your subpar self-control. Besides, if something itches, why not scratch it?";
						eBuffer += "\n\nTo your horror, your first scratch peels away a patch of offending skin, but with it comes a sense of relief. Helpless to stop yourself, you scratch and scratch until the desire is completely gone - and a pile of discarded skin has built up before your " + pc.feet() + ".";
						eBuffer += "\n\nWhat have you done to yourself!? Pulling out your Codex, you use the camera to check.";
					...
					{
						eBuffer +="\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " For the past few minutes, a nasty little headache has been brewing. You squeeze your eyes closed, flexing your jaw in an effort to deal with it, when it abruptly fades, vanishing in the span of a second.";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " A wave of discomfort strikes just behind your forehead, growing worse by the second. There's really only one thing it can be - your horns are getting bigger! You whip out your Codex, wincing from the sudden motion, and flick it on, getting yourself a ticket to watch your own burgeoning masculinity.";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " Your jaw clenches, a low growl escaping your throat entirely uncontrollably. There's a powerful shifting and sliding going on in your skull. It leaves you seeing stars with your eyes half-crossed. There's blessedly little pain, but when it passes, you're very aware of additional weight tugging on your head. Your horns have grown: they're now three inches of gleaming white, bovine awesomeness. You resolve to polish them at the first opportunity, maybe even get some ornamental studs for them.";
						pc.hornLength = 3;
					}
					//3" horns to 4" horns - prolly gonna reuse some of this for guys.
					else if(pc.hornLength < 4)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " Your eyes suddenly cross, and you drop yourself to the ground, lest you run into something or worse. The rumbling sense of movement is working on your skull once more, like giant boulders rolling around the inside of your head. It doesn't hurt, but it is very disconcerting, making it next to impossible to think.";
					...
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " You feel a sense of... potential building within your head, expanding until it changes from a kind of nebulous energy into an unstoppable pressure. You feel your horns giving under the weight of it all, slowly sliding forward, expanding outward, growing heavier by the moment. You wrap your hands around them, feeling the change against your palms. When it's all over, you're left holding two big, strong five-inch horns. Nice.";
						pc.hornLength = 5;
					}
					//5” to six” horns
					else if(pc.hornLength < 6)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " Here it comes! You wince at the onset of tightness in your forehead, increasingly familiar as your horns continue their trek toward their full size. It doesn’t even hurt that bad this time; it just feels like a strange, tight tingling as your horns add another inch to their already impressive length. When the sensation fades, <b>you admire your six-inch long horns.</b> Not too shabby. Any longer and you’ll have to be careful with them when going through doorways.";
						pc.hornLength = 6;
					}
					//6” -> 7”
					else if(pc.hornLength < 7)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " You grunt as the familiar feeling of horn growth sets in. Grabbing hold of the curved, steer-like protrusions, you give them a tug, easing more gleaming ivory into the air. The more horn you grow, the wider their stance and the more threatening you become. You could probably just tip your head an inch forward, snort, and send half the galaxy running. The thought makes you smile almost as much as the idea of a cow-girl squeezing them like handlebars while you give her a few good licks.";
						pc.hornLength = 7;
					}
					//7” -> 8”
					else if(pc.hornLength < 8)
					{
						eBuffer += "\n\n" + logTimeStamp("passive", ((startHours < 82 ? 82 - startHours : 0) + (hornPerTick * (i + 1))) * 60) + " You wince at the headache as it returns. The familiar ache that’s right behind your forehead can only mean one thing: your horns are about to grow again. But they’re already so big! You watch in disbelief as an extra inch";
						if(rand(3) == 0) 
						{
							eBuffer += "... no two extra inches pour";
							pc.hornLength++;
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (155 - startHours) * 60) + ParseText(" Your [pc.sack] sways heavily, more than ever before, the skin stretched taut. It gets your attention without even trying, really.");
			//One nut no new PG
		...
		if(!pc.hasCuntTail() && !pc.hasCockTail() && pc.tailType != GLOBAL.TYPE_BOVINE && startHours < 98 && treatedHours >= 98 && rand(10) != 0)
		{
			...
			if(pc.tailCount == 0)
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (98 - startHours) * 60) + ParseText(" You go to scratch at a spot above your [pc.butt] that's been bothering you for a few hours, and jerk when you hit something that wasn't there before - something rounded and fluffy. Pressing back carefully, you ease your fingers around the growth, discovering its furred texture and cords of muscle. The oddest part is feeling the fingers pressing on you through the fur. There's no doubt about it - <b>you have a tail.</b>\n\nIt's a fairly long tail with a gnarly little poof on the end, just like a cow's.");
				pc.tailCount = 1;
			}
			//Multitail
			else if(pc.tailCount > 1)
			{
				...
				if(pc.tailCount == 1 && !pc.hasTailFlag(GLOBAL.FLAG_LONG))
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (98 - startHours) * 60) + ParseText(" Your [pc.tails] brush against your [pc.leg] as you walk. Wait - your [pc.leg]? When did.... You twist around, staring down in shock. Where once you had [pc.tails], now you've got gently-swaying, bovine tails, complete with fuzzy puffs at the tips.");
					if(!pc.hasTailFlag(GLOBAL.FLAG_FLUFFY)) eBuffer += ParseText(" A fine layer of [pc.furColor] fur covers each one.");
					eBuffer += " You can make them swing on command but little else. The best control you can manage is to make them curl up to swat at your butt, and that takes some serious flexing. At least they look good.";
				}
				//Multi - long
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (98 - startHours) * 60) + ParseText(" Your [pc.tails] feel increasingly warm, moment to moment, and not from the ambient temperature either. The heat is internal, a calefaction that seems ready to set your posterior extremities alight with incredible energy. You twist around, concerned at first, but you smile lazily at what you find.");
					eBuffer += "\n\n" + StringUtil.upperCase(num2Text(pc.tailCount)) + " gently swinging, bovine tails hang behind you. The tips are poofing up, just as you'd expect";
					if(!pc.hasTailFlag(GLOBAL.FLAG_FLUFFY)) eBuffer += ", and a coat of fine fur is growing out over their lengths";
					eBuffer += ". In seconds, the warmth fades, leaving you with new, bovine butt ornaments. You can make them swing on command but little else. The best control you can manage is to make them curl up to swat at your butt, and that takes some serious flexing. At least they look good.";
				}
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (98 - startHours) * 60) + ParseText(" Your tail brushes against your [pc.leg] as you walk. Wait - your [pc.leg]? When did.... You twist around, staring down in shock. Where once you had a [pc.tail], now you've got a gently-swaying, bovine tail, complete with a fuzzy puff at the tip.");
				if(!pc.hasTailFlag(GLOBAL.FLAG_FLUFFY)) eBuffer += ParseText(" A fine layer of [pc.furColor] fur covers the whole thing.");
				eBuffer += " You can make it swing on command but little else. The best control you can manage is to make it curl up to swat at your butt, and that takes some serious flexing. At least it looks good.";
			}
			//Single - long
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (98 - startHours) * 60) + ParseText(" Your [pc.tail] feels increasingly warm, moment to moment, and not from the ambient temperature either. The heat is internal, a calefaction that seems ready to set your posterior extremity alight with incredible energy. You twist around, concerned at first, but you smile lazily at what you find.");
				eBuffer += "\n\nA gently swinging, bovine tail hangs behind you. The tip is poofing up, just as you'd expect";
				if(!pc.hasTailFlag(GLOBAL.FLAG_FLUFFY)) eBuffer += ", and a coat of fine fur is growing out over its length";
				eBuffer += ". In seconds, the warmth fades, leaving you with a new, bovine butt appendage. You can make it swing on command but little else. The best control you can manage is to make it curl up to swat at your butt, and that takes some serious flexing. At least it looks good.";
			}
		...
		{
			eBuffer += "\n\n" + logTimeStamp("passive", (141 - startHours) * 60) + " You go to scratch at one of your " + pc.earsDescript() + ParseText(", only to find it differently shaped - and in a new location - than before. Gingerly feeling it, you discover that your aural organs are soft and leathery, with a fine coat of [pc.furColor] across their outer edges. You can still hear just fine; you're just listening through a pair of floppy cow-ears now. Briefly, you consider how good it would feel to have someone scratch them.");
			pc.earType = GLOBAL.TYPE_BOVINE;
		}
	...
	if (pc.hasCock() && pc.statusEffectv3("Treated") > 0)
	{
		...
		if (pc.isAmazon())
		{
			...
			if (numGains > 0)
			{
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (cockGainTimes[baseGainTime - 1] - startHours) * 60) + " Your " + pc.cocksDescript() + " ";
		...
		else
		{
			if (startHours < 51 && treatedHours >= 51)
			{
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (51 - startHours) * 60) + " Your " + pc.cocksDescript() + " ";
					if(pc.cockTotal() == 1) eBuffer += "is";
					else eBuffer += "are";
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (60 - startHours) * 60) + " You grin when you realize how heavy the swaying length";
				if(pc.cockTotal() > 1) eBuffer += "s";
				if(pc.legCount > 1) eBuffer += ParseText(" between your [pc.legs]");
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (66 - startHours) * 60) + " Fuck yes, your " + pc.cocksDescript() + " ";
				if(pc.cockTotal() == 1) eBuffer += "is";
				else eBuffer += "are";
			...
			if (startHours < 83 && treatedHours >= 83)
			{
				...
				if(pc.isCrotchGarbed())
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (83 - startHours) * 60) + ParseText(" Your can barely fit in your [pc.lowerGarments] anymore. Even soft, your ") + pc.cocksDescript() + " ";
					if(pc.cockTotal() == 1) eBuffer += "is";
					else eBuffer += "are";
				...
				{
					eBuffer += "\n\n" + logTimeStamp("passive", (83 - startHours) * 60) + " You can barely go ten minutes without having to stop and appreciate your expanding manhood";
					if(pc.cockTotal() > 1) eBuffer += "s";
			...
			{
				eBuffer += "\n\n" + logTimeStamp("passive", (100 - startHours) * 60) + " Your " + pc.cocksDescript() + " surge";
				if(pc.cockTotal() == 1) eBuffer += "s";
