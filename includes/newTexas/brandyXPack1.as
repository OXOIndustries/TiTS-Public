...
public function brandyVaginal():void
{
	...
	else output(" tearing a loud, surprised \"MoooOOOOO!\" from her shapely lips, and let your willpower slip away, finally allowing your orgasm to begin.");
...
public function brandyMutualFingering():void
{
	...
	output("\n\nWith the cowgirl already as wet as she is, it's not difficult to slip a pair of fingers back into her, drawing a stuttering \"M-mooooo…\" from her between her lips. Brandy obviously doesn't want you to feel left out, and sinks a finger into your [pc.vagina], spreading your labia and leaving you to moan quietly into your lover's mouth.");
...
public function brandyLetterTalk():void
{
	...
	output("\"I got your letter, by the way,\" you say pulling out the already-opened crimson envelope and showing it to Brandy.");
	...
	output("\n\nWith a nervous smile and a silent chuckle, Brandy stutters out a single, curious \"M-... m-moo?\"");
...
public function brandyCoupleTalk():void
{
	...
	output("\n\n\"Of course we can be together,\" you whisper as your hug continues.");
...
public function getBrandysLetter():void
{
	...
	output("\n\n\"Oh, hey there, [pc.name]. Hold up a second,\" he says, quickly grabbing your attention, \"I got something I'm supposed to deliver to ya'.\"");
	...
	output("\n\n\"Some girl came by and dropped this off: green pig tails, bell around her neck,\" he continues, waving the crimson letter around as you approach the counter, \"She didn't say much… well she didn't say <i>anything</i> come to think, but uh, she pointed out your name on the letter, so I figured it was for you.\"");
	output("\n\nSounds like Brandy.");
	...
	output("\n\n\"No problem, " + pc.mf("sir","missy") + ",\" he says as you walk away, red envelope in hand. <b>You've got a letter from Brandy! Maybe you should open it!</b>");
	//give pc brandy letter key item and an inventory item they can read
	pc.createKeyItem("Letter", 0, 0, 0, 0, "A letter from Brandy.");
	output("\n\n");
...
public function approachBrandySally():void
{
	...
	if (flags["MET_BRANDY_SALLY"] == undefined)
	{
		...
		output("\n\n\"Well hey there, [pc.name],\" she coos with her usual, sultry voice.");
		...
		output("\n\nShe looks back to you for a moment and winks before turning to Brandy again. \"Sweety,\" she says, draping her arms around the nervous cowgirl's shoulders, \"Do you know [pc.name] here?\"");
		output("\n\nBrandy turns her head back and forth between the two of you and then nods, with a wobbly smile and red-flushed cheeks.");
		output("\n\nSally grins at that, and looks up at you again, \"Oh… so you must've been that friend Brandy mentioned.\" The rum-cow releases her brandy-boobed counterpart and leans back again, patting a hand on her shoulder, \"It's good to know she has friends out there.\"");
		output("\n\nHuh, looks like your mute lover has been making some girlfriends recently.");
		output("\n\nBrandy seems to be blushing a bit less now, settling back into her seat as Sally speaks up again, \"Well, now that you're here, [pc.name], what do you think about spending some time with me and Brandy for a bit? We could use some company.\" She winks your way as a sly smile crosses her face before leaning into her green-haired friend again, \"Right, sweetie?\"");
		output("\n\nThe cowgirl seems almost surprised by the question, but nods hurriedly with a happy look on her face.");
		output("\n\n\"Seems like we're in agreement here, sugar,\" Sally coos to you, pheromones wafting over past Brandy and right to your nose, \"So, [pc.name], care to have some drinks with us?\"");
	...
	else
	{
		...
		output("\n\n\"Nice of you to visit us, [pc.name],\" Sally coos, leaning forward and draping her arms over Brandy's shoulders, \"What brought you over to visit lonely ol' us today?\" Then, with a sly grin, she slides her hands down and gives her fellow cow-gal's exposed tits a little, loving squeeze, making her jump and let out a surprised \"Moo!\" while Sally simply giggles.");
...
public function brandySallyTalkThem():void
{
	...
	output("\"Oh, us?\" she says, touching a hand to her collarbone as your drinks arrive, \"Well, me and Brandy used to be co-workers back at Bailey's… we were both in the same department.\" The rum-cow pauses and takes a drink, before licking her lips and turning to her brandy-boobed friend, \"We were acquaintances at the most. I would say 'goodbye' and 'hello' as we came and went, but I never really got to know her, always ran off right after her shift ended… I didn't even know she was mute!\"");
	output("\n\nSally smiles and wraps an arm around a blushing Brandy's shoulders before continuing, \"But, I saw her here at the Bronco");
	
	if (flags["MET_BRANDY_SALLY"] == undefined) output(" about a week ago");
	else output(" one day");
	
	output(" and recognized her, but I didn't know from where… so, I went up to her and I guess we just hit it off.\" She leans into her girlfriend, wrapping her other arm around Brandy in a quick hug, making the minty-haired cowgirl moo happily before Sally pulls back.");
...
public function brandySallyThreesome():void
{
	...
	output("\n\n\"Hmmm,\" The rum-cow muses, leaning forward and wrapping her arms around her girlfriend's waist, \"I dunno why we have to go <i>all the way</i> to ");
	
	if (flags["SEXED_SALLY"] == undefined) output(" Brandy's house");
	else output(" my room");
	
	output(" when we can do the same thing right here?\" With that, Sally slides her hands down to Brandy's thighs and gives her legs a gentle spreading, baring her juicy pink pussy to you (and the rest of the bar). That has the freckled - covered cowgirl squirming in her spot, letting out nervous little moos and turning as red as");
	
	if (silly) output(" some sick ass LEDs in a gaming rig");
	else output(" Epsilon Eridani's second star");
	
	output(" while her much-less-shy lover leans in close to one of her bovine ears. \"C'mon, sweetie,\" she coos, running her hands up Brandy's curves to the swell of her breasts, \"It'll be fun… just like working at the brewery.\"");
	...
	output("\n\nThat prompts a big grin from Sally who looks back up at you, \"Alright, [pc.name], why don't you help me out with this cutie?\" She gives the shy cowslut's tits a gentle squeeze, tearing a quiet, pleasured moo from her lips.");
	...
	if(!pc.isTaur() && pc.hasCock() && pc.cockThatFits(brandyCapacity()) >= 0) 
	{
		...
		output("\n\nSally takes notice of her girlfriend's attempts to quell her own pleasure, and leans in close to one of her bovine ears and whispers to her, \"C'mon, Brandy, cum for me and [pc.name], right here in the bar.\"");
		output("\n\nAnd that, along with the ceaseless pleasure she's receiving and the pressure from this public setting, is enough to bring the minty-haired, lube-leaking New Texan to orgasm. Her legs tense in your grip, and her pussy clamps down around your [pc.cockNoun " + x + "] like a squishy vice. A single long, loud \"MmmmoOOOoooOOOOOO!\" erupts from from her lungs, signalling her climax to the rest of the Bucking Bronco. Girlcum gushes from her convulsing cunt, creaming your cock and coating her barstool, thights, and the floor with a fine coating of her feminine fluids.");
	...
	else
	{
		...
		output("\n\nSally takes notice of her girlfriend's attempts to quell her own pleasure, and leans in close to one of her bovine ears and whispers to her, \"C'mon, Brandy, cum for me and [pc.name], right here in the bar.\"");
		output("\n\nAnd that, along with the ceaseless pleasure she's receiving and the pressure from this public setting, is enough to bring the minty-haired, lube-leaking New Texan to orgasm. Her legs tense in your grip, and her pussy clamps down around you [pc.tongue] like a squishy vice. A single long, loud \"MmmmoOOOoooOOOOOO!\" erupts from from her lungs, signalling her climax to the rest of the Bucking Bronco. Girlcum gushes from her convulsing cunt, coating her barstool, thighs, the floor, and most of your face with a fine coating of her feminine fluids. You happily take all the crystal-clear girl-goo that Brandy will give you, enjoying the flavour of her arousal as she rides out her orgasm.");
		output("\n\nThrough it all, no one in the bar that isn't involved even bats an eye, this obviously being a common sight on New Texas, and even more common in this saloon.");
	...
	output("\n\nSally chuckles, \"Great job, sweetie, don't think I've ever heard Brandy moo like that before!\" The sweet-smelling New Texan takes her hands off her girlfriend's breasts, instead opting to hold her waist like some sort of post-coital snuggle in the middle of a bar. \"Well,\" the rum-cow starts to explain, \"Looks like you really tuckered poor Brandy out! Guess she's just have to rest right here for a bit. Right, sweetie?\"");
	output("\n\nWith that, she looks to the cowgirl in question, who turns back to face Sally, giving her a nod and a quiet, tired \"Moo…\"");
	output("\n\nSmiling, the darker of the two gals gazes back up at you once more, \"Hey, once Brandy's all rested up, I think you should stop by again… I'm sure she'd <i>love</i> to do this again.\"");
