...
public function greetDatTaurBitch():void
{
	...
	//[Leave] [Help]
	clearMenu();
	addButton(1,"Help",offerToHelpHaleyShedSomeWeight,undefined,"Help","Offer to help her shed some weight! Probably going to be messy.");
...
public function keepWatchingDatTaurSlootPoundHerMilkyMilkMaker():void
{
	...
	if(!pc.isTaur()) addButton(0,"Masturbate",masturbateWhileWatchingHaleyHumphumphump,undefined,"Masturbate","Watch the girl chase an orgasm in pursuit of your own.");
