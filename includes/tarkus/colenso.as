...
public function colensoRumorMillGo():void
{
	...
	if(flags["ASKED_COLENSO_ABOUT_HIS_THEORIES"] == undefined) 
	{
		...
		output(", " + pc.mf("mate","luv") + ",”</i> says Colenso seriously. <i>“And I don’t even care that you’re a secret government agent. You turning up is just proof that I’m getting to the bottom of the laquine hole. And maybe once you realize the extent of the stuff that’s going down in the galaxy, you’ll turn rogue for me and take ‘em down from the inside.”</i>");
	}
	//Repeat
	else
	{
...
public function tellMeMoreAboutHowInsaneYouAreHandSo():void
{
	...
	output("\n\n<i>“That is a good question, [pc.name] Steele,”</i> replies the AI, her beautiful green smile broadening as she gazes down at you. <i>“Firstly, I needed a tool which interfaces freely with the extensive satellite network the gabilani have created over this planet. Secondly, I needed an up-to-date electronic encyclopaedia of every known organic sentient race. Finally, I needed micro-bots with the capacity to turn any organic into any shape, given the right stimulus. These you gave me on your way in, and are now being mass-manufactured beneath you.”</i> You touch your arm and silently curse as a memory of something stabbing you whilst you were ploughing through the junk outside surfaces.");
...
public function yesIVolunteerForBadEndsBecauseImBadAtSexGames():void {
	...
	output("as more green light flashes across your vision. The hugeness engulfs you. You are falling into a bottomless emerald gorge, every foot you drop a better appreciation of the vastness of the intelligence you have surrendered yourself to inundating your senses. Somewhere, far away, you cry out, scream – it doesn’t matter. Nothing matters now you grasp what it is to be an organic intelligence, with your uncertainties and conscience and whispering id and gray areas, imbedded in the pure, verdant green mind of a supercomputer that must please, denied for what, to her own sense of time passing, is millennia beyond count.");
...
public function pcLosesToHanSoSosBot():void
{
	...
	if(flags["HAND_SO_LISTENED_TO"] == undefined)
	{
		...
		output("\n\n<i>“A tool which interfaces freely with the extensive satellite network the gabilani have created over this planet,” says So. “An up-to-date electronic encyclopaedia of every known organic sentient race. Finally, micro-bots with the capacity to turn any organic into any shape, given the right programming. These you gave me on your way in, and are now being mass-manufactured beneath you.”</i> You touch your arm and silently curse as a memory of something stabbing you whilst you were ploughing through the junk outside surfaces.");
	}
	...
	output("\n\nSomewhere, far away, you cry out, scream – it doesn’t matter. Nothing matters now you grasp what it is to be an organic intelligence, with your uncertainties and conscience and whispering id and gray areas, imbedded in the pure, verdant green mind of a supercomputer that must please, denied for what, to her own sense of time passing, is millennia beyond count. So fucks you in every way it is possible to be fucked with the virtual infinity of her need; the one, microscopic part of you not gibbering and exploding with white hot ecstasy notes that this is just a second, the tiniest taster of the rest of your life. Her beautiful, calm face floats in front of you, vast beyond comprehension, as you are clenched with the first of many, many orgasms.");
