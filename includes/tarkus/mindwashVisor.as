...
public function startMindwashSceneLucas(choice:String = "menu"):void
{
	...
	if(characterSelect && choice == "menu")
	{
		...
		if(pc.hasKeyItem("VR Program: Advanced Sexdoll")) addButton(button++,"KQ:A. Sexdoll",kqMinibossEncounter,true,"Kiro Quest: Advanced Sexdoll Encounter","Experience battling with (and indulging in) everything Doctor Po's advanced sexbot has to offer!");
		if(pc.hasKeyItem("VR Program: Taursuit")) addButton(button++,"KQ:TaurSuit",taursuitsBonusFunz,true,"Kiro Quest: Taursuit Encounter","Experience encountering the tricky taursuit once more!");
		if(pc.hasKeyItem("VR Program: Doctor Illustria Po")) addButton(button++,"KQ:Dr Po",poVRIntro,undefined,"Kiro Quest: Doctor Po Encounter","Experience battling with Doctor Illustria Po once more!");
		return;
	}
