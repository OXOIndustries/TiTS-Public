...
public function aurorasAircraftThing():void
{
	...
	author("Magic Ted");
	auroraBust();
	output("It’s hard to be clear with the sheer amount of stuff layered between you and it, but that’s definitely a cockpit attached to a miniature aerodynamic frame you see crammed in one corner.");
