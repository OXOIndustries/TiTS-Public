...
{
	if(flags["LANDED_ON_TARKUS"] == undefined)
	{
		...
		flags["LANDED_ON_TARKUS"] = 1;
		CodexManager.unlockEntry("Gabilani");
	}
	else
	{
		if(flags["TARKUS_DESTROYED"] != undefined) output("You fly to what was once Tarkus, managing to steer clear of all the coasting space debris the fragmented planet left behind. You finally land in Novahome’s hangar and step out of your ship.");
		else output("You fly to Tarkus, safely dock in Novahome’s hangar and step out of your ship.");
	}
}
