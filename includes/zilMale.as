...
function rideDatZilCawk():void {
	...
	if(pc.hasCock()) {
		...
		if(pc.cockTotal(BEE) == 0) output(", though you lack the thick, wrinkled, musky shroud his has");
		output(". ");
	...
	//{Nice PC}
		...
		output(" whispering, \"<i>Ohh, a sexy ");
		if(pc.tallness >= 80) output("little ");
		output("guy like you?  Of course I'm gonna let you pop inside me. I bet you have a thick, sticky load in these shuddering balls of yours just waiting to baste my cunny, huh?</i>\"  He nods vigorously, his tool clenching");
...
Swaying rhythmically, the zil zips closer and remarks, \"<i>Oh, that is an odd place for a vagina.... Did you get it from a cunt-snake, or something else?</i>\" He cocks his head to the side, regarding it while his wings beat me more of his pheremonal scent towards you. This in turn causes your [tailgina] to secrete fresh droplets of lubricant, and they spatter down over your [pc.butt] in lewd trains.
...
{lose virginity!}
The alien slaps your [pc.butt] when he bottoms out, making you drip even harder, and he congratulates you, \"<i>Good " + player.mf("boy","girl") + ". It's going to get even better. Now just take it and cum yourself dry.</i>\"
...
{stretch}
Smooth armor compresses your [pc.butt] when the foreskin-wrapped dick bottoms out, the zil's smooth, hairless sack rubbing against you for a moment before he draws back and begins to fuck your [vagOrAss] slowly, almost languidly.
