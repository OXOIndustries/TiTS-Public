...
function worshipZeBullCawk():void
{
	...
	else if(999 == 0) output(" Your Treated mind revels in its new purpose, easily accepting your place of devotion to Ogram’s cock, simmering in the pheromone-induced puddle of fuck that you’ve become, all too eager to lick and kiss your way up his animalistic prick.");
	...
	if(9999 == 0) output("you desperately suppress it, too eager for a taste of Ogram’s seed to be deterred");
