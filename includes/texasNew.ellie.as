...
function meetingEllie():void
{
	...
	else if(pc.hasVagina())
	{
		...
		output(" obscenely between your [pc.legs], unable to hide its sudden and irresistible arousal.");
		if(pc.isCrotchGarbed()) output(" Your equipment visibly darkens around your traitorous crotch.");
	}
	else output("body is wracked with a bout of lust so strong that you desperately wish that you had... something, some genital between your [pc.legs] to give yourself some relief, no matter who’s staring.");
...
function getAHandyFromEllie():void
{
	...
	output("\n\nYou barely notice when Ellie’s milk runs out, or when she removes her breasts from your face. You’re vaguely aware of an empty, cold sensation in the long moment when she moves you ninety degrees on the counter and tosses your [pc.legs] around her shoulders, but that’s all forgotten when her big, warm lips wrap around your cock and start to suck. Something about returning the favor... you’re not sure anymore. Your vision swims as you boil in a cocktail of lust, pheromones, and intoxication... and you love every minute of it. Addled as you are, you can’t help but drift off to sleep in Ellie’s affectionate grip, your heart racing to the beat of what feels like your millionth orgasm to splatter her cheeks and fill the back of her throat...");
	processTime(55);
	pc.orgasm();
	pc.orgasm();
	pc.orgasm();
...
function getTailPeggedByTaurBitches():void
{
	...
	output("\n\nAs Ellie settles in overtop you, you begin to feel a hot, wet, supple... something crawling up your [pc.leg]. You cast a glance over your shoulder, but there’s nothing to see but the soft-scaled underside of Ellie’s bestial body over you, completely dominating your vision. It doesn’t take more than a moment more to <i>feel</i> what it is, though: you cry out as a thin patch of warmth caresses your thigh, and your still-spread cheeks. It’s drooling wet, slick and sticky with a thick coating of leithan girl-cum: as good a lube as any.");
