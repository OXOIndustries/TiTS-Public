...
public function fuckCherryAnywayYo():void
{
	...
	else
	{
		...
		pc.lust(50);
		clearMenu();
		addButton(0,"Next",druggedSteeleGetSlurped2);
	}
}

public function druggedSteeleGetSlurped2():void
{
	clearOutput();
	showCherry(true);
	author("Adjatha");
	...
	pc.lust(100);
	clearMenu();
	addButton(0,"Next",druggedSteeleGetSlurped3);
}

public function druggedSteeleGetSlurped3():void
{
	clearOutput();
	showCherry(true);
	author("Adjatha");
	...
	output("\n\n<i>“I can... hardly wait... for the... full meal...”</i> she whispers, voice nearly lost in the squelching, slapping clamor of her indulgent ride. Cherry pants and moans, her breath hot on you as she bounces her bubble butt atop your [pc.knotBallsHilt]. <i>“So much inside you... so much to come... it’s enough to drive a goo mad.”</i>");

	var x:int = pc.biggestCockIndex();
	//pc cock over 9”</i>
	if(pc.cocks[x].cLength() >= 9) 
	{
		output("\n\nThe rahn mounting you shudders with another orgasmic thrill at the thought of your imminent release, spearing herself to inhuman depths. You can feel her interior stretching upward and outward at the relentless pace of her uninhibited, animal appetites. Your eyes water from the suckling, tensing sensation around your cockflesh. Even reclined and incapacitated, the bulge of your shaft is all too evident within the rahn’s slender midsection.  Her gut, filling to obscenity with the girth of your [pc.cockBiggest], looks very nearly like a red-hued version of the Bubble Buddies she loves so much.");
	...
	{
		output("\n\nA few more long, heavy thrusts down onto your belly-bulging mast drives your cock’s bulge up past the amorph’s stomach. The peak of the phallus-stuffed distension batters against the bottom of her plentiful cleavage as she buries ever more of you inside her pliant, jelly cunt. Heavy breasts bounce atop the rahn’s gravid, gelatinous skin and squeeze your [pc.cockHeadBiggest] with their weight. She takes a series of rapid, shallow strokes while tightening her bosom between her forearms, compressing glistening E-cups around your cyclopean length. Every drop of her hips drives your [pc.cockHeadBiggest] further into the cushioning grip of her curvaceous vale.");
	...
	//if pc has horsecock:
	if(pc.cocks[x].cType == GLOBAL.TYPE_EQUINE || pc.cocks[x].hasFlag(GLOBAL.FLAG_FLARED)) output(" The peak of your [pc.cockBiggest] flares outward in anticipation, billowing flesh fattening in a thick saucer of bestial virility.");
	...
	if(pc.cumQ() >= 4000)
	{
		output("\n\nYour load surges through the thirsty girl’s clutching inner walls, jetting jizz fooding into her in moments. Without your ability to control or hold back, the fullness of your release is less a series of blissful spurts and more a full-on fluid eruption. Your [pc.cockBiggest], gorged to cum-fattened excess with the urethral-bloating climax, pours torrid waves of unrestrained [pc.cum] into Cherry’s suckling womb. Her gut positively glows with the fertilizing revel of your plentiful ejaculate.");
	}
	//ALSO if cum volume 10,000mL+
	if(pc.cumQ() >= 10000)
	{
		output("\n\nNo matter how much [pc.cum] your inflamed libido pours into the rose red girl, it’s never enough. A geyser seemingly without end stretches seconds into minutes, straining your overwrought nerves with seething torrents. The girl’s trembling interior drinks deeply and greedily, widening until it feels as if your mast is just about swimming in your own seed. Your your vision blurs, but in your state, you can no more hold back than you could pass through a solid wall.");
		output("\n\nThe pirate riding your gushing phallus heedlessly rocks her head back and forth from her penetrated perch, huge tits swaying in her gluttonous, cum-drunk indulgence. Oblivious at first,  she slowly seems to realize her meal has not yet ended. Half veiled eyes widen at the squelching, gurgling effluence swelling her midsection to pregnant thickness. She loosens her grip on your " + (pc.isTaur() ? "upstretched legs":"hands") + " as, fingers trembling, she pulls her gloves to hold the gravid opulence you’ve bestowed upon her." + (pc.hasKnot(x) ? " Despite the volume inside her, not a drop manages to find its way past the plug of your [pc.knot].":" Even her stretchy frame and passion-tightened muscles can’t keep your spunky volume from splattering virile ooze between the two of you."));
	}
...
public function druggedSteeleGetSlurped4(cummies:Number):void
{
	...
	// if cum volume was over 70,000 mL, set Cherry to cumflated for 24 hours. 9999
...
output("\n\nhttps://docs.google.com/document/d/1udEXIftSjMQT6UUMzyuT5UNuwDQOhzdi9eOfCNWvhcM/edit?usp=sharing");
...
output("\n\nThat kind of sensitivity is exactly what you’re looking for, however. Before she can fully regain her presence of mind, you rise and grab the gel around her hips, lifting her above the bed. Even without legs, your liquid burden makes the zel’rahn a hefty cargo indeed! Turning her around, you  lower the cumflated pirate onto her back, head dangling off the edge of the bed. She glances around, catching your intent when {taur: you raise your forelegs to mount the bed, eclipsing the girl’s vision with the fullness of your [pc.groin].}{else: to the shadow of your [pc.groin] falls across her face.}");

output("\n\n//cocksize <7:");
output("\n\nYour [pc.cockBiggest] flops down on the crimson girl’s cheek, the heat from her body radiating up your cockflesh like a warm invitation. <i>“Ah, the eternal question: fuck the rahn’s mouth or her tits? I’m all atitter with anticipation.”</i> She squeezes her chest, rolling her orbs against one another temptingly while nuzzling your shaft with the polished ebony of her black lacquered lips.");

output("\n\n//7-14:");
output("\n\nYour [pc.cockBiggest] flops down across her cheek and over her collar. Heavy flesh throbbing against her throat and [pc.cockHeadBiggest] nuzzling the peak of her recumbent breasts, Cherry’s needs a moment to take it all in. <i>“What a monster of a pick-up line,”</i> she pants, running a hand down your length. <i>“Picking on me when I’m down, huh? Better not go easy on me, now; I’m a bad girl and deserve a real pounding,”</i> she teases, kissing your [pc.knotBallsHilt].");

output("\n\n//14+:");
output("\n\nYou flex your abdomen, rising your [pc.cockBiggest] up above the crimson girl’s head before dropping it down atop her. The weight of the impact sends a ripple through the gel’s body. From brow to the furthest reaches of her chest, your colossus of a fuck-stick presses her even deeper in the bowed waterbed.");
...
output("\n\n{no legs: Moving forward to drag your shaft across the gelatinous girl’s throat, she obligingly leans her head back so you can mount her mammaries properly.}{taur: Bracing your front [pc.footOrFeet] against the far end of the bed and stepping forward, you drag your shaft across the gelatinous girl’s throat to mount her mammaries properly.}{else: Stepping forward to brace your legs around the gelatinous girl’s head, you drag your shaft across her throat, positioned perfectly to mount her mammaries.} Cherry’s breath is hot on your [pc.thighs], her juicy chest jiggling at the touch of your [pc.cockHeadBiggest]. The rahn’s ever helpful ponytail coils around your girth to aid your aim, pumping the thickening hardness in long, slow strokes that leave tingles dancing up your [pc.hips]. She folds her arms together under her breasts, squeezing the mounds together until they wobble precariously with every breath she takes. ");

output("\n\n[Next]");

output("\n\nRocking back and forth against the pirate’s semi-firm bosom, you find the cleft of her cleavage even tighter than you expected. The taut surface of her gel membrane has pillowy softness all around the vale, but the space between her compressed tits has the clenching modesty of a virginal pussy. Thankfully, the wet polish of her diluted toxin serves perfectly to lubricate your entry. {taur: Leaning forward to brace a forearm against Cherry’s wall,}{else: Leaning forward to bury your hands in the puffed peaks of the girl’s tremendous bust,} you push forward, parting the fastness between her arm-squashed globes an inch at a time.");

output("\n\nThe straining pressure around your [pc.cockHeadBiggest] is enough to tighten the muscles in your [pc.legOrLegs], sucking wetness stretching around your invading girth with moist, slurping sounds that almost make you think you’ve missed the hole and are forcing your way through the rahn’s thirsty throat. {taur: You kick one of your rear legs back, trying to relieve the building excitement in your hindquarters, the movement adding a little extra thrust to your forward momentum.}{else: Hands full of the ruby jelly’s tits, you paw them toward you, the slick spheres all too happy to swallow your throbbing pole into their narrow seam.} The salacious snugness of the rahn’s voluptuous chest fills with a pulsing ardor that, in most other races, you might take for a racing heartbeat.");

output("\n\nWith an ass-clenching pump, you drive your [pc.cockBiggest] through the tunnel of Cherry’s mountainous tits all the way to your [pc.knotBallsHilt]. {7-14: The crest of your [pc.cockHeadBiggest] peaks out the other side, nerves thrumming at the sudden release from the over-endowed girl’s squishing sanctum.}{14+: Clearing the length of the girl’s copious chest, the fullness of your stroke bumps your [pc.cockHeadBiggest] against the rahn’s over-filled belly. The rounded mound jiggles at the impact, sending a tidal tremor through her whole body.} Pulling back slowly enough to let your girth savor the hugging grip of her cleavage, you begin stroking inside her, dragging the legless pirate a few inches off the bed before pushing her back on.");

output("\n\nCherry laughs at the reckless ride, voice tight with pleasure, cheering you to a faster pace. Before long, you’re riding the buxom girl’s breasts for all you’re worth. Rubber bedding squeaks in protest as she scoots back and forth with each full-length stroke. It doesn’t take long before the rahn shudders and moans in the throes of another orgasm, girl-cum spurting across her bed and pooling under her ample ass. The gel’s climax gives her body a vibrating quality that eggs you on to an even faster pace. To keep from being dragged off entirely, Cherry reaches out to  hold onto the bed’s frame with both arms, her ponytail taking their place in squeezing her tits tightly around your [pc.cockBiggest].");

output("\n\nThe extra limb lacks the strength of her arms, however, loosening the gelatinous resistance of her cavernous vale just a touch. As the pressing firmness ebbs, ner natural softness blooms around you in a supple, quivering embrace. Globs of leaking pre drool into the cum gutter of her chest, your strokes rubbing the [pc.cumVisc] goo into her skin like a fresh coat of oily polish. Her back arching, Cherry moans with [pc.cumGen]-anointed abandon, her ponytail alternating its pressure in time with your thrusts until you reach the precipice of your climax. Burying yourself to the hilt in the pirate’s cleavage, you stop thrusting and just holding the tender, trembling, fist-clenching moment for as long as possible.");
...
output("\n\nHer lips stretch to a broad O against your [pc.balls], her panting desire hot on your [pc.skinFurScales]. {balls under 3”</i>: Cherry’s tongue snakes out to coil around your teste{s}, dragging the whole pouch into her mouth. The wet, sucking pressure of her cheeks alongside the thirsty winding of her oral organ is nearly enough to knock you on your ass. All too soon, however, she lets your nuts slip back out with an impassioned gurgle, her tongue still playing across their girth.}{balls 3-6”</i>: The suction of Cherry’s mouth closes around your ballsack, thirsty zeal melting your endurance. The gel’s vacuuming kiss manages to hoist {one of} your hefty ball{s} into her maw, her cheeks bloating with the girth of your spunk factory. She noisily sloshes the churning mouthful before her trembling lips let it slip from the moist embrace.}{balls over 6”</i>: Cherry’s long tongue makes as much of a circuit as it can around the incredible girth of your spunk factor{y/ies} as she squeezes her pillowy lips against orbs larger than her head. Suck as she might, however, the ambitious rahn’s mouth is simply not large enough to swallow your nut{s} whole. As if recognizing the supremacy of your girth, she turns her suckling pucker to the task of total ball worship. With the single mindedness of a prayer, she covers every inch she can reach with a wet whisper of drooling desire, consecrating her face with your churning heat while bathing your {kingly/queenly} nuts ing her slavish submission.} <i>“Almost... as delicious... as your cum...”</i> she gasps between bouts of desperately tongue-polishing your [pc.balls].");
...
output("\n\nFrom the caressing embrace of her lips, the zel’rahn’s tongue slips across your [pc.skinFurScales] with the sinuous resolution of a serpentine huntress. The lengthy organ snakes its way across the bounds of your lower lips and coils possessively around your [pc.clitOrClits]. A burst of sensitive tightness cracks up your spine, making you grind against the gel’s face. Her lips find your [pc.pussy], obsidian pillows nibbling on the cushions of your labia while she sucks the dripping [pc.girlCum] from your slit. You can’t help but buck and moan, squeezed at both tender ends by the gel’s tits and tongue.");

output("\n\n//merge");

output("\n\nIt’s too much. With Cherry’s silky-smooth cushions around your [pc.cockBiggest], every impulse in your body ignites with the dizzying crescendo of rutting release. Shameless, bestial need floods your [pc.chest] with carnal heat. Overcome by a lustful haze, your liquid passion bursts free, pouring from you in [pc.cumColor] gouts on the ruby rahn’s obscenely bloated body. You buck deeply into her tits, dragging your [pc.cockHeadBiggest] through her pillowy peaks, mixing the delicious ache of your orgasmic bliss with the soothing embrace of her jelly breasts.");

output("\n\nThe streaming rush running between the pirate’s nippleless udders apparently feels as euphoric to her as it does to you. Caught once more in the exhilaration of organic rapture, the amorph squirts the thin, pink goo of her helpless bliss between her plump trunks. As you pump your load into the girl’s bountiful bosom, she drenches the interiors of her rounded stumps with an equal volume of glistening femme cum. <i>“F- fuuuuuuuuuck,”</i> she moans out of the side of her mouth, unable to articulate anything more complicated through the undulating ecstasy of having her tits fucked full of [pc.cumGen] spunk.");
...
output("\n\nBy the time you’ve run dry, the ruby rahn is a sticky mess. If nothing else, you can appreciate her choice in rubber bedsheets. Lazily rubbing the softening length of your [pc.cockBiggest] between her gooped breasts, Cherry runs her tongue across your [pc.knotBallsHilt] to gather up a mouthful of your seeping excess. {pc cum 70,000 mL+: <i>“I’ll have to send Molli in here for cleanup,”</i> she notes between gooey gulps.} <i>“With this kind of mess, you’d think I was filling in for one of my employees!”</i>");

output("\n\n{nice: <i>“If that was anything to go by, I can see why you’re the boss,”</i> you pant in spent satisfaction. You pull back enough to slip free from the gel girl’s cleavage but before you can disentangle yourself, she starts to slurp straight from the drooling slit of your [pc.cockHeadBiggest], thirsty for your seed even now.}{misc: <i>“Well, you’ve certainly got the biggest booth, and an appetite to go with it,”</i> you add, pulling back from the girl’s gooey embrace. As if rising to the challenge, she leans into your retreating length, smearing her blushing face against your drooling cum-slit with an indulgent moan.}{hard: <i>“The cheapest one, at that. Afterall, you work for nuts,”</i> you laugh, gesturing at the gooey mess around her. You pull back just enough to free your mast from the girl’s tits, bouncing your [pc.cockHeadBiggest] against her face on the way out.} You have to force yourself to {taur: dismount}{else: step away} from the bed, before the pirate’s endless appetite can pull your drained and aching body in for another round.");
...
output("\n\nYou grow harder with each passing moment, pumping between her cheeks until the girl’s bubble butt has stroking you to full mast.  <i>“If only there were a nice, hard pommel for support,”</i> you muse, scooting her ample booty backwards to squish up against your [pc.cockBiggest]. Dollops of pre drip from your [pc.cockHeadBiggest] and run down the small of her back and into the cleft of her generous backside.");

output("\n\n//cocksize <7:");
output("\n\nCherry wiggles her ass against your drooling hardon. <i>“I see how it is. Ask and I shall receive? Well, how about you help me mount up properly and I’ll see if I can’t break this stallion.”</i> No sooner asked, you tighten your grip once more and heave the spunk-stuffed slut a half foot into the air. She squeals in delight, her ponytail curling around your [pc.cockBiggest] and aiming it right for her dripping lower lips.");
...
output("\n\nThe effort is {pc str<25: monumental,}{pc str 25-50: a small labor,}{pc str 50+: relatively trivial,} but eventually you’ve hauled the pirate’s jizz-swollen bulk high enough to slap her undercarriage with the bubbling pre dripping down your [pc.cockHeadBiggest]. The pirate girl’s ponytail, acting on its own good instincts, coils around your [pc.cockBiggest] and aims it right for her dripping lower lips.");

output("\n\n//merge");
output("\n\n[Next]");

output("\n\nLowering Cherry down onto your length is more difficult than you would’ve imagined. Her vaginal tightness is so intense, that were it not for the gushing flow of her lubricating nectar, you doubt so much as your pinkie could pass the taut slit. As it is, your cock is caught in the shudderingly sweet clasp of suckling gelatin. The girl’s amplified gravity drags her fattened frame down your inches at a glacial pace, tensed depths parting further only after sampling your girth with a connoisseur’s leisure.");

output("\n\nGlobs of tension-teased ardor bubble up your jelly-suckled mast and you lay back to restrain the urge to flip her around and drill the gel girl’s face into her bedsheets. Resting your head against {pc has giving Cherry a huge bubble: the massive, purple bubble with your likeness printed on it,}{else: one of the massive, filled condoms Cherry keeps at the head of her bed,} you can see why she uses the bloated latex bubbles as pillows. A comforting lake of body heat washes over you, the rubbery package cuping and shaping itself around your neck and shoulders.");

output("\n\nA passing worry about accidentally popping the ballooned pillow is driven from your mind when Cherry’s pink-oiled posterior slips out of your grip, dropping her the rest of the way down your shaft. Piercing her constricting cunt all the way to your [pc.knotBallsHilt] in one, sudden plunge shocks you as much as the girl. The impact of her gravid gut on your diaphram just about knocks the wind from you.");

output("\n\nBreathless and seeing stars, you try to process the moist, quivering ripples Cherry’s body is sending up and down your length. Her midsection further fattened by your throbbing phallus, the rahn gapes in her own bliss-blindness for a long moment. Before she’s even recovered, the gel girl’s hips begin to move, the stumps of her thighs rowing her back and forth along your penetration. {pc has balls: The hefty weight of crimson ass cheeks rub down the the swell of your [pc.balls], demanding just that little bit extra of your galloping libido.}");
...
output("\n\nYou deliver an open-palmed slap across her ruby rear, jolting her upright. Muscles numbed by the heat of your boiling lust, you continue lifting the jumbo-sized gel, thrusting up as she drops back down. <i>“Is that what gets you going? Filling girls till they can’t move and just letting them smother you with their nut-fattened bellies? Well, bubble me with that sweet cream, you beautiful {bastard/bitch}! This condom wants more!”</i>");

output("\n\nYour {pc has balls: cum-bloated balls, churning with the rapid pace of your racing heart,} {else:body} reacts to the desperate plea with a breeder’s exuberance. The heat from Cherry’s spunk-stuffed stomach seems to flow with each slapping impact back into your body. Tendrils of tingling tightness wrap across your [pc.chest] as a cascade of sweet release hits you. Surging through your [pc.hips] and up your [pc.cockBiggest], the redoubled lust pours into the bloated pirate squirming in your lap with all the restraint of a burst dam.");
...
output("\n\n{if knot: The inflation of your [pc.knot] inside her pussy is met with an equally intense pressure of the girl’s echoing orgasm. The ballooning girth of your [pc.knot] leaves the overstimulated girl bucking in wild abandon, saddle-bound against your lap. Plugged by the girth of your [pc.cockLargest] and filling with your liquid heat, Cherry’s gelatinous body stretches further than you would’ve believed possible. Her ponytail cracks like a whip against her ass, your fleshy plug keeping every waistline-stretching load inside her, down to the last [pc.cumVisc] ounce.}");
...
output("\n\n{if knot: The inflation of your [pc.knot] inside her pussy is met with an equally intense pressure of the girl’s echoing orgasm. The ballooning girth of your [pc.knot] leaves the overstimulated girl bucking in wild abandon, saddle-bound against your lap. Plugged by the girth of your [pc.cockLargest] and filling with your liquid heat, Cherry’s gelatinous body stretches further than you would’ve believed possible. Her ponytail cracks like a whip against her ass, your fleshy plug keeping every waistline-stretching load inside her, down to the last [pc.cumVisc] ounce. Practically yowling in climactic, body-stretching bliss, the goo-slut somehow finds room for your gallons, your [pc.knot] refusing to let so much as a drop escape her enjoyment.}");

output("\n\nAs load follows load, the taut tunnel suckling so dearly on your [pc.cockHeadBiggest] expands under your volume. Cherry’s posterior trembles against your [pc.groin], climax-tender nerves quivering in the delicious ache of her swelling midsection. The cum-fat rahn, already gorged with your abundance, rides your pumping profusion with gluttonous euphoria.");

output("\n\nEven after burning through all the energy of the fuck, by the time your {balls: [pc.balls}{else: throbbing shaft} has run dry, Cherry is just that much wider than when the two of you started. Eyelids heavy and an addict’s grin plastered on her face,  Cherry wears a fresh flush of dark red by the time she rolls off of you. The weight removed, your lungs suddenly remember how to breathe, deep, cold gasps working to make up for the momentary crush of the rahn’s over-filled belly. Exhausted and possibly bruised, you can’t help but bask in the afterglow for a moment, lounging against the pirate’s huge {pc has given cherry a huge bubble: you-printed} latex pillow.");
...
output("\n\nCherry groans in the blissful ache of her engorged glut, the pressure inside her hitting its gurgling peak. {Even with your [pc.knot] tying the two of you together, the endless cascade of body-flooding ejaculate manages to push her free with a suckling plop} In the next moment, Cherry is thrown off of you, launched by your ceaseless eruption like a slime-sputtering cum balloon. The over-inflated girl is propelled backward, sliding across cum-slick rubber and rolling head-over-ass, before finally slapping against the abutting wall. Wobbling from the impact and leaking thick gouts of [pc.cumColor] seed from her climax-dazed body, she seems almost like a life-sized onahole, discarded and pouring out its overfilled load.");

output("\n\nWith your [pc.cockBiggest] no longer contained by the bubbled slut, the rest of your copious cream discharges in wild spree. You fill your hands with rubber sheets and buck into the air, your body still throbbing with rahn’s shared heat. Gasping with each release, your [pc.ass] rises and falls, clenching with each long, shuddering spurt. Arcing shafts of [pc.cum] splatter all across the pirate’s quarters, from ceiling to floor, until dripping nut has washed the room in a gooey shellac of your seed.");

output("\n\nWhen you catch your breath and take stock of your surroundings, a {libido < 30: flush of embarrassment heats your face}{libido 30-60: moment of startled awe settles over you}{libido 60+: giggle of light-headed pride bubbles up} at the sheer scale of the mess you’ve made. With her quarters drenched and the pirate herself swooning amid your oceanic discharge, you decide it would probably be best to take your leave.");
...
output("\n\nReaching over to Cherry’s discarded belt, you hoist the bubble-filled loop and give it an appraising look. <i>“Seems like you should really stop playing with your food and eat what’s on your plate,”</i> you scold.");
...
output("\n\n{player is over 5’: Stooping down, you bring yourself face to face with the spoiled slime.} Rolling the two inch sphere between your fingers, you consider the brightly colored, {player hasn’t given Cherry any S. Bubbles: anonymous}{else: violet} condom. Holding it between your forefinger and thumb, you raise the small balloon to the wine-hued woman. <i>“Open wide.”</i>");
...
output("\n\n<i>“Well, just one left,”</i> you remark, pulling the largest, fist-sized bubble off the center of Cherry’s belt. {nice: <i>“You’re doing great! Hold on just a little longer.”</i>}{misc: <i>“This one’s a doozy! Grab onto something and brace for impact.”</i>}{hard: <i>“Seems like you’re pretty stuffed already. Don’t worry, I’ll make it fit.”</i>} Over the cherry-red mountain range of the rahn’s heaving tits, you can just barely make out the impatient nodding of her hard-blushing cheeks. Her ponytail coils around one of her breasts and then the other, as if trying to find something firm to take hold of in preparation.");
...
output("\n\n{Nice: <i>“That’s everything! You’ve earned this.”</i>}{misc: <i>“Good girl. You get a treat!”</i>}{hard: <i>“What an obedient slut.”</i>} Cupping your hand under her chin, you lift slightly and say the word she’s been ravenously waiting for: <i>“Swallow.”</i>");
...
output("\n\nYou take the large cum bubble back from her and hoist the bowling ball-sized orb suggestively. <i>“Any idea what we could do with this?”</i>");
...
output("\n\n{Silly mode: <i>“This is kinda your fault for having an asshole to begin with. What do goos even need one of these for?”</i>");
...
output("\n\nCherry’s breathing gets a bit faster, her shoulders rolling with anxious tension. <i>“You’re going to want to relax,”</i> you caution, sliding your thumb into her asshole without any additional warning. Even without legs, she very nearly jumps right out of bed, her ponytail trying to whip around  to strike you. Luckily, her polished black lips have a firm grasp on tentacle-limb’s tip. You {nice: shush and soothe her, running your free hand down her hips}{misc: tease and tweak her, filling your free hand with her jelly love handles}{hard: punish the outburst with your free hand, spanking her again and again until your palm throbs}, the girl plaintively mewling as you press your digit in to the second knuckle. Slowly, you pull back and push in, gradually acclimating her to the sensation.");
...
output("\n\nDespite its fluid contents, the makeshift dildo is firm enough for you to force its well-lubed tip past the girl’s narrow rectum. She gasps, both hands grabbing at the bedding. You slide an inch of the tension-lengthened condom into her ass, its trapped heat radiating even through your thick gloves. Cherry’s hands tighten to fists and she buries her face in the rubber sheets, jutting her ass up as high as her thick trunks allow.");
...
output("\n\nWisely, you step back a moment before her ponytail whips around. Rather than trying to strike you or to pull the bubble free, the ruby appendage gives a sound stroke to her wobbling caboose. The slap is so loud you {nice: wince in sympathetic pain,}{misc: worry that she’ll pop her own bubble butt,}{hard: can’t help but grin with approval,} her body immobilized in a crystalized moment of rapturous climax. She very nearly vibrates, frozen almost as if her toxic touch had turned against her. Her pleasure paralysis loosens by degrees before she flops back down onto her stomach. Panting and dazed, Cherry seems pretty out of it. Her ponytail, however, wiggles at you in a beckoning motion.");
...
output("\n\n//first time");
output("\n\n<i>“So, what exactly where you planning on doing with that,”</i> you inquire, giving her latest, torso-sized bubble a poke.");
...
output("\n\n//repeat");
output("\n\nAs you retrieve the stolen Bubble-Tap from Cherry’s TamaniCorp collectables shelf, the rahn folds her arms under he breasts gamely. <i>“You know, it’s a good thing I don’t have cameras in here. Getting fed like this would absolutely ruin my reputation. We amorphs are already thought of as being cum-obsessed sluts.”</i>");
...
output("\n\nYou explain your plan to Cherry, who listens with the patience of a stone. <i>“That’s idiotic,”</i> she points out. <i>“I love it. Grab some gloves and let’s do this.”</i>");
...
output("\n\n[end]");
output("\n\n//change Cherry’s status to Cumflated for 24 hours, return to her menu");
