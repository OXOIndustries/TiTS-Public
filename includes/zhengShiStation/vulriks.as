...
public function andTheShadyAnatPastIiiiiisss(promised:Boolean):void
{
	...
	if (promised)
	{
		...
		output("\n\n<i>“My other daughters, dutiful as they were, would do whatever the Empire would ask of them. Falia wanted... more. Deserved more, really. She was not meant for the same life as her half sisters, or her mother, or her mother’s mother. The Empire is wise, but, ehh, bureaucrats are slow to move. Her talents, great as they were, could easily be overlooked. It could have taken decades for her talent to have been realised. And she was so restless, with all of that brilliance bottled up inside her. She saw this, despite her youth. So when she asked me for help...”</i>");
...
public function vulriksDoingYourButt():void
{
	...
	if (pc.hasGenitals()) output("Down below you feel your " + (pc.hasCock() ? "cock melt, exploding in Vulriks’ hand, painting the side of his counter with your sticky [pc.cumColor] cum." : "cunt burn, quivering in Vulriks’ hand, wetness oozing uncontrollably between his fingers."));
