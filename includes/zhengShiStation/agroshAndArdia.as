...
public function ardiasStory():void
{
	...
	output("\n\nArdia nods slowly. <i>“Yeah, right off my homeworld. The part of Hauâ Mai I grew up on is basically one island-wide resort, a real magnet for wealthy tourists looking for a beaches and jungle getaway. I thought I’d be safe from this kinda thing, until I made the mistake of joining a mission trip to one of the, uh, less civilized parts of the planet. I’d heard slavers target the dzaan tribes that still choose to live out in the jungles like they’re still on the homeworld, but we had a bodyguard at our camp and took as many safety precautions as we could. Wasn’t enough, I guess! Middle of the night, a ship comes in and orbits the village we were staying with. Lots of screaming, blinding lights, pirates flying down on jetpacks and grabbing people. Most of the missionaries got out okay, but I guess I was just the slowest tillabeast in the herd. Some big bastard in orange armor came out of the sky, grabbed me by hips, and jump-jetted me away to his ship.”</i>");
...
public function fuckArdiasCunt(x:int):void
{
	...
	showArdia(true);
	author("Savin");
	output("You grin at your lush lover, planting your hands on her knees and spreading ‘em wide. Her cock and balls dangle heavily, still leaking the aftershots of her first orgasm. Her nuts are still " + (9999 ? "apple-sized" : "swollen with seed") + ", so heavy with her alpha’s potent cum that as you slide your [pc.cock " + x + "] under them, each orb rolls onto either side of your shaft and tries to weigh you down before your [pc.cockHead " + x + "] can find purchase in Ardia’s slit.");
	...
	ardia.cuntChange(0,pc.cockVolume(x));
	pc.cockChange();
...
public function worshipArdiasButtYouSluuuut(x:int):void
{
	...
	ardia.buttChange(x >= 0 ? pc.cockVolume(x) : pc.hardLightVolume());
