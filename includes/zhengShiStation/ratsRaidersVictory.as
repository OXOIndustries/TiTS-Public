...
public function ratsTheReasonWeAreHere(useCock:Boolean):void
{
	...
	if (pc.isTaur())
	{
		if (useCock)
		{
			...
			if (pc.longestCockLength() < 24) output("\n\n<i>“Aaahh... Look at this stupidly huge dick!”</i> the rodenian grouses, but there’s a certain determination in her voice, muffled as it is down there. You feel six hands struggle to connect index finger to thumb around the sheer mass of [pc.cockTypeBiggest] meat you’re packing. <i>“Okay, let’s show this silly " + (ratsPCIsKnown() ? "CEO" : "[pc.boyGirl]") + " what we’re made of!”</i>");
...
public function ratsTheRideNeverEnds(vagId:int):void
{
	...
	else if (vagId >= 0)
	{
		...
		output("\n\nEyes cross, eyes shut. Nothing is experienced but the fine detail of rhythmically clenching cunt. The sudden growth of his blunt hardness as it swells with cum is just another mind-scrubbing detail in cacophonous and tempestuous climax. In the space of three spunk-shots, you already feel a few months pregnant. The heat of mouse-spunk forces its way into your womanly core, painting your most sacred place white; another rope, two shots, three… it's undeniably wonderful...");
