...
public function teyaalIsMaaaaad():void
{
	...
	output("\n\nYou nod and pull the hatch open, stepping through and into a small office - no more than 5 yards to a side, and yet luxuriously adorned with draped silks and cushions all across the floor, surrounding a central work terminal. There’s no chair at it: the room’s sole occupant seems more than happy to lounge on the lacy pillows while she works like some elegant harem-girl. Indeed, the whole room seems like it’s a sultan’s fuck-palace more than a scientist’s office. Guess that’s what the room outside is for.");
...
//+Mischievous. Start Teyaal with extra Lust.
...
public function rideTeyaalsDick(x:int):void
{
	...
	output("\n\nIf she insists. You shrug off your gear and stalk forward, bringing your [pc.foot] down on her dick and pressing it right back down on her gut. The gryvain gasps and snarls, but the guttural sound breaks off into a throaty moan as you start to move your ");
...
public function callOlympia():void
{
	...
	output("\n\n<i>“[pc.name],”</i> Olympia says softly, drawing your attention up from your captive to the sexbot’s sultry visage. Her breasts are quaking with every staccato thrust and her hands are sunk deep into Teyaal’s cheeks, but her eyes are locked on you. She crooks a finger, urging you to lean in.");
