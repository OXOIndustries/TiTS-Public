...
public function talkDaneAboutYoCousin():void
{
	...
	output("\n\n<i>“No, he didn’t.”</i> Dane’s lip curls back as his brow sets in anger. The veins on his biceps stand out a little bit more as fingers go white around his glass. <i>“[rival.name] thought that since we got captured, I had <i>“failed”</i> at my job, even though I took a half dozen wounds fighting our way out of that hellhole barehanded.”</i> He presents one of his right arms, displaying a long scar just above his elbow. <i>“They don’t fuck around with those spears of theirs.”</i> After a moment he rests it back upon the polished bartop. <i>“I had to claw my way out of that hellhole, trying not to bleed out the entire time, and by the time we finally get back to the DMZ, I find out that [rival.name] stiffed me </i>and<i> stranded me on that bug-infested shitheap.”</i>");
...
public function askDaneAboutOtherJobs():void
{
	...
	//Merge
	output("\n\nA booming laugh echoes out of the mercenary’s rippling abdominals. <i>“Sure, sure. I’ve been through enough shit to turn my fur white, if it wasn’t already.”</i> Dane pauses, tapping his chin while his spare arms fidget with his glass. <i>“Not all of ‘em strictly legal either. See my last one, pre-shitbag, seemed like it was a simple job: guard a trader while he closes and important deal with his associate. Of course it wasn’t.”</i>");
	//Nonbimbo
