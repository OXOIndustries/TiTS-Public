...
//- rahn tit fucks: HUGE milf girl, anti-morph collar, no mouth, huge areolae, pussy nips, several time slots where a various pirate is using one tit and the player can take the other (contest to fill asymmetrically, bro-down, ?)
...
public function doubleBooty():void
{
	...
	output("Why settle for one when you can enjoy two at the same time? You step over to an alcove shared by two raskvel women who have been installed atop one another, their tails buckled against the wall to keep the dexterous hind-limbs from getting up to any mischief. The one on bottom has a rich, crimson hue while the one above has fair, light blue scales. A pair of flickering, digital portraits on either side of the sandwiched booties depict the girls from the waist up, before they were installed here. The ruby girl has a regal air to her, clad in a tall-necked dress with coiffed hair, her head turned in profile, like she’s too good to look directly at the camera. The turquoise girl, on the other hand, has no such restraint, as her picture shows a pierced, punky brat bending her head to lick her own nipple, without breaking eye-contact.");
...
public function mediumBubbleGiftForCherry2():void
{
	...
	output("\n\nThe customers caught up in the display cheer and clap, but Cherry’s rosy, unguarded gaze is turned only to you. She smiles weakly, chest heaving as she fingers her neckband.");
...
public function bubbledBitchesNeedBoounced():void
{
	...
	showCherry();
	author("Adjatha");
	output("The gravid silhouette of the Tap-Hall’s blushing owner of can’t help but draw your eye. Sidling next to her, you lean over and whisper to ask if she’s still safe to touch.");
