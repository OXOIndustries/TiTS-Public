...
public function victoryOverShockyHoppy():void
{
	...
	if(pc.lust() >= 33)
	{
		...
		if(pc.hasVagina())
		{
			...
			else if(pc.isAmazon()) addButton(6,"Drain Bunnies",vaginaRouter,[drainBunnies,enemy.cockVolume(0),0,0],"Drain Bunnies","After a fight like that, what better way to work out your differences than riding both those rabbits to exhaustion?");
...
public function domTheLDCsAss2(x:int):void
{
	...
	if(pc.isAmazon() || pc.isAss()) output("You’re gonna be wailing to the room how much you love being a sissy in his place.");
	...
	output("\n\nYou stand and collect your gear, all the while thinking of what you should do now as the lawless echelon slowly rouse. One thing’s for sure: you’ve left that bunny-boy little more than a shuddering lump of " + (pc.hasCock() ? "[pc.cumNoun]-splattered ":"") + "coal.");
	output("\n\n");
	processTime(35);
...
public function drainBunnies2(x:int):void
{
	...
	output("\n\n<i>“" + (pc.isAmazon() ? "Hold up, I want her too. But first... she can watch just a little longer.":"Ooh, wait, I want her too! Just gimme a sec...") + "”</i>");
	output("\n\n" + (pc.isAmazon() ? "Alright!":"O-kay!") + " No more waiting around... Nerves fire the second you touch LDC’s bulging cumslit to your sopping-wet box - a squirt of pre fires into your snatch. The laquine’s blunt tip plows through your opening, flare straining against your deliciously wet walls like a mutant knot and forcing out every unkind thought. That was the easy part.");
	output("\n\nThe bunny boss’s groans climb to higher pitches of pleasure, screaming out with inches claimed. What you felt was halting at first, and now your " + (pc.isAmazon() ? "husky":"bubbly") + " voice is layering over his. Eyes widen all around you watching your body rock, flail, and spasm trying to take his slick prick further, your squeezing canal blocking his pre from escaping. This kind of dick was meant for a leithan! You’re already appreciating what that jumpsuit-wearing slut is capable of, because " + (pc.vaginalCapacity(x) >= enemy.cockVolume(0) ? "even with your ‘skills’":"even with the lube") + " this is...");
	...
	output("\n\n<i>“" + (pc.isAmazon() ? "You were saying, little boy? Why don’t you go ahead and tell me how much you need me right now!":"Nah, this is nothin’! We haven’t gotten to the fun part yet!") + "”</i>");
	...
	output("\n\n<i>“" + (pc.isAmazon() ? "G-go on, say it. Let everyone know how your mistress makes you feel, sissy boy!":"Look, it’s all mine now!") + "”</i> you squeal, one eye closed.");
	output("\n\n<i>“" + (pc.isAmazon() ? "<i>“A-ah... Fuck! I love it! There, are you happy!? I can’t take this... Fuck me! Please!":"You’re a total... ah... f-f-fuck me! Please, I can’t take this!") + "”</i> he cries in heaving surrender.");
	...
	output("\n\n<i>“" + (pc.isAmazon() ? "About time, honey bun. Why don’t you go ahead and show me how ‘ya feel about being the lesser girl here?":"Oohh, you feel worked up!”</i> You reach a hand back to spread your cheeks, cooing <i>“Then don’t keep me waiting, big girl!") + "”</i>");
	output("\n\n<i>“" + (pc.isAmazon() ? "I’ll show you lesser when I’m...”</i> The Hopper thrusts indignantly into your [pc.asshole]. <i>“...When I’m turning you into a cum bubble!":"You want him, you get me too...”</i> She growls, thrusting indignantly into your [pc.asshole]. <i>“...I’m gonna fill you until you’re just a cum bubble, slut!") + "”</i> " + (pc.isAmazon() ? "You can’t deny her energy is already firing you up!":"Fuck yes! Every drop in her balls too? <i>Aren’t you just the luckiest slut to get two laquine’s hosing you down?</i>"));
	...
	output("\n\nYour [pc.pussies] strain" + (pc.hasVaginas() ? " and flood":"s and floods") + ", oozing mixed cum into musky crotches. <i>“C’monnn, you two can do better than this!”</i> you chirp, a mischievous smile cresting your blissed features. <i>“I’m soo close to cumming, where are you?”</i> One [pc.hand] around LDC’s ears and the other on his balls, you laugh a happy, " + (pc.isAmazon() ? "triumphant":"bubbly") + " laugh as you throw him into orgasm. The Hopper’s hand " + (pc.hasEmoteEars() ? "ends up around your [pc.ears]":"on your head") + " doing much the same. Their voices quake into you, weaker effects compared to the hard, intense throbbings of their dicks.");
	...
	output("\n\n...Because you weren’t intending to stop at one round. " + (pc.isAmazon() ? "It’s not long before you can breathe again and you’re energized by your own release.":"Your own release refreshes your mind, and breathing becomes simple again. There’s so much cum to take, how can you stop?"));
