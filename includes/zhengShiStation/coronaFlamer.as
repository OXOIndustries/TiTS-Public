	...
	switch (order)
	{
		...
		case FIREPUP_KNEEL:
			...
			if (pc.hasCock())
			{
				...
				if (pc.cumQ() < 1000) output(" shoots down her throat as her eyes roll up into her head in bliss, the familiar noise of her bitch pussy squirting all over the ground reaching your [pc.ears] while you empty yourself into her stomach. The moment you're done you push her backwards coughing and choking, gagging on your cum mid-swallow.");
				else if (pc.cumQ() < 3000) output(" pours smoothly down her throat and into her stomach as her eyes roll up into her head in bliss, the familiar noise of her bitch pussy squirting all over the ground reaching your [pc.ears]. Her belly swells to contain your pumping loads until you've given her everything you care to and push her over into a puddle of her own juices, leaving her coughing and choking as she gags on your cum mid-swallow.");
				else if (pc.cumQ() < 6000) output(" gushes down her tight throat and into her gurgling tummy, pumping it full until her skin draws taut and begins to stretch outwards to contain your seed, her hands stroking the baby bulge. Only when you're satisfied you've given her slut belly every last drop do you push her off the end of your prick into the puddle of juices her pussy squirted all over the ground during her usage, leaving her gagging and choking as she tries to draw air after her rough fucking.");
				else
				{
		...
		case FIREPUP_BEND:
			...
			if (pc.hasCock())
			{
				...
				if (pc.cumQ() < 1000) output(" dripping with your essence, marked as your bitch");
				else if (pc.cumQ() < 3000) output(" with seed streaming down her thighs and her belly slightly swollen");
				else if (pc.cumQ() < 6000) output(" belly swollen outward with your cum and the excess flooding down her weakened thighs");
