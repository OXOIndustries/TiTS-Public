...
public function cousinEncounterBonus():Boolean
{
	if(flags["FERUZE_ZHENG_OUTCOME"] == undefined)
	{
		...
		output("\n\n<i>“Look at that, another of the infamous Steele line who can’t manage to adhere to the simplest tenants of civilization. Why wait your turn when you can brute force your way through life and take it all for yourself?”</i> [rival.HeShe] spits in apparent disgust, the oblong blob of spittle sailing for long seconds into the foundry’s red glow. <i>“Well I’m not relying on that idiot with a dog-dick for brains for any more. You won’t get past Feruze.”</i> [rival.name] giggles to [rival.himHer]self. <i>“That inheritance belongs to </i>me<i>.”</i>");
		output("\n\n[rival.HeShe] clearly isn’t in a talking mood, but his hulking yet feminine bodyguard isn’t coming at you yet. You could back off for the moment if you aren’t ready to take them...");
		//[Fight] [Leave]
		clearMenu();
...
public function normalLossToFeruze():void
{
	...
	else if(pc.HP() <= 1)
	{
		...
		output("\n\nSure enough, her words ring disturbingly true. The numbness fades into a gentle, growing warmth. Everywhere her cunt touched returns to full sensitivity and them some. You can detect every little current of air as it washes over your [pc.skinFurScales], feeling very much like the slobbering tongue. Your whole body flushes as her pussy-secreted drugs spread through your bloodstream, but nowhere so powerfully as in your loins.");
...
public function defeatFeruze():void
{
	...
	if(enemy.HP() <= 1)
	{
		...
		output("\n\n[rival.name] sneers at Feruze. <i>“What a waste. Fortunately I anticipated such a failure. The coordinates are as good as mine.”</i> [rival.HeShe] pockets his glowing tablet with a cocksure smirk. <i>“If you can make it back to the ship, I’ll consider keeping you on... for a reduced rate. Do try to be less disappointing this time, hmmm, Feruze?”</i> With a flourish and a wave, [rival.name] tumbles backward off the catwalk... and high powered boosters in [rival.hisHer] shield belt flash, carrying [rival.himHer] away on streamers of neon-blue exhaust.");
		output("\n\nFuck.");
...
public function fuckFeruzesPussy4(x:int):void
{
	...
	showFeruze();
	author("Fenoxo");
	output("You wake up next to a snoring, drenched Feruze. Her drone is buzzing around on perimeter watch. You feel well-rested and exceedingly satisfied sexually, and judging by the contented girl’s snores, she feels similarly.");
