...
public function questionQuestionQuestionRATS2():void
{
	...
	output("\n\n<i>“You-”</i> [rival.name] growls, <i>“you and I are going to have a long chat about your pay.”</i> [riva.heShe] scowls back to you and your tamed mischief. <i>“This isn’t over, not by a long shot, dear [pc.name]. I anticipated Feruze being bested, but you’ve outdone yourself this time. By all means, get the probe, but rest assured the coordinates are as good as mine!”</i>");
