...
public function enemyAphrodisiacDarts():void
{
	...
	if(foes[0].plural) output("“<i>Boo! Raaaaar!</i>” shouts the big raskvel, waving his arms at you. At the same time, one of the others pulls an injector gun from his belt and fires three needles at you near soundlessly.")
